pub static ALL_PERIPHERAL_VERSIONS: &[(&str, &[&str])] = &[
    (
        "adc",
        &[
            "f1", "f3", "f3_v1_1", "f3_v2", "g0", "g4", "h5", "l0", "u0", "u5", "v1", "v2", "v3", "v4",
        ],
    ),
    ("adccommon", &["f3", "h5", "h50", "u5", "v2", "v3", "v4"]),
    ("adf", &["v1"]),
    ...
    (
        "rcc",
        &[
            "c0", "f0v1", "f0v2", "f0v3", "f0v4", "f1", "f100", "f1cl", "f2", "f37", "f3v1", "f3v2", "f3v3", "f4",
            "f410", "f7", "g0", "g4", "h5", "h50", "h7", "h7ab", "h7rm0433", "h7rs", "l0", "l0_v2", "l1", "l4",
            "l4plus", "l5", "u0", "u5", "wb", "wba", "wl5", "wle",
        ],
    ),
    ("rng", &["v1", "v2", "v3"]),
    (
        "rtc",
        &[
            "v1", "v2f0", "v2f2", "v2f3", "v2f4", "v2f7", "v2h7", "v2l0", "v2l1", "v2l4", "v2wb", "v3", "v3l5", "v3u5",
        ],
    ),
    ("saes", &["v1a", "v1b"]),
