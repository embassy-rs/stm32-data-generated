...
#[path="../registers/dbgmcu_f2.rs"] pub mod dbgmcu;
#[path="../registers/dma_v2.rs"] pub mod dma;
#[path="../registers/exti_v1.rs"] pub mod exti;
#[path="../registers/flash_f2.rs"] pub mod flash;
#[path="../registers/fsmc_v1x3.rs"] pub mod fsmc;
...
#[path="../registers/pwr_f2.rs"] pub mod pwr;
#[path="../registers/rcc_f2.rs"] pub mod rcc;
#[path="../registers/rng_v1.rs"] pub mod rng;
#[path="../registers/rtc_v2f2.rs"] pub mod rtc;
#[path="../registers/sdmmc_v1.rs"] pub mod sdmmc;
#[path="../registers/spi_v1.rs"] pub mod spi;
#[path="../registers/syscfg_f2.rs"] pub mod syscfg;
