...
pub mod pwr;
#[path = "../registers/rcc_f2.rs"]
pub mod rcc;
#[path = "../registers/rng_v1.rs"]
pub mod rng;
#[path = "../registers/rtc_v2_f2.rs"]
pub mod rtc;
#[path = "../registers/sdmmc_v1.rs"]
pub mod sdmmc;
#[path = "../registers/spi_v2_i2s.rs"]
pub mod spi;
#[path = "../registers/syscfg_f2.rs"]
pub mod syscfg;
