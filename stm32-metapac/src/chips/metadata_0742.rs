...
pub mod lptim;
#[path = "../registers/opamp_u0.rs"]
pub mod opamp;
#[path = "../registers/pwr_u0.rs"]
pub mod pwr;
#[path = "../registers/rcc_u0.rs"]
pub mod rcc;
...
pub mod usb;
#[path = "../registers/usbram_32_1024.rs"]
pub mod usbram;
