...
pub enum Interrupt {
    ...
    DMA1_CHANNEL2_3 = 10,
    #[doc = "11 - DMAMUX1_DMA1_CH4_5_6_7"]
    DMAMUX1_DMA1_CH4_5_6_7 = 11,
    #[doc = "12 - ADC1"]
    ADC1 = 12,
...
mod _vectors {
    ...
    pub static __INTERRUPTS: [Vector; 32] = [
        ...
        Vector {
            _handler: DMAMUX1_DMA1_CH4_5_6_7,
        },
...
pub const UID: uid::Uid = unsafe { uid::Uid::from_ptr(0x1fff_7550usize as _) };
...
#[path = "../../peripherals/adc_c0.rs"]
pub mod adc;
#[path = "../../peripherals/adccommon_c0.rs"]
pub mod adccommon;
...
pub mod crc;
#[path = "../../peripherals/dbgmcu_c0.rs"]
pub mod dbgmcu;
#[path = "../../peripherals/dmamux_v1.rs"]
pub mod dmamux;
#[path = "../../peripherals/exti_c0.rs"]
pub mod exti;
#[path = "../../peripherals/fdcanram_v1.rs"]
pub mod fdcanram;
#[path = "../../peripherals/flash_c0.rs"]
pub mod flash;
