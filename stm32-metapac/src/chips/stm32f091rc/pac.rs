...
pub enum Interrupt {
    ...
    #[doc = "9 - DMA1_CH1"]
    DMA1_CH1 = 9,
    #[doc = "10 - DMA1_CH2_3_DMA2_CH1_2"]
    DMA1_CH2_3_DMA2_CH1_2 = 10,
    #[doc = "11 - DMA1_CH4_7_DMA2_CH3_5"]
...
mod _vectors {
    ...
    pub static __INTERRUPTS: [Vector; 31] = [
        ...
        Vector {
            _handler: DMA1_CH4_7_DMA2_CH3_5,
        },
...
pub const CRS: crs::Crs = unsafe { crs::Crs::from_ptr(0x4000_6c00 as _) };
...
pub const USART7: usart::Usart = unsafe { usart::Usart::from_ptr(0x4001_1800 as _) };
pub const USART8: usart::Usart = unsafe { usart::Usart::from_ptr(0x4001_1c00 as _) };
