...
pub const USART7: usart::Usart = unsafe { usart::Usart::from_ptr(0x4001_1800usize as _) };
pub const USART8: usart::Usart = unsafe { usart::Usart::from_ptr(0x4001_1c00usize as _) };
