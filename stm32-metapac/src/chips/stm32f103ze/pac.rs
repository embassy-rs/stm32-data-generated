...
pub enum Interrupt {
    ...
    #[doc = "18 - ADC1_2"]
    ADC1_2 = 18,
    #[doc = "19 - USB_HP_CAN1_TX"]
    USB_HP_CAN1_TX = 19,
    #[doc = "20 - USB_LP_CAN1_RX0"]
    USB_LP_CAN1_RX0 = 20,
    #[doc = "21 - CAN1_RX1"]
    CAN1_RX1 = 21,
    #[doc = "22 - CAN1_SCE"]
...
pub const UID: uid::Uid = unsafe { uid::Uid::from_ptr(0x1fff_f7e8 as _) };
...
pub const TIM5: timer::TimGp16 = unsafe { timer::TimGp16::from_ptr(0x4000_0c00 as _) };
...
pub const BKP: bkp::Bkp = unsafe { bkp::Bkp::from_ptr(0x4000_6c00 as _) };
...
pub const AFIO: afio::Afio = unsafe { afio::Afio::from_ptr(0x4001_0000 as _) };
pub const EXTI: exti::Exti = unsafe { exti::Exti::from_ptr(0x4001_0400 as _) };
pub const GPIOA: gpio::Gpio = unsafe { gpio::Gpio::from_ptr(0x4001_0800 as _) };
pub const GPIOB: gpio::Gpio = unsafe { gpio::Gpio::from_ptr(0x4001_0c00 as _) };
pub const GPIOC: gpio::Gpio = unsafe { gpio::Gpio::from_ptr(0x4001_1000 as _) };
pub const GPIOD: gpio::Gpio = unsafe { gpio::Gpio::from_ptr(0x4001_1400 as _) };
pub const GPIOE: gpio::Gpio = unsafe { gpio::Gpio::from_ptr(0x4001_1800 as _) };
pub const GPIOF: gpio::Gpio = unsafe { gpio::Gpio::from_ptr(0x4001_1c00 as _) };
pub const GPIOG: gpio::Gpio = unsafe { gpio::Gpio::from_ptr(0x4001_2000 as _) };
pub const ADC1: adc::Adc = unsafe { adc::Adc::from_ptr(0x4001_2400 as _) };
pub const ADC_COMMON: *mut () = 0x4001_2400 as _;
pub const ADC2: adc::Adc = unsafe { adc::Adc::from_ptr(0x4001_2800 as _) };
...
pub const ADC3: adc::Adc = unsafe { adc::Adc::from_ptr(0x4001_3c00 as _) };
pub const SDIO: sdmmc::Sdmmc = unsafe { sdmmc::Sdmmc::from_ptr(0x4001_8000 as _) };
