...
pub const COMP2: *mut () = 0x4001_0020 as usize as _;
pub const COMP3: *mut () = 0x4001_0024 as usize as _;
pub const COMP4: *mut () = 0x4001_0028 as usize as _;
...
pub const ADC3_COMMON: adccommon::AdcCommon = unsafe { adccommon::AdcCommon::from_ptr(0x5000_0700 as usize as _) };
