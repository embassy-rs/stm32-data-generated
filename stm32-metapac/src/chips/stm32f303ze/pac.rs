...
pub enum Interrupt {
    ...
    #[doc = "18 - ADC1_2"]
    ADC1_2 = 18,
    #[doc = "19 - USB_HP_CAN_TX"]
    USB_HP_CAN_TX = 19,
    #[doc = "20 - USB_LP_CAN_RX0"]
    USB_LP_CAN_RX0 = 20,
    #[doc = "21 - CAN_RX1"]
    CAN_RX1 = 21,
    #[doc = "22 - CAN_SCE"]
...
pub const VREFINTCAL: vrefintcal::Vrefintcal = unsafe { vrefintcal::Vrefintcal::from_ptr(0x1fff_f7ba as _) };
...
pub const CAN: can::Can = unsafe { can::Can::from_ptr(0x4000_6400 as _) };
...
pub const COMP2: *mut () = 0x4001_0020 as _;
pub const COMP3: *mut () = 0x4001_0024 as _;
pub const COMP4: *mut () = 0x4001_0028 as _;
pub const COMP5: *mut () = 0x4001_002c as _;
pub const COMP6: *mut () = 0x4001_0030 as _;
pub const COMP7: *mut () = 0x4001_0034 as _;
pub const OPAMP1: opamp::Opamp = unsafe { opamp::Opamp::from_ptr(0x4001_0038 as _) };
pub const OPAMP2: opamp::Opamp = unsafe { opamp::Opamp::from_ptr(0x4001_003c as _) };
pub const OPAMP3: opamp::Opamp = unsafe { opamp::Opamp::from_ptr(0x4001_0040 as _) };
pub const OPAMP4: opamp::Opamp = unsafe { opamp::Opamp::from_ptr(0x4001_0044 as _) };
...
pub const ADC3_COMMON: adccommon::AdcCommon = unsafe { adccommon::AdcCommon::from_ptr(0x5000_0700 as _) };
...
pub mod dac;
#[path = "../../peripherals/dbgmcu_f3.rs"]
pub mod dbgmcu;
#[path = "../../peripherals/exti_v1.rs"]
pub mod exti;
#[path = "../../peripherals/flash_f3.rs"]
pub mod flash;
