...
pub const DAC2: dac::Dac = unsafe { dac::Dac::from_ptr(0x4000_9800 as usize as _) };
pub const TIM18: timer::TimBasic = unsafe { timer::TimBasic::from_ptr(0x4000_9c00 as usize as _) };
...
pub const TIM19: timer::TimGp16 = unsafe { timer::TimGp16::from_ptr(0x4001_5c00 as usize as _) };
pub const SDADC1: *mut () = 0x4001_6000 as usize as _;
pub const SDADC2: *mut () = 0x4001_6400 as usize as _;
pub const SDADC3: *mut () = 0x4001_6800 as usize as _;
