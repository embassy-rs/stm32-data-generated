...
pub const FMPI2C1: *mut () = 0x4000_6000 as usize as _;
...
pub const CAN3: can::Can = unsafe { can::Can::from_ptr(0x4000_6c00 as usize as _) };
...
pub const UART10: usart::Usart = unsafe { usart::Usart::from_ptr(0x4001_1c00 as usize as _) };
...
pub const DFSDM1: *mut () = 0x4001_6000 as usize as _;
pub const DFSDM2: *mut () = 0x4001_6400 as usize as _;
