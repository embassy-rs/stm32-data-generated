...
PROVIDE(FMPI2C1_EV = DefaultHandler);
PROVIDE(FMPI2C1_ER = DefaultHandler);
PROVIDE(LPTIM1 = DefaultHandler);
PROVIDE(DFSDM2_FLT0 = DefaultHandler);
PROVIDE(DFSDM2_FLT1 = DefaultHandler);
PROVIDE(DFSDM2_FLT2 = DefaultHandler);
PROVIDE(DFSDM2_FLT3 = DefaultHandler);
