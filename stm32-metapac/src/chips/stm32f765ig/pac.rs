...
pub const CAN3: can::Can = unsafe { can::Can::from_ptr(0x4000_3400 as usize as _) };
...
pub const SPDIFRX: spdifrx::Spdifrx = unsafe { spdifrx::Spdifrx::from_ptr(0x4000_4000 as usize as _) };
...
pub const I2C4: i2c::I2c = unsafe { i2c::I2c::from_ptr(0x4000_6000 as usize as _) };
pub const CAN1: can::Can = unsafe { can::Can::from_ptr(0x4000_6400 as usize as _) };
pub const CAN2: can::Can = unsafe { can::Can::from_ptr(0x4000_6800 as usize as _) };
...
pub const SDMMC2: sdmmc::Sdmmc = unsafe { sdmmc::Sdmmc::from_ptr(0x4001_1c00 as usize as _) };
pub const ADC1: adc::Adc = unsafe { adc::Adc::from_ptr(0x4001_2000 as usize as _) };
pub const ADC2: adc::Adc = unsafe { adc::Adc::from_ptr(0x4001_2100 as usize as _) };
...
pub const SDMMC1: sdmmc::Sdmmc = unsafe { sdmmc::Sdmmc::from_ptr(0x4001_2c00 as usize as _) };
...
pub const TIM10: timer::Tim1ch = unsafe { timer::Tim1ch::from_ptr(0x4001_4400 as usize as _) };
...
pub const DFSDM1: *mut () = 0x4001_7400 as usize as _;
pub const MDIOS: mdios::Mdios = unsafe { mdios::Mdios::from_ptr(0x4001_7800 as usize as _) };
...
pub const GPIOD: gpio::Gpio = unsafe { gpio::Gpio::from_ptr(0x4002_0c00 as usize as _) };
pub const GPIOE: gpio::Gpio = unsafe { gpio::Gpio::from_ptr(0x4002_1000 as usize as _) };
pub const GPIOF: gpio::Gpio = unsafe { gpio::Gpio::from_ptr(0x4002_1400 as usize as _) };
pub const GPIOG: gpio::Gpio = unsafe { gpio::Gpio::from_ptr(0x4002_1800 as usize as _) };
pub const GPIOH: gpio::Gpio = unsafe { gpio::Gpio::from_ptr(0x4002_1c00 as usize as _) };
pub const GPIOI: gpio::Gpio = unsafe { gpio::Gpio::from_ptr(0x4002_2000 as usize as _) };
pub const GPIOJ: gpio::Gpio = unsafe { gpio::Gpio::from_ptr(0x4002_2400 as usize as _) };
pub const GPIOK: gpio::Gpio = unsafe { gpio::Gpio::from_ptr(0x4002_2800 as usize as _) };
pub const CRC: crc::Crc = unsafe { crc::Crc::from_ptr(0x4002_3000 as usize as _) };
pub const RCC: rcc::Rcc = unsafe { rcc::Rcc::from_ptr(0x4002_3800 as usize as _) };
