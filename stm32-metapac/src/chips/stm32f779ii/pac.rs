...
pub const UID: uid::Uid = unsafe { uid::Uid::from_ptr(0x1ff0_f420usize as _) };
pub const VREFINTCAL: vrefintcal::Vrefintcal = unsafe { vrefintcal::Vrefintcal::from_ptr(0x1ff0_f44ausize as _) };
pub const TS_CAL1: tscal::Tscal = unsafe { tscal::Tscal::from_ptr(0x1ff0_f44cusize as _) };
pub const TS_CAL2: tscal::Tscal = unsafe { tscal::Tscal::from_ptr(0x1ff0_f44eusize as _) };
...
pub const CAN3: can::Can = unsafe { can::Can::from_ptr(0x4000_3400usize as _) };
...
pub const SDMMC2: sdmmc::Sdmmc = unsafe { sdmmc::Sdmmc::from_ptr(0x4001_1c00usize as _) };
pub const ADC1: adc::Adc = unsafe { adc::Adc::from_ptr(0x4001_2000usize as _) };
pub const ADC2: adc::Adc = unsafe { adc::Adc::from_ptr(0x4001_2100usize as _) };
pub const ADC3: adc::Adc = unsafe { adc::Adc::from_ptr(0x4001_2200usize as _) };
pub const ADC123_COMMON: adccommon::AdcCommon = unsafe { adccommon::AdcCommon::from_ptr(0x4001_2300usize as _) };
pub const SDMMC1: sdmmc::Sdmmc = unsafe { sdmmc::Sdmmc::from_ptr(0x4001_2c00usize as _) };
...
pub const GPIOJ: gpio::Gpio = unsafe { gpio::Gpio::from_ptr(0x4002_2400usize as _) };
pub const GPIOK: gpio::Gpio = unsafe { gpio::Gpio::from_ptr(0x4002_2800usize as _) };
...
pub const USB_OTG_FS: otg::Otg = unsafe { otg::Otg::from_ptr(0x5000_0000usize as _) };
pub const DCMI: dcmi::Dcmi = unsafe { dcmi::Dcmi::from_ptr(0x5005_0000usize as _) };
pub const JPEG: jpeg::Jpeg = unsafe { jpeg::Jpeg::from_ptr(0x5005_1000usize as _) };
pub const CRYP: cryp::Cryp = unsafe { cryp::Cryp::from_ptr(0x5006_0000usize as _) };
