...
mod _vectors {
    ...
    pub static __INTERRUPTS: [Vector; 32] = [
        ...
        Vector {
            _handler: DMA1_CH4_7_DMAMUX1_OVR,
        },
...
pub const UCPD2: ucpd::Ucpd = unsafe { ucpd::Ucpd::from_ptr(0x4000_a400 as _) };
...
pub const RNG: rng::Rng = unsafe { rng::Rng::from_ptr(0x4002_5000 as _) };
pub const AES: aes::Aes = unsafe { aes::Aes::from_ptr(0x4002_6000 as _) };
