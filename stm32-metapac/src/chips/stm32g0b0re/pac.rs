...
pub enum Interrupt {
    ...
    DMA1_CHANNEL2_3 = 10,
    #[doc = "11 - DMA1_CH4_7_DMA2_CH1_5_DMAMUX1_OVR"]
...
mod _vectors {
    extern "C" {
        ...
        fn DMA1_CHANNEL1();
        fn DMA1_CHANNEL2_3();
        fn DMA1_CH4_7_DMA2_CH1_5_DMAMUX1_OVR();
        fn ADC1();
    ...
    pub static __INTERRUPTS: [Vector; 30] = [
        ...
        Vector {
            _handler: DMA1_CH4_7_DMA2_CH1_5_DMAMUX1_OVR,
        },
        ...
        Vector { _handler: I2C2_3 },
        Vector { _handler: SPI1 },
        Vector { _handler: SPI2_3 },
        Vector { _handler: USART1 },
        Vector { _handler: USART2 },
        Vector { _handler: USART3_4_5_6 },
    ];
}
...
pub const USART4: usart::Usart = unsafe { usart::Usart::from_ptr(0x4000_4c00 as _) };
pub const USART5: usart::Usart = unsafe { usart::Usart::from_ptr(0x4000_5000 as _) };
...
pub const I2C3: i2c::I2c = unsafe { i2c::I2c::from_ptr(0x4000_8800 as _) };
pub const USBRAM: usbram::Usbram = unsafe { usbram::Usbram::from_ptr(0x4000_9800 as _) };
pub const TAMP: tamp::Tamp = unsafe { tamp::Tamp::from_ptr(0x4000_b000 as _) };
...
pub const ADC_COMMON: adccommon::AdcCommon = unsafe { adccommon::AdcCommon::from_ptr(0x4001_2708 as _) };
...
pub const USART6: usart::Usart = unsafe { usart::Usart::from_ptr(0x4001_3c00 as _) };
...
pub const EXTI: exti::Exti = unsafe { exti::Exti::from_ptr(0x4002_1800 as _) };
...
pub const GPIOA: gpio::Gpio = unsafe { gpio::Gpio::from_ptr(0x5000_0000 as _) };
pub const GPIOB: gpio::Gpio = unsafe { gpio::Gpio::from_ptr(0x5000_0400 as _) };
pub const GPIOC: gpio::Gpio = unsafe { gpio::Gpio::from_ptr(0x5000_0800 as _) };
pub const GPIOD: gpio::Gpio = unsafe { gpio::Gpio::from_ptr(0x5000_0c00 as _) };
pub const GPIOE: gpio::Gpio = unsafe { gpio::Gpio::from_ptr(0x5000_1000 as _) };
pub const GPIOF: gpio::Gpio = unsafe { gpio::Gpio::from_ptr(0x5000_1400 as _) };
