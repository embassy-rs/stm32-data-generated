...
pub const UID: uid::Uid = unsafe { uid::Uid::from_ptr(0x1fff_7590 as _) };
...
pub const CRS: crs::Crs = unsafe { crs::Crs::from_ptr(0x4000_2000 as _) };
pub const TAMP: tamp::Tamp = unsafe { tamp::Tamp::from_ptr(0x4000_2400 as _) };
...
pub const USB: usb::Usb = unsafe { usb::Usb::from_ptr(0x4000_5c00 as _) };
pub const USBRAM: usbram::Usbram = unsafe { usbram::Usbram::from_ptr(0x4000_6000 as _) };
pub const FDCAN1: can::Fdcan = unsafe { can::Fdcan::from_ptr(0x4000_6400 as _) };
pub const FDCAN2: can::Fdcan = unsafe { can::Fdcan::from_ptr(0x4000_6800 as _) };
pub const FDCAN3: can::Fdcan = unsafe { can::Fdcan::from_ptr(0x4000_6c00 as _) };
pub const PWR: pwr::Pwr = unsafe { pwr::Pwr::from_ptr(0x4000_7000 as _) };
pub const I2C3: i2c::I2c = unsafe { i2c::I2c::from_ptr(0x4000_7800 as _) };
pub const LPTIM1: lptim::Lptim = unsafe { lptim::Lptim::from_ptr(0x4000_7c00 as _) };
pub const LPUART1: usart::Lpuart = unsafe { usart::Lpuart::from_ptr(0x4000_8000 as _) };
pub const I2C4: i2c::I2c = unsafe { i2c::I2c::from_ptr(0x4000_8400 as _) };
pub const UCPD1: ucpd::Ucpd = unsafe { ucpd::Ucpd::from_ptr(0x4000_a000 as _) };
pub const FDCANRAM1: fdcanram::Fdcanram = unsafe { fdcanram::Fdcanram::from_ptr(0x4000_a400 as _) };
pub const FDCANRAM2: fdcanram::Fdcanram = unsafe { fdcanram::Fdcanram::from_ptr(0x4000_a750 as _) };
pub const FDCANRAM3: fdcanram::Fdcanram = unsafe { fdcanram::Fdcanram::from_ptr(0x4000_aaa0 as _) };
pub const SYSCFG: syscfg::Syscfg = unsafe { syscfg::Syscfg::from_ptr(0x4001_0000 as _) };
pub const COMP1: comp::Comp = unsafe { comp::Comp::from_ptr(0x4001_0200 as _) };
pub const COMP2: comp::Comp = unsafe { comp::Comp::from_ptr(0x4001_0204 as _) };
pub const COMP3: comp::Comp = unsafe { comp::Comp::from_ptr(0x4001_0208 as _) };
pub const COMP4: comp::Comp = unsafe { comp::Comp::from_ptr(0x4001_020c as _) };
pub const COMP5: comp::Comp = unsafe { comp::Comp::from_ptr(0x4001_0210 as _) };
pub const COMP6: comp::Comp = unsafe { comp::Comp::from_ptr(0x4001_0214 as _) };
pub const COMP7: comp::Comp = unsafe { comp::Comp::from_ptr(0x4001_0218 as _) };
pub const OPAMP1: opamp::Opamp = unsafe { opamp::Opamp::from_ptr(0x4001_0300 as _) };
pub const OPAMP2: opamp::Opamp = unsafe { opamp::Opamp::from_ptr(0x4001_0304 as _) };
pub const OPAMP3: opamp::Opamp = unsafe { opamp::Opamp::from_ptr(0x4001_0308 as _) };
pub const OPAMP4: opamp::Opamp = unsafe { opamp::Opamp::from_ptr(0x4001_030c as _) };
pub const OPAMP5: opamp::Opamp = unsafe { opamp::Opamp::from_ptr(0x4001_0310 as _) };
pub const OPAMP6: opamp::Opamp = unsafe { opamp::Opamp::from_ptr(0x4001_0314 as _) };
...
pub const SPI4: spi::Spi = unsafe { spi::Spi::from_ptr(0x4001_3c00 as _) };
...
pub const TIM20: timer::TimAdv = unsafe { timer::TimAdv::from_ptr(0x4001_5000 as _) };
pub const SAI1: sai::Sai = unsafe { sai::Sai::from_ptr(0x4001_5400 as _) };
pub const HRTIM1: hrtim::Hrtim = unsafe { hrtim::Hrtim::from_ptr(0x4001_6800 as _) };
pub const DMA1: bdma::Dma = unsafe { bdma::Dma::from_ptr(0x4002_0000 as _) };
pub const DMA2: bdma::Dma = unsafe { bdma::Dma::from_ptr(0x4002_0400 as _) };
pub const DMAMUX1: dmamux::Dmamux = unsafe { dmamux::Dmamux::from_ptr(0x4002_0800 as _) };
pub const CORDIC: cordic::Cordic = unsafe { cordic::Cordic::from_ptr(0x4002_0c00 as _) };
...
pub const GPIOE: gpio::Gpio = unsafe { gpio::Gpio::from_ptr(0x4800_1000 as _) };
pub const GPIOF: gpio::Gpio = unsafe { gpio::Gpio::from_ptr(0x4800_1400 as _) };
pub const GPIOG: gpio::Gpio = unsafe { gpio::Gpio::from_ptr(0x4800_1800 as _) };
pub const ADC1: adc::Adc = unsafe { adc::Adc::from_ptr(0x5000_0000 as _) };
pub const ADC2: adc::Adc = unsafe { adc::Adc::from_ptr(0x5000_0100 as _) };
pub const ADC_COMMON: adccommon::AdcCommon = unsafe { adccommon::AdcCommon::from_ptr(0x5000_0300 as _) };
pub const ADC3: adc::Adc = unsafe { adc::Adc::from_ptr(0x5000_0400 as _) };
pub const ADC4: adc::Adc = unsafe { adc::Adc::from_ptr(0x5000_0500 as _) };
pub const ADC5: adc::Adc = unsafe { adc::Adc::from_ptr(0x5000_0600 as _) };
pub const DAC1: dac::Dac = unsafe { dac::Dac::from_ptr(0x5000_0800 as _) };
pub const DAC2: dac::Dac = unsafe { dac::Dac::from_ptr(0x5000_0c00 as _) };
pub const DAC3: dac::Dac = unsafe { dac::Dac::from_ptr(0x5000_1000 as _) };
pub const DAC4: dac::Dac = unsafe { dac::Dac::from_ptr(0x5000_1400 as _) };
pub const AES: aes::Aes = unsafe { aes::Aes::from_ptr(0x5006_0000 as _) };
pub const RNG: rng::Rng = unsafe { rng::Rng::from_ptr(0x5006_0800 as _) };
pub const FMC: *mut () = 0x6000_0000 as _;
pub const QUADSPI1: quadspi::Quadspi = unsafe { quadspi::Quadspi::from_ptr(0xa000_1000 as _) };
