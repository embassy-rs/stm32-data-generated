...
FDCAN_CAL = 63 , # [doc = "68 - DMA2_STREAM5"]
...
#[path="../../peripherals/pwr_h7rm0468.rs"] pub mod pwr;
...
#[path="../../peripherals/spdifrx_h7.rs"] pub mod spdifrx;
