...
pub const UID: uid::Uid = unsafe { uid::Uid::from_ptr(0x1ff1_e800 as usize as _) };
...
pub const TIM12: timer::Tim2ch = unsafe { timer::Tim2ch::from_ptr(0x4000_1800 as usize as _) };
pub const TIM13: timer::Tim1ch = unsafe { timer::Tim1ch::from_ptr(0x4000_1c00 as usize as _) };
pub const TIM14: timer::Tim1ch = unsafe { timer::Tim1ch::from_ptr(0x4000_2000 as usize as _) };
...
pub const I2C5: i2c::I2c = unsafe { i2c::I2c::from_ptr(0x4000_6400 as usize as _) };
pub const CEC: *mut () = 0x4000_6c00 as usize as _;
...
pub const TIM1: timer::TimAdv = unsafe { timer::TimAdv::from_ptr(0x4001_0000 as usize as _) };
pub const TIM8: timer::TimAdv = unsafe { timer::TimAdv::from_ptr(0x4001_0400 as usize as _) };
pub const USART1: usart::Usart = unsafe { usart::Usart::from_ptr(0x4001_1000 as usize as _) };
pub const USART6: usart::Usart = unsafe { usart::Usart::from_ptr(0x4001_1400 as usize as _) };
pub const UART9: usart::Usart = unsafe { usart::Usart::from_ptr(0x4001_1800 as usize as _) };
pub const USART10: usart::Usart = unsafe { usart::Usart::from_ptr(0x4001_1c00 as usize as _) };
...
pub const DFSDM1: *mut () = 0x4001_7800 as usize as _;
...
pub const OCTOSPI1: octospi::Octospi = unsafe { octospi::Octospi::from_ptr(0x5200_5000 as usize as _) };
pub const SDMMC1: sdmmc::Sdmmc = unsafe { sdmmc::Sdmmc::from_ptr(0x5200_7000 as usize as _) };
pub const OCTOSPI2: octospi::Octospi = unsafe { octospi::Octospi::from_ptr(0x5200_a000 as usize as _) };
pub const OCTOSPIM: octospim::Octospim = unsafe { octospim::Octospim::from_ptr(0x5200_b400 as usize as _) };
pub const OTFDEC1: *mut () = 0x5200_b800 as usize as _;
pub const OTFDEC2: *mut () = 0x5200_bc00 as usize as _;
...
pub const LPUART1: usart::Lpuart = unsafe { usart::Lpuart::from_ptr(0x5800_0c00 as usize as _) };
pub const SPI6: spi::Spi = unsafe { spi::Spi::from_ptr(0x5800_1400 as usize as _) };
pub const I2C4: i2c::I2c = unsafe { i2c::I2c::from_ptr(0x5800_1c00 as usize as _) };
pub const LPTIM2: lptim::Lptim = unsafe { lptim::Lptim::from_ptr(0x5800_2400 as usize as _) };
pub const LPTIM3: lptim::Lptim = unsafe { lptim::Lptim::from_ptr(0x5800_2800 as usize as _) };
pub const LPTIM4: lptim::Lptim = unsafe { lptim::Lptim::from_ptr(0x5800_2c00 as usize as _) };
pub const LPTIM5: lptim::Lptim = unsafe { lptim::Lptim::from_ptr(0x5800_3000 as usize as _) };
pub const COMP1: *mut () = 0x5800_380c as usize as _;
pub const COMP2: *mut () = 0x5800_3810 as usize as _;
pub const VREFBUF: *mut () = 0x5800_3c00 as usize as _;
pub const RTC: rtc::Rtc = unsafe { rtc::Rtc::from_ptr(0x5800_4000 as usize as _) };
pub const IWDG1: iwdg::Iwdg = unsafe { iwdg::Iwdg::from_ptr(0x5800_4800 as usize as _) };
pub const SAI4: sai::Sai = unsafe { sai::Sai::from_ptr(0x5800_5400 as usize as _) };
pub const DTS: *mut () = 0x5800_6800 as usize as _;
pub const GPIOA: gpio::Gpio = unsafe { gpio::Gpio::from_ptr(0x5802_0000 as usize as _) };
pub const GPIOB: gpio::Gpio = unsafe { gpio::Gpio::from_ptr(0x5802_0400 as usize as _) };
pub const GPIOC: gpio::Gpio = unsafe { gpio::Gpio::from_ptr(0x5802_0800 as usize as _) };
pub const GPIOD: gpio::Gpio = unsafe { gpio::Gpio::from_ptr(0x5802_0c00 as usize as _) };
pub const GPIOE: gpio::Gpio = unsafe { gpio::Gpio::from_ptr(0x5802_1000 as usize as _) };
pub const GPIOF: gpio::Gpio = unsafe { gpio::Gpio::from_ptr(0x5802_1400 as usize as _) };
pub const GPIOG: gpio::Gpio = unsafe { gpio::Gpio::from_ptr(0x5802_1800 as usize as _) };
pub const GPIOH: gpio::Gpio = unsafe { gpio::Gpio::from_ptr(0x5802_1c00 as usize as _) };
pub const GPIOJ: gpio::Gpio = unsafe { gpio::Gpio::from_ptr(0x5802_2400 as usize as _) };
pub const GPIOK: gpio::Gpio = unsafe { gpio::Gpio::from_ptr(0x5802_2800 as usize as _) };
pub const RCC: rcc::Rcc = unsafe { rcc::Rcc::from_ptr(0x5802_4400 as usize as _) };
pub const PWR: pwr::Pwr = unsafe { pwr::Pwr::from_ptr(0x5802_4800 as usize as _) };
pub const CRC: crc::Crc = unsafe { crc::Crc::from_ptr(0x5802_4c00 as usize as _) };
pub const BDMA: bdma::Dma = unsafe { bdma::Dma::from_ptr(0x5802_5400 as usize as _) };
pub const DMAMUX2: dmamux::Dmamux = unsafe { dmamux::Dmamux::from_ptr(0x5802_5800 as usize as _) };
pub const ADC3: adc::Adc = unsafe { adc::Adc::from_ptr(0x5802_6000 as usize as _) };
pub const ADC3_COMMON: adccommon::AdcCommon = unsafe { adccommon::AdcCommon::from_ptr(0x5802_6300 as usize as _) };
