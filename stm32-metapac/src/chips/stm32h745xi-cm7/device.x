...
PROVIDE(CM7_SEV = DefaultHandler);
PROVIDE(CM4_SEV = DefaultHandler);
...
PROVIDE(HSEM2 = DefaultHandler);
PROVIDE(ADC3 = DefaultHandler);
PROVIDE(DMAMUX2_OVR = DefaultHandler);
PROVIDE(BDMA_CHANNEL0 = DefaultHandler);
PROVIDE(BDMA_CHANNEL1 = DefaultHandler);
PROVIDE(BDMA_CHANNEL2 = DefaultHandler);
PROVIDE(BDMA_CHANNEL3 = DefaultHandler);
PROVIDE(BDMA_CHANNEL4 = DefaultHandler);
