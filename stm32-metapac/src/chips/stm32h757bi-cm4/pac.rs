...
mod _vectors {
    ...
    pub static __INTERRUPTS: [Vector; 150] = [
        ...
        Vector { _handler: CM7_SEV },
        Vector { _handler: CM4_SEV },
        Vector { _reserved: 0 },
        Vector { _reserved: 0 },
...
pub const WWDG2: wwdg::Wwdg = unsafe { wwdg::Wwdg::from_ptr(0x4000_2c00 as usize as _) };
...
pub const JPEG: jpeg::Jpeg = unsafe { jpeg::Jpeg::from_ptr(0x5200_3000 as usize as _) };
pub const FMC: fmc::Fmc = unsafe { fmc::Fmc::from_ptr(0x5200_4000 as usize as _) };
pub const QUADSPI: quadspi::Quadspi = unsafe { quadspi::Quadspi::from_ptr(0x5200_5000 as usize as _) };
...
pub const IWDG2: iwdg::Iwdg = unsafe { iwdg::Iwdg::from_ptr(0x5800_4c00 as usize as _) };
...
pub const GPIOI: gpio::Gpio = unsafe { gpio::Gpio::from_ptr(0x5802_2000 as usize as _) };
