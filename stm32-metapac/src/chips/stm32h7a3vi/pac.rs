...
pub const SPDIFRX: *mut () = 0x4000_4000usize as _;
...
pub const DAC2: dac::Dac = unsafe { dac::Dac::from_ptr(0x5800_3400usize as _) };
...
pub const BDMA2: bdma::Dma = unsafe { bdma::Dma::from_ptr(0x5802_5400usize as _) };
