...
pub const LPUART1: usart::Lpuart = unsafe { usart::Lpuart::from_ptr(0x4000_4800 as _) };
...
pub const COMP1: *mut () = 0x4001_0018 as _;
pub const COMP2: *mut () = 0x4001_001c as _;
pub const EXTI: exti::Exti = unsafe { exti::Exti::from_ptr(0x4001_0400 as _) };
pub const TIM21: timer::Tim2ch = unsafe { timer::Tim2ch::from_ptr(0x4001_0800 as _) };
pub const TIM22: timer::Tim2ch = unsafe { timer::Tim2ch::from_ptr(0x4001_1400 as _) };
...
pub const GPIOH: gpio::Gpio = unsafe { gpio::Gpio::from_ptr(0x5000_1c00 as _) };
