...
pub const TIM21: timer::Tim2ch = unsafe { timer::Tim2ch::from_ptr(0x4001_0800 as usize as _) };
pub const TIM22: timer::Tim2ch = unsafe { timer::Tim2ch::from_ptr(0x4001_1400 as usize as _) };
