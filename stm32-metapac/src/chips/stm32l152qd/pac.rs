...
pub const COMP1: *mut () = 0x4000_7c00 as usize as _;
pub const COMP2: *mut () = 0x4000_7c01 as usize as _;
pub const OPAMP1: *mut () = 0x4000_7c5c as usize as _;
pub const OPAMP2: *mut () = 0x4000_7c5d as usize as _;
...
pub const GPIOH: gpio::Gpio = unsafe { gpio::Gpio::from_ptr(0x4002_1400 as usize as _) };
pub const GPIOF: gpio::Gpio = unsafe { gpio::Gpio::from_ptr(0x4002_1800 as usize as _) };
pub const GPIOG: gpio::Gpio = unsafe { gpio::Gpio::from_ptr(0x4002_1c00 as usize as _) };
