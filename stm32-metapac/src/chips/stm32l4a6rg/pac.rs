...
pub const LCD: lcd::Lcd = unsafe { lcd::Lcd::from_ptr(0x4000_2400 as _) };
...
pub const SDMMC1: sdmmc::Sdmmc = unsafe { sdmmc::Sdmmc::from_ptr(0x4001_2800 as _) };
...
pub const ADC3: adc::Adc = unsafe { adc::Adc::from_ptr(0x5004_0200 as _) };
