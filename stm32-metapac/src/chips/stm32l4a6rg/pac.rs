...
pub const DFSDM1: dfsdm::Dfsdm8ch4fltTrg3Adc = unsafe { dfsdm::Dfsdm8ch4fltTrg3Adc::from_ptr(0x4001_6000usize as _) };
...
pub const GPIOI: gpio::Gpio = unsafe { gpio::Gpio::from_ptr(0x4800_2000usize as _) };
...
pub const ADC3: adc::Adc = unsafe { adc::Adc::from_ptr(0x5004_0200usize as _) };
pub const ADC123_COMMON: adccommon::AdcCommon = unsafe { adccommon::AdcCommon::from_ptr(0x5004_0300usize as _) };
