...
pub const VREFINTCAL: vrefintcal::Vrefintcal = unsafe { vrefintcal::Vrefintcal::from_ptr(0x1fff_75aa as _) };
...
pub const SAI2: sai::Sai = unsafe { sai::Sai::from_ptr(0x4001_5800 as _) };
pub const DFSDM1: *mut () = 0x4001_6000 as _;
pub const LTDC: *mut () = 0x4001_6800 as _;
...
pub const GPIOH: gpio::Gpio = unsafe { gpio::Gpio::from_ptr(0x4800_1c00 as _) };
pub const GPIOI: gpio::Gpio = unsafe { gpio::Gpio::from_ptr(0x4800_2000 as _) };
pub const USB_OTG_FS: otg::Otg = unsafe { otg::Otg::from_ptr(0x5000_0000 as _) };
pub const ADC1: adc::Adc = unsafe { adc::Adc::from_ptr(0x5004_0000 as _) };
pub const ADC2: adc::Adc = unsafe { adc::Adc::from_ptr(0x5004_0100 as _) };
pub const ADC_COMMON: adccommon::AdcCommon = unsafe { adccommon::AdcCommon::from_ptr(0x5004_0300 as _) };
pub const DCMI: dcmi::Dcmi = unsafe { dcmi::Dcmi::from_ptr(0x5005_0000 as _) };
pub const PSSI: *mut () = 0x5005_0400 as _;
...
pub const OCTOSPIM: octospim::Octospim = unsafe { octospim::Octospim::from_ptr(0x5006_1c00 as _) };
pub const SDMMC1: *mut () = 0x5006_2400 as _;
pub const SDMMC2: *mut () = 0x5006_2800 as _;
pub const FMC: *mut () = 0x6000_0000 as _;
pub const OCTOSPI1: octospi::Octospi = unsafe { octospi::Octospi::from_ptr(0xa000_1000 as _) };
pub const OCTOSPI2: octospi::Octospi = unsafe { octospi::Octospi::from_ptr(0xa000_1400 as _) };
