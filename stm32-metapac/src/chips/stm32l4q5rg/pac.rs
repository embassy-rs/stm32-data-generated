...
pub const DFSDM1: dfsdm::Dfsdm4ch2fltDlyTrg5Adc =
    unsafe { dfsdm::Dfsdm4ch2fltDlyTrg5Adc::from_ptr(0x4001_6000usize as _) };
...
pub const ADC12_COMMON: adccommon::AdcCommon = unsafe { adccommon::AdcCommon::from_ptr(0x5004_0300usize as _) };
...
pub const SDMMC1: sdmmc::Sdmmc = unsafe { sdmmc::Sdmmc::from_ptr(0x5006_2400usize as _) };
