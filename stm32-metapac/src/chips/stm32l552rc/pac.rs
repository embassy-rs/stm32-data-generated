...
pub const UID: uid::Uid = unsafe { uid::Uid::from_ptr(0x0bfa_0590 as _) };
...
pub const TAMP: tamp::Tamp = unsafe { tamp::Tamp::from_ptr(0x4000_3400 as _) };
...
pub const OPAMP1: *mut () = 0x4000_7800 as _;
pub const OPAMP2: *mut () = 0x4000_7810 as _;
...
pub const LPTIM3: lptim::Lptim = unsafe { lptim::Lptim::from_ptr(0x4000_9800 as _) };
...
pub const USB: usb::Usb = unsafe { usb::Usb::from_ptr(0x4000_d400 as _) };
pub const USBRAM: usbram::Usbram = unsafe { usbram::Usbram::from_ptr(0x4000_d800 as _) };
...
pub const VREFBUF: *mut () = 0x4001_0100 as _;
pub const COMP1: *mut () = 0x4001_0200 as _;
pub const COMP2: *mut () = 0x4001_0204 as _;
...
pub const EXTI: exti::Exti = unsafe { exti::Exti::from_ptr(0x4002_f400 as _) };
...
pub const ADC1: adc::Adc = unsafe { adc::Adc::from_ptr(0x4202_8000 as _) };
pub const ADC2: adc::Adc = unsafe { adc::Adc::from_ptr(0x4202_8100 as _) };
pub const ADC_COMMON: adccommon::AdcCommon = unsafe { adccommon::AdcCommon::from_ptr(0x4202_8300 as _) };
...
pub const OCTOSPI1: octospi::Octospi = unsafe { octospi::Octospi::from_ptr(0x4402_1000 as _) };
