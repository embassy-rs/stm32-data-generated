...
mod _vectors {
    ...
    pub static __INTERRUPTS: [Vector; 32] = [
        ...
        Vector {
            _handler: DMA1_CH4_7_DMAMUX_OVR,
        },
        Vector { _handler: ADC_COMP1 },
        Vector {
...
pub const UID: uid::Uid = unsafe { uid::Uid::from_ptr(0x1fff_3e50usize as _) };
