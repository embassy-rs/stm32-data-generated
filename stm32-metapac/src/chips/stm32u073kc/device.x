...
PROVIDE(DMA1_CH4_7_DMA2_CH1_5_DMAMUX_OVR = DefaultHandler);
PROVIDE(ADC_COMP1_2 = DefaultHandler);
...
PROVIDE(I2C2_3_4 = DefaultHandler);
...
PROVIDE(RNG_CRYP = DefaultHandler);
