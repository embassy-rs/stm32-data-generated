...
pub const TIM3: timer::TimGp32 = unsafe { timer::TimGp32::from_ptr(0x4000_0400 as usize as _) };
pub const TIM4: timer::TimGp32 = unsafe { timer::TimGp32::from_ptr(0x4000_0800 as usize as _) };
...
pub const I2C5: i2c::I2c = unsafe { i2c::I2c::from_ptr(0x4000_9800 as usize as _) };
pub const I2C6: i2c::I2c = unsafe { i2c::I2c::from_ptr(0x4000_9c00 as usize as _) };
...
pub const CORDIC: cordic::Cordic = unsafe { cordic::Cordic::from_ptr(0x4002_1000 as usize as _) };
...
pub const DCACHE2: *mut () = 0x4003_1800 as usize as _;
...
pub const GPIOJ: gpio::Gpio = unsafe { gpio::Gpio::from_ptr(0x4202_2400 as usize as _) };
...
pub const OCTOSPI1: octospi::Octospi = unsafe { octospi::Octospi::from_ptr(0x420d_1400 as usize as _) };
pub const OCTOSPI2: octospi::Octospi = unsafe { octospi::Octospi::from_ptr(0x420d_2400 as usize as _) };
...
pub const LPTIM3: lptim::Lptim = unsafe { lptim::Lptim::from_ptr(0x4600_4800 as usize as _) };
pub const LPTIM4: lptim::Lptim = unsafe { lptim::Lptim::from_ptr(0x4600_4c00 as usize as _) };
pub const OPAMP1: *mut () = 0x4600_5000 as usize as _;
pub const OPAMP2: *mut () = 0x4600_5010 as usize as _;
pub const COMP1: *mut () = 0x4600_5400 as usize as _;
