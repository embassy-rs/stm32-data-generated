...
pub const TIM1: timer::TimAdv = unsafe { timer::TimAdv::from_ptr(0x4000_2000usize as _) };
...
pub const I2C2: i2c::I2c = unsafe { i2c::I2c::from_ptr(0x4100_1000usize as _) };
pub const SPI1: spi::Spi = unsafe { spi::Spi::from_ptr(0x4100_2000usize as _) };
pub const SPI2: spi::Spi = unsafe { spi::Spi::from_ptr(0x4100_3000usize as _) };
