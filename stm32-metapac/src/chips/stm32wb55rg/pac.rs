...
pub enum Interrupt {
    ...
    #[doc = "54 - FPU"]
    FPU = 54,
    #[doc = "55 - DMA2_CHANNEL1"]
    DMA2_CHANNEL1 = 55,
    #[doc = "56 - DMA2_CHANNEL2"]
    DMA2_CHANNEL2 = 56,
    #[doc = "57 - DMA2_CHANNEL3"]
    DMA2_CHANNEL3 = 57,
    #[doc = "58 - DMA2_CHANNEL4"]
    DMA2_CHANNEL4 = 58,
    #[doc = "59 - DMA2_CHANNEL5"]
    DMA2_CHANNEL5 = 59,
    #[doc = "60 - DMA2_CHANNEL6"]
    DMA2_CHANNEL6 = 60,
    #[doc = "61 - DMA2_CHANNEL7"]
    DMA2_CHANNEL7 = 61,
    #[doc = "62 - DMAMUX1_OVR"]
    DMAMUX1_OVR = 62,
}
...
mod _vectors {
    ...
    pub static __INTERRUPTS: [Vector; 63] = [
        ...
        Vector { _handler: CRS },
        Vector { _reserved: 0 },
        Vector { _handler: IPCC_C1_RX },
        Vector { _handler: IPCC_C1_TX },
...
pub const USB: usb::Usb = unsafe { usb::Usb::from_ptr(0x4000_6800 as _) };
pub const USBRAM: usbram::Usbram = unsafe { usbram::Usbram::from_ptr(0x4000_6c00 as _) };
...
pub const AES1: *mut () = 0x5006_0000 as _;
pub const RCC: rcc::Rcc = unsafe { rcc::Rcc::from_ptr(0x5800_0000 as _) };
pub const PWR: pwr::Pwr = unsafe { pwr::Pwr::from_ptr(0x5800_0400 as _) };
pub const EXTI: exti::Exti = unsafe { exti::Exti::from_ptr(0x5800_0800 as _) };
pub const IPCC: ipcc::Ipcc = unsafe { ipcc::Ipcc::from_ptr(0x5800_0c00 as _) };
pub const RNG: rng::Rng = unsafe { rng::Rng::from_ptr(0x5800_1000 as _) };
pub const HSEM: *mut () = 0x5800_1400 as _;
pub const AES2: *mut () = 0x5800_1800 as _;
pub const PKA: *mut () = 0x5800_2000 as _;
pub const FLASH: flash::Flash = unsafe { flash::Flash::from_ptr(0x5800_4000 as _) };
pub const QUADSPI: quadspi::Quadspi = unsafe { quadspi::Quadspi::from_ptr(0x9000_0000 as _) };
