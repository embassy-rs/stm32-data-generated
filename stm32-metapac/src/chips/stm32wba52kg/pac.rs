...
pub const UID: uid::Uid = unsafe { uid::Uid::from_ptr(0x0bf9_0700 as _) };
...
pub const AES: *mut () = 0x420c_0000 as _;
...
pub const HSEM: *mut () = 0x420c_1c00 as _;
...
pub const TAMP: *mut () = 0x4600_7c00 as _;
