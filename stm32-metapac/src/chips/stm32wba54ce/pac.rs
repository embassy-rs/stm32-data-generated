...
pub const TS_CAL1: tscal::Tscal = unsafe { tscal::Tscal::from_ptr(0x0bf9_0710usize as _) };
pub const TS_CAL2: tscal::Tscal = unsafe { tscal::Tscal::from_ptr(0x0bf9_0742usize as _) };
