...
pub const VREFBUF: *mut () = 0x4001_0030 as _;
...
pub const AES: aes::Aes = unsafe { aes::Aes::from_ptr(0x5800_1800 as _) };
pub const PKA: *mut () = 0x5800_2000 as _;
pub const FLASH: flash::Flash = unsafe { flash::Flash::from_ptr(0x5800_4000 as _) };
pub const SUBGHZSPI: spi::Spi = unsafe { spi::Spi::from_ptr(0x5801_0000 as _) };
