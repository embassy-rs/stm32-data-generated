...
pub const LPTIM3: lptim::Lptim = unsafe { lptim::Lptim::from_ptr(0x4000_9800 as usize as _) };
...
pub const AES: aes::Aes = unsafe { aes::Aes::from_ptr(0x5800_1800 as usize as _) };
