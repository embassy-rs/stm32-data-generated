...
impl Adc {
    ...
    #[doc = "offset 1-4 configuration register"]
    #[inline(always)]
    ...
    #[doc = "watchdog lower threshold register 1"]
    #[inline(always)]
    pub const fn ltr1(self) -> crate::common::Reg<regs::Ltr1, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0xa8usize) as _) }
    }
    #[doc = "watchdog higher threshold register 1"]
    #[inline(always)]
...
pub mod regs {
    ...
    impl Calfact {
        ...
        #[doc = "Calibration additional offset."]
        #[must_use]
        #[inline(always)]
        pub const fn caladdos(&self) -> bool {
            let val = (self.0 >> 31usize) & 0x01;
            val != 0
        }
        #[doc = "Calibration additional offset."]
        #[inline(always)]
        pub const fn set_caladdos(&mut self, val: bool) {
    ...
    impl defmt::Format for Calfact {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Calfact {{ calfact_s: {=u16:?}, calfact_d: {=u16:?}, caladdos: {=bool:?} }}",
                self.calfact_s(),
                self.calfact_d(),
                self.caladdos()
            )
    ...
    impl defmt::Format for Cfgr2 {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Cfgr2 {{ rovse: {=bool:?}, jovse: {=bool:?}, ovss: {=u8:?}, trovs: {:?}, rovsm: {:?}, bulb: {=bool:?}, swtrig: {=bool:?}, smptrig: {=bool:?}, ovsr: {=u16:?}, lshift: {=u8:?} }}",
                self.rovse(),
                self.jovse(),
                self.ovss(),
                self.trovs(),
    ...
    impl defmt::Format for Cr {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Cr {{ aden: {=bool:?}, addis: {=bool:?}, adstart: {=bool:?}, jadstart: {=bool:?}, adstp: {:?}, jadstp: {=bool:?}, deeppwd: {=bool:?}, adcaldif: {:?}, adcal: {=bool:?} }}",
                self.aden(),
                self.addis(),
                self.adstart(),
                self.jadstart(),
    ...
    impl defmt::Format for Isr {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Isr {{ adrdy: {=bool:?}, eosmp: {=bool:?}, eoc: {=bool:?}, eos: {=bool:?}, ovr: {=bool:?}, jeoc: {=bool:?}, jeos: {=bool:?}, awd1: {=bool:?}, awd2: {=bool:?}, awd3: {=bool:?} }}",
                self.adrdy(),
                self.eosmp(),
                self.eoc(),
                self.eos(),
    ...
    impl Or {
        ...
        #[must_use]
        #[inline(always)]
        pub const fn selref(&self) -> bool {
            let val = (self.0 >> 0usize) & 0x01;
            val != 0
        }
        #[doc = "Internal reference voltage selection."]
        #[inline(always)]
        pub const fn set_selref(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 0usize)) | (((val as u32) & 0x01) << 0usize);
        }
        #[doc = "Bandgap selection."]
        #[must_use]
        #[inline(always)]
        pub const fn selbg(&self) -> bool {
            let val = (self.0 >> 1usize) & 0x01;
            val != 0
        }
        #[doc = "Bandgap selection."]
        #[inline(always)]
        pub const fn set_selbg(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 1usize)) | (((val as u32) & 0x01) << 1usize);
        }
        #[doc = "VDDCORE enable."]
        #[must_use]
        #[inline(always)]
        pub const fn vddcoreen(&self) -> bool {
            let val = (self.0 >> 2usize) & 0x01;
            val != 0
        }
        #[doc = "VDDCORE enable."]
        #[inline(always)]
        pub const fn set_vddcoreen(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 2usize)) | (((val as u32) & 0x01) << 2usize);
        }
    }
    impl Default for Or {
    ...
    impl defmt::Format for Or {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Or {{ selref: {=bool:?}, selbg: {=bool:?}, vddcoreen: {=bool:?} }}",
                self.selref(),
                self.selbg(),
                self.vddcoreen()
            )
...
pub mod vals {
    ...
    pub enum SampleTime {
        ...
        Cycles25 = 0x0,
        #[doc = "3.5 clock cycles"]
        Cycles35 = 0x01,
        #[doc = "7.5 clock cycles"]
        Cycles75 = 0x02,
