...
impl Adc {
    ...
    #[doc = "offset configuration register"]
    #[inline(always)]
...
pub mod regs {
    ...
    impl Awd2cr {
        ...
        #[doc = "Analog watchdog 2 channel selection"]
        #[inline(always)]
        pub const fn set_awdch(&mut self, val: u32) {
    ...
    impl defmt::Format for Cfgr2 {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Cfgr2 {{ rovse: {=bool:?}, jovse: {=bool:?}, ovss: {=u8:?}, trovs: {=bool:?}, rovsm: {=bool:?}, bulb: {=bool:?}, swtrig: {=bool:?}, smptrig: {=bool:?}, ovsr: {=u16:?}, lshift: {=u8:?} }}",
                self.rovse(),
                self.jovse(),
                self.ovss(),
                self.trovs(),
    ...
    impl Cr {
        ...
        #[doc = "start of regular conversion"]
        #[must_use]
        #[inline(always)]
        ...
        #[doc = "start of injected conversion"]
        #[must_use]
        #[inline(always)]
        ...
        #[doc = "stop of regular conversion command"]
        #[must_use]
        #[inline(always)]
        ...
        #[doc = "stop of injected conversion command"]
        #[must_use]
        #[inline(always)]
        ...
        #[doc = "internal voltage regulator enable"]
        #[must_use]
        #[inline(always)]
    ...
    impl defmt::Format for Cr {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Cr {{ aden: {=bool:?}, addis: {=bool:?}, adstart: {=bool:?}, jadstart: {=bool:?}, adstp: {:?}, jadstp: {=bool:?}, advregen: {=bool:?}, deeppwd: {=bool:?}, adcaldif: {=bool:?}, adcal: {=bool:?} }}",
                self.aden(),
                self.addis(),
                self.adstart(),
                self.jadstart(),
    ...
    impl Ier {
        ...
        #[doc = "Analog watchdog 1-3 interrupt enable"]
        #[must_use]
        #[inline(always)]
        ...
        #[doc = "internal voltage regulator interrupt enable"]
        #[must_use]
        #[inline(always)]
    ...
    impl defmt::Format for Ier {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Ier {{ adrdyie: {=bool:?}, eosmpie: {=bool:?}, eocie: {=bool:?}, eosie: {=bool:?}, ovrie: {=bool:?}, jeocie: {=bool:?}, jeosie: {=bool:?}, awdie[0]: {=bool:?}, awdie[1]: {=bool:?}, awdie[2]: {=bool:?}, jqovfie: {=bool:?}, ldordyie: {=bool:?} }}",
                self.adrdyie(),
                self.eosmpie(),
                self.eocie(),
                self.eosie(),
    ...
    impl Isr {
        ...
        #[doc = "internal voltage regulator output ready flag"]
        #[must_use]
        #[inline(always)]
    ...
    #[doc = "injected channel 1 data register"]
    #[repr(transparent)]
    #[derive(Copy, Clone, Eq, PartialEq)]
    ...
    impl Jsqr {
        ...
        #[doc = "1st-4th conversion in the injected sequence"]
        #[must_use]
        #[inline(always)]
    ...
    #[doc = "offset 1 configuration register"]
    #[repr(transparent)]
    #[derive(Copy, Clone, Eq, PartialEq)]
...
bits."]
    ...
    impl Or {
        ...
        #[doc = "Set and cleared by software to enable the vcore channel"]
        #[inline(always)]
        pub const fn set_vcoren(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 0usize)) | (((val as u32) & 0x01) << 0usize);
        }
    }
    impl Default for Or {
    ...
    impl defmt::Format for Pcsel {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Pcsel {{ pcsel[0]: {:?}, pcsel[1]: {:?}, pcsel[2]: {:?}, pcsel[3]: {:?}, pcsel[4]: {:?}, pcsel[5]: {:?}, pcsel[6]: {:?}, pcsel[7]: {:?}, pcsel[8]: {:?}, pcsel[9]: {:?}, pcsel[10]: {:?}, pcsel[11]: {:?}, pcsel[12]: {:?}, pcsel[13]: {:?}, pcsel[14]: {:?}, pcsel[15]: {:?}, pcsel[16]: {:?}, pcsel[17]: {:?}, pcsel[18]: {:?} }}",
                self.pcsel(0usize),
                self.pcsel(1usize),
                self.pcsel(2usize),
                self.pcsel(3usize),
    ...
    impl Sqr1 {
        ...
        #[doc = "1st-4th conversions in regular sequence"]
        #[must_use]
        #[inline(always)]
    ...
    impl Sqr2 {
        #[doc = "5th-9th conversions in regular sequence"]
        #[must_use]
        #[inline(always)]
        pub const fn sq(&self, n: usize) -> u8 {
            assert!(n < 5usize);
    ...
    impl Sqr3 {
        #[doc = "10th-14th conversions in regular sequence"]
        #[must_use]
        #[inline(always)]
        pub const fn sq(&self, n: usize) -> u8 {
            assert!(n < 5usize);
    ...
    impl Sqr4 {
        #[doc = "15th-16th conversion in regular sequence"]
        #[must_use]
        #[inline(always)]
        pub const fn sq(&self, n: usize) -> u8 {
            assert!(n < 2usize);
