...
pub mod regs {
    ...
    impl Cr1 {
        ...
        #[doc = "Dual mode selection (ADC1 only)"]
        #[must_use]
        #[inline(always)]
    ...
    impl Cr2 {
        ...
        #[doc = "Temperature sensor and VREFINT enable (ADC1 only)"]
        #[must_use]
        #[inline(always)]
    ...
    impl defmt::Format for Cr2 {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Cr2 {{ adon: {=bool:?}, cont: {=bool:?}, cal: {=bool:?}, rstcal: {=bool:?}, dma: {=bool:?}, align: {:?}, jextsel: {=u8:?}, jexttrig: {=bool:?}, extsel: {=u8:?}, exttrig: {=bool:?}, jswstart: {=bool:?}, swstart: {=bool:?}, tsvrefe: {=bool:?} }}",
                self.adon(),
                self.cont(),
                self.cal(),
                self.rstcal(),
    ...
    impl Dr {
        ...
        #[doc = "ADC2 data (ADC1 in dual mode only)"]
        #[must_use]
        #[inline(always)]
