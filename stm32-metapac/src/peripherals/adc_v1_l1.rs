    ...
    pub const fn smpr(self, n: usize) -> crate::common::Reg<regs::Smpr, crate::common::RW> {
        ...
        unsafe {
            crate::common::Reg::from_ptr(
                self.ptr
                    .wrapping_add(0x0cusize + ([8usize, 4usize, 0usize, 80usize][n] as usize)) as _,
            )
        }
    }
...
pub mod regs {
    ...
    impl Cr1 {
        ...
        #[doc = "Power down during the delay phase"]
        #[inline(always)]
        pub const fn set_pdd(&mut self, val: bool) {
    ...
    impl defmt::Format for Cr1 {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Cr1 {{ awdch: {=u8:?}, eocie: {=bool:?}, awdie: {=bool:?}, jeocie: {=bool:?}, scan: {=bool:?}, awdsgl: {=bool:?}, jauto: {=bool:?}, discen: {=bool:?}, jdiscen: {=bool:?}, discnum: {=u8:?}, pdd: {=bool:?}, pdi: {=bool:?}, jawden: {=bool:?}, awden: {=bool:?}, res: {:?}, ovrie: {=bool:?} }}",
                self.awdch(),
                self.eocie(),
                self.awdie(),
                self.jeocie(),
    ...
    impl Cr2 {
        ...
        #[doc = "ADC configuration (channel bank selection)"]
        #[must_use]
        #[inline(always)]
        ...
        #[doc = "ADC configuration (channel bank selection)"]
        #[inline(always)]
        pub const fn set_adc_cfg(&mut self, val: super::vals::AdcCfg) {
    ...
    impl defmt::Format for Cr2 {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Cr2 {{ adon: {=bool:?}, cont: {=bool:?}, adc_cfg: {:?}, dels: {:?}, dma: {=bool:?}, dds: {=bool:?}, eocs: {=bool:?}, align: {:?}, jextsel: {=u8:?}, jexten: {:?}, jswstart: {=bool:?}, extsel: {=u8:?}, exten: {:?}, swstart: {=bool:?} }}",
                self.adon(),
                self.cont(),
                self.adc_cfg(),
                self.dels(),
    ...
    impl Csr {
        ...
        #[doc = "End of conversion of the ADC"]
        #[inline(always)]
        pub const fn set_eoc1(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 1usize)) | (((val as u32) & 0x01) << 1usize);
        }
        ...
        #[doc = "Injected channel end of conversion of the ADC"]
        #[inline(always)]
        pub const fn set_jeoc1(&mut self, val: bool) {
        ...
        #[doc = "Injected channel start flag of the ADC"]
        #[inline(always)]
        pub const fn set_jstrt1(&mut self, val: bool) {
        ...
        #[doc = "Regular channel start flag of the ADC"]
        #[inline(always)]
        pub const fn set_strt1(&mut self, val: bool) {
        ...
        #[doc = "Overrun flag of the ADC"]
        #[inline(always)]
        pub const fn set_ovr1(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 5usize)) | (((val as u32) & 0x01) << 5usize);
        }
        #[doc = "ADON status of the ADC"]
        #[must_use]
        #[inline(always)]
        ...
        #[doc = "ADON status of the ADC"]
        #[inline(always)]
        pub const fn set_adons1(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 6usize)) | (((val as u32) & 0x01) << 6usize);
        }
    }
    ...
    impl defmt::Format for Csr {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Csr {{ awd1: {=bool:?}, eoc1: {=bool:?}, jeoc1: {=bool:?}, jstrt1: {=bool:?}, strt1: {=bool:?}, ovr1: {=bool:?}, adons1: {=bool:?} }}",
                self.awd1(),
                self.eoc1(),
                self.jeoc1(),
                self.jstrt1(),
    ...
    impl defmt::Format for Sqr4 {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Sqr4 {{ sq[0]: {=u8:?}, sq[1]: {=u8:?}, sq[2]: {=u8:?}, sq[3]: {=u8:?}, sq[4]: {=u8:?}, sq[5]: {=u8:?} }}",
                self.sq(0usize),
                self.sq(1usize),
                self.sq(2usize),
                self.sq(3usize),
    ...
    impl defmt::Format for Sqr5 {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Sqr5 {{ sq[0]: {=u8:?}, sq[1]: {=u8:?}, sq[2]: {=u8:?}, sq[3]: {=u8:?}, sq[4]: {=u8:?}, sq[5]: {=u8:?} }}",
                self.sq(0usize),
                self.sq(1usize),
                self.sq(2usize),
                self.sq(3usize),
    ...
    impl Sr {
        ...
        #[doc = "ADC ON status"]
        #[inline(always)]
        pub const fn set_adons(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 6usize)) | (((val as u32) & 0x01) << 6usize);
        }
        ...
        #[doc = "Regular channel not ready"]
        #[inline(always)]
        pub const fn set_rcnr(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 8usize)) | (((val as u32) & 0x01) << 8usize);
        }
        ...
        #[doc = "Injected channel not ready"]
        #[inline(always)]
        pub const fn set_jcnr(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 9usize)) | (((val as u32) & 0x01) << 9usize);
        }
    }
    impl Default for Sr {
    ...
    impl defmt::Format for Sr {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Sr {{ awd: {=bool:?}, eoc: {=bool:?}, jeoc: {=bool:?}, jstrt: {=bool:?}, strt: {=bool:?}, ovr: {=bool:?}, adons: {=bool:?}, rcnr: {=bool:?}, jcnr: {=bool:?} }}",
                self.awd(),
                self.eoc(),
                self.jeoc(),
                self.jstrt(),
...
pub mod vals {
    ...
    #[cfg_attr(feature = "defmt", derive(defmt::Format))]
    pub enum Adcpre {
        #[doc = "HSI divided by 1"]
        Div1 = 0x0,
        #[doc = "HSI divided by 2"]
        Div2 = 0x01,
        #[doc = "HSI divided by 4"]
        Div4 = 0x02,
        _RESERVED_3 = 0x03,
    }
    impl Adcpre {
    ...
    pub enum Dels {
        #[doc = "No delay"]
        NoDelay = 0x0,
        #[doc = "Delay until the converted data has been read"]
        AfterRead = 0x01,
        #[doc = "7 APB clock cycles"]
        Delay7 = 0x02,
        #[doc = "15 APB clock cycles"]
        Delay15 = 0x03,
        #[doc = "31 APB clock cycles"]
        Delay31 = 0x04,
        #[doc = "63 APB clock cycles"]
        Delay63 = 0x05,
        #[doc = "127 APB clock cycles"]
        Delay127 = 0x06,
        #[doc = "255 APB clock cycles"]
        Delay255 = 0x07,
    }
    impl Dels {
        #[inline(always)]
