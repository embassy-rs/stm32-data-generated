...
# [inline (always)]
pub const fn cont (& self) -> super :: vals :: Cont { let val = (self . 0 >> 1usize) & 0x01 ; super :: vals :: Cont :: from_bits (val as u8) } # [doc = "Continuous conversion"]
# [inline (always)]
pub fn set_cont (& mut self , val : super :: vals :: Cont) { self . 0 = (self . 0 & ! (0x01 << 1usize)) | (((val . to_bits () as u32) & 0x01) << 1usize) ; } # [doc = "Direct memory access mode (for single ADC mode)"]
# [inline (always)]
...
# [derive (Copy , Clone , Eq , PartialEq , Ord , PartialOrd)]
pub enum Cont { # [doc = "Single conversion mode"]
SINGLE = 0x0 , # [doc = "Continuous conversion mode"]
CONTINUOUS = 0x01 , } impl Cont { # [inline (always)]
pub const fn from_bits (val : u8) -> Cont { unsafe { core :: mem :: transmute (val & 0x01) } } # [inline (always)]
pub const fn to_bits (self) -> u8 { unsafe { core :: mem :: transmute (self) } } } impl From < u8 > for Cont { # [inline (always)]
fn from (val : u8) -> Cont { Cont :: from_bits (val) } } impl From < Cont > for u8 { # [inline (always)]
fn from (val : Cont) -> u8 { Cont :: to_bits (val) } } # [repr (u8)]
# [derive (Copy , Clone , Eq , PartialEq , Ord , PartialOrd)]
