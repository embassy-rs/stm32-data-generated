...
pub mod regs {
    ...
    impl defmt::Format for Cfgr2 {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Cfgr2 {{ rovse: {=bool:?}, jovse: {=bool:?}, ovss: {=u8:?}, trovs: {:?}, rovsm: {:?}, bulb: {=bool:?}, swtrig: {:?}, smptrig: {=bool:?}, ovsr: {=u16:?}, lshift: {=u8:?} }}",
                self.rovse(),
                self.jovse(),
                self.ovss(),
                self.trovs(),
    ...
    impl defmt::Format for Cr {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Cr {{ aden: {=bool:?}, addis: {=bool:?}, adstart: {=bool:?}, jadstart: {=bool:?}, adstp: {=bool:?}, jadstp: {=bool:?}, advregen: {=bool:?}, deeppwd: {=bool:?}, adcal: {=bool:?} }}",
                self.aden(),
                self.addis(),
                self.adstart(),
                self.jadstart(),
...
only)"]
    ...
    impl defmt::Format for Ier {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Ier {{ adrdyie: {=bool:?}, eosmpie: {=bool:?}, eocie: {=bool:?}, eosie: {=bool:?}, ovrie: {=bool:?}, jeocie: {=bool:?}, jeosie: {=bool:?}, awdie[0]: {=bool:?}, awdie[1]: {=bool:?}, awdie[2]: {=bool:?}, ldordyie: {=bool:?} }}",
                self.adrdyie(),
                self.eosmpie(),
                self.eocie(),
                self.eosie(),
    ...
    impl defmt::Format for Isr {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Isr {{ adrdy: {=bool:?}, eosmp: {=bool:?}, eoc: {=bool:?}, eos: {=bool:?}, ovr: {=bool:?}, jeoc: {=bool:?}, jeos: {=bool:?}, awd[0]: {=bool:?}, awd[1]: {=bool:?}, awd[2]: {=bool:?}, ldordy: {=bool:?} }}",
                self.adrdy(),
                self.eosmp(),
                self.eoc(),
                self.eos(),
    ...
    impl defmt::Format for Pcsel {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Pcsel {{ pcsel[0]: {=bool:?}, pcsel[1]: {=bool:?}, pcsel[2]: {=bool:?}, pcsel[3]: {=bool:?}, pcsel[4]: {=bool:?}, pcsel[5]: {=bool:?}, pcsel[6]: {=bool:?}, pcsel[7]: {=bool:?}, pcsel[8]: {=bool:?}, pcsel[9]: {=bool:?}, pcsel[10]: {=bool:?}, pcsel[11]: {=bool:?}, pcsel[12]: {=bool:?}, pcsel[13]: {=bool:?} }}",
                self.pcsel(0usize),
                self.pcsel(1usize),
                self.pcsel(2usize),
                self.pcsel(3usize),
...
pub mod vals {
    ...
    pub enum SampleTime {
        ...
        Cycles8 = 0x02,
        #[doc = "13 ADC clock cycles"]
        Cycles13 = 0x03,
        #[doc = "25 ADC clock cycles"]
        Cycles25 = 0x04,
        #[doc = "48 ADC clock cycles"]
        Cycles48 = 0x05,
        #[doc = "139 ADC clock cycles"]
        Cycles139 = 0x06,
        #[doc = "289 ADC clock cycles"]
        Cycles289 = 0x07,
    }
    impl SampleTime {
        #[inline(always)]
