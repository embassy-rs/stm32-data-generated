...
pub mod regs {
    ...
    impl defmt::Format for Awd2cr {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Awd2cr {{ awd2ch[0]: {=bool:?}, awd2ch[1]: {=bool:?}, awd2ch[2]: {=bool:?}, awd2ch[3]: {=bool:?}, awd2ch[4]: {=bool:?}, awd2ch[5]: {=bool:?}, awd2ch[6]: {=bool:?}, awd2ch[7]: {=bool:?}, awd2ch[8]: {=bool:?}, awd2ch[9]: {=bool:?}, awd2ch[10]: {=bool:?}, awd2ch[11]: {=bool:?}, awd2ch[12]: {=bool:?}, awd2ch[13]: {=bool:?}, awd2ch[14]: {=bool:?}, awd2ch[15]: {=bool:?}, awd2ch[16]: {=bool:?}, awd2ch[17]: {=bool:?}, awd2ch[18]: {=bool:?} }}",
                self.awd2ch(0usize),
                self.awd2ch(1usize),
                self.awd2ch(2usize),
                self.awd2ch(3usize),
    ...
    impl defmt::Format for Awd3cr {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Awd3cr {{ awd3ch[0]: {=bool:?}, awd3ch[1]: {=bool:?}, awd3ch[2]: {=bool:?}, awd3ch[3]: {=bool:?}, awd3ch[4]: {=bool:?}, awd3ch[5]: {=bool:?}, awd3ch[6]: {=bool:?}, awd3ch[7]: {=bool:?}, awd3ch[8]: {=bool:?}, awd3ch[9]: {=bool:?}, awd3ch[10]: {=bool:?}, awd3ch[11]: {=bool:?}, awd3ch[12]: {=bool:?}, awd3ch[13]: {=bool:?}, awd3ch[14]: {=bool:?}, awd3ch[15]: {=bool:?}, awd3ch[16]: {=bool:?}, awd3ch[17]: {=bool:?}, awd3ch[18]: {=bool:?} }}",
                self.awd3ch(0usize),
                self.awd3ch(1usize),
                self.awd3ch(2usize),
                self.awd3ch(3usize),
    ...
    impl Cfgr {
        ...
        #[doc = "DFSDM mode configuration"]
        #[must_use]
        #[inline(always)]
        pub const fn dfsdmcfg(&self) -> bool {
            let val = (self.0 >> 2usize) & 0x01;
            val != 0
        }
        #[doc = "DFSDM mode configuration"]
        #[inline(always)]
        pub const fn set_dfsdmcfg(&mut self, val: bool) {
    ...
    impl defmt::Format for Cfgr {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Cfgr {{ dmaen: {=bool:?}, dmacfg: {:?}, dfsdmcfg: {=bool:?}, res: {:?}, align: {:?}, extsel: {=u8:?}, exten: {:?}, ovrmod: {=bool:?}, cont: {=bool:?}, autdly: {=bool:?}, discen: {=bool:?}, discnum: {=u8:?}, jdiscen: {=bool:?}, jqm: {=bool:?}, awd1sgl: {=bool:?}, awd1en: {=bool:?}, jawd1en: {=bool:?}, jauto: {=bool:?}, awd1ch: {=u8:?}, jqdis: {=bool:?} }}",
                self.dmaen(),
                self.dmacfg(),
                self.dfsdmcfg(),
                self.res(),
    ...
    impl defmt::Format for Cfgr2 {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Cfgr2 {{ rovse: {=bool:?}, jovse: {=bool:?}, ovsr: {:?}, ovss: {=u8:?}, trovs: {:?}, rovsm: {:?} }}",
                self.rovse(),
                self.jovse(),
                self.ovsr(),
                self.ovss(),
    ...
    impl defmt::Format for Difsel {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Difsel {{ difsel[0]: {=bool:?}, difsel[1]: {=bool:?}, difsel[2]: {=bool:?}, difsel[3]: {=bool:?}, difsel[4]: {=bool:?}, difsel[5]: {=bool:?}, difsel[6]: {=bool:?}, difsel[7]: {=bool:?}, difsel[8]: {=bool:?}, difsel[9]: {=bool:?}, difsel[10]: {=bool:?}, difsel[11]: {=bool:?}, difsel[12]: {=bool:?}, difsel[13]: {=bool:?}, difsel[14]: {=bool:?}, difsel[15]: {=bool:?}, difsel[16]: {=bool:?}, difsel[17]: {=bool:?}, difsel[18]: {=bool:?} }}",
                self.difsel(0usize),
                self.difsel(1usize),
                self.difsel(2usize),
                self.difsel(3usize),
