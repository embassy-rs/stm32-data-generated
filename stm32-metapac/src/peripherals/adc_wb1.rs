...
pub mod regs {
    ...
    impl Ccr {
        #[doc = "Common clock prescalar for asynchronous clock source"]
        #[must_use]
        #[inline(always)]
    ...
    impl Cfgr1 {
        ...
        #[doc = "Group regular sequencer mode"]
        #[must_use]
        #[inline(always)]
        ...
        #[doc = "Enable the analog watchdog on a single channel or on all channels"]
        #[must_use]
        #[inline(always)]
    ...
    impl Cfgr2 {
        #[doc = "ADC low frequency trigger mode"]
        #[must_use]
        #[inline(always)]
    ...
    impl Chselr {
        #[doc = "Channel-x selection (available when CFGR1_CHSELRMOD is cleared)"]
        #[must_use]
        #[inline(always)]
        ...
        #[doc = "Sequencer-x selection (available when CFGR1_CHSELRMOD is set)"]
        #[must_use]
        #[inline(always)]
        pub const fn seq_x(&self, n: usize) -> u8 {
            assert!(n < 8usize);
        ...
        #[doc = "Sequencer-x selection (available when CFGR1_CHSELRMOD is set)"]
        #[inline(always)]
        pub const fn set_seq_x(&mut self, n: usize, val: u8) {
            assert!(n < 8usize);
            let offs = 0usize + n * 4usize;
    ...
    impl core::fmt::Debug for Chselr {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("Chselr")
                ...
                .field("seq_x[0]", &self.seq_x(0usize))
                .field("seq_x[1]", &self.seq_x(1usize))
                .field("seq_x[2]", &self.seq_x(2usize))
                .field("seq_x[3]", &self.seq_x(3usize))
                .field("seq_x[4]", &self.seq_x(4usize))
                .field("seq_x[5]", &self.seq_x(5usize))
                .field("seq_x[6]", &self.seq_x(6usize))
                .field("seq_x[7]", &self.seq_x(7usize))
                .finish()
        }
    }
    #[cfg(feature = "defmt")]
    ...
    impl Cr {
        ...
        #[doc = "ADC voltage regulator enable command"]
        #[must_use]
        #[inline(always)]
    ...
    impl Ier {
        ...
        #[doc = "Channel configuration interrupt enable"]
        #[must_use]
        #[inline(always)]
    ...
    impl Smpr {
        #[doc = "Group sampling time selection"]
        #[must_use]
        #[inline(always)]
        ...
        #[doc = "Channel sampling time group selection"]
        #[must_use]
        #[inline(always)]
