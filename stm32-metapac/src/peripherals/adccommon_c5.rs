...
pub mod regs {
    ...
    impl Ccr {
        ...
        #[doc = "Delay between two sampling phases"]
        #[must_use]
        #[inline(always)]
        ...
        #[doc = "Temperature sensor voltage enable"]
        #[must_use]
        #[inline(always)]
    ...
    impl defmt::Format for Ccr {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Ccr {{ dual: {:?}, delay: {=u8:?}, damdf: {:?}, vrefen: {=bool:?}, vsenseen: {=bool:?} }}",
                self.dual(),
                self.delay(),
                self.damdf(),
                self.vrefen(),
    ...
    impl Csr {
        ...
        #[doc = "internal voltage regulator flag of the master ADC"]
        #[must_use]
        #[inline(always)]
        ...
        #[doc = "internal voltage regulator flag of the slave ADC"]
        #[must_use]
        #[inline(always)]
    ...
    impl defmt::Format for Csr {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Csr {{ adrdy_mst: {=bool:?}, eosmp_mst: {=bool:?}, eoc_mst: {=bool:?}, eos_mst: {=bool:?}, ovr_mst: {=bool:?}, jeoc_mst: {=bool:?}, jeos_mst: {=bool:?}, awd1_mst: {=bool:?}, awd2_mst: {=bool:?}, awd3_mst: {=bool:?}, ldordy_mst: {=bool:?}, adrdy_slv: {=bool:?}, eosmp_slv: {=bool:?}, eoc_slv: {=bool:?}, eos_slv: {=bool:?}, ovr_slv: {=bool:?}, jeoc_slv: {=bool:?}, jeos_slv: {=bool:?}, awd1_slv: {=bool:?}, awd2_slv: {=bool:?}, awd3_slv: {=bool:?}, ldordy_slv: {=bool:?} }}",
                self.adrdy_mst(),
                self.eosmp_mst(),
                self.eoc_mst(),
                self.eos_mst(),
...
pub mod vals {
    ...
    pub enum Damdf {
        #[doc = "Dual ADC mode without data packing (CDR and CDR2 registers not used)."]
        NoPack = 0x0,
        _RESERVED_1 = 0x01,
        #[doc = "Data formatting mode for any data width (CDR data register is used when the data width is less than 16 bits, otherwise CDR2 register is used)."]
        Format32to10 = 0x02,
        #[doc = "Data formatting mode for data width lower that 8 bits (CDR data register is used)."]
        Format8 = 0x03,
    }
    impl Damdf {
        #[inline(always)]
