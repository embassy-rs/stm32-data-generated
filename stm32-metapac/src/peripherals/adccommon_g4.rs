...
pub mod vals {
    ...
    #[cfg_attr(feature = "defmt", derive(defmt::Format))]
    pub enum Mdma {
        #[doc = "Dual DMA mode is disabled"]
        DISABLED = 0x0,
        #[doc = "Reserved"]
        RESERVED = 0x01,
        #[doc = "Dual DMA mode enabled for 12 and 10-bit resolution"]
        ENABLED12B10B = 0x02,
        #[doc = "Dual DMA mode enabled for 8 and 6-bit resolution"]
        ENABLED8B6B = 0x03,
    }
    impl Mdma {
        #[inline(always)]
