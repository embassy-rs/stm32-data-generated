...
pub mod regs {
    ...
    impl Mapr {
        ...
        #[doc = "Set and cleared by software"]
        #[inline(always)]
        pub const fn set_tim5ch4_iremap(&mut self, val: bool) {
        ...
        #[doc = "ADC 1 External trigger injected conversion remapping"]
        #[inline(always)]
        pub const fn set_adc1_etrginj_remap(&mut self, val: bool) {
        ...
        #[doc = "ADC 1 external trigger regular conversion remapping"]
        #[inline(always)]
        pub const fn set_adc1_etrgreg_remap(&mut self, val: bool) {
        ...
        #[doc = "ADC 2 external trigger injected conversion remapping"]
        #[inline(always)]
        pub const fn set_adc2_etrginj_remap(&mut self, val: bool) {
        ...
        #[doc = "ADC 2 external trigger regular conversion remapping"]
        #[inline(always)]
        pub const fn set_adc2_etrgreg_remap(&mut self, val: bool) {
        ...
        #[doc = "Ethernet MAC I/O remapping"]
        #[inline(always)]
        pub const fn set_eth_remap(&mut self, val: bool) {
        ...
        #[doc = "TIM2 internal trigger 1 remapping"]
        #[inline(always)]
        pub const fn set_tim2itr1_iremap(&mut self, val: bool) {
    ...
    impl defmt::Format for Mapr {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                ...
                self.pd01_remap(),
                self.tim5ch4_iremap(),
                self.adc1_etrginj_remap(),
                self.adc1_etrgreg_remap(),
                self.adc2_etrginj_remap(),
    ...
    impl Mapr2 {
        ...
        #[doc = "TIM15 remapping"]
        #[inline(always)]
        pub const fn set_tim15_remap(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 0usize)) | (((val as u32) & 0x01) << 0usize);
        }
        #[doc = "TIM16 remapping"]
        #[must_use]
        ...
        #[doc = "TIM16 remapping"]
        #[inline(always)]
        pub const fn set_tim16_remap(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 1usize)) | (((val as u32) & 0x01) << 1usize);
        }
        #[doc = "TIM17 remapping"]
        #[must_use]
        ...
        #[doc = "TIM17 remapping"]
        #[inline(always)]
        pub const fn set_tim17_remap(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 2usize)) | (((val as u32) & 0x01) << 2usize);
        }
        #[doc = "CEC remapping"]
        #[must_use]
        ...
        #[doc = "CEC remapping"]
        #[inline(always)]
        pub const fn set_cec_remap(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 3usize)) | (((val as u32) & 0x01) << 3usize);
        }
        ...
        #[doc = "TIM1 DMA remapping"]
        #[inline(always)]
        pub const fn set_tim1_dma_remap(&mut self, val: bool) {
        ...
        #[doc = "TIM10 remapping"]
        #[inline(always)]
        pub const fn set_tim10_remap(&mut self, val: bool) {
        ...
        #[doc = "TIM11 remapping"]
        #[inline(always)]
        pub const fn set_tim11_remap(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 7usize)) | (((val as u32) & 0x01) << 7usize);
        }
        #[doc = "TIM13 remapping"]
        #[must_use]
        ...
        #[doc = "TIM13 remapping"]
        #[inline(always)]
        pub const fn set_tim13_remap(&mut self, val: bool) {
        ...
        #[doc = "TIM14 remapping"]
        #[inline(always)]
        pub const fn set_tim14_remap(&mut self, val: bool) {
        ...
        #[doc = "TIM67_DAC DMA remapping"]
        #[inline(always)]
        pub const fn set_tim67_dac_dma_remap(&mut self, val: bool) {
        ...
        #[doc = "TIM12 remapping"]
        #[inline(always)]
        pub const fn set_tim12_remap(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 12usize)) | (((val as u32) & 0x01) << 12usize);
        }
        ...
        #[doc = "Miscellaneous features remapping"]
        #[inline(always)]
        pub const fn set_misc_remap(&mut self, val: bool) {
    ...
    impl defmt::Format for Mapr2 {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Mapr2 {{ tim15_remap: {=bool:?}, tim16_remap: {=bool:?}, tim17_remap: {=bool:?}, cec_remap: {=bool:?}, tim1_dma_remap: {=bool:?}, tim9_remap: {=bool:?}, tim10_remap: {=bool:?}, tim11_remap: {=bool:?}, tim13_remap: {=bool:?}, tim14_remap: {=bool:?}, fsmc_nadv: {=bool:?}, tim67_dac_dma_remap: {=bool:?}, tim12_remap: {=bool:?}, misc_remap: {=bool:?} }}",
                self.tim15_remap(),
                self.tim16_remap(),
                self.tim17_remap(),
                self.cec_remap(),
