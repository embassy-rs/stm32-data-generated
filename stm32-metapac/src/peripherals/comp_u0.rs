...
# [inline (always)]
pub const fn winmode (& self) -> super :: vals :: Winmode { let val = (self . 0 >> 14usize) & 0x01 ; super :: vals :: Winmode :: from_bits (val as u8) } # [doc = "Comparator 1 noninverting input selector for window mode."]
# [inline (always)]
pub fn set_winmode (& mut self , val : super :: vals :: Winmode) { self . 0 = (self . 0 & ! (0x01 << 14usize)) | (((val . to_bits () as u32) & 0x01) << 14usize) ; } # [doc = "Comparator 1 output selector."]
# [inline (always)]
pub const fn winout (& self) -> super :: vals :: Winout { let val = (self . 0 >> 14usize) & 0x01 ; super :: vals :: Winout :: from_bits (val as u8) } # [doc = "Comparator 1 output selector."]
# [inline (always)]
pub fn set_winout (& mut self , val : super :: vals :: Winout) { self . 0 = (self . 0 & ! (0x01 << 14usize)) | (((val . to_bits () as u32) & 0x01) << 14usize) ; } # [doc = "Polarity selection bit."]
# [inline (always)]
...
# [inline (always)]
pub fn set_blanksel (& mut self , val : super :: vals :: Blanking) { self . 0 = (self . 0 & ! (0x1f << 20usize)) | (((val . to_bits () as u32) & 0x1f) << 20usize) ; } # [doc = "Scaler bridge enable."]
# [inline (always)]
pub const fn brgen (& self) -> bool { let val = (self . 0 >> 22usize) & 0x01 ; val != 0 } # [doc = "Scaler bridge enable."]
# [inline (always)]
pub fn set_brgen (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 22usize)) | (((val as u32) & 0x01) << 22usize) ; } # [doc = "Output status bit."]
# [inline (always)]
...
# [derive (Copy , Clone , Eq , PartialEq , Ord , PartialOrd)]
pub enum Winmode { # [doc = "Signal selected with INPSEL\\[2:0\\]
...
OTHERINPSEL = 0x01 , } impl Winmode { # [inline (always)]
pub const fn from_bits (val : u8) -> Winmode { unsafe { core :: mem :: transmute (val & 0x01) } } # [inline (always)]
pub const fn to_bits (self) -> u8 { unsafe { core :: mem :: transmute (self) } } } impl From < u8 > for Winmode { # [inline (always)]
fn from (val : u8) -> Winmode { Winmode :: from_bits (val) } } impl From < Winmode > for u8 { # [inline (always)]
fn from (val : Winmode) -> u8 { Winmode :: to_bits (val) } } # [repr (u8)]
# [derive (Copy , Clone , Eq , PartialEq , Ord , PartialOrd)]
pub enum Winout { # [doc = "Comparator 1 value."]
COMP1_VALUE = 0x0 , # [doc = "Comparator 1 value XOR comparator 2 value (required for window mode)."]
COMP1_VALUEXORCOMP2_VALUE = 0x01 , } impl Winout { # [inline (always)]
pub const fn from_bits (val : u8) -> Winout { unsafe { core :: mem :: transmute (val & 0x01) } } # [inline (always)]
pub const fn to_bits (self) -> u8 { unsafe { core :: mem :: transmute (self) } } } impl From < u8 > for Winout { # [inline (always)]
fn from (val : u8) -> Winout { Winout :: from_bits (val) } } impl From < Winout > for u8 { # [inline (always)]
fn from (val : Winout) -> u8 { Winout :: to_bits (val) } } }