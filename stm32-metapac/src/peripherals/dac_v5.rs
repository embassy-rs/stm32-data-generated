...
# [inline (always)]
pub fn set_cen (& mut self , n : usize , val : bool) { assert ! (n < 2usize) ; let offs = 14usize + n * 16usize ; self . 0 = (self . 0 & ! (0x01 << offs)) | (((val as u32) & 0x01) << offs) ; } # [doc = "high frequency interface mode enable"]
# [inline (always)]
pub const fn hfsel (& self) -> bool { let val = (self . 0 >> 15usize) & 0x01 ; val != 0 } # [doc = "high frequency interface mode enable"]
# [inline (always)]
pub fn set_hfsel (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 15usize)) | (((val as u32) & 0x01) << 15usize) ; } } impl Default for Cr { # [inline (always)]
