...
pub mod regs {
    ...
    impl Apb2fzr1 {
        ...
        #[doc = "HRTIM stop in debug mode"]
        #[inline(always)]
        pub const fn set_hrtim(&mut self, val: bool) {
    ...
    impl Apb3fzr1 {
        ...
        #[doc = "WWDG1 stop in debug mode"]
        #[inline(always)]
        pub const fn set_wwdg1(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 6usize)) | (((val as u32) & 0x01) << 6usize);
        }
    }
    ...
    impl Apb4fzr1 {
        ...
        #[doc = "LPTIM4 stop in debug mode"]
        #[inline(always)]
        pub const fn set_lptim4(&mut self, val: bool) {
        ...
        #[doc = "LPTIM5 stop in debug mode"]
        #[inline(always)]
        pub const fn set_lptim5(&mut self, val: bool) {
        ...
        #[doc = "Independent watchdog for D1 stop in debug mode"]
        #[inline(always)]
        pub const fn set_iwdg1(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 18usize)) | (((val as u32) & 0x01) << 18usize);
        }
    }
    ...
    impl Cr {
        ...
        #[doc = "Allow debug in D1 Sleep mode"]
        #[inline(always)]
        pub const fn set_dbgsleep_d1(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 0usize)) | (((val as u32) & 0x01) << 0usize);
        }
        ...
        #[doc = "Allow debug in D1 Stop mode"]
        #[inline(always)]
        pub const fn set_dbgstop_d1(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 1usize)) | (((val as u32) & 0x01) << 1usize);
        }
        ...
        #[doc = "Allow debug in D1 Standby mode"]
        #[inline(always)]
        pub const fn set_dbgstby_d1(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 2usize)) | (((val as u32) & 0x01) << 2usize);
        }
        ...
        #[doc = "Trace clock enable enable"]
        #[inline(always)]
        pub const fn set_traceclken(&mut self, val: bool) {
        ...
        #[doc = "D1 debug clock enable enable"]
        #[inline(always)]
        pub const fn set_d1dbgcken(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 21usize)) | (((val as u32) & 0x01) << 21usize);
        }
        ...
        #[doc = "D3 debug clock enable enable"]
        #[inline(always)]
        pub const fn set_d3dbgcken(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 22usize)) | (((val as u32) & 0x01) << 22usize);
        }
        ...
        #[doc = "External trigger output enable"]
        #[inline(always)]
        pub const fn set_trgoen(&mut self, val: bool) {
