...
pub mod regs {
    ...
    impl Cwsize {
        ...
        #[doc = "Capture count"]
        #[inline(always)]
        pub const fn set_capcnt(&mut self, val: u16) {
        ...
        #[doc = "Vertical line count"]
        #[inline(always)]
        pub const fn set_vline(&mut self, val: u16) {
    ...
    impl Cwstrt {
        ...
        #[doc = "Horizontal offset count"]
        #[inline(always)]
        pub const fn set_hoffcnt(&mut self, val: u16) {
            self.0 = (self.0 & !(0x3fff << 0usize)) | (((val as u32) & 0x3fff) << 0usize);
        }
        ...
        #[doc = "Vertical start line count"]
        #[inline(always)]
        pub const fn set_vst(&mut self, val: u16) {
    ...
    impl Mis {
        ...
        #[doc = "Capture complete masked interrupt status"]
        #[inline(always)]
        pub const fn set_frame_mis(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 0usize)) | (((val as u32) & 0x01) << 0usize);
        }
        ...
        #[doc = "Synchronization error masked interrupt status"]
        #[inline(always)]
        pub const fn set_err_mis(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 2usize)) | (((val as u32) & 0x01) << 2usize);
        }
        ...
        #[doc = "VSYNC masked interrupt status"]
        #[inline(always)]
        pub const fn set_vsync_mis(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 3usize)) | (((val as u32) & 0x01) << 3usize);
        }
        ...
        #[doc = "Line masked interrupt status"]
        #[inline(always)]
        pub const fn set_line_mis(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 4usize)) | (((val as u32) & 0x01) << 4usize);
        }
    }
    ...
    impl Ris {
        ...
        #[doc = "Capture complete raw interrupt status"]
        #[inline(always)]
        pub const fn set_frame_ris(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 0usize)) | (((val as u32) & 0x01) << 0usize);
        }
        ...
        #[doc = "Synchronization error raw interrupt status"]
        #[inline(always)]
        pub const fn set_err_ris(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 2usize)) | (((val as u32) & 0x01) << 2usize);
        }
        ...
        #[doc = "VSYNC raw interrupt status"]
        #[inline(always)]
        pub const fn set_vsync_ris(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 3usize)) | (((val as u32) & 0x01) << 3usize);
        }
        ...
        #[doc = "Line raw interrupt status"]
        #[inline(always)]
        pub const fn set_line_ris(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 4usize)) | (((val as u32) & 0x01) << 4usize);
        }
    }
