...
# [inline (always)]
pub fn set_ct (& mut self , val : super :: vals :: Ct) { self . 0 = (self . 0 & ! (0x01 << 19usize)) | (((val . to_bits () as u32) & 0x01) << 19usize) ; } # [doc = "Peripheral burst transfer configuration"]
# [inline (always)]
...
# [inline (always)]
pub fn set_mburst (& mut self , val : super :: vals :: Burst) { self . 0 = (self . 0 & ! (0x03 << 23usize)) | (((val . to_bits () as u32) & 0x03) << 23usize) ; } # [doc = "Channel selection"]
# [inline (always)]
pub const fn chsel (& self) -> u8 { let val = (self . 0 >> 25usize) & 0x0f ; val as u8 } # [doc = "Channel selection"]
# [inline (always)]
pub fn set_chsel (& mut self , val : u8) { self . 0 = (self . 0 & ! (0x0f << 25usize)) | (((val as u32) & 0x0f) << 25usize) ; } } impl Default for Cr { # [inline (always)]
