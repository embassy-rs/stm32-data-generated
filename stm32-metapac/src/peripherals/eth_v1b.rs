...
pub mod regs {
    ...
    impl Dmabmr {
        ...
        #[inline(always)]
        pub const fn edfe(&self) -> super::vals::Edfe {
            let val = (self.0 >> 7usize) & 0x01;
            super::vals::Edfe::from_bits(val as u8)
        }
        #[doc = "Enhanced descriptor format enable"]
        #[inline(always)]
        pub fn set_edfe(&mut self, val: super::vals::Edfe) {
    ...
    impl Maccr {
        ...
        #[inline(always)]
        pub const fn cstf(&self) -> super::vals::Cstf {
            let val = (self.0 >> 25usize) & 0x01;
            super::vals::Cstf::from_bits(val as u8)
        }
        #[doc = "CRC stripping for type frames"]
        #[inline(always)]
        pub fn set_cstf(&mut self, val: super::vals::Cstf) {
            self.0 = (self.0 & !(0x01 << 25usize)) | (((val.to_bits() as u32) & 0x01) << 25usize);
        }
    }
...
pub mod vals {
    ...
    impl Cstf {
        #[inline(always)]
        pub const fn from_bits(val: u8) -> Cstf {
            unsafe { core::mem::transmute(val & 0x01) }
        }
        #[inline(always)]
        pub const fn to_bits(self) -> u8 {
    ...
    impl From<u8> for Cstf {
        #[inline(always)]
        fn from(val: u8) -> Cstf {
            Cstf::from_bits(val)
        }
    }
    impl From<Cstf> for u8 {
        #[inline(always)]
        fn from(val: Cstf) -> u8 {
            Cstf::to_bits(val)
        }
    ...
    impl Edfe {
        #[inline(always)]
        pub const fn from_bits(val: u8) -> Edfe {
            unsafe { core::mem::transmute(val & 0x01) }
        }
        #[inline(always)]
        pub const fn to_bits(self) -> u8 {
    ...
    impl From<u8> for Edfe {
        #[inline(always)]
        fn from(val: u8) -> Edfe {
            Edfe::from_bits(val)
        }
    }
    impl From<Edfe> for u8 {
        #[inline(always)]
        fn from(val: Edfe) -> u8 {
            Edfe::to_bits(val)
        }
