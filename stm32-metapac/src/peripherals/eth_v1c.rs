...
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
pub struct Macalr (pub u32) ; impl Macalr { # [doc = "thernet MAC address 1/2/3 low"]
# [inline (always)]
pub const fn macal (& self) -> u32 { let val = (self . 0 >> 0usize) & 0xffff_ffff ; val as u32 } # [doc = "thernet MAC address 1/2/3 low"]
# [inline (always)]
