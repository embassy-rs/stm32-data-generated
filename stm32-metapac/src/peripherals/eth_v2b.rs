...
impl EthernetMac {
    ...
    #[doc = "Watchdog and jabber timeout register."]
    #[inline(always)]
    ...
    #[inline(always)]
    pub const fn mac_rx_tx_sr(self) -> crate::common::Reg<regs::MacRxTxSr, crate::common::RW> {
    ...
    #[inline(always)]
    pub const fn mmc_rx_interrupt(self) -> crate::common::Reg<regs::MmcRxInterrupt, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x0704usize) as _) }
    }
    #[doc = "MMC Tx interrupt register."]
    #[inline(always)]
    pub const fn mmc_tx_interrupt(self) -> crate::common::Reg<regs::MmcTxInterrupt, crate::common::RW> {
    ...
    #[doc = "Rx domain time increment register."]
    #[inline(always)]
    pub const fn mac_rx_dti(self) -> crate::common::Reg<regs::Macrxdti, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x0b24usize) as _) }
    }
    #[doc = "Tx domain time increment register."]
    #[inline(always)]
    pub const fn mac_tx_dti(self) -> crate::common::Reg<regs::MacTxDti, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x0b28usize) as _) }
    }
    #[doc = "Tx timestamp status nanoseconds register."]
    #[inline(always)]
    pub const fn mac_tx_tssnr(self) -> crate::common::Reg<regs::MacTxTssnr, crate::common::RW> {
...
impl EthernetMtl {
    ...
    #[inline(always)]
    pub const fn mtl_tx_qur(self) -> crate::common::Reg<regs::MtlTxQur, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x0104usize) as _) }
    }
    ...
    #[inline(always)]
    pub const fn mtl_rx_qmpocr(self) -> crate::common::Reg<regs::MtlRxQmpocr, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x0134usize) as _) }
    }
...
pub mod regs {
    ...
    impl DmacRxIwtr {
        ...
        #[must_use]
        #[inline(always)]
        pub const fn rwtu(&self) -> super::vals::Rwtu {
            let val = (self.0 >> 16usize) & 0x03;
            super::vals::Rwtu::from_bits(val as u8)
        }
        #[doc = "Receive Interrupt Watchdog Timer Count Units."]
        #[inline(always)]
        pub const fn set_rwtu(&mut self, val: super::vals::Rwtu) {
            self.0 = (self.0 & !(0x03 << 16usize)) | (((val.to_bits() as u32) & 0x03) << 16usize);
        }
        #[doc = "Rx Idle Timer Count Units."]
        #[must_use]
        #[inline(always)]
        pub const fn itcu(&self) -> super::vals::Itcu {
            let val = (self.0 >> 18usize) & 0x03;
            super::vals::Itcu::from_bits(val as u8)
        }
        #[doc = "Rx Idle Timer Count Units."]
        #[inline(always)]
        pub const fn set_itcu(&mut self, val: super::vals::Itcu) {
    ...
    impl defmt::Format for DmacRxIwtr {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "DmacRxIwtr {{ rwt: {=u8:?}, itw: {=u8:?}, rwtu: {:?}, itcu: {:?}, rbct: {=u16:?}, psel: {:?} }}",
                self.rwt(),
                self.itw(),
                self.rwtu(),
                self.itcu(),
    ...
    impl Dmaccr {
        ...
        #[doc = "Descriptor refetch when OWN bit is 0."]
        #[must_use]
        #[inline(always)]
    ...
    impl defmt::Format for Dmaisr {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Dmaisr {{ dcis: {=bool:?}, mtlis: {=bool:?}, macis: {=bool:?} }}",
                self.dcis(),
                self.mtlis(),
                self.macis()
            )
    ...
    impl defmt::Format for Dmamr {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Dmamr {{ swr: {=bool:?}, da: {:?}, txpr: {=bool:?}, pr: {:?}, intm: {=u8:?} }}",
                self.swr(),
                self.da(),
                self.txpr(),
                self.pr(),
    ...
    impl core::fmt::Debug for MacTxDti {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("MacTxDti").field("txns", &self.txns()).finish()
        }
    }
    #[cfg(feature = "defmt")]
    ...
    impl defmt::Format for Machwf0r {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Machwf0r {{ miisel: {=bool:?}, gmiisel: {=bool:?}, hdsel: {=bool:?}, pcssel: {=bool:?}, vlhash: {=bool:?}, smasel: {=bool:?}, rwksel: {=bool:?}, mgksel: {=bool:?}, mmcsel: {=bool:?}, arpoffsel: {=bool:?}, tssel: {=bool:?}, eeesel: {=bool:?}, txcoesel: {=bool:?}, rxcoesel: {=bool:?}, addmacadrsel: {=u8:?}, macadr32sel: {=bool:?}, macadr64sel: {=bool:?}, tsstssel: {:?}, savlanins: {=bool:?}, actphysel: {=u8:?} }}",
                self.miisel(),
                self.gmiisel(),
                self.hdsel(),
                self.pcssel(),
    ...
    impl defmt::Format for Macisr {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Macisr {{ phyis: {=bool:?}, pmtis: {=bool:?}, lpiis: {=bool:?}, mmcis: {=bool:?}, mmcrxis: {=bool:?}, mmctxis: {=bool:?}, tsis: {=bool:?}, txstsis: {=bool:?}, rxstsis: {=bool:?}, mdiois: {=bool:?} }}",
                self.phyis(),
                self.pmtis(),
                self.lpiis(),
                self.mmcis(),
    ...
    impl Macppscr {
        ...
        #[must_use]
        #[inline(always)]
        pub const fn ppscmd(&self) -> u8 {
            let val = (self.0 >> 0usize) & 0x0f;
            val as u8
        }
        #[doc = "PPS Output Frequency Control."]
        #[inline(always)]
        pub const fn set_ppscmd(&mut self, val: u8) {
            self.0 = (self.0 & !(0x0f << 0usize)) | (((val as u32) & 0x0f) << 0usize);
        }
        ...
        #[must_use]
        #[inline(always)]
        pub const fn trgtmodsel(&self) -> u8 {
            let val = (self.0 >> 5usize) & 0x03;
            val as u8
        }
        #[doc = "Target Time Register Mode for PPS Output."]
        #[inline(always)]
        pub const fn set_trgtmodsel(&mut self, val: u8) {
            self.0 = (self.0 & !(0x03 << 5usize)) | (((val as u32) & 0x03) << 5usize);
        }
        #[doc = "MCGR Mode Enable for PPS Output."]
        #[must_use]
        #[inline(always)]
        pub const fn mcgren(&self) -> bool {
            let val = (self.0 >> 7usize) & 0x01;
            val != 0
        }
        #[doc = "MCGR Mode Enable for PPS Output."]
        #[inline(always)]
        pub const fn set_mcgren(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 7usize)) | (((val as u32) & 0x01) << 7usize);
        }
        #[doc = "Time Select."]
        #[must_use]
    ...
    impl core::fmt::Debug for Macppscr {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("Macppscr")
                ...
                .field("trgtmodsel", &self.trgtmodsel())
                .field("mcgren", &self.mcgren())
    ...
    impl defmt::Format for Macppscr {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Macppscr {{ ppscmd: {=u8:?}, ppsen0: {=bool:?}, trgtmodsel: {=u8:?}, mcgren: {=bool:?}, timesel: {=bool:?} }}",
                self.ppscmd(),
                self.ppsen0(),
                self.trgtmodsel(),
                self.mcgren(),
    ...
    impl core::fmt::Debug for Macrxdti {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("Macrxdti").field("rxns", &self.rxns()).finish()
        }
    }
    #[cfg(feature = "defmt")]
    ...
    impl Mactscr {
        ...
        #[doc = "Enable PCS latencies."]
        #[must_use]
        #[inline(always)]
        pub const fn epcsl(&self) -> super::vals::Epcsl {
            let val = (self.0 >> 25usize) & 0x01;
            super::vals::Epcsl::from_bits(val as u8)
        }
        #[doc = "Enable PCS latencies."]
        #[inline(always)]
        pub const fn set_epcsl(&mut self, val: super::vals::Epcsl) {
            self.0 = (self.0 & !(0x01 << 25usize)) | (((val.to_bits() as u32) & 0x01) << 25usize);
        }
        #[doc = "Enable Timestamp Capturing in PTP Clock Domain."]
        #[must_use]
        #[inline(always)]
        ...
        #[doc = "Latency Input Based Timestamp Accuracy Disable."]
        #[must_use]
        #[inline(always)]
        pub const fn lita(&self) -> super::vals::Lita {
            let val = (self.0 >> 27usize) & 0x01;
            super::vals::Lita::from_bits(val as u8)
        }
        #[doc = "Latency Input Based Timestamp Accuracy Disable."]
        #[inline(always)]
        pub const fn set_lita(&mut self, val: super::vals::Lita) {
    ...
    impl defmt::Format for Mactscr {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Mactscr {{ tsena: {=bool:?}, tscfupdt: {=bool:?}, tsinit: {=bool:?}, tsupdt: {=bool:?}, tsaddreg: {=bool:?}, ptge: {=bool:?}, tsenall: {=bool:?}, tsctrlssr: {=bool:?}, tsver2ena: {=bool:?}, tsipena: {=bool:?}, tsipv6ena: {=bool:?}, tsipv4ena: {=bool:?}, tsevntena: {=bool:?}, tsmstrena: {=bool:?}, snaptypsel: {=u8:?}, tsenmacaddr: {=bool:?}, txtsstsm: {=bool:?}, epcsl: {:?}, ecpd: {=bool:?}, lita: {:?}, av8021asmen: {=bool:?} }}",
                self.tsena(),
                self.tscfupdt(),
                self.tsinit(),
                self.tsupdt(),
    ...
    impl defmt::Format for Mactssr {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Mactssr {{ tssovf: {=bool:?}, tstargt: {=bool:?}, auxtstrig: {=bool:?}, tstrgterr: {=bool:?}, txtssis: {=bool:?}, atsstn: {=u8:?}, atsstm: {=bool:?}, atsns: {=u8:?} }}",
                self.tssovf(),
                self.tstargt(),
                self.auxtstrig(),
                self.tstrgterr(),
    ...
    impl defmt::Format for Macvtcr {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Macvtcr {{ vl: {=u16:?}, etv: {=bool:?}, vtim: {=bool:?}, esvl: {=bool:?}, ersvlm: {=bool:?}, dovltc: {=bool:?}, evls: {=u8:?}, evlrxs: {=bool:?}, vthm: {=bool:?}, edvlp: {=bool:?}, erivlt: {=bool:?}, eivls: {=u8:?}, eivlrxs: {=bool:?} }}",
                self.vl(),
                self.etv(),
                self.vtim(),
                self.esvl(),
    ...
    impl defmt::Format for Macwtr {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Macwtr {{ wto: {=u8:?}, pwe: {=bool:?}, jto: {:?}, pje: {=bool:?} }}",
                self.wto(),
                self.pwe(),
                self.jto(),
                self.pje()
    ...
    impl defmt::Format for MtlRxQomr {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "MtlRxQomr {{ rtc: {=u8:?}, fup: {=bool:?}, fep: {=bool:?}, rsf: {=bool:?}, dis_tcp_ef: {=bool:?}, rqs: {=u8:?} }}",
                self.rtc(),
                self.fup(),
                self.fep(),
                self.rsf(),
    ...
    impl Mtlisr {
        ...
        #[must_use]
        #[inline(always)]
        pub const fn qis(&self) -> bool {
            let val = (self.0 >> 0usize) & 0x01;
            val != 0
        }
        #[doc = "Queue interrupt status."]
        #[inline(always)]
        pub const fn set_qis(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 0usize)) | (((val as u32) & 0x01) << 0usize);
        }
    }
    ...
    impl core::fmt::Debug for Mtlisr {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("Mtlisr").field("qis", &self.qis()).finish()
        }
    }
    #[cfg(feature = "defmt")]
    impl defmt::Format for Mtlisr {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(f, "Mtlisr {{ qis: {=bool:?} }}", self.qis())
        }
    }
    #[doc = "Operating mode Register."]
    #[repr(transparent)]
...
pub mod vals {
    ...
    #[cfg_attr(feature = "defmt", derive(defmt::Format))]
    pub enum Epcsl {
        #[doc = "The XPCS latencies are not considered in the captured timestamp."]
        B0x0 = 0x0,
        #[doc = "Timestamp captured at the egress and ingress ports includes the ingress and egress latencies provided by XPCS."]
        B0x1 = 0x01,
    }
    impl Epcsl {
        #[inline(always)]
        pub const fn from_bits(val: u8) -> Epcsl {
            unsafe { core::mem::transmute(val & 0x01) }
        }
        #[inline(always)]
        pub const fn to_bits(self) -> u8 {
    ...
    impl From<u8> for Epcsl {
        #[inline(always)]
        fn from(val: u8) -> Epcsl {
            Epcsl::from_bits(val)
        }
    }
    impl From<Epcsl> for u8 {
        #[inline(always)]
        fn from(val: Epcsl) -> u8 {
            Epcsl::to_bits(val)
        }
    }
    #[repr(u8)]
    ...
    impl Itcu {
        #[inline(always)]
        pub const fn from_bits(val: u8) -> Itcu {
    ...
    impl From<u8> for Itcu {
        #[inline(always)]
        fn from(val: u8) -> Itcu {
            Itcu::from_bits(val)
        }
    }
    impl From<Itcu> for u8 {
        #[inline(always)]
        fn from(val: Itcu) -> u8 {
            Itcu::to_bits(val)
        }
    ...
    pub enum Lita {
        _RESERVED_0 = 0x0,
        #[doc = "Toggle inputs and PCS latencies are computed by MAC."]
        B0x1 = 0x01,
    }
    impl Lita {
        #[inline(always)]
        pub const fn from_bits(val: u8) -> Lita {
            unsafe { core::mem::transmute(val & 0x01) }
        }
        #[inline(always)]
        pub const fn to_bits(self) -> u8 {
    ...
    impl From<u8> for Lita {
        #[inline(always)]
        fn from(val: u8) -> Lita {
            Lita::from_bits(val)
        }
    }
    impl From<Lita> for u8 {
        #[inline(always)]
        fn from(val: Lita) -> u8 {
            Lita::to_bits(val)
        }
    ...
    pub enum Psel {
        #[doc = "RBCT\\[9:0\\]
is used to generate interrupt based on the number of bytes received."]
        B0x0 = 0x0,
        #[doc = "RBCT\\[9:0\\]
is used to generate interrupt based on the number of packets received."]
        B0x1 = 0x01,
    }
    impl Psel {
        #[inline(always)]
    ...
    impl Rwtu {
        #[inline(always)]
        pub const fn from_bits(val: u8) -> Rwtu {
            unsafe { core::mem::transmute(val & 0x03) }
        }
        #[inline(always)]
        pub const fn to_bits(self) -> u8 {
    ...
    impl From<u8> for Rwtu {
        #[inline(always)]
        fn from(val: u8) -> Rwtu {
            Rwtu::from_bits(val)
        }
    }
    impl From<Rwtu> for u8 {
        #[inline(always)]
        fn from(val: Rwtu) -> u8 {
            Rwtu::to_bits(val)
        }
