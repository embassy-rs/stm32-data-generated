...
impl Fdcanram {
    ...
    pub const fn rxfifo0(self, n: usize) -> crate::common::Reg<u32, crate::common::RW> {
        assert!(n < 54usize);
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0xb0usize + n * 4usize) as _) }
    }
    #[doc = "Rx FIFO 1"]
    #[inline(always)]
    pub const fn rxfifo1(self, n: usize) -> crate::common::Reg<u32, crate::common::RW> {
        assert!(n < 54usize);
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x0188usize + n * 4usize) as _) }
    }
    #[doc = "Tx event FIFO"]
    #[inline(always)]
    pub const fn txefifo(self, n: usize) -> crate::common::Reg<u32, crate::common::RW> {
        assert!(n < 6usize);
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x0260usize + n * 4usize) as _) }
    }
    #[doc = "Tx buffer"]
    #[inline(always)]
    pub const fn txbuf(self, n: usize) -> crate::common::Reg<u32, crate::common::RW> {
        assert!(n < 54usize);
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x0278usize + n * 4usize) as _) }
    }
}
