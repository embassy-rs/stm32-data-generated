...
impl Flash {
    ...
    #[doc = "Bank 2 key register"]
    #[inline(always)]
    pub const fn keyr2(self) -> crate::common::Reg<u32, crate::common::W> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x44usize) as _) }
    }
    #[doc = "Bank 2 status register"]
    #[inline(always)]
    pub const fn sr2(self) -> crate::common::Reg<regs::Sr, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x4cusize) as _) }
    }
    #[doc = "Bank 2 control register"]
    #[inline(always)]
    pub const fn cr2(self) -> crate::common::Reg<regs::Cr2, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x50usize) as _) }
    }
    #[doc = "Bank 2 address register"]
    #[inline(always)]
    pub const fn ar2(self) -> crate::common::Reg<regs::Ar, crate::common::W> {
...
pub mod regs {
    ...
    impl defmt::Format for Cr2 {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Cr2 {{ pg: {=bool:?}, per: {=bool:?}, mer: {=bool:?}, strt: {=bool:?}, lock: {=bool:?}, errie: {=bool:?}, eopie: {=bool:?} }}",
                self.pg(),
                self.per(),
                self.mer(),
                self.strt(),
    ...
    impl Obr {
        ...
        #[doc = "Read protection"]
        #[inline(always)]
        pub const fn set_rdprt(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 1usize)) | (((val as u32) & 0x01) << 1usize);
        }
        #[doc = "WDG_SW"]
        #[must_use]
        ...
        #[doc = "Boot from bank 1 when set; otherwise check bank 2 before bank 1"]
        #[must_use]
        #[inline(always)]
        ...
        #[doc = "Boot from bank 1 when set; otherwise check bank 2 before bank 1"]
        #[inline(always)]
        pub const fn set_bfb2(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 5usize)) | (((val as u32) & 0x01) << 5usize);
        }
        #[doc = "Data0"]
        #[must_use]
    ...
    impl defmt::Format for Obr {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Obr {{ opterr: {=bool:?}, rdprt: {=bool:?}, wdg_sw: {=bool:?}, n_rst_stop: {=bool:?}, n_rst_stdby: {=bool:?}, bfb2: {=bool:?}, data0: {=u8:?}, data1: {=u8:?} }}",
                self.opterr(),
                self.rdprt(),
                self.wdg_sw(),
                self.n_rst_stop(),
    ...
    impl Sr {
        ...
        #[doc = "Programming error. Cleared by writing 1."]
        #[must_use]
        #[inline(always)]
        ...
        #[doc = "Write protection error. Cleared by writing 1."]
        #[must_use]
        #[inline(always)]
        ...
        #[doc = "End of operation. Cleared by writing 1."]
        #[must_use]
        #[inline(always)]
