...
pub mod regs {
    ...
    impl Acr {
        ...
        #[doc = "Flash half cycle access enable"]
        #[inline(always)]
        pub const fn set_hlfcya(&mut self, val: bool) {
        ...
        #[doc = "PRFTBE"]
        #[inline(always)]
        pub const fn set_prftbe(&mut self, val: bool) {
        ...
        #[doc = "PRFTBS"]
        #[inline(always)]
        pub const fn set_prftbs(&mut self, val: bool) {
    ...
    impl defmt::Format for Cr {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Cr {{ pg: {=bool:?}, per: {=bool:?}, mer: {=bool:?}, optpg: {=bool:?}, opter: {=bool:?}, strt: {=bool:?}, lock: {=bool:?}, optwre: {=bool:?}, errie: {=bool:?}, eopie: {=bool:?}, obl_launch: {=bool:?} }}",
                self.pg(),
                self.per(),
                self.mer(),
                self.optpg(),
    ...
    impl Obr {
        ...
        #[doc = "Read protection Level status"]
        #[inline(always)]
        pub const fn set_rdprt(&mut self, val: super::vals::Rdprt) {
        ...
        #[doc = "WDG_SW"]
        #[inline(always)]
        pub const fn set_wdg_sw(&mut self, val: super::vals::WdgSw) {
        ...
        #[doc = "nRST_STOP"]
        #[inline(always)]
        pub const fn set_n_rst_stop(&mut self, val: super::vals::NRstStop) {
        ...
        #[doc = "nRST_STDBY"]
        #[inline(always)]
        pub const fn set_n_rst_stdby(&mut self, val: super::vals::NRstStdby) {
        ...
        #[doc = "VDDA_MONITOR"]
        #[inline(always)]
        pub const fn set_vdda_monitor(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 13usize)) | (((val as u32) & 0x01) << 13usize);
        }
        ...
        #[doc = "SRAM_PARITY_CHECK"]
        #[inline(always)]
        pub const fn set_sram_parity_check(&mut self, val: bool) {
        ...
        #[doc = "SDADC12_VDD_MONITOR"]
        #[inline(always)]
        pub const fn set_sdadc12_vdd_monitor(&mut self, val: bool) {
    ...
    impl defmt::Format for Obr {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Obr {{ opterr: {=bool:?}, rdprt: {:?}, wdg_sw: {:?}, n_rst_stop: {:?}, n_rst_stdby: {:?}, n_boot1: {=bool:?}, vdda_monitor: {=bool:?}, sram_parity_check: {=bool:?}, sdadc12_vdd_monitor: {=bool:?}, data0: {=u8:?}, data1: {=u8:?} }}",
                self.opterr(),
                self.rdprt(),
                self.wdg_sw(),
                self.n_rst_stop(),
                ...
                self.n_boot1(),
                self.vdda_monitor(),
                self.sram_parity_check(),
                self.sdadc12_vdd_monitor(),
                self.data0(),
                self.data1()
            )
        }
    ...
    impl Wrpr {
        ...
        #[doc = "Write protect"]
        #[inline(always)]
        pub const fn set_wrp(&mut self, val: u32) {
            self.0 = (self.0 & !(0xffff_ffff << 0usize)) | (((val as u32) & 0xffff_ffff) << 0usize);
        }
    }
