...
# [inline (always)]
pub fn set_hlfcya (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 3usize)) | (((val as u32) & 0x01) << 3usize) ; } # [doc = "PRFTBE"]
# [inline (always)]
pub const fn prftbe (& self) -> bool { let val = (self . 0 >> 4usize) & 0x01 ; val != 0 } # [doc = "PRFTBE"]
# [inline (always)]
pub fn set_prftbe (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 4usize)) | (((val as u32) & 0x01) << 4usize) ; } # [doc = "PRFTBS"]
# [inline (always)]
pub const fn prftbs (& self) -> bool { let val = (self . 0 >> 5usize) & 0x01 ; val != 0 } # [doc = "PRFTBS"]
# [inline (always)]
...
# [inline (always)]
pub const fn obl_launch (& self) -> bool { let val = (self . 0 >> 13usize) & 0x01 ; val != 0 } # [doc = "Force option byte loading"]
# [inline (always)]
pub fn set_obl_launch (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 13usize)) | (((val as u32) & 0x01) << 13usize) ; } } impl Default for Cr { # [inline (always)]
...
# [inline (always)]
pub fn set_n_rst_stdby (& mut self , val : super :: vals :: NRstStdby) { self . 0 = (self . 0 & ! (0x01 << 10usize)) | (((val . to_bits () as u32) & 0x01) << 10usize) ; } # [doc = "BOOT1"]
# [inline (always)]
pub const fn n_boot1 (& self) -> bool { let val = (self . 0 >> 12usize) & 0x01 ; val != 0 } # [doc = "BOOT1"]
# [inline (always)]
pub fn set_n_boot1 (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 12usize)) | (((val as u32) & 0x01) << 12usize) ; } # [doc = "VDDA_MONITOR"]
# [inline (always)]
pub const fn vdda_monitor (& self) -> bool { let val = (self . 0 >> 13usize) & 0x01 ; val != 0 } # [doc = "VDDA_MONITOR"]
# [inline (always)]
pub fn set_vdda_monitor (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 13usize)) | (((val as u32) & 0x01) << 13usize) ; } # [doc = "SRAM_PARITY_CHECK"]
# [inline (always)]
...
# [inline (always)]
pub const fn sdadc12_vdd_monitor (& self) -> bool { let val = (self . 0 >> 15usize) & 0x01 ; val != 0 } # [doc = "SDADC12_VDD_MONITOR"]
# [inline (always)]
pub fn set_sdadc12_vdd_monitor (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 15usize)) | (((val as u32) & 0x01) << 15usize) ; } # [doc = "Data0"]
# [inline (always)]
...
pub enum Latency { # [doc = "0 wait states, if 0 < HCLK <= 24 MHz"]
WS0 = 0x0 , # [doc = "1 wait state, if 24 < HCLK <= 48 MHz"]
WS1 = 0x01 , # [doc = "2 wait states, if 48 < HCLK <= 72 MHz"]
