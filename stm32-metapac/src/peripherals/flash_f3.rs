    ...
    impl defmt::Format for Obr {
        fn format(&self, f: defmt::Formatter) {
            ...
            struct Obr {
                ...
                n_boot1: bool,
                vdda_monitor: bool,
                sram_parity_check: bool,
                sdadc12_vdd_monitor: bool,
                data0: u8,
                data1: u8,
            }
            let proxy = Obr {
                ...
                sram_parity_check: self.sram_parity_check(),
                sdadc12_vdd_monitor: self.sdadc12_vdd_monitor(),
                data0: self.data0(),
                data1: self.data1(),
            };
            defmt::write!(f, "{}", proxy)
