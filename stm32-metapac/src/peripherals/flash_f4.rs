...
pub mod regs {
    ...
    impl Optcr {
        ...
        #[doc = "Not write protect"]
        #[inline(always)]
        pub const fn set_n_wrp(&mut self, val: u16) {
        ...
        #[doc = "Dual-bank enable on 1 Mbyte Flash memory devices"]
        #[inline(always)]
        pub const fn set_db1m(&mut self, val: bool) {
        ...
        #[doc = "Selection of protection mode for nWPRi bits"]
        #[inline(always)]
        pub const fn set_sprmod(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 31usize)) | (((val as u32) & 0x01) << 31usize);
        }
    }
    ...
    impl defmt::Format for Optcr {
        fn format(&self, f: defmt::Formatter) {
            defmt :: write ! (f , "Optcr {{ optlock: {=bool:?}, optstrt: {=bool:?}, bor_lev: {=u8:?}, wdg_sw: {=bool:?}, n_rst_stop: {=bool:?}, n_rst_stdby: {=bool:?}, rdp: {=u8:?}, n_wrp: {=u16:?}, db1m: {=bool:?}, sprmod: {=bool:?} }}" , self . optlock () , self . optstrt () , self . bor_lev () , self . wdg_sw () , self . n_rst_stop () , self . n_rst_stdby () , self . rdp () , self . n_wrp () , self . db1m () , self . sprmod ())
        }
    }
    #[doc = "Status register"]
    #[repr(transparent)]
