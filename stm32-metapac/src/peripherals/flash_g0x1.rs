...
pub mod regs {
    ...
    impl defmt::Format for Pcrop2asr {
        fn format(&self, f: defmt::Formatter) {
            ...
            let proxy = Pcrop2asr {
                pcrop2a_strt: self.pcrop2a_strt(),
            };
            defmt::write!(f, "{}", proxy)
        }
    }
    ...
    impl defmt::Format for Pcrop2bsr {
        fn format(&self, f: defmt::Formatter) {
            ...
            let proxy = Pcrop2bsr {
                pcrop2b_strt: self.pcrop2b_strt(),
            };
            defmt::write!(f, "{}", proxy)
        }
    }
