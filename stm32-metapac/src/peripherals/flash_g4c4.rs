...
pub mod regs {
    ...
    impl defmt::Format for Acr {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Acr {{ latency: {:?}, prften: {=bool:?}, icen: {=bool:?}, dcen: {=bool:?}, icrst: {=bool:?}, dcrst: {=bool:?}, run_pd: {=bool:?}, sleep_pd: {=bool:?}, dbg_swen: {=bool:?} }}",
                self.latency(),
                self.prften(),
                self.icen(),
                self.dcen(),
    ...
    impl Cr {
        ...
        #[doc = "Securable memory area protection enable"]
        #[inline(always)]
        pub const fn set_sec_prot1(&mut self, val: bool) {
    ...
    impl defmt::Format for Cr {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Cr {{ pg: {=bool:?}, per: {=bool:?}, mer1: {=bool:?}, pnb: {=u8:?}, strt: {=bool:?}, optstrt: {=bool:?}, fstpg: {=bool:?}, eopie: {=bool:?}, errie: {=bool:?}, rderrie: {=bool:?}, obl_launch: {=bool:?}, sec_prot1: {=bool:?}, optlock: {=bool:?}, lock: {=bool:?} }}",
                self.pg(),
                self.per(),
                self.mer1(),
                self.pnb(),
    ...
    impl Eccr {
        ...
        #[doc = "ECC correction"]
        #[inline(always)]
        pub const fn set_eccc2(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 28usize)) | (((val as u32) & 0x01) << 28usize);
        }
        #[doc = "ECC2 detection"]
        #[must_use]
        ...
        #[doc = "ECC2 detection"]
        #[inline(always)]
        pub const fn set_eccd2(&mut self, val: bool) {
    ...
    impl Optr {
        ...
        #[doc = "PB4 pull-up enable"]
        #[inline(always)]
        pub const fn set_pb4_pupen(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 22usize)) | (((val as u32) & 0x01) << 22usize);
        }
    ...
    impl defmt::Format for Optr {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Optr {{ rdp: {:?}, bor_lev: {=u8:?}, n_rst_stop: {=bool:?}, n_rst_stdby: {=bool:?}, n_rst_shdw: {=bool:?}, idwg_sw: {=bool:?}, iwdg_stop: {=bool:?}, iwdg_stdby: {=bool:?}, wwdg_sw: {=bool:?}, pb4_pupen: {=bool:?}, n_boot1: {=bool:?}, sram2_pe: {=bool:?}, sram2_rst: {=bool:?}, n_swboot0: {=bool:?}, n_boot0: {=bool:?}, nrst_mode: {:?}, irhen: {=bool:?} }}",
                self.rdp(),
                self.bor_lev(),
                self.n_rst_stop(),
                self.n_rst_stdby(),
    ...
    impl Sec1r {
        ...
        #[doc = "SEC_SIZE1"]
        #[inline(always)]
        pub const fn set_sec_size1(&mut self, val: u8) {
