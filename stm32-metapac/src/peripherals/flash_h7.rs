...
impl Flash {
    ...
    pub const fn bank(self, n: usize) -> Bank {
        assert!(n < 2usize);
        unsafe { Bank::from_ptr(self.ptr.wrapping_add(0x04usize + n * 256usize) as _) }
    }
...
pub mod regs {
    ...
    impl Ccr {
        ...
        #[doc = "Bank 1 OPERR1 flag clear bit"]
        #[inline(always)]
        pub const fn set_clr_operr(&mut self, val: bool) {
        ...
        #[doc = "Bank 1 RDPERR1 flag clear bit"]
        #[inline(always)]
        pub const fn set_clr_rdperr(&mut self, val: bool) {
        ...
        #[doc = "Bank 1 RDSERR1 flag clear bit"]
        #[inline(always)]
        pub const fn set_clr_rdserr(&mut self, val: bool) {
        ...
        #[doc = "Bank 1 SNECCERR1 flag clear bit"]
        #[inline(always)]
        pub const fn set_clr_sneccerr(&mut self, val: bool) {
        ...
        #[doc = "Bank 1 DBECCERR1 flag clear bit"]
        #[inline(always)]
        pub const fn set_clr_dbeccerr(&mut self, val: bool) {
        ...
        #[doc = "Bank 1 CRCEND1 flag clear bit"]
        #[inline(always)]
        pub const fn set_clr_crcend(&mut self, val: bool) {
        ...
        #[doc = "Bank 1 CRC read error clear bit"]
        #[inline(always)]
        pub const fn set_clr_crcrderr(&mut self, val: bool) {
    ...
    impl Cr {
        ...
        #[doc = "Bank 1 read protection error interrupt enable bit"]
        #[inline(always)]
        pub const fn set_rdperrie(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 23usize)) | (((val as u32) & 0x01) << 23usize);
        }
        ...
        #[doc = "Bank 1 secure error interrupt enable bit"]
        #[inline(always)]
        pub const fn set_rdserrie(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 24usize)) | (((val as u32) & 0x01) << 24usize);
        }
        ...
        #[doc = "Bank 1 ECC single correction error interrupt enable bit"]
        #[inline(always)]
        pub const fn set_sneccerrie(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 25usize)) | (((val as u32) & 0x01) << 25usize);
        }
        ...
        #[doc = "Bank 1 ECC double detection error interrupt enable bit"]
        #[inline(always)]
        pub const fn set_dbeccerrie(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 26usize)) | (((val as u32) & 0x01) << 26usize);
        }
        ...
        #[doc = "Bank 1 end of CRC calculation interrupt enable bit"]
        #[inline(always)]
        pub const fn set_crcendie(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 27usize)) | (((val as u32) & 0x01) << 27usize);
        }
        ...
        #[doc = "Bank 1 CRC read error interrupt enable bit"]
        #[inline(always)]
        pub const fn set_crcrderrie(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 28usize)) | (((val as u32) & 0x01) << 28usize);
        }
    }
    impl Default for Cr {
    ...
    impl defmt::Format for Cr {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Cr {{ lock: {=bool:?}, pg: {=bool:?}, ser: {=bool:?}, ber: {=bool:?}, psize: {=u8:?}, fw: {=bool:?}, start: {=bool:?}, snb: {=u8:?}, crc_en: {=bool:?}, eopie: {=bool:?}, wrperrie: {=bool:?}, pgserrie: {=bool:?}, strberrie: {=bool:?}, incerrie: {=bool:?}, operrie: {=bool:?}, rdperrie: {=bool:?}, rdserrie: {=bool:?}, sneccerrie: {=bool:?}, dbeccerrie: {=bool:?}, crcendie: {=bool:?}, crcrderrie: {=bool:?} }}",
                self.lock(),
                self.pg(),
                self.ser(),
                self.ber(),
    ...
    impl Crccr {
        ...
        #[doc = "Bank 1 CRC sector number"]
        #[inline(always)]
        pub const fn set_crc_sect(&mut self, val: u8) {
            self.0 = (self.0 & !(0x07 << 0usize)) | (((val as u32) & 0x07) << 0usize);
        }
        ...
        #[doc = "Bank 1 CRC select bit"]
        #[inline(always)]
        pub const fn set_all_bank(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 7usize)) | (((val as u32) & 0x01) << 7usize);
        }
        ...
        #[doc = "Bank 1 CRC sector mode select bit"]
        #[inline(always)]
        pub const fn set_crc_by_sect(&mut self, val: bool) {
        ...
        #[doc = "Bank 1 CRC sector select bit"]
        #[inline(always)]
        pub const fn set_add_sect(&mut self, val: bool) {
        ...
        #[doc = "Bank 1 CRC sector list clear bit"]
        #[inline(always)]
        pub const fn set_clean_sect(&mut self, val: bool) {
        ...
        #[doc = "Bank 1 CRC start bit"]
        #[inline(always)]
        pub const fn set_start_crc(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 16usize)) | (((val as u32) & 0x01) << 16usize);
        }
        ...
        #[doc = "Bank 1 CRC clear bit"]
        #[inline(always)]
        pub const fn set_clean_crc(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 17usize)) | (((val as u32) & 0x01) << 17usize);
        }
        ...
        #[doc = "Bank 1 CRC burst size"]
        #[inline(always)]
        pub const fn set_crc_burst(&mut self, val: u8) {
    ...
    impl Crcdatar {
        ...
        #[doc = "CRC result"]
        #[inline(always)]
        pub const fn set_crc_data(&mut self, val: u32) {
    ...
    impl Crceaddr {
        ...
        #[doc = "CRC end address on bank 1"]
        #[inline(always)]
        pub const fn set_crc_end_addr(&mut self, val: u32) {
            self.0 = (self.0 & !(0xffff_ffff << 0usize)) | (((val as u32) & 0xffff_ffff) << 0usize);
        }
    }
    ...
    impl Crcsaddr {
        ...
        #[doc = "CRC start address on bank 1"]
        #[inline(always)]
        pub const fn set_crc_start_addr(&mut self, val: u32) {
            self.0 = (self.0 & !(0xffff_ffff << 0usize)) | (((val as u32) & 0xffff_ffff) << 0usize);
        }
    }
    ...
    impl Far {
        ...
        #[doc = "Bank 1 ECC error address"]
        #[inline(always)]
        pub const fn set_fail_ecc_addr(&mut self, val: u16) {
    ...
    impl defmt::Format for Optcr {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Optcr {{ optlock: {=bool:?}, optstart: {=bool:?}, mer: {=bool:?}, optchangeerrie: {=bool:?}, swap_bank: {=bool:?} }}",
                self.optlock(),
                self.optstart(),
                self.mer(),
                self.optchangeerrie(),
    ...
    impl OptsrCur {
        ...
        #[doc = "User option bit 1"]
        #[inline(always)]
        pub const fn set_rss1(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 26usize)) | (((val as u32) & 0x01) << 26usize);
        }
    ...
    impl defmt::Format for OptsrCur {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "OptsrCur {{ opt_busy: {=bool:?}, bor_lev: {=u8:?}, iwdg1_hw: {=bool:?}, n_rst_stop_d1: {=bool:?}, n_rst_stby_d1: {=bool:?}, rdp: {=u8:?}, fz_iwdg_stop: {=bool:?}, fz_iwdg_sdby: {=bool:?}, st_ram_size: {=u8:?}, security: {=bool:?}, boot_cm4: {=bool:?}, boot_cm7: {=bool:?}, rss1: {=bool:?}, perso_ok: {=bool:?}, io_hslv: {=bool:?}, optchangeerr: {=bool:?}, swap_bank_opt: {=bool:?} }}",
                self.opt_busy(),
                self.bor_lev(),
                self.iwdg1_hw(),
                self.n_rst_stop_d1(),
    ...
    impl OptsrPrg {
        ...
        #[doc = "User option configuration bit 2"]
        #[inline(always)]
        pub const fn set_rss2(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 27usize)) | (((val as u32) & 0x01) << 27usize);
        }
    ...
    impl defmt::Format for OptsrPrg {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "OptsrPrg {{ bor_lev: {=u8:?}, iwdg1_hw: {=bool:?}, n_rst_stop_d1: {=bool:?}, n_rst_stby_d1: {=bool:?}, rdp: {=u8:?}, fz_iwdg_stop: {=bool:?}, fz_iwdg_sdby: {=bool:?}, st_ram_size: {=u8:?}, security: {=bool:?}, boot_cm4: {=bool:?}, boot_cm7: {=bool:?}, rss1: {=bool:?}, rss2: {=bool:?}, io_hslv: {=bool:?}, swap_bank_opt: {=bool:?} }}",
                self.bor_lev(),
                self.iwdg1_hw(),
                self.n_rst_stop_d1(),
                self.n_rst_stby_d1(),
    ...
    impl PrarCur {
        ...
        #[doc = "Bank 1 lowest PCROP protected address"]
        #[inline(always)]
        pub const fn set_prot_area_start(&mut self, val: u16) {
        ...
        #[doc = "Bank 1 highest PCROP protected address"]
        #[inline(always)]
        pub const fn set_prot_area_end(&mut self, val: u16) {
        ...
        #[doc = "Bank 1 PCROP protected erase enable option status bit"]
        #[inline(always)]
        pub const fn set_dmep(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 31usize)) | (((val as u32) & 0x01) << 31usize);
        }
    }
    ...
    impl ScarCur {
        ...
        #[doc = "Bank 1 lowest secure protected address"]
        #[inline(always)]
        pub const fn set_sec_area_start(&mut self, val: u16) {
            self.0 = (self.0 & !(0x0fff << 0usize)) | (((val as u32) & 0x0fff) << 0usize);
        }
        ...
        #[doc = "Bank 1 highest secure protected address"]
        #[inline(always)]
        pub const fn set_sec_area_end(&mut self, val: u16) {
            self.0 = (self.0 & !(0x0fff << 16usize)) | (((val as u32) & 0x0fff) << 16usize);
        }
        ...
        #[doc = "Bank 1 secure protected erase enable option status bit"]
        #[inline(always)]
        pub const fn set_dmes(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 31usize)) | (((val as u32) & 0x01) << 31usize);
        }
    }
    ...
    impl Sr {
        ...
        #[doc = "Bank 1 wait queue flag"]
        #[inline(always)]
        pub const fn set_qw(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 2usize)) | (((val as u32) & 0x01) << 2usize);
        }
