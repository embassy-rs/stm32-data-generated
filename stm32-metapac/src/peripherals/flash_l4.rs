...
pub mod regs {
    ...
    impl Acr {
        ...
        #[doc = "Data cache enable"]
        #[inline(always)]
        pub const fn set_dcen(&mut self, val: bool) {
        ...
        #[doc = "Data cache reset"]
        #[inline(always)]
        pub const fn set_dcrst(&mut self, val: bool) {
    ...
    impl defmt::Format for Acr {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Acr {{ latency: {=u8:?}, prften: {=bool:?}, icen: {=bool:?}, dcen: {=bool:?}, icrst: {=bool:?}, dcrst: {=bool:?}, run_pd: {=bool:?}, sleep_pd: {=bool:?} }}",
                self.latency(),
                self.prften(),
                self.icen(),
                self.dcen(),
    ...
    impl Cr {
        ...
        #[doc = "Bank 1 Mass erase"]
        #[inline(always)]
        pub const fn set_mer(&mut self, n: usize, val: bool) {
            assert!(n < 2usize);
            let offs = 2usize + n * 13usize;
    ...
    impl defmt::Format for Cr {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Cr {{ pg: {=bool:?}, per: {=bool:?}, mer[0]: {=bool:?}, mer[1]: {=bool:?}, pnb: {=u8:?}, bker: {=bool:?}, start: {=bool:?}, optstrt: {=bool:?}, fstpg: {=bool:?}, eopie: {=bool:?}, errie: {=bool:?}, rderrie: {=bool:?}, obl_launch: {=bool:?}, optlock: {=bool:?}, lock: {=bool:?} }}",
                self.pg(),
                self.per(),
                self.mer(0usize),
                self.mer(1usize),
    ...
    impl Optr {
        ...
        #[doc = "Dual-bank boot"]
        #[inline(always)]
        pub const fn set_bfb(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 20usize)) | (((val as u32) & 0x01) << 20usize);
        }
    ...
    impl defmt::Format for Optr {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Optr {{ rdp: {=u8:?}, bor_lev: {=u8:?}, n_rst_stop: {=bool:?}, n_rst_stdby: {=bool:?}, n_rst_shdw: {=bool:?}, idwg_sw: {=bool:?}, iwdg_stop: {=bool:?}, iwdg_stdby: {=bool:?}, wwdg_sw: {=bool:?}, bfb: {=bool:?}, dualbank: {=bool:?}, n_boot1: {=bool:?}, sram2_pe: {=bool:?}, sram2_rst: {=bool:?}, n_swboot0: {=bool:?}, n_boot0: {=bool:?} }}",
                self.rdp(),
                self.bor_lev(),
                self.n_rst_stop(),
                self.n_rst_stdby(),
    ...
    impl Pcrop1er {
        ...
        #[doc = "Bank 1 PCROP area end offset"]
        #[inline(always)]
        pub const fn set_pcrop1_end(&mut self, val: u16) {
    ...
    impl Pcrop1sr {
        ...
        #[doc = "Bank 1 PCROP area start offset"]
        #[inline(always)]
        pub const fn set_pcrop1_strt(&mut self, val: u16) {
            self.0 = (self.0 & !(0xffff << 0usize)) | (((val as u32) & 0xffff) << 0usize);
        }
    }
    ...
    impl Pcrop2er {
        ...
        #[doc = "Bank 2 PCROP area end offset"]
        #[inline(always)]
        pub const fn set_pcrop2_end(&mut self, val: u16) {
            self.0 = (self.0 & !(0xffff << 0usize)) | (((val as u32) & 0xffff) << 0usize);
        }
    }
    ...
    impl Pcrop2sr {
        ...
        #[doc = "Bank 2 PCROP area start offset"]
        #[inline(always)]
        pub const fn set_pcrop2_strt(&mut self, val: u16) {
            self.0 = (self.0 & !(0xffff << 0usize)) | (((val as u32) & 0xffff) << 0usize);
        }
    }
    ...
    impl Sr {
        ...
        #[doc = "Fast programming data miss error"]
        #[inline(always)]
        pub const fn set_miserr(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 8usize)) | (((val as u32) & 0x01) << 8usize);
        }
    ...
    impl defmt::Format for Sr {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Sr {{ eop: {=bool:?}, operr: {=bool:?}, progerr: {=bool:?}, wrperr: {=bool:?}, pgaerr: {=bool:?}, sizerr: {=bool:?}, pgserr: {=bool:?}, miserr: {=bool:?}, fasterr: {=bool:?}, rderr: {=bool:?}, optverr: {=bool:?}, bsy: {=bool:?} }}",
                self.eop(),
                self.operr(),
                self.progerr(),
                self.wrperr(),
    ...
    impl Wrp2ar {
        ...
        #[doc = "Bank 2 WRP first area A start offset"]
        #[inline(always)]
        pub const fn set_wrp2a_strt(&mut self, val: u8) {
            self.0 = (self.0 & !(0xff << 0usize)) | (((val as u32) & 0xff) << 0usize);
        }
        ...
        #[doc = "Bank 2 WRP first area A end offset"]
        #[inline(always)]
        pub const fn set_wrp2a_end(&mut self, val: u8) {
            self.0 = (self.0 & !(0xff << 16usize)) | (((val as u32) & 0xff) << 16usize);
        }
    }
    ...
    impl Wrp2br {
        ...
        #[doc = "Bank 2 WRP second area B start offset"]
        #[inline(always)]
        pub const fn set_wrp2b_strt(&mut self, val: u8) {
            self.0 = (self.0 & !(0xff << 0usize)) | (((val as u32) & 0xff) << 0usize);
        }
        ...
        #[doc = "Bank 2 WRP second area B end offset"]
        #[inline(always)]
        pub const fn set_wrp2b_end(&mut self, val: u8) {
            self.0 = (self.0 & !(0xff << 16usize)) | (((val as u32) & 0xff) << 16usize);
        }
    }
