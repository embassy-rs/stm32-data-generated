...
pub mod regs {
    ...
    impl Acr {
        ...
        #[doc = "LVEN"]
        #[inline(always)]
        pub const fn set_lven(&mut self, val: bool) {
    ...
    impl Nscr {
        ...
        #[doc = "NSPG"]
        #[inline(always)]
        pub const fn set_nspg(&mut self, val: bool) {
        ...
        #[doc = "NSPER"]
        #[inline(always)]
        pub const fn set_nsper(&mut self, val: bool) {
        ...
        #[doc = "NSPNB"]
        #[inline(always)]
        pub const fn set_nspnb(&mut self, val: u8) {
    ...
    impl Nssr {
        ...
        #[doc = "NSEOP"]
        #[inline(always)]
        pub const fn set_nseop(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 0usize)) | (((val as u32) & 0x01) << 0usize);
        }
        #[doc = "NSOPERR"]
        #[must_use]
        ...
        #[doc = "NSBusy"]
        #[inline(always)]
        pub const fn set_nsbsy(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 16usize)) | (((val as u32) & 0x01) << 16usize);
        }
    }
    ...
    impl Optr {
        ...
        #[doc = "DB256K"]
        #[inline(always)]
        pub const fn set_db256k(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 21usize)) | (((val as u32) & 0x01) << 21usize);
        }
        #[doc = "DBANK"]
        #[must_use]
    ...
    impl Secbb1r1 {
        ...
        #[doc = "SECBB1"]
        #[inline(always)]
        pub const fn set_secbb1(&mut self, val: u32) {
    ...
    impl Secbb2r1 {
        ...
        #[doc = "SECBB2"]
        #[inline(always)]
        pub const fn set_secbb2(&mut self, val: u32) {
            self.0 = (self.0 & !(0xffff_ffff << 0usize)) | (((val as u32) & 0xffff_ffff) << 0usize);
        }
    }
    ...
    impl Seccr {
        ...
        #[doc = "SECPG"]
        #[inline(always)]
        pub const fn set_secpg(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 0usize)) | (((val as u32) & 0x01) << 0usize);
        }
        #[doc = "SECPER"]
        #[must_use]
    ...
    impl Secsr {
        ...
        #[doc = "SECEOP"]
        #[inline(always)]
        pub const fn set_seceop(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 0usize)) | (((val as u32) & 0x01) << 0usize);
        }
        #[doc = "SECOPERR"]
        #[must_use]
        ...
        #[doc = "SECOPERR"]
        #[inline(always)]
        pub const fn set_secoperr(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 1usize)) | (((val as u32) & 0x01) << 1usize);
        }
        #[doc = "SECPROGERR"]
        #[must_use]
        ...
        #[doc = "SECPROGERR"]
        #[inline(always)]
        pub const fn set_secprogerr(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 3usize)) | (((val as u32) & 0x01) << 3usize);
        }
        #[doc = "SECWRPERR"]
        #[must_use]
        ...
        #[doc = "SECWRPERR"]
        #[inline(always)]
        pub const fn set_secwrperr(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 4usize)) | (((val as u32) & 0x01) << 4usize);
        }
        #[doc = "SECPGAERR"]
        #[must_use]
        ...
        #[doc = "SECPGAERR"]
        #[inline(always)]
        pub const fn set_secpgaerr(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 5usize)) | (((val as u32) & 0x01) << 5usize);
        }
        #[doc = "SECSIZERR"]
        #[must_use]
        ...
        #[doc = "SECSIZERR"]
        #[inline(always)]
        pub const fn set_secsizerr(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 6usize)) | (((val as u32) & 0x01) << 6usize);
        }
        #[doc = "SECPGSERR"]
        #[must_use]
        ...
        #[doc = "SECPGSERR"]
        #[inline(always)]
        pub const fn set_secpgserr(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 7usize)) | (((val as u32) & 0x01) << 7usize);
        }
        ...
        #[doc = "Secure read protection error"]
        #[inline(always)]
        pub const fn set_secrderr(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 14usize)) | (((val as u32) & 0x01) << 14usize);
        }
        #[doc = "SECBusy"]
        #[must_use]
        ...
        #[doc = "SECBusy"]
        #[inline(always)]
        pub const fn set_secbsy(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 16usize)) | (((val as u32) & 0x01) << 16usize);
        }
    }
    ...
    impl Secwm1r2 {
        ...
        #[doc = "PCROP1_PSTRT"]
        #[inline(always)]
        pub const fn set_pcrop1_pstrt(&mut self, val: u8) {
            self.0 = (self.0 & !(0x7f << 0usize)) | (((val as u32) & 0x7f) << 0usize);
        }
        #[doc = "PCROP1EN"]
        #[must_use]
        ...
        #[doc = "PCROP1EN"]
        #[inline(always)]
        pub const fn set_pcrop1en(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 15usize)) | (((val as u32) & 0x01) << 15usize);
        }
        #[doc = "HDP1_PEND"]
        #[must_use]
    ...
    impl Secwm2r2 {
        ...
        #[doc = "PCROP2_PSTRT"]
        #[inline(always)]
        pub const fn set_pcrop2_pstrt(&mut self, val: u8) {
            self.0 = (self.0 & !(0x7f << 0usize)) | (((val as u32) & 0x7f) << 0usize);
        }
        #[doc = "PCROP2EN"]
        #[must_use]
        ...
        #[doc = "PCROP2EN"]
        #[inline(always)]
        pub const fn set_pcrop2en(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 15usize)) | (((val as u32) & 0x01) << 15usize);
        }
        #[doc = "HDP2_PEND"]
        #[must_use]
