...
pub mod regs {
    ...
    impl C2sr {
        ...
        #[doc = "Programming or erase operation suspended"]
        #[inline(always)]
        pub const fn set_pesd(&mut self, val: bool) {
    ...
    impl Ipccbr {
        ...
        #[doc = "PCC mailbox data buffer base address"]
        #[inline(always)]
        pub const fn set_ipccdba(&mut self, val: u16) {
    ...
    impl Optr {
        ...
        #[doc = "Security enabled"]
        #[inline(always)]
        pub const fn set_ese(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 8usize)) | (((val as u32) & 0x01) << 8usize);
        }
        #[doc = "BOR reset Level"]
        #[must_use]
    ...
    impl Pcrop1aer {
        ...
        #[doc = "Bank 1 PCROP area end offset"]
        #[inline(always)]
        pub const fn set_pcrop1a_end(&mut self, val: u16) {
    ...
    impl Pcrop1asr {
        ...
        #[doc = "Bank 1 PCROPQ area start offset"]
        #[inline(always)]
        pub const fn set_pcrop1a_strt(&mut self, val: u16) {
            self.0 = (self.0 & !(0x01ff << 0usize)) | (((val as u32) & 0x01ff) << 0usize);
        }
    }
    ...
    impl Pcrop1ber {
        ...
        #[doc = "Bank 1 PCROP area end area B offset"]
        #[inline(always)]
        pub const fn set_pcrop1b_end(&mut self, val: u16) {
            self.0 = (self.0 & !(0x01ff << 0usize)) | (((val as u32) & 0x01ff) << 0usize);
        }
    }
    ...
    impl Pcrop1bsr {
        ...
        #[doc = "Bank 1 PCROP area B start offset"]
        #[inline(always)]
        pub const fn set_pcrop1b_strt(&mut self, val: u16) {
            self.0 = (self.0 & !(0x01ff << 0usize)) | (((val as u32) & 0x01ff) << 0usize);
        }
    }
    ...
    impl Sfr {
        ...
        #[doc = "Secure flash start address"]
        #[inline(always)]
        pub const fn set_sfsa(&mut self, val: u8) {
            self.0 = (self.0 & !(0xff << 0usize)) | (((val as u32) & 0xff) << 0usize);
        }
    ...
    impl Sr {
        ...
        #[doc = "User Option OPTVAL indication"]
        #[inline(always)]
        pub const fn set_optnv(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 13usize)) | (((val as u32) & 0x01) << 13usize);
        }
        #[doc = "PCROP read error"]
        #[must_use]
    ...
    impl Srrvr {
        ...
        #[doc = "cortex M0 access control register"]
        #[inline(always)]
        pub const fn set_sbrv(&mut self, val: u32) {
        ...
        #[doc = "Secure backup SRAM2a start address"]
        #[inline(always)]
        pub const fn set_sbrsa(&mut self, val: u8) {
        ...
        #[doc = "backup SRAM2a security disable"]
        #[inline(always)]
        pub const fn set_brsd(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 23usize)) | (((val as u32) & 0x01) << 23usize);
        }
        ...
        #[doc = "Secure non backup SRAM2a start address"]
        #[inline(always)]
        pub const fn set_snbrsa(&mut self, val: u8) {
        ...
        #[doc = "non-backup SRAM2b security disable"]
        #[inline(always)]
        pub const fn set_nbrsd(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 30usize)) | (((val as u32) & 0x01) << 30usize);
        }
        ...
        #[doc = "CPU2 cortex M0 boot reset vector memory selection"]
        #[inline(always)]
        pub const fn set_c2opt(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 31usize)) | (((val as u32) & 0x01) << 31usize);
        }
    }
