...
pub mod regs {
    ...
    impl defmt::Format for Pcrop1asr {
        fn format(&self, f: defmt::Formatter) {
            ...
            let proxy = Pcrop1asr {
                pcrop1a_strt: self.pcrop1a_strt(),
            };
            defmt::write!(f, "{}", proxy)
        }
    }
    ...
    impl defmt::Format for Pcrop1bsr {
        fn format(&self, f: defmt::Formatter) {
            ...
            let proxy = Pcrop1bsr {
                pcrop1b_strt: self.pcrop1b_strt(),
            };
            defmt::write!(f, "{}", proxy)
        }
    }
