...
pub mod regs {
    ...
    impl defmt::Format for TzscPrivcfgr3 {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "TzscPrivcfgr3 {{ crcpriv: {=bool:?}, tscpriv: {=bool:?}, icache_regpriv: {=bool:?}, otgpriv: {=bool:?}, aespriv: {=bool:?}, hashpriv: {=bool:?}, rngpriv: {=bool:?}, saespriv: {=bool:?}, pkapriv: {=bool:?}, ramcfgpriv: {=bool:?}, radiopriv: {=bool:?}, ptaconvpriv: {=bool:?} }}",
                self.crcpriv(),
                self.tscpriv(),
                self.icache_regpriv(),
                self.otgpriv(),
    ...
    impl defmt::Format for TzscSeccfgr3 {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "TzscSeccfgr3 {{ crcsec: {=bool:?}, tscsec: {=bool:?}, icache_regsec: {=bool:?}, otgsec: {=bool:?}, aessec: {=bool:?}, hashsec: {=bool:?}, rngsec: {=bool:?}, saessec: {=bool:?}, pkasec: {=bool:?}, ramcfgsec: {=bool:?}, radiosec: {=bool:?}, ptaconvsec: {=bool:?} }}",
                self.crcsec(),
                self.tscsec(),
                self.icache_regsec(),
                self.otgsec(),
