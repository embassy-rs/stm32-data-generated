...
pub mod regs {
    ...
    impl Cr {
        ...
        #[doc = "Algorithm selection."]
        #[inline(always)]
        pub const fn set_algo0(&mut self, val: bool) {
        ...
        #[doc = "ALGO."]
        #[inline(always)]
        pub const fn set_algo1(&mut self, val: bool) {
    ...
    impl defmt::Format for Cr {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Cr {{ init: {=bool:?}, dmae: {=bool:?}, datatype: {=u8:?}, mode: {=bool:?}, algo0: {=bool:?}, nbw: {=u8:?}, dinne: {=bool:?}, mdmat: {=bool:?}, lkey: {=bool:?}, algo1: {=bool:?} }}",
                self.init(),
                self.dmae(),
                self.datatype(),
                self.mode(),
