...
pub mod regs {
    ...
    impl Cr1 {
        ...
        #[doc = "Fast-mode Plus 20 mA drive enable."]
        #[inline(always)]
        pub fn set_fmp(&mut self, val: bool) {
    ...
    impl defmt::Format for Cr1 {
        fn format(&self, f: defmt::Formatter) {
            ...
            let proxy = Cr1 {
                ...
                sbc: self.sbc(),
                nostretch: self.nostretch(),
                gcen: self.gcen(),
                smbhen: self.smbhen(),
                smbden: self.smbden(),
                alerten: self.alerten(),
                pecen: self.pecen(),
                fmp: self.fmp(),
                addraclr: self.addraclr(),
                stopfaclr: self.stopfaclr(),
            };
            defmt::write!(f, "{}", proxy)
        }
    }
    ...
    impl defmt::Format for Cr2 {
        fn format(&self, f: defmt::Formatter) {
            ...
            struct Cr2 {
                sadd: u16,
                dir: super::vals::Dir,
                add10: super::vals::Addmode,
                head10r: super::vals::Headr,
                start: bool,
                stop: bool,
                nack: bool,
                nbytes: u8,
                reload: super::vals::Reload,
                autoend: super::vals::Autoend,
                pecbyte: bool,
            }
            let proxy = Cr2 {
                sadd: self.sadd(),
                dir: self.dir(),
                add10: self.add10(),
                head10r: self.head10r(),
                start: self.start(),
                stop: self.stop(),
                nack: self.nack(),
                nbytes: self.nbytes(),
                reload: self.reload(),
                autoend: self.autoend(),
                pecbyte: self.pecbyte(),
            };
            defmt::write!(f, "{}", proxy)
        }
    }
    ...
    impl defmt::Format for Icr {
        fn format(&self, f: defmt::Formatter) {
            ...
            let proxy = Icr {
                ...
                ovrcf: self.ovrcf(),
                peccf: self.peccf(),
                timoutcf: self.timoutcf(),
                alertcf: self.alertcf(),
            };
            defmt::write!(f, "{}", proxy)
        }
    }
    ...
    impl defmt::Format for Oar1 {
        fn format(&self, f: defmt::Formatter) {
            ...
            struct Oar1 {
                oa1: u16,
                oa1mode: super::vals::Addmode,
                oa1en: bool,
            }
            let proxy = Oar1 {
                oa1: self.oa1(),
                oa1mode: self.oa1mode(),
                oa1en: self.oa1en(),
            };
            defmt::write!(f, "{}", proxy)
        }
    ...
    impl defmt::Format for Timeoutr {
        fn format(&self, f: defmt::Formatter) {
            ...
            let proxy = Timeoutr {
                timeouta: self.timeouta(),
                tidle: self.tidle(),
                timouten: self.timouten(),
                timeoutb: self.timeoutb(),
                texten: self.texten(),
            };
            defmt::write!(f, "{}", proxy)
        }
