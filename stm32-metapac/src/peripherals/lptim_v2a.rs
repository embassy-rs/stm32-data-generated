...
# [inline (always)]
pub const fn isr (self) -> crate :: common :: Reg < regs :: Isr , crate :: common :: R > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x0usize) as _) } } # [doc = "Interrupt Clear Register."]
# [inline (always)]
pub const fn icr (self) -> crate :: common :: Reg < regs :: Icr , crate :: common :: W > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x04usize) as _) } } # [doc = "Interrupt Enable Register."]
# [inline (always)]
pub const fn ier (self) -> crate :: common :: Reg < regs :: Ier , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x08usize) as _) } } # [doc = "Configuration Register."]
# [inline (always)]
pub const fn cfgr (self) -> crate :: common :: Reg < regs :: Cfgr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x0cusize) as _) } } # [doc = "Control Register."]
# [inline (always)]
pub const fn cr (self) -> crate :: common :: Reg < regs :: Cr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x10usize) as _) } } # [doc = "Compare Register."]
# [inline (always)]
pub const fn cmp (self) -> crate :: common :: Reg < regs :: Cmp , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x14usize) as _) } } # [doc = "Autoreload Register."]
# [inline (always)]
pub const fn arr (self) -> crate :: common :: Reg < regs :: Arr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x18usize) as _) } } # [doc = "Counter Register."]
# [inline (always)]
pub const fn cnt (self) -> crate :: common :: Reg < regs :: Cnt , crate :: common :: R > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x1cusize) as _) } } # [doc = "LPTIM option register."]
# [inline (always)]
pub const fn or (self) -> crate :: common :: Reg < u32 , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x20usize) as _) } } # [doc = "LPTIM repetition register."]
# [inline (always)]
pub const fn rcr (self) -> crate :: common :: Reg < regs :: Rcr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x28usize) as _) } } } pub mod regs { # [doc = "Autoreload Register."]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Arr { Arr (0) } } # [doc = "Configuration Register."]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
pub struct Cfgr (pub u32) ; impl Cfgr { # [doc = "Clock selector."]
# [inline (always)]
pub const fn cksel (& self) -> super :: vals :: Cksel { let val = (self . 0 >> 0usize) & 0x01 ; super :: vals :: Cksel :: from_bits (val as u8) } # [doc = "Clock selector."]
# [inline (always)]
pub fn set_cksel (& mut self , val : super :: vals :: Cksel) { self . 0 = (self . 0 & ! (0x01 << 0usize)) | (((val . to_bits () as u32) & 0x01) << 0usize) ; } # [doc = "Clock Polarity."]
# [inline (always)]
pub const fn ckpol (& self) -> super :: vals :: Ckpol { let val = (self . 0 >> 1usize) & 0x03 ; super :: vals :: Ckpol :: from_bits (val as u8) } # [doc = "Clock Polarity."]
# [inline (always)]
pub fn set_ckpol (& mut self , val : super :: vals :: Ckpol) { self . 0 = (self . 0 & ! (0x03 << 1usize)) | (((val . to_bits () as u32) & 0x03) << 1usize) ; } # [doc = "Configurable digital filter for external clock."]
# [inline (always)]
pub const fn ckflt (& self) -> super :: vals :: Filter { let val = (self . 0 >> 3usize) & 0x03 ; super :: vals :: Filter :: from_bits (val as u8) } # [doc = "Configurable digital filter for external clock."]
# [inline (always)]
pub fn set_ckflt (& mut self , val : super :: vals :: Filter) { self . 0 = (self . 0 & ! (0x03 << 3usize)) | (((val . to_bits () as u32) & 0x03) << 3usize) ; } # [doc = "Configurable digital filter for trigger."]
# [inline (always)]
pub const fn trgflt (& self) -> super :: vals :: Filter { let val = (self . 0 >> 6usize) & 0x03 ; super :: vals :: Filter :: from_bits (val as u8) } # [doc = "Configurable digital filter for trigger."]
# [inline (always)]
pub fn set_trgflt (& mut self , val : super :: vals :: Filter) { self . 0 = (self . 0 & ! (0x03 << 6usize)) | (((val . to_bits () as u32) & 0x03) << 6usize) ; } # [doc = "Clock prescaler."]
# [inline (always)]
pub const fn presc (& self) -> super :: vals :: Presc { let val = (self . 0 >> 9usize) & 0x07 ; super :: vals :: Presc :: from_bits (val as u8) } # [doc = "Clock prescaler."]
# [inline (always)]
pub fn set_presc (& mut self , val : super :: vals :: Presc) { self . 0 = (self . 0 & ! (0x07 << 9usize)) | (((val . to_bits () as u32) & 0x07) << 9usize) ; } # [doc = "Trigger selector."]
# [inline (always)]
...
fn default () -> Cfgr { Cfgr (0) } } # [doc = "Compare Register."]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Cmp { Cmp (0) } } # [doc = "Counter Register."]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Cnt { Cnt (0) } } # [doc = "Control Register."]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
# [inline (always)]
pub fn set_cntstrt (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 2usize)) | (((val as u32) & 0x01) << 2usize) ; } # [doc = "Reset after read enable."]
# [inline (always)]
pub const fn rstare (& self) -> bool { let val = (self . 0 >> 3usize) & 0x01 ; val != 0 } # [doc = "Reset after read enable."]
# [inline (always)]
pub fn set_rstare (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 3usize)) | (((val as u32) & 0x01) << 3usize) ; } # [doc = "Counter reset."]
# [inline (always)]
pub const fn countrst (& self) -> bool { let val = (self . 0 >> 4usize) & 0x01 ; val != 0 } # [doc = "Counter reset."]
# [inline (always)]
pub fn set_countrst (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 4usize)) | (((val as u32) & 0x01) << 4usize) ; } } impl Default for Cr { # [inline (always)]
...
# [inline (always)]
pub fn set_downcf (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 6usize)) | (((val as u32) & 0x01) << 6usize) ; } # [doc = "Update event clear flag."]
# [inline (always)]
pub const fn uecf (& self) -> bool { let val = (self . 0 >> 7usize) & 0x01 ; val != 0 } # [doc = "Update event clear flag."]
# [inline (always)]
pub fn set_uecf (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 7usize)) | (((val as u32) & 0x01) << 7usize) ; } # [doc = "Repetition register update OK clear flag."]
# [inline (always)]
pub const fn repokcf (& self) -> bool { let val = (self . 0 >> 8usize) & 0x01 ; val != 0 } # [doc = "Repetition register update OK clear flag."]
# [inline (always)]
pub fn set_repokcf (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 8usize)) | (((val as u32) & 0x01) << 8usize) ; } } impl Default for Icr { # [inline (always)]
...
# [inline (always)]
pub fn set_ueie (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 7usize)) | (((val as u32) & 0x01) << 7usize) ; } # [doc = "REPOKIE."]
# [inline (always)]
pub const fn repokie (& self) -> bool { let val = (self . 0 >> 8usize) & 0x01 ; val != 0 } # [doc = "REPOKIE."]
# [inline (always)]
pub fn set_repokie (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 8usize)) | (((val as u32) & 0x01) << 8usize) ; } } impl Default for Ier { # [inline (always)]
...
# [inline (always)]
pub fn set_down (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 6usize)) | (((val as u32) & 0x01) << 6usize) ; } # [doc = "LPTIM update event occurred."]
# [inline (always)]
pub const fn ue (& self) -> bool { let val = (self . 0 >> 7usize) & 0x01 ; val != 0 } # [doc = "LPTIM update event occurred."]
# [inline (always)]
pub fn set_ue (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 7usize)) | (((val as u32) & 0x01) << 7usize) ; } # [doc = "Repetition register update Ok."]
# [inline (always)]
pub const fn repok (& self) -> bool { let val = (self . 0 >> 8usize) & 0x01 ; val != 0 } # [doc = "Repetition register update Ok."]
# [inline (always)]
pub fn set_repok (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 8usize)) | (((val as u32) & 0x01) << 8usize) ; } } impl Default for Isr { # [inline (always)]
fn default () -> Isr { Isr (0) } } # [doc = "LPTIM repetition register."]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
pub struct Rcr (pub u32) ; impl Rcr { # [doc = "Repetition register value."]
# [inline (always)]
pub const fn rep (& self) -> u8 { let val = (self . 0 >> 0usize) & 0xff ; val as u8 } # [doc = "Repetition register value."]
# [inline (always)]
...
# [derive (Copy , Clone , Eq , PartialEq , Ord , PartialOrd)]
pub enum Cksel { # [doc = "LPTIM is clocked by internal clock source (APB clock or any of the embedded oscillators)"]
INTERNAL = 0x0 , # [doc = "LPTIM is clocked by an external clock source through the LPTIM external Input1"]
EXTERNAL = 0x01 , } impl Cksel { # [inline (always)]
pub const fn from_bits (val : u8) -> Cksel { unsafe { core :: mem :: transmute (val & 0x01) } } # [inline (always)]
pub const fn to_bits (self) -> u8 { unsafe { core :: mem :: transmute (self) } } } impl From < u8 > for Cksel { # [inline (always)]
fn from (val : u8) -> Cksel { Cksel :: from_bits (val) } } impl From < Cksel > for u8 { # [inline (always)]
fn from (val : Cksel) -> u8 { Cksel :: to_bits (val) } } # [repr (u8)]
# [derive (Copy , Clone , Eq , PartialEq , Ord , PartialOrd)]
