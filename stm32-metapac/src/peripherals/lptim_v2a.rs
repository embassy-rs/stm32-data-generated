...
impl Lptim {
    ...
    #[inline(always)]
    pub const fn isr(self) -> crate::common::Reg<regs::IsrAdv, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x0usize) as _) }
    }
    #[doc = "LPTIM interrupt clear register."]
    #[inline(always)]
    pub const fn icr(self) -> crate::common::Reg<regs::IcrAdv, crate::common::RW> {
    ...
    pub const fn ccmr(self, n: usize) -> crate::common::Reg<regs::Ccmr, crate::common::RW> {
        assert!(n < 1usize);
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x2cusize + n * 1usize) as _) }
    }
}
#[doc = "Low power timer with Output Compare"]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct LptimBasic {
    ptr: *mut u8,
}
unsafe impl Send for LptimBasic {}
unsafe impl Sync for LptimBasic {}
impl LptimBasic {
    #[inline(always)]
    pub const unsafe fn from_ptr(ptr: *mut ()) -> Self {
        Self { ptr: ptr as _ }
    ...
    #[doc = "LPTIM interrupt and status register."]
    #[inline(always)]
    pub const fn isr(self) -> crate::common::Reg<regs::IsrBasic, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x0usize) as _) }
    }
    #[doc = "LPTIM interrupt clear register."]
    #[inline(always)]
    pub const fn icr(self) -> crate::common::Reg<regs::IcrBasic, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x04usize) as _) }
    }
    #[doc = "LPTIM interrupt enable register."]
    #[inline(always)]
...
value."]
    ...
    impl Ccmr {
        ...
        #[doc = "Capture/compare 1 selection This bitfield defines the direction of the channel input (capture) or output mode."]
        #[inline(always)]
        pub const fn set_ccsel(&mut self, n: usize, val: super::vals::Ccsel) {
            assert!(n < 2usize);
            let offs = 0usize + n * 16usize;
        ...
        #[doc = "Capture/compare 1 output polarity. Only bit2 is used to set polarity when output mode is enabled, bit3 is don't care. This field is used to select the IC1 polarity for capture operations."]
        #[inline(always)]
        pub const fn set_ccp_input(&mut self, n: usize, val: super::vals::CcpInput) {
            assert!(n < 2usize);
            let offs = 2usize + n * 16usize;
        ...
        #[doc = "Capture/compare 1 output polarity. Only bit2 is used to set polarity when output mode is enabled, bit3 is don't care. This field is used to select the IC1 polarity for capture operations."]
        #[inline(always)]
        pub const fn set_ccp_output(&mut self, n: usize, val: super::vals::CcpOutput) {
            assert!(n < 2usize);
            let offs = 2usize + n * 16usize;
            self.0 = (self.0 & !(0x03 << offs)) | (((val.to_bits() as u32) & 0x03) << offs);
        }
        ...
        #[doc = "Input capture 1 prescaler This bitfield defines the ratio of the prescaler acting on the CC1 input (IC1)."]
        #[inline(always)]
        pub const fn set_icpsc(&mut self, n: usize, val: super::vals::Filter) {
            assert!(n < 2usize);
            let offs = 8usize + n * 16usize;
            self.0 = (self.0 & !(0x03 << offs)) | (((val.to_bits() as u32) & 0x03) << offs);
        }
        ...
        #[doc = "Input capture 1 filter This bitfield defines the number of consecutive equal samples that should be detected when a level change occurs on an external input capture signal before it is considered as a valid level transition. An internal clock source must be present to use this feature."]
        #[inline(always)]
        pub const fn set_icf(&mut self, n: usize, val: super::vals::Filter) {
            assert!(n < 2usize);
            let offs = 12usize + n * 16usize;
            self.0 = (self.0 & !(0x03 << offs)) | (((val.to_bits() as u32) & 0x03) << offs);
        }
    ...
    impl defmt::Format for Ccmr {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Ccmr {{ ccsel[0]: {:?}, ccsel[1]: {:?}, cce[0]: {=bool:?}, cce[1]: {=bool:?}, ccp_input[0]: {:?}, ccp_input[1]: {:?}, ccp_output[0]: {:?}, ccp_output[1]: {:?}, icpsc[0]: {:?}, icpsc[1]: {:?}, icf[0]: {:?}, icf[1]: {:?} }}",
                self.ccsel(0usize),
                self.ccsel(1usize),
                self.cce(0usize),
                self.cce(1usize),
                self.ccp_input(0usize),
                self.ccp_input(1usize),
                self.ccp_output(0usize),
                self.ccp_output(1usize),
                self.icpsc(0usize),
                self.icpsc(1usize),
                self.icf(0usize),
                self.icf(1usize)
    ...
    impl Cfgr {
        ...
        #[doc = "Clock selector The CKSEL bit selects which clock source the LPTIM uses:."]
        #[inline(always)]
        pub const fn set_cksel(&mut self, val: super::vals::ClockSource) {
        ...
        #[doc = "Configurable digital filter for external clock The CKFLT value sets the number of consecutive equal samples that should be detected when a level change occurs on an external clock signal before it is considered as a valid level transition. An internal clock source must be present to use this feature."]
        #[inline(always)]
        pub const fn set_ckflt(&mut self, val: super::vals::Filter) {
        ...
        #[doc = "Configurable digital filter for trigger The TRGFLT value sets the number of consecutive equal samples that should be detected when a level change occurs on an internal trigger before it is considered as a valid level transition. An internal clock source must be present to use this feature."]
        #[inline(always)]
        pub const fn set_trgflt(&mut self, val: super::vals::Filter) {
        ...
        #[doc = "Trigger enable and polarity The TRIGEN bits controls whether the LPTIM counter is started by an external trigger or not. If the external trigger option is selected, three configurations are possible for the trigger active edge:."]
        #[inline(always)]
        pub const fn set_trigen(&mut self, val: super::vals::Trigen) {
        ...
        #[doc = "Waveform shape polarity The WAVEPOL bit controls the output polarity Note: If the LPTIM implements at least one capture/compare channel, this bit is reserved. Please refer to."]
        #[inline(always)]
        pub const fn set_wavpol(&mut self, val: super::vals::Wavpol) {
        ...
        #[doc = "counter mode enabled The COUNTMODE bit selects which clock source is used by the LPTIM to clock the counter:."]
        #[inline(always)]
        pub const fn set_countmode(&mut self, val: super::vals::ClockSource) {
...
different than ‘00’), setting this bit starts the timer in Continuous mode as soon as an external trigger is detected. If this bit is set when a single pulse mode counting is ongoing, then the timer does not stop at the next match between the LPTIM_ARR and LPTIM_CNT registers and the LPTIM counter keeps counting in Continuous mode. This bit can be set only when the LPTIM is enabled. It is automatically reset by hardware."]
    ...
    impl defmt::Format for DierAdv {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "DierAdv {{ ccie[0]: {=bool:?}, ccie[1]: {=bool:?}, arrmie: {=bool:?}, exttrigie: {=bool:?}, cmpokie[0]: {=bool:?}, cmpokie[1]: {=bool:?}, arrokie: {=bool:?}, upie: {=bool:?}, downie: {=bool:?}, ueie: {=bool:?}, repokie: {=bool:?}, ccoie[0]: {=bool:?}, ccoie[1]: {=bool:?}, ccde[0]: {=bool:?}, ccde[1]: {=bool:?} }}",
                self.ccie(0usize),
                self.ccie(1usize),
                self.arrmie(),
                self.exttrigie(),
    ...
    impl defmt::Format for DierBasic {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "DierBasic {{ ccie[0]: {=bool:?}, arrmie: {=bool:?}, exttrigie: {=bool:?}, cmpokie[0]: {=bool:?}, arrokie: {=bool:?}, upie: {=bool:?}, downie: {=bool:?}, ueie: {=bool:?}, repokie: {=bool:?} }}",
                self.ccie(0usize),
                self.arrmie(),
                self.exttrigie(),
                self.cmpokie(0usize),
    ...
    impl defmt::Format for IcrAdv {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "IcrAdv {{ cccf[0]: {=bool:?}, cccf[1]: {=bool:?}, arrmcf: {=bool:?}, exttrigcf: {=bool:?}, cmpokcf[0]: {=bool:?}, cmpokcf[1]: {=bool:?}, arrokcf: {=bool:?}, upcf: {=bool:?}, downcf: {=bool:?}, uecf: {=bool:?}, repokcf: {=bool:?}, ccocf[0]: {=bool:?}, ccocf[1]: {=bool:?}, dierokcf: {=bool:?} }}",
                self.cccf(0usize),
                self.cccf(1usize),
                self.arrmcf(),
                self.exttrigcf(),
    ...
    impl defmt::Format for IcrBasic {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "IcrBasic {{ cccf[0]: {=bool:?}, arrmcf: {=bool:?}, exttrigcf: {=bool:?}, cmpokcf[0]: {=bool:?}, arrokcf: {=bool:?}, upcf: {=bool:?}, downcf: {=bool:?}, uecf: {=bool:?}, repokcf: {=bool:?}, dierokcf: {=bool:?} }}",
                self.cccf(0usize),
                self.arrmcf(),
                self.exttrigcf(),
                self.cmpokcf(0usize),
    ...
    impl defmt::Format for IsrAdv {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "IsrAdv {{ ccif[0]: {=bool:?}, ccif[1]: {=bool:?}, arrm: {=bool:?}, exttrig: {=bool:?}, cmpok[0]: {=bool:?}, cmpok[1]: {=bool:?}, arrok: {=bool:?}, up: {=bool:?}, down: {=bool:?}, ue: {=bool:?}, repok: {=bool:?}, ccof[0]: {=bool:?}, ccof[1]: {=bool:?}, dierok: {=bool:?} }}",
                self.ccif(0usize),
                self.ccif(1usize),
                self.arrm(),
                self.exttrig(),
    ...
    impl defmt::Format for IsrBasic {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "IsrBasic {{ ccif[0]: {=bool:?}, arrm: {=bool:?}, exttrig: {=bool:?}, cmpok[0]: {=bool:?}, arrok: {=bool:?}, up: {=bool:?}, down: {=bool:?}, ue: {=bool:?}, repok: {=bool:?}, dierok: {=bool:?} }}",
                self.ccif(0usize),
                self.arrm(),
                self.exttrig(),
                self.cmpok(0usize),
