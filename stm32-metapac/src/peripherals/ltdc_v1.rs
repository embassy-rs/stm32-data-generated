...
# [inline (always)]
pub const fn bf (& self , n : usize) -> super :: vals :: Bf2 { assert ! (n < 2usize) ; let offs = 0usize + n * 8usize ; let val = (self . 0 >> offs) & 0x07 ; super :: vals :: Bf2 :: from_bits (val as u8) } # [doc = "Blending Factor 2"]
# [inline (always)]
pub fn set_bf (& mut self , n : usize , val : super :: vals :: Bf2) { assert ! (n < 2usize) ; let offs = 0usize + n * 8usize ; self . 0 = (self . 0 & ! (0x07 << offs)) | (((val . to_bits () as u32) & 0x07) << offs) ; } } impl Default for Bfcr { # [inline (always)]
