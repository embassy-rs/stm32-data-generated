...
impl Mdf {
    ...
    #[doc = "MDF serial interface control register 0."]
    #[inline(always)]
    ...
    #[doc = "MDF bitstream matrix control register 0."]
    #[inline(always)]
    ...
    #[doc = "MDF digital filter control register 0."]
    #[inline(always)]
    ...
    #[doc = "MDF digital filter configuration register 0."]
    #[inline(always)]
    ...
    #[doc = "MDF reshape filter configuration register 0."]
    #[inline(always)]
    ...
    #[doc = "MDF integrator configuration register 0."]
    #[inline(always)]
    ...
    #[doc = "MDF out-of limit detector control register 0."]
    #[inline(always)]
    ...
    #[doc = "MDF OLD0 low threshold register 0."]
    #[inline(always)]
    ...
    #[doc = "MDF OLD0 high threshold register 0."]
    #[inline(always)]
    ...
    #[doc = "MDF delay control register 0."]
    #[inline(always)]
    ...
    #[doc = "MDF short circuit detector control register 0."]
    #[inline(always)]
    ...
    #[doc = "MDF DFLT0 interrupt enable register 0."]
    #[inline(always)]
    ...
    #[doc = "MDF offset error compensation control register 0."]
    #[inline(always)]
    ...
    #[doc = "MDF snapshot data register 0."]
    #[inline(always)]
    pub const fn snpsdr(self, n: usize) -> crate::common::Reg<regs::Snpsdr, crate::common::RW> {
        assert!(n < 6usize);
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0xecusize + n * 128usize) as _) }
    }
    #[doc = "MDF digital filter data register 0."]
    #[inline(always)]
    pub const fn dfltdr(self, n: usize) -> crate::common::Reg<regs::Dfltdr, crate::common::RW> {
        assert!(n < 6usize);
...
pub mod regs {
    ...
    impl Ckgcr {
        ...
        #[doc = "CKGEN trigger sensitivity selection."]
        #[must_use]
        #[inline(always)]
        ...
        #[doc = "Divider to control the MDF_CCK clock."]
        #[must_use]
        #[inline(always)]
    ...
    impl Dfltcicr {
        ...
        #[doc = "CIC decimation ratio selection."]
        #[must_use]
        #[inline(always)]
        pub const fn mcicd(&self) -> u8 {
            let val = (self.0 >> 8usize) & 0xff;
            val as u8
        }
        #[doc = "CIC decimation ratio selection."]
        #[inline(always)]
        pub const fn set_mcicd(&mut self, val: u8) {
            self.0 = (self.0 & !(0xff << 8usize)) | (((val as u32) & 0xff) << 8usize);
        }
        #[doc = "CIC decimation ratio selection."]
        #[must_use]
        #[inline(always)]
        pub const fn mcicd8(&self) -> bool {
            let val = (self.0 >> 16usize) & 0x01;
            val != 0
        }
        #[doc = "CIC decimation ratio selection."]
        #[inline(always)]
        pub const fn set_mcicd8(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 16usize)) | (((val as u32) & 0x01) << 16usize);
        }
        #[doc = "Scaling factor selection."]
        #[must_use]
        #[inline(always)]
    ...
    impl defmt::Format for Dfltcicr {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Dfltcicr {{ datsrc: {:?}, cicmod: {:?}, mcicd: {=u8:?}, mcicd8: {=bool:?}, scale: {=u8:?} }}",
                self.datsrc(),
                self.cicmod(),
                self.mcicd(),
                self.mcicd8(),
    ...
    impl Dfltcr {
        ...
        #[doc = "Digital filter trigger sensitivity selection."]
        #[must_use]
        #[inline(always)]
        pub const fn trgsens(&self) -> super::vals::Trgsens {
            let val = (self.0 >> 8usize) & 0x01;
        ...
        #[doc = "Digital filter run status flag."]
        #[must_use]
        #[inline(always)]
        ...
        #[doc = "Digital filter active flag."]
        #[must_use]
        #[inline(always)]
    ...
    impl Dfltier {
        ...
        #[doc = "Snapshot data ready interrupt enable."]
        #[must_use]
        #[inline(always)]
        ...
        #[doc = "Snapshot overrun interrupt enable."]
        #[must_use]
        #[inline(always)]
    ...
    impl Dfltintr {
        ...
        #[doc = "Integration value selection."]
        #[must_use]
        #[inline(always)]
    ...
    impl Dfltisr {
        ...
        #[doc = "High-threshold status flag."]
        #[must_use]
        #[inline(always)]
    ...
    impl Dfltrsfr {
        ...
        #[doc = "High-pass filter cut-off frequency."]
        #[must_use]
        #[inline(always)]
    ...
    impl Oldcr {
        ...
        #[doc = "Break signal assignment for out-of limit detector."]
        #[must_use]
        #[inline(always)]
        ...
        #[doc = "OLDx CIC decimation ratio selection."]
        #[must_use]
        #[inline(always)]
    ...
    impl Scdcr {
        ...
        #[doc = "Break signal assignment for short circuit detector."]
        #[must_use]
        #[inline(always)]
    ...
    impl Sitfcr {
        ...
        #[doc = "Manchester symbol threshold/SPI threshold."]
        #[must_use]
        #[inline(always)]
        ...
        #[doc = "Serial interface active flag."]
        #[must_use]
        #[inline(always)]
    ...
    impl Snpsdr {
        #[doc = "Contains the MCIC decimation counter value when the last trigger event occurs (MCIC_CNT)."]
        #[must_use]
        #[inline(always)]
