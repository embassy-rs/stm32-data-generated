...
# [derive (Copy , Clone , Eq , PartialEq , Ord , PartialOrd)]
pub enum VpSel { # [doc = "GPIO connected to OPAMPx_VINP"]
GPIO = 0x0 , # [doc = "dac_outx connected to OPAMPx_VINP"]
DACOUT = 0x01 , _RESERVED_2 = 0x02 , _RESERVED_3 = 0x03 , } impl VpSel { # [inline (always)]
