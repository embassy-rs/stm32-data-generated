...
pub mod regs {
    ...
    impl Csr {
        ...
        #[doc = "Internal output enable"]
        #[inline(always)]
        pub const fn set_opaintoen(&mut self, val: bool) {
    ...
    impl Tcmr {
        ...
        #[doc = "Inverting input secondary selection"]
        #[inline(always)]
        pub const fn set_vms_sel(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 0usize)) | (((val as u32) & 0x01) << 0usize);
        }
        ...
        #[doc = "TIM1 controlled mux mode enable"]
        #[inline(always)]
        pub const fn set_t1cm_en(&mut self, val: bool) {
        ...
        #[doc = "TIM8 controlled mux mode enable"]
        #[inline(always)]
        pub const fn set_t8cm_en(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 4usize)) | (((val as u32) & 0x01) << 4usize);
        }
        ...
        #[doc = "TIM20 controlled mux mode enable"]
        #[inline(always)]
        pub const fn set_t20cm_en(&mut self, val: bool) {
