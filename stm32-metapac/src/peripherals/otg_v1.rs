...
# [inline (always)]
pub const fn dieptxf0 (self) -> crate :: common :: Reg < regs :: Fsiz , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x28usize) as _) } } # [doc = "Non-periodic transmit FIFO size register (host mode)"]
# [inline (always)]
pub const fn hnptxfsiz (self) -> crate :: common :: Reg < regs :: Fsiz , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x28usize) as _) } } # [doc = "Non-periodic transmit FIFO/queue status register (host mode)"]
# [inline (always)]
pub const fn hnptxsts (self) -> crate :: common :: Reg < regs :: Hnptxsts , crate :: common :: R > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x2cusize) as _) } } # [doc = "OTG I2C access register"]
# [inline (always)]
pub const fn gi2cctl (self) -> crate :: common :: Reg < regs :: Gi2cctl , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x30usize) as _) } } # [doc = "General core configuration register, for core_id 0x0000_1xxx"]
# [inline (always)]
...
# [inline (always)]
pub const fn gccfg_v2 (self) -> crate :: common :: Reg < regs :: GccfgV2 , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x38usize) as _) } } # [doc = "General core configuration register, for core_id 0x0000_5xxx"]
# [inline (always)]
pub const fn gccfg_v3 (self) -> crate :: common :: Reg < regs :: GccfgV3 , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x38usize) as _) } } # [doc = "Core ID register"]
# [inline (always)]
pub const fn cid (self) -> crate :: common :: Reg < regs :: Cid , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x3cusize) as _) } } # [doc = "Synopsis ID Register"]
# [inline (always)]
pub const fn snpsid (self) -> crate :: common :: Reg < u32 , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x40usize) as _) } } # [doc = "User HW Config 1 Register"]
# [inline (always)]
pub const fn hwcfg1 (self) -> crate :: common :: Reg < u32 , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x44usize) as _) } } # [doc = "User HW Config 2 Register"]
# [inline (always)]
pub const fn hwcfg2 (self) -> crate :: common :: Reg < u32 , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x48usize) as _) } } # [doc = "User HW Config 3 Register"]
# [inline (always)]
pub const fn hwcfg3 (self) -> crate :: common :: Reg < u32 , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x4cusize) as _) } } # [doc = "User HW Config 4 Register"]
# [inline (always)]
pub const fn hwcfg4 (self) -> crate :: common :: Reg < u32 , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x50usize) as _) } } # [doc = "OTG core LPM configuration register"]
# [inline (always)]
pub const fn glpmcfg (self) -> crate :: common :: Reg < regs :: Glpmcfg , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x54usize) as _) } } # [doc = "Global PowerDn Register"]
# [inline (always)]
pub const fn gpwrdn (self) -> crate :: common :: Reg < u32 , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x58usize) as _) } } # [doc = "Global DFIFO SW Config Register"]
# [inline (always)]
pub const fn gdfifocfg (self) -> crate :: common :: Reg < u32 , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x5cusize) as _) } } # [doc = "ADP (Attach Detection Protocol) Control Register"]
# [inline (always)]
pub const fn adpctl (self) -> crate :: common :: Reg < regs :: Adpctl , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x60usize) as _) } } # [doc = "Host periodic transmit FIFO size register"]
# [inline (always)]
pub const fn hptxfsiz (self) -> crate :: common :: Reg < regs :: Fsiz , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x0100usize) as _) } } # [doc = "Device IN endpoint transmit FIFO size register"]
# [inline (always)]
...
# [inline (always)]
pub const fn hptxsts (self) -> crate :: common :: Reg < regs :: Hptxsts , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x0410usize) as _) } } # [doc = "Host all channels interrupt register"]
# [inline (always)]
...
# [inline (always)]
pub const fn haintmsk (self) -> crate :: common :: Reg < regs :: Haintmsk , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x0418usize) as _) } } # [doc = "Host Frame Scheduling List Register"]
# [inline (always)]
pub const fn hflbaddr (self) -> crate :: common :: Reg < u32 , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x041cusize) as _) } } # [doc = "Host port control and status register"]
# [inline (always)]
pub const fn hprt (self) -> crate :: common :: Reg < regs :: Hprt , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x0440usize) as _) } } # [doc = "Host channel characteristics register"]
# [inline (always)]
pub const fn hcchar (self , n : usize) -> crate :: common :: Reg < regs :: Hcchar , crate :: common :: RW > { assert ! (n < 12usize) ; unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x0500usize + n * 32usize) as _) } } # [doc = "Host channel split control register"]
# [inline (always)]
pub const fn hcsplt (self , n : usize) -> crate :: common :: Reg < u32 , crate :: common :: RW > { assert ! (n < 12usize) ; unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x0504usize + n * 32usize) as _) } } # [doc = "Host channel interrupt register"]
# [inline (always)]
pub const fn hcint (self , n : usize) -> crate :: common :: Reg < regs :: Hcint , crate :: common :: RW > { assert ! (n < 12usize) ; unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x0508usize + n * 32usize) as _) } } # [doc = "Host channel mask register"]
# [inline (always)]
pub const fn hcintmsk (self , n : usize) -> crate :: common :: Reg < regs :: Hcintmsk , crate :: common :: RW > { assert ! (n < 12usize) ; unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x050cusize + n * 32usize) as _) } } # [doc = "Host channel transfer size register"]
# [inline (always)]
pub const fn hctsiz (self , n : usize) -> crate :: common :: Reg < regs :: Hctsiz , crate :: common :: RW > { assert ! (n < 12usize) ; unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x0510usize + n * 32usize) as _) } } # [doc = "Host channel DMA address register (config for scatter/gather)"]
# [inline (always)]
pub const fn hcdma (self , n : usize) -> crate :: common :: Reg < regs :: Hcdma , crate :: common :: RW > { assert ! (n < 12usize) ; unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x0514usize + n * 32usize) as _) } } # [doc = "Host channel DMA address register (address for current transfer; debug)"]
# [inline (always)]
pub const fn hcdmab (self , n : usize) -> crate :: common :: Reg < u32 , crate :: common :: RW > { assert ! (n < 12usize) ; unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x051cusize + n * 32usize) as _) } } # [doc = "Device configuration register"]
# [inline (always)]
...
# [inline (always)]
pub const fn dvbuspulse (self) -> crate :: common :: Reg < regs :: Dvbuspulse , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x082cusize) as _) } } # [doc = "Device IN endpoint FIFO empty interrupt mask register"]
# [inline (always)]
pub const fn diepempmsk (self) -> crate :: common :: Reg < regs :: Diepempmsk , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x0834usize) as _) } } # [doc = "Device IN endpoint control register"]
# [inline (always)]
...
# [inline (always)]
pub const fn doeptsiz (self , n : usize) -> crate :: common :: Reg < regs :: Doeptsiz , crate :: common :: RW > { assert ! (n < 16usize) ; unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x0b10usize + n * 32usize) as _) } } # [doc = "Device OUT/IN endpoint DMA address register"]
# [inline (always)]
pub const fn doepdma (self , n : usize) -> crate :: common :: Reg < u32 , crate :: common :: RW > { assert ! (n < 16usize) ; unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x0b14usize + n * 32usize) as _) } } # [doc = "Power and clock gating control register"]
# [inline (always)]
...
# [inline (always)]
pub const fn fifo (self , n : usize) -> crate :: common :: Reg < regs :: Fifo , crate :: common :: RW > { assert ! (n < 16usize) ; unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x1000usize + n * 4096usize) as _) } } } pub mod regs { # [doc = "ADP (Attach Detection Protocol) Control Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
pub struct Adpctl (pub u32) ; impl Adpctl { # [doc = "Probe Discharge time (times for TADP_DSCHG)"]
# [inline (always)]
pub const fn prb_dschg (& self) -> u8 { let val = (self . 0 >> 0usize) & 0x03 ; val as u8 } # [doc = "Probe Discharge time (times for TADP_DSCHG)"]
# [inline (always)]
pub fn set_prb_dschg (& mut self , val : u8) { self . 0 = (self . 0 & ! (0x03 << 0usize)) | (((val as u32) & 0x03) << 0usize) ; } # [doc = "Probe Delta (resolution for RTIM)"]
# [inline (always)]
pub const fn prb_delta (& self) -> u8 { let val = (self . 0 >> 2usize) & 0x03 ; val as u8 } # [doc = "Probe Delta (resolution for RTIM)"]
# [inline (always)]
pub fn set_prb_delta (& mut self , val : u8) { self . 0 = (self . 0 & ! (0x03 << 2usize)) | (((val as u32) & 0x03) << 2usize) ; } # [doc = "Probe Period (TADP_PRD)"]
# [inline (always)]
pub const fn prb_per (& self) -> u8 { let val = (self . 0 >> 4usize) & 0x03 ; val as u8 } # [doc = "Probe Period (TADP_PRD)"]
# [inline (always)]
pub fn set_prb_per (& mut self , val : u8) { self . 0 = (self . 0 & ! (0x03 << 4usize)) | (((val as u32) & 0x03) << 4usize) ; } # [doc = "Probe Period (TADP_PRD)"]
# [inline (always)]
pub const fn rtim (& self) -> u16 { let val = (self . 0 >> 6usize) & 0x07ff ; val as u16 } # [doc = "Probe Period (TADP_PRD)"]
# [inline (always)]
...
# [inline (always)]
pub const fn adpres (& self) -> bool { let val = (self . 0 >> 19usize) & 0x01 ; val != 0 } # [doc = "ADP Reset"]
# [inline (always)]
pub fn set_adpres (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 19usize)) | (((val as u32) & 0x01) << 19usize) ; } # [doc = "ADP Enable"]
# [inline (always)]
pub const fn adpen (& self) -> bool { let val = (self . 0 >> 20usize) & 0x01 ; val != 0 } # [doc = "ADP Enable"]
# [inline (always)]
pub fn set_adpen (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 20usize)) | (((val as u32) & 0x01) << 20usize) ; } # [doc = "ADP Probe Interrupt Enable"]
# [inline (always)]
pub const fn adp_prb_int (& self) -> bool { let val = (self . 0 >> 21usize) & 0x01 ; val != 0 } # [doc = "ADP Probe Interrupt Enable"]
# [inline (always)]
pub fn set_adp_prb_int (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 21usize)) | (((val as u32) & 0x01) << 21usize) ; } # [doc = "ADP Sense Interrupt Enable"]
# [inline (always)]
pub const fn adp_sns_int (& self) -> bool { let val = (self . 0 >> 22usize) & 0x01 ; val != 0 } # [doc = "ADP Sense Interrupt Enable"]
# [inline (always)]
pub fn set_adp_sns_int (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 22usize)) | (((val as u32) & 0x01) << 22usize) ; } # [doc = "ADP Timeout Interrupt Enable"]
# [inline (always)]
pub const fn adp_tmout_int (& self) -> bool { let val = (self . 0 >> 23usize) & 0x01 ; val != 0 } # [doc = "ADP Timeout Interrupt Enable"]
# [inline (always)]
pub fn set_adp_tmout_int (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 23usize)) | (((val as u32) & 0x01) << 23usize) ; } # [doc = "ADP Probe Interrupt Mask"]
# [inline (always)]
pub const fn adp_prb_msk (& self) -> bool { let val = (self . 0 >> 24usize) & 0x01 ; val != 0 } # [doc = "ADP Probe Interrupt Mask"]
# [inline (always)]
pub fn set_adp_prb_msk (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 24usize)) | (((val as u32) & 0x01) << 24usize) ; } # [doc = "ADP Timeout Interrupt Mask"]
# [inline (always)]
pub const fn adp_tmout_msk (& self) -> bool { let val = (self . 0 >> 25usize) & 0x01 ; val != 0 } # [doc = "ADP Timeout Interrupt Mask"]
# [inline (always)]
pub fn set_adp_tmout_msk (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 25usize)) | (((val as u32) & 0x01) << 25usize) ; } # [doc = "Access Request"]
# [inline (always)]
pub const fn ar (& self) -> bool { let val = (self . 0 >> 26usize) & 0x01 ; val != 0 } # [doc = "Access Request"]
# [inline (always)]
pub fn set_ar (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 26usize)) | (((val as u32) & 0x01) << 26usize) ; } } impl Default for Adpctl { # [inline (always)]
fn default () -> Adpctl { Adpctl (0) } } # [doc = "Core ID register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
# [inline (always)]
pub fn set_datafsusp (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 22usize)) | (((val as u32) & 0x01) << 22usize) ; } # [doc = "Reset detected"]
# [inline (always)]
pub const fn resetdet (& self) -> bool { let val = (self . 0 >> 23usize) & 0x01 ; val != 0 } # [doc = "Reset detected"]
# [inline (always)]
pub fn set_resetdet (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 23usize)) | (((val as u32) & 0x01) << 23usize) ; } # [doc = "Host port interrupt"]
# [inline (always)]
...
# [inline (always)]
pub fn set_dad (& mut self , val : u8) { self . 0 = (self . 0 & ! (0x7f << 22usize)) | (((val as u32) & 0x7f) << 22usize) ; } # [doc = "Odd frame (request iso/interrupt transaction to be performed on odd micro-frame)"]
# [inline (always)]
pub const fn oddfrm (& self) -> bool { let val = (self . 0 >> 29usize) & 0x01 ; val != 0 } # [doc = "Odd frame (request iso/interrupt transaction to be performed on odd micro-frame)"]
# [inline (always)]
...
fn default () -> Hcchar { Hcchar (0) } } # [doc = "Host channel DMA config register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
pub struct Hcdma (pub u32) ; impl Hcdma { # [doc = "QTD list base address"]
# [inline (always)]
pub const fn qtdaddr (& self) -> u32 { let val = (self . 0 >> 0usize) & 0xffff_ffff ; val as u32 } # [doc = "QTD list base address"]
# [inline (always)]
pub fn set_qtdaddr (& mut self , val : u32) { self . 0 = (self . 0 & ! (0xffff_ffff << 0usize)) | (((val as u32) & 0xffff_ffff) << 0usize) ; } # [doc = "Current QTD (transfer descriptor) index"]
# [inline (always)]
pub const fn cqtd (& self) -> u8 { let val = (self . 0 >> 3usize) & 0x3f ; val as u8 } # [doc = "Current QTD (transfer descriptor) index"]
# [inline (always)]
pub fn set_cqtd (& mut self , val : u8) { self . 0 = (self . 0 & ! (0x3f << 3usize)) | (((val as u32) & 0x3f) << 3usize) ; } } impl Default for Hcdma { # [inline (always)]
fn default () -> Hcdma { Hcdma (0) } } # [doc = "Host configuration register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
# [inline (always)]
pub fn set_fslss (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 2usize)) | (((val as u32) & 0x01) << 2usize) ; } # [doc = "Descriptor DMA-mode enable (qtd)"]
# [inline (always)]
pub const fn descdma (& self) -> bool { let val = (self . 0 >> 23usize) & 0x01 ; val != 0 } # [doc = "Descriptor DMA-mode enable (qtd)"]
# [inline (always)]
pub fn set_descdma (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 23usize)) | (((val as u32) & 0x01) << 23usize) ; } # [doc = "Frame list length"]
# [inline (always)]
pub const fn frlistlen (& self) -> super :: vals :: Frlistlen { let val = (self . 0 >> 24usize) & 0x03 ; super :: vals :: Frlistlen :: from_bits (val as u8) } # [doc = "Frame list length"]
# [inline (always)]
pub fn set_frlistlen (& mut self , val : super :: vals :: Frlistlen) { self . 0 = (self . 0 & ! (0x03 << 24usize)) | (((val . to_bits () as u32) & 0x03) << 24usize) ; } # [doc = "Period scheduling enable"]
# [inline (always)]
pub const fn perschedena (& self) -> bool { let val = (self . 0 >> 26usize) & 0x01 ; val != 0 } # [doc = "Period scheduling enable"]
# [inline (always)]
pub fn set_perschedena (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 26usize)) | (((val as u32) & 0x01) << 26usize) ; } } impl Default for Hcfg { # [inline (always)]
...
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
pub struct Hctsiz (pub u32) ; impl Hctsiz { # [doc = "Schedule info for isochronuous & interrupt pipes (xfrsiz\\[7:0\\])"]
# [inline (always)]
pub const fn schedinfo (& self) -> u8 { let val = (self . 0 >> 0usize) & 0xff ; val as u8 } # [doc = "Schedule info for isochronuous & interrupt pipes (xfrsiz\\[7:0\\])"]
# [inline (always)]
pub fn set_schedinfo (& mut self , val : u8) { self . 0 = (self . 0 & ! (0xff << 0usize)) | (((val as u32) & 0xff) << 0usize) ; } # [doc = "Transfer size for non-isochronuous/interrupt pipes"]
# [inline (always)]
pub const fn xfrsiz (& self) -> u32 { let val = (self . 0 >> 0usize) & 0x0007_ffff ; val as u32 } # [doc = "Transfer size for non-isochronuous/interrupt pipes"]
# [inline (always)]
pub fn set_xfrsiz (& mut self , val : u32) { self . 0 = (self . 0 & ! (0x0007_ffff << 0usize)) | (((val as u32) & 0x0007_ffff) << 0usize) ; } # [doc = "NTD descriptor list length for isochronuous & interrupt pipes (xfrsiz\\[15:8\\], note val+1 is actual length)"]
# [inline (always)]
pub const fn ntdl (& self) -> u8 { let val = (self . 0 >> 8usize) & 0xff ; val as u8 } # [doc = "NTD descriptor list length for isochronuous & interrupt pipes (xfrsiz\\[15:8\\], note val+1 is actual length)"]
# [inline (always)]
pub fn set_ntdl (& mut self , val : u8) { self . 0 = (self . 0 & ! (0xff << 8usize)) | (((val as u32) & 0xff) << 8usize) ; } # [doc = "Packet count"]
# [inline (always)]
pub const fn pktcnt (& self) -> u16 { let val = (self . 0 >> 19usize) & 0x03ff ; val as u16 } # [doc = "Packet count"]
# [inline (always)]
...
# [inline (always)]
pub fn set_dpid (& mut self , val : u8) { self . 0 = (self . 0 & ! (0x03 << 29usize)) | (((val as u32) & 0x03) << 29usize) ; } # [doc = "Do Ping"]
# [inline (always)]
pub const fn doping (& self) -> bool { let val = (self . 0 >> 31usize) & 0x01 ; val != 0 } # [doc = "Do Ping"]
# [inline (always)]
pub fn set_doping (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 31usize)) | (((val as u32) & 0x01) << 31usize) ; } } impl Default for Hctsiz { # [inline (always)]
...
# [inline (always)]
pub fn set_frivl (& mut self , val : u16) { self . 0 = (self . 0 & ! (0xffff << 0usize)) | (((val as u32) & 0xffff) << 0usize) ; } # [doc = "Dynamic Loading Control"]
# [inline (always)]
pub const fn rldctrl (& self) -> bool { let val = (self . 0 >> 16usize) & 0x01 ; val != 0 } # [doc = "Dynamic Loading Control"]
# [inline (always)]
...
# [inline (always)]
pub fn set_pcdet (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 1usize)) | (((val as u32) & 0x01) << 1usize) ; } # [doc = "Port enable (W1C)"]
# [inline (always)]
pub const fn pena (& self) -> bool { let val = (self . 0 >> 2usize) & 0x01 ; val != 0 } # [doc = "Port enable (W1C)"]
# [inline (always)]
...
# [derive (Copy , Clone , Eq , PartialEq , Ord , PartialOrd)]
pub enum Frlistlen { # [doc = "Length = 8"]
LEN8 = 0x0 , # [doc = "Length = 16"]
LEN16 = 0x01 , # [doc = "Length = 32"]
LEN32 = 0x02 , # [doc = "Length = 64"]
LEN64 = 0x03 , } impl Frlistlen { # [inline (always)]
pub const fn from_bits (val : u8) -> Frlistlen { unsafe { core :: mem :: transmute (val & 0x03) } } # [inline (always)]
pub const fn to_bits (self) -> u8 { unsafe { core :: mem :: transmute (self) } } } impl From < u8 > for Frlistlen { # [inline (always)]
fn from (val : u8) -> Frlistlen { Frlistlen :: from_bits (val) } } impl From < Frlistlen > for u8 { # [inline (always)]
fn from (val : Frlistlen) -> u8 { Frlistlen :: to_bits (val) } } # [repr (u8)]
# [derive (Copy , Clone , Eq , PartialEq , Ord , PartialOrd)]
