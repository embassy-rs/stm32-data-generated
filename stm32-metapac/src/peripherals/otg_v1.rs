...
# [inline (always)]
pub const fn glpmcfg (self) -> crate :: common :: Reg < regs :: Glpmcfg , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x54usize) as _) } } # [doc = "Host periodic transmit FIFO size register"]
# [inline (always)]
...
# [inline (always)]
pub const fn hctsiz (self , n : usize) -> crate :: common :: Reg < regs :: Hctsiz , crate :: common :: RW > { assert ! (n < 12usize) ; unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x0510usize + n * 32usize) as _) } } # [doc = "Device configuration register"]
# [inline (always)]
...
# [inline (always)]
pub const fn doeptsiz (self , n : usize) -> crate :: common :: Reg < regs :: Doeptsiz , crate :: common :: RW > { assert ! (n < 16usize) ; unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x0b10usize + n * 32usize) as _) } } # [doc = "Power and clock gating control register"]
# [inline (always)]
