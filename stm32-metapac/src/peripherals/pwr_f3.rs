...
# [inline (always)]
pub const fn ensd (& self , n : usize) -> bool { assert ! (n < 3usize) ; let offs = 9usize + n * 1usize ; let val = (self . 0 >> offs) & 0x01 ; val != 0 } # [doc = "ENable SD1 ADC"]
# [inline (always)]
pub fn set_ensd (& mut self , n : usize , val : bool) { assert ! (n < 3usize) ; let offs = 9usize + n * 1usize ; self . 0 = (self . 0 & ! (0x01 << offs)) | (((val as u32) & 0x01) << offs) ; } } impl Default for Cr { # [inline (always)]
...
# [inline (always)]
pub const fn ewup (& self , n : usize) -> bool { assert ! (n < 2usize) ; let offs = 8usize + n * 1usize ; let val = (self . 0 >> offs) & 0x01 ; val != 0 } # [doc = "Enable WKUP1 pin"]
# [inline (always)]
pub fn set_ewup (& mut self , n : usize , val : bool) { assert ! (n < 2usize) ; let offs = 8usize + n * 1usize ; self . 0 = (self . 0 & ! (0x01 << offs)) | (((val as u32) & 0x01) << offs) ; } } impl Default for Csr { # [inline (always)]
