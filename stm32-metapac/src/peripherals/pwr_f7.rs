...
pub mod regs {
    ...
    impl Cr1 {
        ...
        #[doc = "Low-power regulator in deepsleep under-drive mode"]
        #[inline(always)]
        pub const fn set_lpuds(&mut self, val: bool) {
        ...
        #[doc = "Main regulator in deepsleep under-drive mode"]
        #[inline(always)]
        pub const fn set_mruds(&mut self, val: bool) {
    ...
    impl defmt::Format for Cr1 {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Cr1 {{ lpds: {=bool:?}, pdds: {:?}, csbf: {=bool:?}, pvde: {=bool:?}, pls: {=u8:?}, dbp: {=bool:?}, fpds: {=bool:?}, lpuds: {=bool:?}, mruds: {=bool:?}, adcdc1: {=bool:?}, vos: {:?}, oden: {=bool:?}, odswen: {=bool:?}, uden: {=u8:?} }}",
                self.lpds(),
                self.pdds(),
                self.csbf(),
                self.pvde(),
    ...
    impl Cr2 {
        ...
        #[doc = "Clear Wakeup Pin flag for PA0"]
        #[inline(always)]
        pub const fn set_cwupf(&mut self, n: usize, val: bool) {
            assert!(n < 6usize);
            let offs = 0usize + n * 1usize;
        ...
        #[doc = "Wakeup pin polarity bit for PA0"]
        #[inline(always)]
        pub const fn set_wupp(&mut self, n: usize, val: bool) {
            assert!(n < 6usize);
            let offs = 8usize + n * 1usize;
            self.0 = (self.0 & !(0x01 << offs)) | (((val as u32) & 0x01) << offs);
        }
    ...
    impl defmt::Format for Cr2 {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Cr2 {{ cwupf[0]: {=bool:?}, cwupf[1]: {=bool:?}, cwupf[2]: {=bool:?}, cwupf[3]: {=bool:?}, cwupf[4]: {=bool:?}, cwupf[5]: {=bool:?}, wupp[0]: {=bool:?}, wupp[1]: {=bool:?}, wupp[2]: {=bool:?}, wupp[3]: {=bool:?}, wupp[4]: {=bool:?}, wupp[5]: {=bool:?} }}",
                self.cwupf(0usize),
                self.cwupf(1usize),
                self.cwupf(2usize),
                self.cwupf(3usize),
    ...
    impl Csr1 {
        ...
        #[doc = "Wakeup internal flag"]
        #[inline(always)]
        pub const fn set_wuif(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 0usize)) | (((val as u32) & 0x01) << 0usize);
        }
        #[doc = "Standby flag"]
        #[must_use]
        ...
        #[doc = "Enable internal wakeup"]
        #[inline(always)]
        pub const fn set_eiwup(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 8usize)) | (((val as u32) & 0x01) << 8usize);
        }
    ...
    impl defmt::Format for Csr1 {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Csr1 {{ wuif: {=bool:?}, sbf: {=bool:?}, pvdo: {=bool:?}, brr: {=bool:?}, eiwup: {=bool:?}, bre: {=bool:?}, vosrdy: {=bool:?}, odrdy: {=bool:?}, odswrdy: {=bool:?}, udrdy: {=u8:?} }}",
                self.wuif(),
                self.sbf(),
                self.pvdo(),
                self.brr(),
    ...
    impl Csr2 {
        ...
        #[doc = "Wakeup Pin flag for PA0"]
        #[inline(always)]
        pub const fn set_wupf(&mut self, n: usize, val: bool) {
            assert!(n < 6usize);
            let offs = 0usize + n * 1usize;
            self.0 = (self.0 & !(0x01 << offs)) | (((val as u32) & 0x01) << offs);
        }
    ...
    impl defmt::Format for Csr2 {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Csr2 {{ wupf[0]: {=bool:?}, wupf[1]: {=bool:?}, wupf[2]: {=bool:?}, wupf[3]: {=bool:?}, wupf[4]: {=bool:?}, wupf[5]: {=bool:?}, ewup[0]: {=bool:?}, ewup[1]: {=bool:?}, ewup[2]: {=bool:?}, ewup[3]: {=bool:?}, ewup[4]: {=bool:?}, ewup[5]: {=bool:?} }}",
                self.wupf(0usize),
                self.wupf(1usize),
                self.wupf(2usize),
                self.wupf(3usize),
