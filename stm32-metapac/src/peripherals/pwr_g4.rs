...
pub mod regs {
    ...
    impl Cr2 {
        ...
        #[doc = "Peripheral voltage monitoring 1 enable: VDDA vs. COMP min voltage"]
        #[inline(always)]
        pub const fn set_pvmen1(&mut self, val: bool) {
        ...
        #[doc = "Peripheral voltage monitoring 2 enable: VDDA vs. Fast DAC min voltage"]
        #[inline(always)]
        pub const fn set_pvmen2(&mut self, val: bool) {
        ...
        #[doc = "Peripheral voltage monitoring 3 enable: VDDA vs. ADC min voltage 1.62V"]
        #[inline(always)]
        pub const fn set_pvmen3(&mut self, val: bool) {
        ...
        #[doc = "Peripheral voltage monitoring 4 enable: VDDA vs. OPAMP/DAC min voltage"]
        #[inline(always)]
        pub const fn set_pvmen4(&mut self, val: bool) {
    ...
    impl defmt::Format for Cr2 {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Cr2 {{ pvde: {=bool:?}, pls: {=u8:?}, pvmen1: {=bool:?}, pvmen2: {=bool:?}, pvmen3: {=bool:?}, pvmen4: {=bool:?} }}",
                self.pvde(),
                self.pls(),
                self.pvmen1(),
                self.pvmen2(),
    ...
    impl Cr3 {
        ...
        #[doc = "STDBY"]
        #[inline(always)]
        pub const fn set_ucpd1_stdby(&mut self, val: bool) {
        ...
        #[doc = "DBDIS"]
        #[inline(always)]
        pub const fn set_ucpd1_dbdis(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 14usize)) | (((val as u32) & 0x01) << 14usize);
        }
    ...
    impl defmt::Format for Cr3 {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Cr3 {{ ewup1: {=bool:?}, ewup2: {=bool:?}, ewup3: {=bool:?}, ewup4: {=bool:?}, ewup5: {=bool:?}, rrs: {=bool:?}, apc: {=bool:?}, ucpd1_stdby: {=bool:?}, ucpd1_dbdis: {=bool:?}, eiwul: {=bool:?} }}",
                self.ewup1(),
                self.ewup2(),
                self.ewup3(),
                self.ewup4(),
    ...
    impl defmt::Format for Scr {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Scr {{ cwuf1: {=bool:?}, cwuf2: {=bool:?}, cwuf3: {=bool:?}, cwuf4: {=bool:?}, cwuf5: {=bool:?}, csbf: {=bool:?} }}",
                self.cwuf1(),
                self.cwuf2(),
                self.cwuf3(),
                self.cwuf4(),
    ...
    impl defmt::Format for Sr1 {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Sr1 {{ wuf1: {=bool:?}, wuf2: {=bool:?}, wuf3: {=bool:?}, wuf4: {=bool:?}, wuf5: {=bool:?}, sbf: {=bool:?}, wufi: {=bool:?} }}",
                self.wuf1(),
                self.wuf2(),
                self.wuf3(),
                self.wuf4(),
