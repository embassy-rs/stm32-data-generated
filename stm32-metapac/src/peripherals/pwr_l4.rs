...
impl Pwr {
    ...
    pub const fn pucr(self, n: usize) -> crate::common::Reg<regs::Pcr, crate::common::RW> {
        assert!(n < 8usize);
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x20usize + n * 8usize) as _) }
    }
...
pub mod regs {
    ...
    impl Cr1 {
        ...
        #[doc = "Low-power run"]
        #[inline(always)]
        pub const fn set_lpr(&mut self, val: super::vals::Lpr) {
    ...
    impl Cr2 {
        ...
        #[doc = "Peripheral voltage monitoring 2 enable: VDDIO2 vs. 0.9V"]
        #[inline(always)]
        pub const fn set_pvme2(&mut self, val: bool) {
        ...
        #[doc = "VDDIO2 Independent I/Os supply valid"]
        #[inline(always)]
        pub const fn set_iosv(&mut self, val: bool) {
    ...
    impl defmt::Format for Cr2 {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Cr2 {{ pvde: {=bool:?}, pls: {:?}, pvme1: {=bool:?}, pvme2: {=bool:?}, pvme3: {=bool:?}, pvme4: {=bool:?}, iosv: {=bool:?}, usv: {=bool:?} }}",
                self.pvde(),
                self.pls(),
                self.pvme1(),
                self.pvme2(),
    ...
    impl Cr3 {
        ...
        #[doc = "Enable internal wakeup line"]
        #[inline(always)]
        pub const fn set_ewf(&mut self, val: bool) {
    ...
    impl defmt::Format for Cr3 {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Cr3 {{ ewup[0]: {=bool:?}, ewup[1]: {=bool:?}, ewup[2]: {=bool:?}, ewup[3]: {=bool:?}, ewup[4]: {=bool:?}, rrs: {:?}, apc: {=bool:?}, ewf: {=bool:?} }}",
                self.ewup(0usize),
                self.ewup(1usize),
                self.ewup(2usize),
                self.ewup(3usize),
    ...
    impl defmt::Format for Cr4 {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Cr4 {{ wp1: {=bool:?}, wp2: {=bool:?}, wp3: {=bool:?}, wp4: {=bool:?}, wp5: {=bool:?}, vbe: {=bool:?}, vbrs: {=bool:?} }}",
                self.wp1(),
                self.wp2(),
                self.wp3(),
                self.wp4(),
    ...
    impl Pcr {
        ...
        #[doc = "Port pull bit y (y=0..15)"]
        #[inline(always)]
        pub const fn set_p(&mut self, n: usize, val: bool) {
            assert!(n < 16usize);
            let offs = 0usize + n * 1usize;
            self.0 = (self.0 & !(0x01 << offs)) | (((val as u32) & 0x01) << offs);
        }
    ...
    impl defmt::Format for Scr {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Scr {{ cwuf[0]: {=bool:?}, cwuf[1]: {=bool:?}, cwuf[2]: {=bool:?}, cwuf[3]: {=bool:?}, cwuf[4]: {=bool:?}, sbf: {=bool:?} }}",
                self.cwuf(0usize),
                self.cwuf(1usize),
                self.cwuf(2usize),
                self.cwuf(3usize),
    ...
    impl defmt::Format for Sr1 {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Sr1 {{ cwuf1: {=bool:?}, cwuf2: {=bool:?}, cwuf3: {=bool:?}, cwuf4: {=bool:?}, cwuf5: {=bool:?}, csbf: {=bool:?}, wufi: {=bool:?} }}",
                self.cwuf1(),
                self.cwuf2(),
                self.cwuf3(),
                self.cwuf4(),
    ...
    impl Sr2 {
        ...
        #[doc = "Peripheral voltage monitoring output: VDDIO2 vs. 0.9 V"]
        #[inline(always)]
        pub const fn set_pvmo2(&mut self, val: bool) {
    ...
    impl defmt::Format for Sr2 {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Sr2 {{ reglps: {=bool:?}, reglpf: {=bool:?}, vosf: {=bool:?}, pvdo: {=bool:?}, pvmo1: {=bool:?}, pvmo2: {=bool:?}, pvmo3: {=bool:?}, pvmo4: {=bool:?} }}",
                self.reglps(),
                self.reglpf(),
                self.vosf(),
                self.pvdo(),
