...
pub mod regs {
    ...
    impl Cr3 {
        ...
        #[doc = "UCPD_STDBY"]
        #[inline(always)]
        pub const fn set_ucpd_stdby(&mut self, val: bool) {
    ...
    impl defmt::Format for Cr3 {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Cr3 {{ ewup[0]: {=bool:?}, ewup[1]: {=bool:?}, ewup[2]: {=bool:?}, ewup[3]: {=bool:?}, ewup[4]: {=bool:?}, rrs: {:?}, apc: {=bool:?}, ulpmen: {=bool:?}, ucpd_stdby: {=bool:?}, ucpd_dbdis: {=bool:?} }}",
                self.ewup(0usize),
                self.ewup(1usize),
                self.ewup(2usize),
                self.ewup(3usize),
    ...
    impl Cr4 {
        ...
        #[doc = "SMPSBYP"]
        #[inline(always)]
        pub const fn set_smpsbyp(&mut self, val: bool) {
        ...
        #[doc = "EXTSMPSEN"]
        #[inline(always)]
        pub const fn set_extsmpsen(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 13usize)) | (((val as u32) & 0x01) << 13usize);
        }
        #[doc = "SMPSFSTEN"]
        #[must_use]
        ...
        #[doc = "SMPSFSTEN"]
        #[inline(always)]
        pub const fn set_smpsfsten(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 14usize)) | (((val as u32) & 0x01) << 14usize);
        }
        #[doc = "SMPSLPEN"]
        #[must_use]
        ...
        #[doc = "SMPSLPEN"]
        #[inline(always)]
        pub const fn set_smpslpen(&mut self, val: bool) {
    ...
    impl defmt::Format for Cr4 {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Cr4 {{ wp1: {=bool:?}, wp2: {=bool:?}, wp3: {=bool:?}, wp4: {=bool:?}, wp5: {=bool:?}, vbe: {=bool:?}, vbrs: {=bool:?}, smpsbyp: {=bool:?}, extsmpsen: {=bool:?}, smpsfsten: {=bool:?}, smpslpen: {=bool:?} }}",
                self.wp1(),
                self.wp2(),
                self.wp3(),
                self.wp4(),
    ...
    impl defmt::Format for Seccfgr {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Seccfgr {{ wup1sec: {=bool:?}, wup2sec: {=bool:?}, wup3sec: {=bool:?}, wup4sec: {=bool:?}, wup5sec: {=bool:?}, lpmsec: {=bool:?}, vdmsec: {=bool:?}, vbsec: {=bool:?}, apcsec: {=bool:?} }}",
                self.wup1sec(),
                self.wup2sec(),
                self.wup3sec(),
                self.wup4sec(),
