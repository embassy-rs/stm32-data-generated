...
pub mod regs {
    ...
    impl defmt::Format for Apbenr1 {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Apbenr1 {{ tim3en: {=bool:?}, rtcapben: {=bool:?}, wwdgen: {=bool:?}, usart2en: {=bool:?}, i2c1en: {=bool:?}, dbgen: {=bool:?}, pwren: {=bool:?} }}",
                self.tim3en(),
                self.rtcapben(),
                self.wwdgen(),
                self.usart2en(),
    ...
    impl defmt::Format for Apbenr2 {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Apbenr2 {{ syscfgen: {=bool:?}, tim1en: {=bool:?}, spi1en: {=bool:?}, usart1en: {=bool:?}, tim14en: {=bool:?}, tim16en: {=bool:?}, tim17en: {=bool:?}, adc1en: {=bool:?} }}",
                self.syscfgen(),
                self.tim1en(),
                self.spi1en(),
                self.usart1en(),
    ...
    impl defmt::Format for Apbrstr1 {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Apbrstr1 {{ tim3rst: {=bool:?}, usart2rst: {=bool:?}, i2c1rst: {=bool:?}, dbgrst: {=bool:?}, pwrrst: {=bool:?} }}",
                self.tim3rst(),
                self.usart2rst(),
                self.i2c1rst(),
                self.dbgrst(),
    ...
    impl defmt::Format for Apbrstr2 {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Apbrstr2 {{ syscfgrst: {=bool:?}, tim1rst: {=bool:?}, spi1rst: {=bool:?}, usart1rst: {=bool:?}, tim14rst: {=bool:?}, tim16rst: {=bool:?}, tim17rst: {=bool:?}, adc1rst: {=bool:?} }}",
                self.syscfgrst(),
                self.tim1rst(),
                self.spi1rst(),
                self.usart1rst(),
    ...
    impl defmt::Format for Apbsmenr1 {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Apbsmenr1 {{ tim3smen: {=bool:?}, rtcapbsmen: {=bool:?}, wwdgsmen: {=bool:?}, usart2smen: {=bool:?}, i2c1smen: {=bool:?}, dbgsmen: {=bool:?}, pwrsmen: {=bool:?} }}",
                self.tim3smen(),
                self.rtcapbsmen(),
                self.wwdgsmen(),
                self.usart2smen(),
    ...
    impl Apbsmenr2 {
        ...
        #[doc = "TIM14 timer clock enable during Sleep mode Set and cleared by software."]
        #[inline(always)]
        pub const fn set_tim14smen(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 15usize)) | (((val as u32) & 0x01) << 15usize);
        }
        ...
        #[doc = "ADC clock enable during Sleep mode Set and cleared by software."]
        #[inline(always)]
        pub const fn set_adc1smen(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 20usize)) | (((val as u32) & 0x01) << 20usize);
        }
    }
    ...
    impl defmt::Format for Apbsmenr2 {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Apbsmenr2 {{ syscfgsmen: {=bool:?}, tim1smen: {=bool:?}, spi1smen: {=bool:?}, usart1smen: {=bool:?}, tim14smen: {=bool:?}, tim16smen: {=bool:?}, tim17smen: {=bool:?}, adc1smen: {=bool:?} }}",
                self.syscfgsmen(),
                self.tim1smen(),
                self.spi1smen(),
                self.usart1smen(),
    ...
    impl Ccipr {
        ...
        #[doc = "I2S1 clock source selection This bitfield is controlled by software to select I2S1 clock source as follows:"]
        #[inline(always)]
        pub const fn set_i2s1sel(&mut self, val: super::vals::I2s1sel) {
        ...
        #[doc = "ADCs clock source selection This bitfield is controlled by software to select the clock source for ADC:"]
        #[inline(always)]
        pub const fn set_adc1sel(&mut self, val: super::vals::Adcsel) {
    ...
    impl defmt::Format for Cfgr {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Cfgr {{ sw: {:?}, sws: {:?}, hpre: {:?}, ppre: {:?}, mco2sel: {:?}, mco2pre: {:?}, mco1sel: {:?}, mco1pre: {:?} }}",
                self.sw(),
                self.sws(),
                self.hpre(),
                self.ppre(),
    ...
    impl defmt::Format for Cicr {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Cicr {{ lsirdyc: {=bool:?}, lserdyc: {=bool:?}, hsirdyc: {=bool:?}, hserdyc: {=bool:?}, cssc: {=bool:?}, lsecssc: {=bool:?} }}",
                self.lsirdyc(),
                self.lserdyc(),
                self.hsirdyc(),
                self.hserdyc(),
    ...
    impl defmt::Format for Cier {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Cier {{ lsirdyie: {=bool:?}, lserdyie: {=bool:?}, hsirdyie: {=bool:?}, hserdyie: {=bool:?} }}",
                self.lsirdyie(),
                self.lserdyie(),
                self.hsirdyie(),
                self.hserdyie()
    ...
    impl defmt::Format for Cifr {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Cifr {{ lsirdyf: {=bool:?}, lserdyf: {=bool:?}, hsirdyf: {=bool:?}, hserdyf: {=bool:?}, cssf: {=bool:?}, lsecssf: {=bool:?} }}",
                self.lsirdyf(),
                self.lserdyf(),
                self.hsirdyf(),
                self.hserdyf(),
    ...
    impl Cr {
        ...
        #[doc = "HSI kernel clock division factor This bitfield controlled by software sets the division factor of the kernel clock divider to produce HSIKER clock:"]
        #[inline(always)]
        pub const fn set_hsikerdiv(&mut self, val: super::vals::Hsikerdiv) {
    ...
    impl defmt::Format for Cr {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Cr {{ hsikerdiv: {:?}, hsion: {=bool:?}, hsikeron: {=bool:?}, hsirdy: {=bool:?}, hsidiv: {:?}, hseon: {=bool:?}, hserdy: {=bool:?}, hsebyp: {=bool:?}, csson: {=bool:?} }}",
                self.hsikerdiv(),
                self.hsion(),
                self.hsikeron(),
                self.hsirdy(),
    ...
    impl defmt::Format for Csr1 {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Csr1 {{ lseon: {=bool:?}, lserdy: {=bool:?}, lsebyp: {=bool:?}, lsedrv: {:?}, lsecsson: {=bool:?}, lsecssd: {=bool:?}, rtcsel: {:?}, rtcen: {=bool:?}, rtcrst: {=bool:?}, lscoen: {=bool:?}, lscosel: {:?} }}",
                self.lseon(),
                self.lserdy(),
                self.lsebyp(),
                self.lsedrv(),
    ...
    impl defmt::Format for Csr2 {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Csr2 {{ lsion: {=bool:?}, lsirdy: {=bool:?}, rmvf: {=bool:?}, oblrstf: {=bool:?}, pinrstf: {=bool:?}, pwrrstf: {=bool:?}, sftrstf: {=bool:?}, iwdgrstf: {=bool:?}, wwdgrstf: {=bool:?}, lpwrrstf: {=bool:?} }}",
                self.lsion(),
                self.lsirdy(),
                self.rmvf(),
                self.oblrstf(),
    ...
    impl defmt::Format for Gpioenr {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Gpioenr {{ gpioaen: {=bool:?}, gpioben: {=bool:?}, gpiocen: {=bool:?}, gpioden: {=bool:?}, gpiofen: {=bool:?} }}",
                self.gpioaen(),
                self.gpioben(),
                self.gpiocen(),
                self.gpioden(),
    ...
    impl defmt::Format for Gpiorstr {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Gpiorstr {{ gpioarst: {=bool:?}, gpiobrst: {=bool:?}, gpiocrst: {=bool:?}, gpiodrst: {=bool:?}, gpiofrst: {=bool:?} }}",
                self.gpioarst(),
                self.gpiobrst(),
                self.gpiocrst(),
                self.gpiodrst(),
    ...
    impl defmt::Format for Gpiosmenr {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Gpiosmenr {{ gpioasmen: {=bool:?}, gpiobsmen: {=bool:?}, gpiocsmen: {=bool:?}, gpiodsmen: {=bool:?}, gpiofsmen: {=bool:?} }}",
                self.gpioasmen(),
                self.gpiobsmen(),
                self.gpiocsmen(),
                self.gpiodsmen(),
