...
pub mod regs {
    ...
    impl defmt::Format for Ahbenr {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Ahbenr {{ dmaen: {=bool:?}, dma2en: {=bool:?}, sramen: {=bool:?}, flashen: {=bool:?}, crcen: {=bool:?}, gpioaen: {=bool:?}, gpioben: {=bool:?}, gpiocen: {=bool:?}, gpioden: {=bool:?}, gpioeen: {=bool:?}, gpiofen: {=bool:?}, tscen: {=bool:?} }}",
                self.dmaen(),
                self.dma2en(),
                self.sramen(),
                self.flashen(),
    ...
    impl defmt::Format for Apb1enr {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Apb1enr {{ tim2en: {=bool:?}, tim3en: {=bool:?}, tim6en: {=bool:?}, tim7en: {=bool:?}, tim14en: {=bool:?}, wwdgen: {=bool:?}, spi2en: {=bool:?}, usart2en: {=bool:?}, usart3en: {=bool:?}, usart4en: {=bool:?}, usart5en: {=bool:?}, i2c1en: {=bool:?}, i2c2en: {=bool:?}, usben: {=bool:?}, canen: {=bool:?}, crsen: {=bool:?}, pwren: {=bool:?}, dacen: {=bool:?}, cecen: {=bool:?} }}",
                self.tim2en(),
                self.tim3en(),
                self.tim6en(),
                self.tim7en(),
    ...
    impl defmt::Format for Apb1rstr {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Apb1rstr {{ tim2rst: {=bool:?}, tim3rst: {=bool:?}, tim6rst: {=bool:?}, tim7rst: {=bool:?}, tim14rst: {=bool:?}, wwdgrst: {=bool:?}, spi2rst: {=bool:?}, usart2rst: {=bool:?}, usart3rst: {=bool:?}, usart4rst: {=bool:?}, usart5rst: {=bool:?}, i2c1rst: {=bool:?}, i2c2rst: {=bool:?}, usbrst: {=bool:?}, canrst: {=bool:?}, crsrst: {=bool:?}, pwrrst: {=bool:?}, dacrst: {=bool:?}, cecrst: {=bool:?} }}",
                self.tim2rst(),
                self.tim3rst(),
                self.tim6rst(),
                self.tim7rst(),
    ...
    impl Apb2enr {
        ...
        #[doc = "USART7 clock enable"]
        #[inline(always)]
        pub const fn set_usart7en(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 6usize)) | (((val as u32) & 0x01) << 6usize);
        }
        ...
        #[doc = "USART8 clock enable"]
        #[inline(always)]
        pub const fn set_usart8en(&mut self, val: bool) {
    ...
    impl defmt::Format for Apb2enr {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Apb2enr {{ syscfgen: {=bool:?}, usart6en: {=bool:?}, usart7en: {=bool:?}, usart8en: {=bool:?}, adcen: {=bool:?}, tim1en: {=bool:?}, spi1en: {=bool:?}, usart1en: {=bool:?}, tim15en: {=bool:?}, tim16en: {=bool:?}, tim17en: {=bool:?}, dbgmcuen: {=bool:?} }}",
                self.syscfgen(),
                self.usart6en(),
                self.usart7en(),
                self.usart8en(),
    ...
    impl Apb2rstr {
        ...
        #[doc = "USART7 reset"]
        #[inline(always)]
        pub const fn set_usart7rst(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 6usize)) | (((val as u32) & 0x01) << 6usize);
        }
        #[doc = "USART8 reset"]
        #[must_use]
        ...
        #[doc = "USART8 reset"]
        #[inline(always)]
        pub const fn set_usart8rst(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 7usize)) | (((val as u32) & 0x01) << 7usize);
        }
    ...
    impl defmt::Format for Apb2rstr {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Apb2rstr {{ syscfgrst: {=bool:?}, usart6rst: {=bool:?}, usart7rst: {=bool:?}, usart8rst: {=bool:?}, adcrst: {=bool:?}, tim1rst: {=bool:?}, spi1rst: {=bool:?}, usart1rst: {=bool:?}, tim15rst: {=bool:?}, tim16rst: {=bool:?}, tim17rst: {=bool:?}, dbgmcurst: {=bool:?} }}",
                self.syscfgrst(),
                self.usart6rst(),
                self.usart7rst(),
                self.usart8rst(),
    ...
    impl Cfgr {
        ...
        #[doc = "APB Low speed prescaler (APB1)"]
        #[inline(always)]
        pub const fn set_ppre(&mut self, val: super::vals::Ppre) {
        ...
        #[doc = "APCPRE is deprecated. See ADC field in CFGR2 register."]
        #[inline(always)]
        pub const fn set_adcpre(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 14usize)) | (((val as u32) & 0x01) << 14usize);
        }
...
from CFGR2 register. Refer to it for its meaning"]
        ...
        #[doc = "PLL clock not divided for MCO"]
        #[inline(always)]
        pub const fn set_pllmcodiv(&mut self, val: super::vals::Pllmcodiv) {
    ...
    impl defmt::Format for Cfgr {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Cfgr {{ sw: {:?}, sws: {:?}, hpre: {:?}, ppre: {:?}, adcpre: {=bool:?}, pllsrc: {:?}, pllxtpre: {:?}, pllmul: {:?}, mcosel: {:?}, mcopre: {:?}, pllmcodiv: {:?} }}",
                self.sw(),
                self.sws(),
                self.hpre(),
                self.ppre(),
    ...
    impl Cfgr3 {
        ...
        #[doc = "USB clock source selection"]
        #[inline(always)]
        pub const fn set_usbsw(&mut self, val: super::vals::Usbsw) {
        ...
        #[doc = "ADCSW is deprecated. See ADC field in CFGR2 register."]
        #[inline(always)]
        pub const fn set_adcsw(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 8usize)) | (((val as u32) & 0x01) << 8usize);
        }
    ...
    impl defmt::Format for Cfgr3 {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Cfgr3 {{ usart1sw: {:?}, i2c1sw: {:?}, cecsw: {:?}, usbsw: {:?}, adcsw: {=bool:?}, usart2sw: {:?}, usart3sw: {:?} }}",
                self.usart1sw(),
                self.i2c1sw(),
                self.cecsw(),
                self.usbsw(),
    ...
    impl Cir {
        ...
        #[doc = "HSI14 ready interrupt flag"]
        #[inline(always)]
        pub const fn set_hsi14rdyf(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 5usize)) | (((val as u32) & 0x01) << 5usize);
        }
        ...
        #[doc = "HSI14 ready interrupt enable"]
        #[inline(always)]
        pub const fn set_hsi14rdyie(&mut self, val: bool) {
        ...
        #[doc = "HSI 14 MHz Ready Interrupt Clear"]
        #[inline(always)]
        pub const fn set_hsi14rdyc(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 21usize)) | (((val as u32) & 0x01) << 21usize);
        }
    ...
    impl defmt::Format for Cir {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Cir {{ lsirdyf: {=bool:?}, lserdyf: {=bool:?}, hsirdyf: {=bool:?}, hserdyf: {=bool:?}, pllrdyf: {=bool:?}, hsi14rdyf: {=bool:?}, cssf: {=bool:?}, lsirdyie: {=bool:?}, lserdyie: {=bool:?}, hsirdyie: {=bool:?}, hserdyie: {=bool:?}, pllrdyie: {=bool:?}, hsi14rdyie: {=bool:?}, lsirdyc: {=bool:?}, lserdyc: {=bool:?}, hsirdyc: {=bool:?}, hserdyc: {=bool:?}, pllrdyc: {=bool:?}, hsi14rdyc: {=bool:?}, cssc: {=bool:?} }}",
                self.lsirdyf(),
                self.lserdyf(),
                self.hsirdyf(),
                self.hserdyf(),
    ...
    impl Cr2 {
        ...
        #[doc = "HSI14 clock enable"]
        #[inline(always)]
        pub const fn set_hsi14on(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 0usize)) | (((val as u32) & 0x01) << 0usize);
        }
        ...
        #[doc = "HR14 clock ready flag"]
        #[inline(always)]
        pub const fn set_hsi14rdy(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 1usize)) | (((val as u32) & 0x01) << 1usize);
        }
        ...
        #[doc = "HSI14 clock request from ADC disable"]
        #[inline(always)]
        pub const fn set_hsi14dis(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 2usize)) | (((val as u32) & 0x01) << 2usize);
        }
        ...
        #[doc = "HSI14 clock trimming"]
        #[inline(always)]
        pub const fn set_hsi14trim(&mut self, val: u8) {
            self.0 = (self.0 & !(0x1f << 3usize)) | (((val as u32) & 0x1f) << 3usize);
        }
        ...
        #[doc = "HSI14 clock calibration"]
        #[inline(always)]
        pub const fn set_hsi14cal(&mut self, val: u8) {
            self.0 = (self.0 & !(0xff << 8usize)) | (((val as u32) & 0xff) << 8usize);
        }
    }
    ...
    impl defmt::Format for Cr2 {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Cr2 {{ hsi14on: {=bool:?}, hsi14rdy: {=bool:?}, hsi14dis: {=bool:?}, hsi14trim: {=u8:?}, hsi14cal: {=u8:?} }}",
                self.hsi14on(),
                self.hsi14rdy(),
                self.hsi14dis(),
                self.hsi14trim(),
