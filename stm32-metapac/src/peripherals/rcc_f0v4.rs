...
# [inline (always)]
pub fn set_hsi48cal (& mut self , val : u8) { self . 0 = (self . 0 & ! (0xff << 24usize)) | (((val as u32) & 0xff) << 24usize) ; } } impl Default for Cr2 { # [inline (always)]
...
PLL = 0x07 , # [doc = "Internal RC 48 MHz (HSI48) oscillator clock selected"]
...
HSE_DIV_PREDIV = 0x02 , # [doc = "HSI48 divided by PREDIV selected as PLL input clock"]
HSI48_DIV_PREDIV = 0x03 , } impl Pllsrc { # [inline (always)]
...
PLL1_P = 0x02 , # [doc = "HSI48 used as system clock"]
HSI48 = 0x03 , } impl Sw { # [inline (always)]
...
# [derive (Copy , Clone , Eq , PartialEq , Ord , PartialOrd)]
pub enum Usbsw { # [doc = "HSI48 selected as USB clock source"]
HSI48 = 0x0 , # [doc = "PLL clock selected as USB clock source"]
