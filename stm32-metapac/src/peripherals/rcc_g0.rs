    ...
    impl defmt::Format for Apbsmenr1 {
        fn format(&self, f: defmt::Formatter) {
            ...
            let proxy = Apbsmenr1 {
                ...
                cecsmen: self.cecsmen(),
                ucpd1smen: self.ucpd1smen(),
                ucpd2smen: self.ucpd2smen(),
    ...
    impl defmt::Format for Ccipr {
        fn format(&self, f: defmt::Formatter) {
            ...
            struct Ccipr {
                ...
                i2c2i2s1sel: super::vals::I2c2i2s1sel,
