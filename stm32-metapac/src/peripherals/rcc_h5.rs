...
pub mod regs {
    ...
    impl defmt::Format for Ahb1enr {
        fn format(&self, f: defmt::Formatter) {
            ...
            let proxy = Ahb1enr {
                ...
                tzsc1en: self.tzsc1en(),
                bkpramen: self.bkpramen(),
                dcacheen: self.dcacheen(),
    ...
    impl defmt::Format for Ahb2lpenr {
        fn format(&self, f: defmt::Formatter) {
            ...
            let proxy = Ahb2lpenr {
                ...
                dcmi_pssilpen: self.dcmi_pssilpen(),
    ...
    impl defmt::Format for Ahb2rstr {
        fn format(&self, f: defmt::Formatter) {
            ...
            let proxy = Ahb2rstr {
                ...
                dcmi_pssirst: self.dcmi_pssirst(),
                aesrst: self.aesrst(),
    ...
    impl defmt::Format for Apb1llpenr {
        fn format(&self, f: defmt::Formatter) {
            ...
            let proxy = Apb1llpenr {
                ...
                usart10lpen: self.usart10lpen(),
                usart11lpen: self.usart11lpen(),
    ...
    impl defmt::Format for Ccipr1 {
        fn format(&self, f: defmt::Formatter) {
            ...
            struct Ccipr1 {
                ...
                uart7sel: super::vals::Usartsel,
                uart8sel: super::vals::Usartsel,
                uart9sel: super::vals::Usartsel,
                usart10sel: super::vals::Usartsel,
            ...
            let proxy = Ccipr1 {
                ...
                uart9sel: self.uart9sel(),
                usart10sel: self.usart10sel(),
    ...
    impl defmt::Format for Ccipr2 {
        fn format(&self, f: defmt::Formatter) {
            #[derive(defmt :: Format)]
            struct Ccipr2 {
                usart11sel: super::vals::Usartsel,
                usart12sel: super::vals::Usartsel,
                lptim1sel: super::vals::Lptimsel,
                lptim2sel: super::vals::Lptim2sel,
                lptim3sel: super::vals::Lptimsel,
                lptim4sel: super::vals::Lptimsel,
                lptim5sel: super::vals::Lptimsel,
                lptim6sel: super::vals::Lptimsel,
            }
            let proxy = Ccipr2 {
                usart11sel: self.usart11sel(),
                usart12sel: self.usart12sel(),
                lptim1sel: self.lptim1sel(),
                lptim2sel: self.lptim2sel(),
                lptim3sel: self.lptim3sel(),
                lptim4sel: self.lptim4sel(),
                lptim5sel: self.lptim5sel(),
                lptim6sel: self.lptim6sel(),
            };
            defmt::write!(f, "{}", proxy)
        }
    }
    ...
    impl defmt::Format for Ccipr3 {
        fn format(&self, f: defmt::Formatter) {
            ...
            struct Ccipr3 {
                ...
                spi4sel: super::vals::Spi4sel,
                spi5sel: super::vals::Spi5sel,
            ...
            let proxy = Ccipr3 {
                ...
                spi4sel: self.spi4sel(),
                spi5sel: self.spi5sel(),
    ...
    impl defmt::Format for Ccipr4 {
        fn format(&self, f: defmt::Formatter) {
            ...
            struct Ccipr4 {
                ...
                i2c3sel: super::vals::I2c34sel,
                i2c4sel: super::vals::I2c34sel,
