...
pub mod regs {
    ...
    impl defmt::Format for Ahb3lpenr {
        fn format(&self, f: defmt::Formatter) {
            ...
            let proxy = Ahb3lpenr {
                ...
                octospi1lpen: self.octospi1lpen(),
    ...
    impl defmt::Format for D2ccip1r {
        fn format(&self, f: defmt::Formatter) {
            ...
            struct D2ccip1r {
                ...
                sai2asel: super::vals::Saiasel,
                sai2bsel: super::vals::Saiasel,
            ...
            let proxy = D2ccip1r {
                ...
                sai2asel: self.sai2asel(),
                sai2bsel: self.sai2bsel(),
    ...
    impl defmt::Format for Gcr {
        fn format(&self, f: defmt::Formatter) {
            ...
            let proxy = Gcr { ww1rsc: self.ww1rsc() };
            defmt::write!(f, "{}", proxy)
        }
    }
    #[doc = "RCC HSI configuration register"]
