...
# [inline (always)]
pub fn set_eth1rxen (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 17usize)) | (((val as u32) & 0x01) << 17usize) ; } # [doc = "USB_OTG_HS Peripheral Clocks Enable"]
# [inline (always)]
...
# [inline (always)]
pub fn set_eth1rxlpen (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 17usize)) | (((val as u32) & 0x01) << 17usize) ; } # [doc = "USB_OTG_HS peripheral clock enable during CSleep mode"]
# [inline (always)]
...
# [inline (always)]
pub fn set_eth1macrst (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 15usize)) | (((val as u32) & 0x01) << 15usize) ; } # [doc = "USB_OTG_HS block reset"]
# [inline (always)]
...
# [inline (always)]
pub fn set_octospisel (& mut self , val : super :: vals :: Fmcsel) { self . 0 = (self . 0 & ! (0x03 << 4usize)) | (((val . to_bits () as u32) & 0x03) << 4usize) ; } # [doc = "kernel clock source selection"]
# [inline (always)]
