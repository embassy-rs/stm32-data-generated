...
impl Rcc {
    ...
    #[inline(always)]
    pub const fn pllsai2cfgr(self) -> crate::common::Reg<regs::Pllsai2cfgr, crate::common::RW> {
...
pub mod regs {
    ...
    impl Ccipr {
        ...
        #[inline(always)]
        pub const fn swpmi1sel(&self) -> bool {
            let val = (self.0 >> 30usize) & 0x01;
            val != 0
        }
        #[doc = "SWPMI1 clock source selection"]
        #[inline(always)]
        pub fn set_swpmi1sel(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 30usize)) | (((val as u32) & 0x01) << 30usize);
        }
    ...
    impl Ccipr2 {
        ...
        #[inline(always)]
        pub const fn pllsai2divr(&self) -> u8 {
            let val = (self.0 >> 16usize) & 0x03;
            val as u8
        }
        #[doc = "division factor for LTDC clock"]
        #[inline(always)]
        pub fn set_pllsai2divr(&mut self, val: u8) {
            self.0 = (self.0 & !(0x03 << 16usize)) | (((val as u32) & 0x03) << 16usize);
        }
    ...
    impl Pllsai1cfgr {
        ...
        #[inline(always)]
        pub const fn pllsai1m(&self) -> u8 {
            let val = (self.0 >> 4usize) & 0x0f;
            val as u8
        }
        #[doc = "Division factor for PLLSAI1 input clock"]
        #[inline(always)]
        pub fn set_pllsai1m(&mut self, val: u8) {
            self.0 = (self.0 & !(0x0f << 4usize)) | (((val as u32) & 0x0f) << 4usize);
        }
        #[doc = "SAI1PLL multiplication factor for VCO"]
        #[inline(always)]
        pub const fn pllsai1n(&self) -> u8 {
            let val = (self.0 >> 8usize) & 0x7f;
            val as u8
        }
        #[doc = "SAI1PLL multiplication factor for VCO"]
        #[inline(always)]
        pub fn set_pllsai1n(&mut self, val: u8) {
            self.0 = (self.0 & !(0x7f << 8usize)) | (((val as u32) & 0x7f) << 8usize);
        }
        #[doc = "SAI1PLL PLLSAI1CLK output enable"]
        #[inline(always)]
        pub const fn pllsai1pen(&self) -> bool {
            let val = (self.0 >> 16usize) & 0x01;
            val != 0
        }
        #[doc = "SAI1PLL PLLSAI1CLK output enable"]
        #[inline(always)]
        pub fn set_pllsai1pen(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 16usize)) | (((val as u32) & 0x01) << 16usize);
        }
        #[doc = "SAI1PLL division factor for PLLSAI1CLK (SAI1 or SAI2 clock)"]
        #[inline(always)]
        pub const fn pllsai1p(&self) -> bool {
            let val = (self.0 >> 17usize) & 0x01;
            val != 0
        }
        #[doc = "SAI1PLL division factor for PLLSAI1CLK (SAI1 or SAI2 clock)"]
        #[inline(always)]
        pub fn set_pllsai1p(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 17usize)) | (((val as u32) & 0x01) << 17usize);
        }
        #[doc = "SAI1PLL PLLUSB2CLK output enable"]
        #[inline(always)]
        pub const fn pllsai1qen(&self) -> bool {
            let val = (self.0 >> 20usize) & 0x01;
            val != 0
        }
        #[doc = "SAI1PLL PLLUSB2CLK output enable"]
        #[inline(always)]
        pub fn set_pllsai1qen(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 20usize)) | (((val as u32) & 0x01) << 20usize);
        }
        #[doc = "SAI1PLL division factor for PLLUSB2CLK (48 MHz clock)"]
        #[inline(always)]
        pub const fn pllsai1q(&self) -> u8 {
            let val = (self.0 >> 21usize) & 0x03;
            val as u8
        }
        #[doc = "SAI1PLL division factor for PLLUSB2CLK (48 MHz clock)"]
        #[inline(always)]
        pub fn set_pllsai1q(&mut self, val: u8) {
            self.0 = (self.0 & !(0x03 << 21usize)) | (((val as u32) & 0x03) << 21usize);
        }
        #[doc = "PLLSAI1 PLLADC1CLK output enable"]
        #[inline(always)]
        pub const fn pllsai1ren(&self) -> bool {
            let val = (self.0 >> 24usize) & 0x01;
            val != 0
        }
        #[doc = "PLLSAI1 PLLADC1CLK output enable"]
        #[inline(always)]
        pub fn set_pllsai1ren(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 24usize)) | (((val as u32) & 0x01) << 24usize);
        }
        #[doc = "PLLSAI1 division factor for PLLADC1CLK (ADC clock)"]
        #[inline(always)]
        pub const fn pllsai1r(&self) -> u8 {
            let val = (self.0 >> 25usize) & 0x03;
            val as u8
        }
        #[doc = "PLLSAI1 division factor for PLLADC1CLK (ADC clock)"]
        #[inline(always)]
        pub fn set_pllsai1r(&mut self, val: u8) {
            self.0 = (self.0 & !(0x03 << 25usize)) | (((val as u32) & 0x03) << 25usize);
        }
        #[doc = "PLLSAI1 division factor for PLLSAI1CLK"]
        #[inline(always)]
        pub const fn pllsai1pdiv(&self) -> u8 {
            let val = (self.0 >> 27usize) & 0x1f;
            val as u8
        }
        #[doc = "PLLSAI1 division factor for PLLSAI1CLK"]
        #[inline(always)]
        pub fn set_pllsai1pdiv(&mut self, val: u8) {
            self.0 = (self.0 & !(0x1f << 27usize)) | (((val as u32) & 0x1f) << 27usize);
        }
    }
    ...
    impl Pllsai2cfgr {
        ...
        #[inline(always)]
        pub const fn pllsai2m(&self) -> u8 {
            let val = (self.0 >> 4usize) & 0x0f;
            val as u8
        }
        #[doc = "Division factor for PLLSAI2 input clock"]
        #[inline(always)]
        pub fn set_pllsai2m(&mut self, val: u8) {
            self.0 = (self.0 & !(0x0f << 4usize)) | (((val as u32) & 0x0f) << 4usize);
        }
        #[doc = "SAI2PLL multiplication factor for VCO"]
        #[inline(always)]
        pub const fn pllsai2n(&self) -> u8 {
            let val = (self.0 >> 8usize) & 0x7f;
            val as u8
        }
        #[doc = "SAI2PLL multiplication factor for VCO"]
        #[inline(always)]
        pub fn set_pllsai2n(&mut self, val: u8) {
            self.0 = (self.0 & !(0x7f << 8usize)) | (((val as u32) & 0x7f) << 8usize);
        }
        #[doc = "SAI2PLL PLLSAI2CLK output enable"]
        #[inline(always)]
        pub const fn pllsai2pen(&self) -> bool {
            let val = (self.0 >> 16usize) & 0x01;
            val != 0
        }
        #[doc = "SAI2PLL PLLSAI2CLK output enable"]
        #[inline(always)]
        pub fn set_pllsai2pen(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 16usize)) | (((val as u32) & 0x01) << 16usize);
        }
        #[doc = "SAI1PLL division factor for PLLSAI2CLK (SAI1 or SAI2 clock)"]
        #[inline(always)]
        pub const fn pllsai2p(&self) -> bool {
            let val = (self.0 >> 17usize) & 0x01;
            val != 0
        }
        #[doc = "SAI1PLL division factor for PLLSAI2CLK (SAI1 or SAI2 clock)"]
        #[inline(always)]
        pub fn set_pllsai2p(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 17usize)) | (((val as u32) & 0x01) << 17usize);
        }
        #[doc = "PLLSAI2 division factor for PLLDISCLK"]
        #[inline(always)]
        pub const fn pllsai2qen(&self) -> bool {
            let val = (self.0 >> 20usize) & 0x01;
            val != 0
        }
        #[doc = "PLLSAI2 division factor for PLLDISCLK"]
        #[inline(always)]
        pub fn set_pllsai2qen(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 20usize)) | (((val as u32) & 0x01) << 20usize);
        }
        #[doc = "SAI2PLL PLLSAI2CLK output enable"]
        #[inline(always)]
        pub const fn pllsai2q(&self) -> u8 {
            let val = (self.0 >> 21usize) & 0x03;
            val as u8
        }
        #[doc = "SAI2PLL PLLSAI2CLK output enable"]
        #[inline(always)]
        pub fn set_pllsai2q(&mut self, val: u8) {
            self.0 = (self.0 & !(0x03 << 21usize)) | (((val as u32) & 0x03) << 21usize);
        }
        #[doc = "PLLSAI2 PLLADC2CLK output enable"]
        #[inline(always)]
        pub const fn pllsai2ren(&self) -> bool {
            let val = (self.0 >> 24usize) & 0x01;
            val != 0
        }
        #[doc = "PLLSAI2 PLLADC2CLK output enable"]
        #[inline(always)]
        pub fn set_pllsai2ren(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 24usize)) | (((val as u32) & 0x01) << 24usize);
        }
        #[doc = "PLLSAI2 division factor for PLLADC2CLK (ADC clock)"]
        #[inline(always)]
        pub const fn pllsai2r(&self) -> u8 {
            let val = (self.0 >> 25usize) & 0x03;
            val as u8
        }
        #[doc = "PLLSAI2 division factor for PLLADC2CLK (ADC clock)"]
        #[inline(always)]
        pub fn set_pllsai2r(&mut self, val: u8) {
            self.0 = (self.0 & !(0x03 << 25usize)) | (((val as u32) & 0x03) << 25usize);
        }
        #[doc = "PLLSAI2 division factor for PLLSAI2CLK"]
        #[inline(always)]
        pub const fn pllsai2pdiv(&self) -> u8 {
            let val = (self.0 >> 27usize) & 0x1f;
            val as u8
        }
        #[doc = "PLLSAI2 division factor for PLLSAI2CLK"]
        #[inline(always)]
        pub fn set_pllsai2pdiv(&mut self, val: u8) {
            self.0 = (self.0 & !(0x1f << 27usize)) | (((val as u32) & 0x1f) << 27usize);
        }
    }
    impl Default for Pllsai2cfgr {
        #[inline(always)]
        fn default() -> Pllsai2cfgr {
            Pllsai2cfgr(0)
        }
    }
}
