...
pub mod regs {
    ...
    impl defmt::Format for Ccipr2 {
        fn format(&self, f: defmt::Formatter) {
            ...
            struct Ccipr2 {
                ...
                adfsdmsel: super::vals::Adfsdmsel,
    ...
    impl defmt::Format for Dlycfgr {
        fn format(&self, f: defmt::Formatter) {
            ...
            let proxy = Dlycfgr {
                octospi1_dly: self.octospi1_dly(),
                octospi2_dly: self.octospi2_dly(),
            };
            defmt::write!(f, "{}", proxy)
        }
    }
