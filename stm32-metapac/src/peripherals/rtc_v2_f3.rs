...
impl Rtc {
    ...
    pub const fn alrmr(self, n: usize) -> crate::common::Reg<regs::Alrmr, crate::common::RW> {
        assert!(n < 2usize);
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x1cusize + n * 4usize) as _) }
    }
    ...
    pub const fn alrmssr(self, n: usize) -> crate::common::Reg<regs::Alrmssr, crate::common::RW> {
        assert!(n < 2usize);
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x44usize + n * 4usize) as _) }
    }
    #[doc = "Backup register"]
    #[inline(always)]
...
pub mod regs {
    ...
    impl Cr {
        ...
        #[doc = "Wakeup clock selection"]
        #[inline(always)]
        pub const fn set_wucksel(&mut self, val: super::vals::Wucksel) {
    ...
    impl defmt::Format for Cr {
        fn format(&self, f: defmt::Formatter) {
            defmt :: write ! (f , "Cr {{ wucksel: {:?}, tsedge: {:?}, refckon: {=bool:?}, bypshad: {=bool:?}, fmt: {:?}, alre[0]: {=bool:?}, alre[1]: {=bool:?}, wute: {=bool:?}, tse: {=bool:?}, alrie[0]: {=bool:?}, alrie[1]: {=bool:?}, wutie: {=bool:?}, tsie: {=bool:?}, add1h: {=bool:?}, sub1h: {=bool:?}, bkp: {=bool:?}, cosel: {:?}, pol: {:?}, osel: {:?}, coe: {=bool:?} }}" , self . wucksel () , self . tsedge () , self . refckon () , self . bypshad () , self . fmt () , self . alre (0usize) , self . alre (1usize) , self . wute () , self . tse () , self . alrie (0usize) , self . alrie (1usize) , self . wutie () , self . tsie () , self . add1h () , self . sub1h () , self . bkp () , self . cosel () , self . pol () , self . osel () , self . coe ())
        }
    }
    #[doc = "Date register"]
    #[repr(transparent)]
    ...
    impl Isr {
        ...
        #[doc = "Alarm flag"]
        #[inline(always)]
        pub const fn set_alrf(&mut self, n: usize, val: bool) {
            assert!(n < 2usize);
            let offs = 8usize + n * 1usize;
            self.0 = (self.0 & !(0x01 << offs)) | (((val as u32) & 0x01) << offs);
        }
    ...
    impl defmt::Format for Isr {
        fn format(&self, f: defmt::Formatter) {
            defmt :: write ! (f , "Isr {{ alrwf[0]: {=bool:?}, alrwf[1]: {=bool:?}, wutwf: {=bool:?}, shpf: {=bool:?}, inits: {=bool:?}, rsf: {=bool:?}, initf: {=bool:?}, init: {=bool:?}, alrf[0]: {=bool:?}, alrf[1]: {=bool:?}, wutf: {=bool:?}, tsf: {=bool:?}, tsovf: {=bool:?}, tampf[0]: {=bool:?}, tampf[1]: {=bool:?}, tampf[2]: {=bool:?}, recalpf: {:?} }}" , self . alrwf (0usize) , self . alrwf (1usize) , self . wutwf () , self . shpf () , self . inits () , self . rsf () , self . initf () , self . init () , self . alrf (0usize) , self . alrf (1usize) , self . wutf () , self . tsf () , self . tsovf () , self . tampf (0usize) , self . tampf (1usize) , self . tampf (2usize) , self . recalpf ())
        }
    }
    #[doc = "Prescaler register"]
    #[repr(transparent)]
    ...
    impl Tafcr {
        ...
        #[doc = "Tamper interrupt enable"]
        #[inline(always)]
        pub const fn set_tampie(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 2usize)) | (((val as u32) & 0x01) << 2usize);
        }
        ...
        #[doc = "Tamper pull-up disable"]
        #[inline(always)]
        pub const fn set_tamppudis(&mut self, val: super::vals::Tamppudis) {
            self.0 = (self.0 & !(0x01 << 15usize)) | (((val.to_bits() as u32) & 0x01) << 15usize);
        }
        #[doc = "PC13 value"]
        #[must_use]
        #[inline(always)]
        pub const fn pc13value(&self) -> super::vals::Pcvalue {
            let val = (self.0 >> 18usize) & 0x01;
            super::vals::Pcvalue::from_bits(val as u8)
        }
        #[doc = "PC13 value"]
        #[inline(always)]
        pub const fn set_pc13value(&mut self, val: super::vals::Pcvalue) {
            self.0 = (self.0 & !(0x01 << 18usize)) | (((val.to_bits() as u32) & 0x01) << 18usize);
        }
        #[doc = "PC13 mode"]
        #[must_use]
        #[inline(always)]
        pub const fn pc13mode(&self) -> super::vals::Pcmode {
            let val = (self.0 >> 19usize) & 0x01;
            super::vals::Pcmode::from_bits(val as u8)
        }
        #[doc = "PC13 mode"]
        #[inline(always)]
        pub const fn set_pc13mode(&mut self, val: super::vals::Pcmode) {
            self.0 = (self.0 & !(0x01 << 19usize)) | (((val.to_bits() as u32) & 0x01) << 19usize);
        }
        #[doc = "PC14 value"]
        #[must_use]
        #[inline(always)]
        pub const fn pc14value(&self) -> super::vals::Pcvalue {
            let val = (self.0 >> 20usize) & 0x01;
            super::vals::Pcvalue::from_bits(val as u8)
        }
        #[doc = "PC14 value"]
        #[inline(always)]
        pub const fn set_pc14value(&mut self, val: super::vals::Pcvalue) {
            self.0 = (self.0 & !(0x01 << 20usize)) | (((val.to_bits() as u32) & 0x01) << 20usize);
        }
        #[doc = "PC14 mode"]
        #[must_use]
        #[inline(always)]
        pub const fn pc14mode(&self) -> super::vals::Pcmode {
            let val = (self.0 >> 21usize) & 0x01;
            super::vals::Pcmode::from_bits(val as u8)
        }
        #[doc = "PC14 mode"]
        #[inline(always)]
        pub const fn set_pc14mode(&mut self, val: super::vals::Pcmode) {
            self.0 = (self.0 & !(0x01 << 21usize)) | (((val.to_bits() as u32) & 0x01) << 21usize);
        }
        #[doc = "PC15 value"]
        #[must_use]
        #[inline(always)]
        pub const fn pc15value(&self) -> super::vals::Pcvalue {
            let val = (self.0 >> 22usize) & 0x01;
            super::vals::Pcvalue::from_bits(val as u8)
        }
        #[doc = "PC15 value"]
        #[inline(always)]
        pub const fn set_pc15value(&mut self, val: super::vals::Pcvalue) {
            self.0 = (self.0 & !(0x01 << 22usize)) | (((val.to_bits() as u32) & 0x01) << 22usize);
        }
        #[doc = "PC15 mode"]
        #[must_use]
        #[inline(always)]
        pub const fn pc15mode(&self) -> super::vals::Pcmode {
            let val = (self.0 >> 23usize) & 0x01;
            super::vals::Pcmode::from_bits(val as u8)
        }
        #[doc = "PC15 mode"]
        #[inline(always)]
        pub const fn set_pc15mode(&mut self, val: super::vals::Pcmode) {
            self.0 = (self.0 & !(0x01 << 23usize)) | (((val.to_bits() as u32) & 0x01) << 23usize);
        }
    }
    ...
    impl defmt::Format for Tafcr {
        fn format(&self, f: defmt::Formatter) {
            defmt :: write ! (f , "Tafcr {{ tampe[0]: {=bool:?}, tampe[1]: {=bool:?}, tamptrg[0]: {:?}, tamptrg[1]: {:?}, tampie: {=bool:?}, tampts: {=bool:?}, tampfreq: {:?}, tampflt: {:?}, tampprch: {:?}, tamppudis: {:?}, pc13value: {:?}, pc13mode: {:?}, pc14value: {:?}, pc14mode: {:?}, pc15value: {:?}, pc15mode: {:?} }}" , self . tampe (0usize) , self . tampe (1usize) , self . tamptrg (0usize) , self . tamptrg (1usize) , self . tampie () , self . tampts () , self . tampfreq () , self . tampflt () , self . tampprch () , self . tamppudis () , self . pc13value () , self . pc13mode () , self . pc14value () , self . pc14mode () , self . pc15value () , self . pc15mode ())
        }
    }
    #[doc = "Time register"]
    #[repr(transparent)]
...
is don’t care"]
    ...
    impl Pcmode {
        #[inline(always)]
        pub const fn from_bits(val: u8) -> Pcmode {
            unsafe { core::mem::transmute(val & 0x01) }
        }
        #[inline(always)]
        pub const fn to_bits(self) -> u8 {
    ...
    impl From<u8> for Pcmode {
        #[inline(always)]
        fn from(val: u8) -> Pcmode {
            Pcmode::from_bits(val)
        }
    }
    impl From<Pcmode> for u8 {
        #[inline(always)]
        fn from(val: Pcmode) -> u8 {
            Pcmode::to_bits(val)
        }
    }
    #[repr(u8)]
    ...
    impl Pcvalue {
        #[inline(always)]
        pub const fn from_bits(val: u8) -> Pcvalue {
            unsafe { core::mem::transmute(val & 0x01) }
        }
        #[inline(always)]
        pub const fn to_bits(self) -> u8 {
    ...
    impl From<u8> for Pcvalue {
        #[inline(always)]
        fn from(val: u8) -> Pcvalue {
            Pcvalue::from_bits(val)
        }
    }
    impl From<Pcvalue> for u8 {
        #[inline(always)]
        fn from(val: Pcvalue) -> u8 {
            Pcvalue::to_bits(val)
        }
    }
    #[repr(u8)]
