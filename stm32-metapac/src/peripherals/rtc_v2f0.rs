...
pub mod regs {
    ...
    impl Isr {
        #[doc = "Alarm write flag"]
        #[inline(always)]
        pub const fn alrwf(&self, n: usize) -> super::vals::Alrwf {
            assert!(n < 1usize);
            let offs = 0usize + n * 1usize;
            let val = (self.0 >> offs) & 0x01;
            super::vals::Alrwf::from_bits(val as u8)
        }
        #[doc = "Alarm write flag"]
        #[inline(always)]
        pub fn set_alrwf(&mut self, n: usize, val: super::vals::Alrwf) {
            assert!(n < 1usize);
            let offs = 0usize + n * 1usize;
    ...
    impl Tafcr {
        ...
        #[doc = "PC13 value"]
        #[inline(always)]
        pub fn set_pc13value(&mut self, val: super::vals::Pcvalue) {
        ...
        #[doc = "PC13 mode"]
        #[inline(always)]
        pub fn set_pc13mode(&mut self, val: super::vals::Pcmode) {
            self.0 = (self.0 & !(0x01 << 19usize)) | (((val.to_bits() as u32) & 0x01) << 19usize);
        }
        #[doc = "PC14 value"]
        #[inline(always)]
        ...
        #[doc = "PC14 value"]
        #[inline(always)]
        pub fn set_pc14value(&mut self, val: super::vals::Pcvalue) {
            self.0 = (self.0 & !(0x01 << 20usize)) | (((val.to_bits() as u32) & 0x01) << 20usize);
        }
        #[doc = "PC14 mode"]
        #[inline(always)]
        ...
        #[doc = "PC14 mode"]
        #[inline(always)]
        pub fn set_pc14mode(&mut self, val: super::vals::Pcmode) {
        ...
        #[doc = "PC15 value"]
        #[inline(always)]
        pub fn set_pc15value(&mut self, val: super::vals::Pcvalue) {
            self.0 = (self.0 & !(0x01 << 22usize)) | (((val.to_bits() as u32) & 0x01) << 22usize);
        }
        #[doc = "PC15 mode"]
        #[inline(always)]
        ...
        #[doc = "PC15 mode"]
        #[inline(always)]
        pub fn set_pc15mode(&mut self, val: super::vals::Pcmode) {
            self.0 = (self.0 & !(0x01 << 23usize)) | (((val.to_bits() as u32) & 0x01) << 23usize);
        }
    }
...
is don’t care"]
    ...
    impl Alrwf {
        #[inline(always)]
        pub const fn from_bits(val: u8) -> Alrwf {
            unsafe { core::mem::transmute(val & 0x01) }
        }
        #[inline(always)]
        pub const fn to_bits(self) -> u8 {
    ...
    impl From<u8> for Alrwf {
        #[inline(always)]
        fn from(val: u8) -> Alrwf {
            Alrwf::from_bits(val)
        }
    }
    impl From<Alrwf> for u8 {
        #[inline(always)]
        fn from(val: Alrwf) -> u8 {
            Alrwf::to_bits(val)
        }
    }
    #[repr(u8)]
