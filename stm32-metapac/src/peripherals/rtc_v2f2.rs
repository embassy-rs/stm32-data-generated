...
# [inline (always)]
pub const fn wutr (self) -> crate :: common :: Reg < regs :: Wutr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x14usize) as _) } } # [doc = "Calibration register"]
# [inline (always)]
pub const fn calibr (self) -> crate :: common :: Reg < regs :: Calibr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x18usize) as _) } } # [doc = "Alarm register"]
# [inline (always)]
...
# [inline (always)]
pub const fn wpr (self) -> crate :: common :: Reg < regs :: Wpr , crate :: common :: W > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x24usize) as _) } } # [doc = "Timestamp time register"]
# [inline (always)]
...
# [inline (always)]
pub const fn tsdr (self) -> crate :: common :: Reg < regs :: Tsdr , crate :: common :: R > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x34usize) as _) } } # [doc = "Tamper and alternate function configuration register"]
# [inline (always)]
pub const fn tafcr (self) -> crate :: common :: Reg < regs :: Tafcr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x40usize) as _) } } # [doc = "Backup register"]
# [inline (always)]
pub const fn bkpr (self , n : usize) -> crate :: common :: Reg < regs :: Bkpr , crate :: common :: RW > { assert ! (n < 20usize) ; unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x50usize + n * 4usize) as _) } } } pub mod regs { # [doc = "Alarm register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Alrmr { Alrmr (0) } } # [doc = "Backup register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
pub struct Calibr (pub u32) ; impl Calibr { # [doc = "Digital calibration"]
# [inline (always)]
pub const fn dc (& self) -> u8 { let val = (self . 0 >> 0usize) & 0x1f ; val as u8 } # [doc = "Digital calibration"]
# [inline (always)]
pub fn set_dc (& mut self , val : u8) { self . 0 = (self . 0 & ! (0x1f << 0usize)) | (((val as u32) & 0x1f) << 0usize) ; } # [doc = "Digital calibration sign"]
# [inline (always)]
pub const fn dcs (& self) -> bool { let val = (self . 0 >> 7usize) & 0x01 ; val != 0 } # [doc = "Digital calibration sign"]
# [inline (always)]
pub fn set_dcs (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 7usize)) | (((val as u32) & 0x01) << 7usize) ; } } impl Default for Calibr { # [inline (always)]
fn default () -> Calibr { Calibr (0) } } # [doc = "Control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
# [inline (always)]
pub fn set_refckon (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 4usize)) | (((val as u32) & 0x01) << 4usize) ; } # [doc = "Hour format"]
# [inline (always)]
pub const fn fmt (& self) -> bool { let val = (self . 0 >> 6usize) & 0x01 ; val != 0 } # [doc = "Hour format"]
# [inline (always)]
pub fn set_fmt (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 6usize)) | (((val as u32) & 0x01) << 6usize) ; } # [doc = "Coarse digital calibration enable"]
# [inline (always)]
pub const fn dce (& self) -> bool { let val = (self . 0 >> 7usize) & 0x01 ; val != 0 } # [doc = "Coarse digital calibration enable"]
# [inline (always)]
pub fn set_dce (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 7usize)) | (((val as u32) & 0x01) << 7usize) ; } # [doc = "Alarm enable"]
# [inline (always)]
...
# [inline (always)]
pub fn set_bkp (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 18usize)) | (((val as u32) & 0x01) << 18usize) ; } # [doc = "Output polarity"]
# [inline (always)]
...
# [inline (always)]
pub fn set_wutwf (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 2usize)) | (((val as u32) & 0x01) << 2usize) ; } # [doc = "Initialization status flag"]
# [inline (always)]
...
# [inline (always)]
pub const fn tampf (& self , n : usize) -> bool { assert ! (n < 1usize) ; let offs = 13usize + n * 1usize ; let val = (self . 0 >> offs) & 0x01 ; val != 0 } # [doc = "Tamper detection flag"]
# [inline (always)]
pub fn set_tampf (& mut self , n : usize , val : bool) { assert ! (n < 1usize) ; let offs = 13usize + n * 1usize ; self . 0 = (self . 0 & ! (0x01 << offs)) | (((val as u32) & 0x01) << offs) ; } } impl Default for Isr { # [inline (always)]
...
fn default () -> Prer { Prer (0) } } # [doc = "Tamper and alternate function configuration register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
pub struct Tafcr (pub u32) ; impl Tafcr { # [doc = "Tamper detection enable"]
# [inline (always)]
pub const fn tampe (& self , n : usize) -> bool { assert ! (n < 1usize) ; let offs = 0usize + ([0usize]
[n]
as usize) ; let val = (self . 0 >> offs) & 0x01 ; val != 0 } # [doc = "Tamper detection enable"]
# [inline (always)]
pub fn set_tampe (& mut self , n : usize , val : bool) { assert ! (n < 1usize) ; let offs = 0usize + ([0usize]
[n]
as usize) ; self . 0 = (self . 0 & ! (0x01 << offs)) | (((val as u32) & 0x01) << offs) ; } # [doc = "Active level for tamper"]
# [inline (always)]
pub const fn tamptrg (& self , n : usize) -> super :: vals :: Tamptrg { assert ! (n < 1usize) ; let offs = 1usize + ([0usize]
[n]
as usize) ; let val = (self . 0 >> offs) & 0x01 ; super :: vals :: Tamptrg :: from_bits (val as u8) } # [doc = "Active level for tamper"]
# [inline (always)]
pub fn set_tamptrg (& mut self , n : usize , val : super :: vals :: Tamptrg) { assert ! (n < 1usize) ; let offs = 1usize + ([0usize]
[n]
...
# [inline (always)]
pub fn set_tampie (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 2usize)) | (((val as u32) & 0x01) << 2usize) ; } # [doc = "Tamper 1 mapping"]
# [inline (always)]
pub const fn tamp1insel (& self) -> bool { let val = (self . 0 >> 16usize) & 0x01 ; val != 0 } # [doc = "Tamper 1 mapping"]
# [inline (always)]
pub fn set_tamp1insel (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 16usize)) | (((val as u32) & 0x01) << 16usize) ; } # [doc = "Timestamp mapping"]
# [inline (always)]
pub const fn tsinsel (& self) -> bool { let val = (self . 0 >> 17usize) & 0x01 ; val != 0 } # [doc = "Timestamp mapping"]
# [inline (always)]
pub fn set_tsinsel (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 17usize)) | (((val as u32) & 0x01) << 17usize) ; } # [doc = "AFO_ALARM output type"]
# [inline (always)]
pub const fn alarmouttype (& self) -> bool { let val = (self . 0 >> 18usize) & 0x01 ; val != 0 } # [doc = "AFO_ALARM output type"]
# [inline (always)]
pub fn set_alarmouttype (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 18usize)) | (((val as u32) & 0x01) << 18usize) ; } } impl Default for Tafcr { # [inline (always)]
...
fn default () -> Tsdr { Tsdr (0) } } # [doc = "Timestamp time register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
