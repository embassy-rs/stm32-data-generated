...
fn default () -> Calibr { Calibr (0) } } # [doc = "Calibration register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
# [inline (always)]
pub fn set_fmt (& mut self , val : super :: vals :: Fmt) { self . 0 = (self . 0 & ! (0x01 << 6usize)) | (((val . to_bits () as u32) & 0x01) << 6usize) ; } # [doc = "Coarse digital calibration enable"]
# [inline (always)]
...
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
pub struct Isr (pub u32) ; impl Isr { # [doc = "Alarm write allowed"]
# [inline (always)]
pub const fn alrwf (& self , n : usize) -> bool { assert ! (n < 2usize) ; let offs = 0usize + n * 1usize ; let val = (self . 0 >> offs) & 0x01 ; val != 0 } # [doc = "Alarm write allowed"]
# [inline (always)]
pub fn set_alrwf (& mut self , n : usize , val : bool) { assert ! (n < 2usize) ; let offs = 0usize + n * 1usize ; self . 0 = (self . 0 & ! (0x01 << offs)) | (((val as u32) & 0x01) << offs) ; } # [doc = "Wakeup timer write allowed"]
# [inline (always)]
pub const fn wutwf (& self) -> bool { let val = (self . 0 >> 2usize) & 0x01 ; val != 0 } # [doc = "Wakeup timer write allowed"]
# [inline (always)]
...
# [inline (always)]
pub fn set_tamppudis (& mut self , val : super :: vals :: Tamppudis) { self . 0 = (self . 0 & ! (0x01 << 15usize)) | (((val . to_bits () as u32) & 0x01) << 15usize) ; } # [doc = "Tamper 1 mapping"]
# [inline (always)]
