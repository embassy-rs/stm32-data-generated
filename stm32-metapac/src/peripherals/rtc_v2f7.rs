...
# [inline (always)]
pub const fn calr (self) -> crate :: common :: Reg < regs :: Calr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x3cusize) as _) } } # [doc = "Tamper configuration register"]
# [inline (always)]
pub const fn tampcr (self) -> crate :: common :: Reg < regs :: Tampcr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x40usize) as _) } } # [doc = "Alarm sub second register"]
# [inline (always)]
pub const fn alrmssr (self , n : usize) -> crate :: common :: Reg < regs :: Alrmssr , crate :: common :: RW > { assert ! (n < 2usize) ; unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x44usize + n * 4usize) as _) } } # [doc = "Option register"]
# [inline (always)]
pub const fn or (self) -> crate :: common :: Reg < regs :: Or , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x4cusize) as _) } } # [doc = "Backup register"]
# [inline (always)]
...
# [inline (always)]
pub fn set_itse (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 24usize)) | (((val as u32) & 0x01) << 24usize) ; } } impl Default for Cr { # [inline (always)]
...
# [inline (always)]
pub fn set_recalpf (& mut self , val : super :: vals :: Recalpf) { self . 0 = (self . 0 & ! (0x01 << 16usize)) | (((val . to_bits () as u32) & 0x01) << 16usize) ; } # [doc = "Internal time-stamp flag"]
# [inline (always)]
pub const fn itsf (& self) -> bool { let val = (self . 0 >> 17usize) & 0x01 ; val != 0 } # [doc = "Internal time-stamp flag"]
# [inline (always)]
pub fn set_itsf (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 17usize)) | (((val as u32) & 0x01) << 17usize) ; } } impl Default for Isr { # [inline (always)]
fn default () -> Isr { Isr (0) } } # [doc = "Option register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
pub struct Or (pub u32) ; impl Or { # [doc = "Timestamp mapping"]
# [inline (always)]
pub const fn tsinsel (& self) -> u8 { let val = (self . 0 >> 1usize) & 0x03 ; val as u8 } # [doc = "Timestamp mapping"]
# [inline (always)]
pub fn set_tsinsel (& mut self , val : u8) { self . 0 = (self . 0 & ! (0x03 << 1usize)) | (((val as u32) & 0x03) << 1usize) ; } # [doc = "RTC_ALARM on PC13 output type"]
# [inline (always)]
pub const fn rtc_alarm_type (& self) -> bool { let val = (self . 0 >> 3usize) & 0x01 ; val != 0 } # [doc = "RTC_ALARM on PC13 output type"]
# [inline (always)]
pub fn set_rtc_alarm_type (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 3usize)) | (((val as u32) & 0x01) << 3usize) ; } } impl Default for Or { # [inline (always)]
fn default () -> Or { Or (0) } } # [doc = "Prescaler register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ssr { Ssr (0) } } # [doc = "Tamper configuration register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
pub struct Tampcr (pub u32) ; impl Tampcr { # [doc = "Tamper detection enable"]
# [inline (always)]
pub const fn tampe (& self , n : usize) -> bool { assert ! (n < 3usize) ; let offs = 0usize + ([0usize , 3usize , 5usize]
[n]
as usize) ; let val = (self . 0 >> offs) & 0x01 ; val != 0 } # [doc = "Tamper detection enable"]
# [inline (always)]
pub fn set_tampe (& mut self , n : usize , val : bool) { assert ! (n < 3usize) ; let offs = 0usize + ([0usize , 3usize , 5usize]
[n]
as usize) ; self . 0 = (self . 0 & ! (0x01 << offs)) | (((val as u32) & 0x01) << offs) ; } # [doc = "Active level for tamper"]
# [inline (always)]
pub const fn tamptrg (& self , n : usize) -> super :: vals :: Tamptrg { assert ! (n < 3usize) ; let offs = 1usize + ([0usize , 3usize , 5usize]
[n]
as usize) ; let val = (self . 0 >> offs) & 0x01 ; super :: vals :: Tamptrg :: from_bits (val as u8) } # [doc = "Active level for tamper"]
# [inline (always)]
pub fn set_tamptrg (& mut self , n : usize , val : super :: vals :: Tamptrg) { assert ! (n < 3usize) ; let offs = 1usize + ([0usize , 3usize , 5usize]
[n]
...
# [inline (always)]
pub fn set_tamppudis (& mut self , val : super :: vals :: Tamppudis) { self . 0 = (self . 0 & ! (0x01 << 15usize)) | (((val . to_bits () as u32) & 0x01) << 15usize) ; } # [doc = "Tamper interrupt enable"]
# [inline (always)]
pub const fn tampxie (& self , n : usize) -> bool { assert ! (n < 3usize) ; let offs = 16usize + n * 3usize ; let val = (self . 0 >> offs) & 0x01 ; val != 0 } # [doc = "Tamper interrupt enable"]
# [inline (always)]
pub fn set_tampxie (& mut self , n : usize , val : bool) { assert ! (n < 3usize) ; let offs = 16usize + n * 3usize ; self . 0 = (self . 0 & ! (0x01 << offs)) | (((val as u32) & 0x01) << offs) ; } # [doc = "Tamper no erase"]
# [inline (always)]
pub const fn tampxnoerase (& self , n : usize) -> bool { assert ! (n < 3usize) ; let offs = 17usize + n * 3usize ; let val = (self . 0 >> offs) & 0x01 ; val != 0 } # [doc = "Tamper no erase"]
# [inline (always)]
pub fn set_tampxnoerase (& mut self , n : usize , val : bool) { assert ! (n < 3usize) ; let offs = 17usize + n * 3usize ; self . 0 = (self . 0 & ! (0x01 << offs)) | (((val as u32) & 0x01) << offs) ; } # [doc = "Tamper mask flag"]
# [inline (always)]
pub const fn tampxmf (& self , n : usize) -> bool { assert ! (n < 3usize) ; let offs = 18usize + n * 3usize ; let val = (self . 0 >> offs) & 0x01 ; val != 0 } # [doc = "Tamper mask flag"]
# [inline (always)]
pub fn set_tampxmf (& mut self , n : usize , val : bool) { assert ! (n < 3usize) ; let offs = 18usize + n * 3usize ; self . 0 = (self . 0 & ! (0x01 << offs)) | (((val as u32) & 0x01) << offs) ; } } impl Default for Tampcr { # [inline (always)]
fn default () -> Tampcr { Tampcr (0) } } # [doc = "Time register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
