...
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
pub struct Or (pub u32) ; impl Or { # [doc = "RTC_ALARM output type on PC13"]
# [inline (always)]
pub const fn rtc_alarm_type (& self) -> bool { let val = (self . 0 >> 0usize) & 0x01 ; val != 0 } # [doc = "RTC_ALARM output type on PC13"]
# [inline (always)]
