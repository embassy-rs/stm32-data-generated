...
# [inline (always)]
pub fn set_rtc_alarm_type (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 0usize)) | (((val as u32) & 0x01) << 0usize) ; } # [doc = "RTC_ALARM on PC13 output type"]
# [inline (always)]
pub const fn rtc_out_rmp (& self) -> bool { let val = (self . 0 >> 1usize) & 0x01 ; val != 0 } # [doc = "RTC_ALARM on PC13 output type"]
# [inline (always)]
pub fn set_rtc_out_rmp (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 1usize)) | (((val as u32) & 0x01) << 1usize) ; } } impl Default for Or { # [inline (always)]
