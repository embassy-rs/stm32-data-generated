...
pub mod regs {
    ...
    impl Confchr1 {
        ...
        #[doc = "CONFCH0."]
        #[inline(always)]
        pub const fn set_confch(&mut self, n: usize, val: u8) {
            assert!(n < 8usize);
            let offs = 0usize + n * 4usize;
    ...
    impl Confr {
        ...
        #[doc = "Single-ended mode for configuration 0."]
        #[inline(always)]
        pub const fn set_se(&mut self, val: u8) {
        ...
        #[doc = "Common mode for configuration 0."]
        #[inline(always)]
        pub const fn set_common(&mut self, val: u8) {
    ...
    impl Cr1 {
        ...
        #[doc = "Reference voltage selection."]
        #[inline(always)]
        pub const fn set_refv(&mut self, val: u8) {
        ...
        #[doc = "Slow clock mode enable."]
        #[inline(always)]
        pub const fn set_slowck(&mut self, val: bool) {
        ...
        #[doc = "Enter Standby mode when idle."]
        #[inline(always)]
        pub const fn set_sbi(&mut self, val: bool) {
    ...
    impl Cr2 {
        ...
        #[doc = "Number of calibration sequences to be performed (number of valid configurations)."]
        #[inline(always)]
        pub const fn set_calibcnt(&mut self, val: u8) {
        ...
        #[doc = "Start calibration."]
        #[inline(always)]
        pub const fn set_startcalib(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 4usize)) | (((val as u32) & 0x01) << 4usize);
        }
        ...
        #[doc = "Continuous mode selection for injected conversions."]
        #[inline(always)]
        pub const fn set_jcont(&mut self, val: bool) {
        ...
        #[doc = "Delay start of injected conversions."]
        #[inline(always)]
        pub const fn set_jds(&mut self, val: bool) {
    ...
    impl Isr {
        ...
        #[doc = "End of calibration flag."]
        #[inline(always)]
        pub const fn set_eocalf(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 0usize)) | (((val as u32) & 0x01) << 0usize);
        }
        ...
        #[doc = "Calibration in progress status."]
        #[inline(always)]
        pub const fn set_calibip(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 12usize)) | (((val as u32) & 0x01) << 12usize);
        }
        ...
        #[doc = "Stabilization in progress status."]
        #[inline(always)]
        pub const fn set_stabip(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 15usize)) | (((val as u32) & 0x01) << 15usize);
        }
        ...
        #[doc = "Initialization mode is ready."]
        #[inline(always)]
        pub const fn set_initrdy(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 31usize)) | (((val as u32) & 0x01) << 31usize);
        }
    }
    ...
    impl Jchgr {
        ...
        #[doc = "Injected channel group selection."]
        #[inline(always)]
        pub const fn set_jchg(&mut self, val: u16) {
