...
pub mod regs {
    ...
    impl defmt::Format for Clkcr {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Clkcr {{ clkdiv: {=u8:?}, clken: {=bool:?}, pwrsav: {=bool:?}, bypass: {=bool:?}, widbus: {=u8:?}, negedge: {=bool:?}, hwfc_en: {=bool:?} }}",
                self.clkdiv(),
                self.clken(),
                self.pwrsav(),
                self.bypass(),
    ...
    impl defmt::Format for Cmdr {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Cmdr {{ cmdindex: {=u8:?}, waitresp: {=u8:?}, waitint: {=bool:?}, waitpend: {=bool:?}, cpsmen: {=bool:?}, sdio_suspend: {=bool:?} }}",
                self.cmdindex(),
                self.waitresp(),
                self.waitint(),
                self.waitpend(),
    ...
    impl Dctrl {
        ...
        #[doc = "Data transfer mode selection 1: Stream or SDIO multibyte data transfer"]
        #[inline(always)]
        pub const fn set_dtmode(&mut self, val: bool) {
    ...
    impl defmt::Format for Dctrl {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Dctrl {{ dten: {=bool:?}, dtdir: {=bool:?}, dtmode: {=bool:?}, dmaen: {=bool:?}, dblocksize: {=u8:?}, rwstart: {=bool:?}, rwstop: {=bool:?}, rwmod: {=bool:?}, sdioen: {=bool:?} }}",
                self.dten(),
                self.dtdir(),
                self.dtmode(),
                self.dmaen(),
    ...
    impl Fifocnt {
        ...
        #[doc = "Remaining number of words to be written to or read from the FIFO"]
        #[inline(always)]
        pub const fn set_fifocount(&mut self, val: u32) {
    ...
    impl Icr {
        ...
        #[doc = "STBITERR flag clear bit"]
        #[inline(always)]
        pub const fn set_stbiterrc(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 9usize)) | (((val as u32) & 0x01) << 9usize);
        }
    ...
    impl defmt::Format for Icr {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Icr {{ ccrcfailc: {=bool:?}, dcrcfailc: {=bool:?}, ctimeoutc: {=bool:?}, dtimeoutc: {=bool:?}, txunderrc: {=bool:?}, rxoverrc: {=bool:?}, cmdrendc: {=bool:?}, cmdsentc: {=bool:?}, dataendc: {=bool:?}, stbiterrc: {=bool:?}, dbckendc: {=bool:?}, sdioitc: {=bool:?} }}",
                self.ccrcfailc(),
                self.dcrcfailc(),
                self.ctimeoutc(),
                self.dtimeoutc(),
    ...
    impl Maskr {
        ...
        #[doc = "STBITERR interrupt enable"]
        #[inline(always)]
        pub const fn set_stbiterre(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 9usize)) | (((val as u32) & 0x01) << 9usize);
        }
        ...
        #[doc = "Command acting interrupt enable"]
        #[inline(always)]
        pub const fn set_cmdactie(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 11usize)) | (((val as u32) & 0x01) << 11usize);
        }
        ...
        #[doc = "Data transmit acting interrupt enable"]
        #[inline(always)]
        pub const fn set_txactie(&mut self, val: bool) {
        ...
        #[doc = "Data receive acting interrupt enable"]
        #[inline(always)]
        pub const fn set_rxactie(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 13usize)) | (((val as u32) & 0x01) << 13usize);
        }
        ...
        #[doc = "Tx FIFO full interrupt enable"]
        #[inline(always)]
        pub const fn set_txfifofie(&mut self, val: bool) {
        ...
        #[doc = "Rx FIFO empty interrupt enable"]
        #[inline(always)]
        pub const fn set_rxfifoeie(&mut self, val: bool) {
        ...
        #[doc = "Data available in Tx FIFO interrupt enable"]
        #[inline(always)]
        pub const fn set_txdavlie(&mut self, val: bool) {
        ...
        #[doc = "Data available in Rx FIFO interrupt enable"]
        #[inline(always)]
        pub const fn set_rxdavlie(&mut self, val: bool) {
    ...
    impl defmt::Format for Maskr {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Maskr {{ ccrcfailie: {=bool:?}, dcrcfailie: {=bool:?}, ctimeoutie: {=bool:?}, dtimeoutie: {=bool:?}, txunderrie: {=bool:?}, rxoverrie: {=bool:?}, cmdrendie: {=bool:?}, cmdsentie: {=bool:?}, dataendie: {=bool:?}, stbiterre: {=bool:?}, dbckendie: {=bool:?}, cmdactie: {=bool:?}, txactie: {=bool:?}, rxactie: {=bool:?}, txfifoheie: {=bool:?}, rxfifohfie: {=bool:?}, txfifofie: {=bool:?}, rxfifofie: {=bool:?}, txfifoeie: {=bool:?}, rxfifoeie: {=bool:?}, txdavlie: {=bool:?}, rxdavlie: {=bool:?}, sdioitie: {=bool:?} }}",
                self.ccrcfailie(),
                self.dcrcfailie(),
                self.ctimeoutie(),
                self.dtimeoutie(),
    ...
    impl Star {
        ...
        #[doc = "Data transmit in progress"]
        #[inline(always)]
        pub const fn set_txact(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 12usize)) | (((val as u32) & 0x01) << 12usize);
        }
        ...
        #[doc = "Data receive in progress"]
        #[inline(always)]
        pub const fn set_rxact(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 13usize)) | (((val as u32) & 0x01) << 13usize);
        }
