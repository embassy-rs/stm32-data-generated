...
# [inline (always)]
pub const fn ifcr (self) -> crate :: common :: Reg < regs :: Ifcr , crate :: common :: W > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x18usize) as _) } } # [inline (always)]
pub const fn autocr (self) -> crate :: common :: Reg < regs :: Autocr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x1cusize) as _) } } # [doc = "Transmit Data Register - half-word sized"]
# [inline (always)]
...
# [inline (always)]
pub const fn udrdr (self) -> crate :: common :: Reg < regs :: Udrdr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x4cusize) as _) } } } pub mod regs { # [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
pub struct Autocr (pub u32) ; impl Autocr { # [doc = "trigger selection (refer ). ... Note: these bits can be written only when SPE = 0."]
# [inline (always)]
pub const fn trigsel (& self) -> u8 { let val = (self . 0 >> 16usize) & 0x0f ; val as u8 } # [doc = "trigger selection (refer ). ... Note: these bits can be written only when SPE = 0."]
# [inline (always)]
pub fn set_trigsel (& mut self , val : u8) { self . 0 = (self . 0 & ! (0x0f << 16usize)) | (((val as u32) & 0x0f) << 16usize) ; } # [doc = "trigger polarity Note: This bit can be written only when SPE = 0."]
# [inline (always)]
pub const fn trigpol (& self) -> super :: vals :: Trigpol { let val = (self . 0 >> 20usize) & 0x01 ; super :: vals :: Trigpol :: from_bits (val as u8) } # [doc = "trigger polarity Note: This bit can be written only when SPE = 0."]
# [inline (always)]
pub fn set_trigpol (& mut self , val : super :: vals :: Trigpol) { self . 0 = (self . 0 & ! (0x01 << 20usize)) | (((val . to_bits () as u32) & 0x01) << 20usize) ; } # [doc = "trigger of CSTART control enable Note: if user can't prevent trigger event during write, the TRIGEN has to be changed when SPI is disabled"]
# [inline (always)]
pub const fn trigen (& self) -> bool { let val = (self . 0 >> 21usize) & 0x01 ; val != 0 } # [doc = "trigger of CSTART control enable Note: if user can't prevent trigger event during write, the TRIGEN has to be changed when SPI is disabled"]
# [inline (always)]
pub fn set_trigen (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 21usize)) | (((val as u32) & 0x01) << 21usize) ; } } impl Default for Autocr { # [inline (always)]
fn default () -> Autocr { Autocr (0) } } # [doc = "configuration register 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
# [derive (Copy , Clone , Eq , PartialEq , Ord , PartialOrd)]
pub enum Trigpol { # [doc = "trigger is active on raising edge"]
RISINGEDGE = 0x0 , # [doc = "trigger is active on falling edge"]
FALLINGEDGE = 0x01 , } impl Trigpol { # [inline (always)]
pub const fn from_bits (val : u8) -> Trigpol { unsafe { core :: mem :: transmute (val & 0x01) } } # [inline (always)]
...
fn from (val : Trigpol) -> u8 { Trigpol :: to_bits (val) } } # [repr (u8)]
# [derive (Copy , Clone , Eq , PartialEq , Ord , PartialOrd)]
