...
pub mod regs {
    ...
    impl Cfgr1 {
        ...
        #[doc = "IR Modulation Envelope signal selection."]
        #[inline(always)]
        pub const fn set_ir_mod(&mut self, val: u8) {
        ...
        #[doc = "Strobe signal bit for UCPD1"]
        #[inline(always)]
        pub const fn set_ucpd1_strobe(&mut self, val: bool) {
        ...
        #[doc = "Strobe signal bit for UCPD2"]
        #[inline(always)]
        pub const fn set_ucpd2_strobe(&mut self, val: bool) {
    ...
    impl Cfgr2 {
        ...
        #[doc = "ECC error lock bit"]
        #[inline(always)]
        pub const fn set_ecc_lock(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 3usize)) | (((val as u32) & 0x01) << 3usize);
        }
        ...
        #[doc = "PA1_CDEN"]
        #[inline(always)]
        pub const fn set_pa1_cden(&mut self, val: bool) {
        ...
        #[doc = "PA3_CDEN"]
        #[inline(always)]
        pub const fn set_pa3_cden(&mut self, val: bool) {
        ...
        #[doc = "PA5_CDEN"]
        #[inline(always)]
        pub const fn set_pa5_cden(&mut self, val: bool) {
        ...
        #[doc = "PA6_CDEN"]
        #[inline(always)]
        pub const fn set_pa6_cden(&mut self, val: bool) {
        ...
        #[doc = "PA13_CDEN"]
        #[inline(always)]
        pub const fn set_pa13_cden(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 20usize)) | (((val as u32) & 0x01) << 20usize);
        }
        #[doc = "PB0_CDEN"]
        #[must_use]
        ...
        #[doc = "PB0_CDEN"]
        #[inline(always)]
        pub const fn set_pb0_cden(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 21usize)) | (((val as u32) & 0x01) << 21usize);
        }
        #[doc = "PB1_CDEN"]
        #[must_use]
        ...
        #[doc = "PB1_CDEN"]
        #[inline(always)]
        pub const fn set_pb1_cden(&mut self, val: bool) {
        ...
        #[doc = "PB2_CDEN"]
        #[inline(always)]
        pub const fn set_pb2_cden(&mut self, val: bool) {
    ...
    impl Itline14 {
        ...
        #[doc = "TIM1_CC"]
        #[inline(always)]
        pub const fn set_tim1_cc(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 0usize)) | (((val as u32) & 0x01) << 0usize);
        }
    }
    ...
    impl Itline29 {
        ...
        #[inline(always)]
        pub const fn set_usart6(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 4usize)) | (((val as u32) & 0x01) << 4usize);
        }
    }
    ...
    impl Itline30 {
        ...
        #[doc = "CEC"]
        #[inline(always)]
        pub const fn set_cec(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 0usize)) | (((val as u32) & 0x01) << 0usize);
        }
    }
    ...
    impl Itline8 {
        ...
        #[doc = "UCPD1"]
        #[inline(always)]
        pub const fn set_ucpd1(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 0usize)) | (((val as u32) & 0x01) << 0usize);
        }
        #[doc = "UCPD2"]
        #[must_use]
        ...
        #[doc = "UCPD2"]
        #[inline(always)]
        pub const fn set_ucpd2(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 1usize)) | (((val as u32) & 0x01) << 1usize);
        }
        #[doc = "USB"]
        #[must_use]
    ...
    impl VrefbufCsr {
        ...
        #[doc = "Voltage reference scale. 0: Voltage reference set to VREF_OUT1 (around 2.048 V). 1: Voltage reference set to VREF_OUT2 (around 2.5 V)."]
        #[inline(always)]
        pub const fn set_vrs(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 2usize)) | (((val as u32) & 0x01) << 2usize);
        }
