...
pub mod regs {
    ...
    impl Cfgr1 {
        ...
        #[doc = "User bank swapping"]
        #[inline(always)]
        pub const fn set_ufb(&mut self, val: bool) {
    ...
    impl Cfgr2 {
        ...
        #[doc = "Firewall disable bit"]
        #[inline(always)]
        pub const fn set_fwdis(&mut self, val: bool) {
    ...
    impl Cfgr3 {
        ...
        #[doc = "VREFINT enable and scaler control for COMP2 enable bit"]
        #[inline(always)]
        pub const fn set_en_vrefint(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 0usize)) | (((val as u32) & 0x01) << 0usize);
        }
        ...
        #[doc = "VREFINT_ADC connection bit"]
        #[inline(always)]
        pub const fn set_sel_vref_out(&mut self, val: u8) {
        ...
        #[doc = "VREFINT reference for ADC enable bit"]
        #[inline(always)]
        pub const fn set_enbuf_vrefint_adc(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 8usize)) | (((val as u32) & 0x01) << 8usize);
        }
        ...
        #[doc = "Temperature sensor reference for ADC enable bit"]
        #[inline(always)]
        pub const fn set_enbuf_sensor_adc(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 9usize)) | (((val as u32) & 0x01) << 9usize);
        }
        ...
        #[doc = "VREFINT reference for COMP2 scaler enable bit"]
        #[inline(always)]
        pub const fn set_enbuf_vrefint_comp2(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 12usize)) | (((val as u32) & 0x01) << 12usize);
        }
        ...
        #[doc = "VREFINT reference for HSI48 oscillator enable bit"]
        #[inline(always)]
        pub const fn set_enref_hsi48(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 13usize)) | (((val as u32) & 0x01) << 13usize);
        }
        ...
        #[doc = "VREFINT ready flag"]
        #[inline(always)]
        pub const fn set_vrefint_rdyf(&mut self, val: bool) {
