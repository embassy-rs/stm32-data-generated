...
pub mod regs {
    ...
    impl defmt::Format for Cfgr1 {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Cfgr1 {{ fwdis: {=bool:?}, boosten: {=bool:?}, i2c_pb6_fmp: {=bool:?}, i2c_pb7_fmp: {=bool:?}, i2c_pb8_fmp: {=bool:?}, i2c_pb9_fmp: {=bool:?}, i2c1_fmp: {=bool:?}, i2c2_fmp: {=bool:?}, i2c3_fmp: {=bool:?}, fpu_ie: {=u8:?} }}",
                self.fwdis(),
                self.boosten(),
                self.i2c_pb6_fmp(),
                self.i2c_pb7_fmp(),
    ...
    impl Memrmp {
        ...
        #[doc = "QUADSPI memory mapping swap"]
        #[inline(always)]
        pub const fn set_qfs(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 3usize)) | (((val as u32) & 0x01) << 3usize);
        }
