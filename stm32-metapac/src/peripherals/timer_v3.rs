...
pub mod regs {
    ...
    impl Af11chCmp {
        ...
        #[doc = "BRK DFSDM1_BREAKx enable (x=0 if TIM15, x=1 if TIM16, x=2 if TIM17)"]
        #[inline(always)]
        pub const fn set_bkdf1bke(&mut self, val: bool) {
    ...
    impl defmt::Format for Af11chCmp {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Af11chCmp {{ bkine: {=bool:?}, bkcmpe[0]: {=bool:?}, bkcmpe[1]: {=bool:?}, bkdf1bke: {=bool:?}, bkinp: {:?}, bkcmpp[0]: {:?}, bkcmpp[1]: {:?} }}",
                self.bkine(),
                self.bkcmpe(0usize),
                self.bkcmpe(1usize),
                self.bkdf1bke(),
    ...
    impl defmt::Format for Af1Adv {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Af1Adv {{ bkine: {=bool:?}, bkcmpe[0]: {=bool:?}, bkcmpe[1]: {=bool:?}, bkdf1bke: {=bool:?}, bkinp: {:?}, bkcmpp[0]: {:?}, bkcmpp[1]: {:?}, etrsel: {=u8:?} }}",
                self.bkine(),
                self.bkcmpe(0usize),
                self.bkcmpe(1usize),
                self.bkdf1bke(),
    ...
    impl Af2Adv {
        ...
        #[doc = "BRK2 DFSDM1_BREAK1 enable"]
        #[inline(always)]
        pub const fn set_bk2df1bk1e(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 8usize)) | (((val as u32) & 0x01) << 8usize);
        }
    ...
    impl defmt::Format for Af2Adv {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Af2Adv {{ bk2ine: {=bool:?}, bk2cmpe[0]: {=bool:?}, bk2df1bk1e: {=bool:?}, bk2inp: {:?}, bk2cmpp[0]: {:?}, bk2cmpp[1]: {:?} }}",
                self.bk2ine(),
                self.bk2cmpe(0usize),
                self.bk2df1bk1e(),
                self.bk2inp(),
    ...
    impl defmt::Format for Bdtr1chCmp {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Bdtr1chCmp {{ dtg: {=u8:?}, lock: {:?}, ossi: {:?}, ossr: {:?}, bke[0]: {=bool:?}, bkp[0]: {:?}, aoe: {=bool:?}, moe: {=bool:?}, bkf[0]: {:?} }}",
                self.dtg(),
                self.lock(),
                self.ossi(),
                self.ossr(),
    ...
    impl defmt::Format for BdtrAdv {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "BdtrAdv {{ dtg: {=u8:?}, lock: {:?}, ossi: {:?}, ossr: {:?}, bke[0]: {=bool:?}, bke[1]: {=bool:?}, bkp[0]: {:?}, bkp[1]: {:?}, aoe: {=bool:?}, moe: {=bool:?}, bkf[0]: {:?}, bkf[1]: {:?} }}",
                self.dtg(),
                self.lock(),
                self.ossi(),
                self.ossr(),
    ...
    impl defmt::Format for CcerAdv {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "CcerAdv {{ cce[0]: {=bool:?}, cce[1]: {=bool:?}, cce[2]: {=bool:?}, cce[3]: {=bool:?}, cce[4]: {=bool:?}, cce[5]: {=bool:?}, ccp[0]: {=bool:?}, ccp[1]: {=bool:?}, ccp[2]: {=bool:?}, ccp[3]: {=bool:?}, ccp[4]: {=bool:?}, ccp[5]: {=bool:?}, ccne[0]: {=bool:?}, ccne[1]: {=bool:?}, ccne[2]: {=bool:?}, ccnp[0]: {=bool:?}, ccnp[1]: {=bool:?}, ccnp[2]: {=bool:?}, ccnp[3]: {=bool:?} }}",
                self.cce(0usize),
                self.cce(1usize),
                self.cce(2usize),
                self.cce(3usize),
    ...
    impl Ccmr3Adv {
        ...
        #[must_use]
        #[inline(always)]
        pub const fn ocm(&self, n: usize) -> super::vals::OcmGp {
            assert!(n < 2usize);
            let mut val = 0;
            ...
            super::vals::OcmGp::from_bits(val as u8)
        }
        #[doc = "Output compare x (x=5,6) mode"]
        #[inline(always)]
        pub const fn set_ocm(&mut self, n: usize, val: super::vals::OcmGp) {
            assert!(n < 2usize);
            let offs = 4usize + n * 8usize;
    ...
    impl CcmrOutput1ch {
        ...
        #[must_use]
        #[inline(always)]
        pub const fn ocm(&self, n: usize) -> super::vals::OcmLimited {
            assert!(n < 1usize);
            let mut val = 0;
            let offs = 4usize + n * 8usize;
            val += (((self.0 >> offs) & 0x07) << 0usize);
            let offs = 16usize + n * 8usize;
            val += (((self.0 >> offs) & 0x01) << 3usize);
            super::vals::OcmLimited::from_bits(val as u8)
        }
        #[doc = "Output compare y mode"]
        #[inline(always)]
        pub const fn set_ocm(&mut self, n: usize, val: super::vals::OcmLimited) {
            assert!(n < 1usize);
            let offs = 4usize + n * 8usize;
            self.0 = (self.0 & !(0x07 << offs)) | (((val.to_bits() as u32 >> 0usize) & 0x07) << offs);
            let offs = 16usize + n * 8usize;
    ...
    impl defmt::Format for SrAdv {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "SrAdv {{ uif: {=bool:?}, ccif[0]: {=bool:?}, ccif[1]: {=bool:?}, ccif[2]: {=bool:?}, ccif[3]: {=bool:?}, comif: {=bool:?}, tif: {=bool:?}, bif[0]: {=bool:?}, bif[1]: {=bool:?}, ccof[0]: {=bool:?}, ccof[1]: {=bool:?}, ccof[2]: {=bool:?}, ccof[3]: {=bool:?}, sbif: {=bool:?}, ccif5: {=bool:?}, ccif6: {=bool:?} }}",
                self.uif(),
                self.ccif(0usize),
                self.ccif(1usize),
                self.ccif(2usize),
...
pub mod vals {
    ...
    impl OcmGp {
        #[inline(always)]
        pub const fn from_bits(val: u8) -> OcmGp {
            unsafe { core::mem::transmute(val & 0x0f) }
        }
        #[inline(always)]
        pub const fn to_bits(self) -> u8 {
    ...
    impl From<u8> for OcmGp {
        #[inline(always)]
        fn from(val: u8) -> OcmGp {
            OcmGp::from_bits(val)
        }
    }
    impl From<OcmGp> for u8 {
        #[inline(always)]
        fn from(val: OcmGp) -> u8 {
            OcmGp::to_bits(val)
        }
    }
    #[repr(u8)]
