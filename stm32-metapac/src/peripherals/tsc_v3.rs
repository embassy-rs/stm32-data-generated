...
pub mod regs {
    ...
    impl defmt::Format for Iogcsr {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Iogcsr {{ g1e: {=bool:?}, g2e: {=bool:?}, g3e: {=bool:?}, g4e: {=bool:?}, g5e: {=bool:?}, g6e: {=bool:?}, g7e: {=bool:?}, g8e: {=bool:?}, g1s: {=bool:?}, g2s: {=bool:?}, g3s: {=bool:?}, g4s: {=bool:?}, g5s: {=bool:?}, g6s: {=bool:?}, g7s: {=bool:?}, g8s: {=bool:?} }}",
                self.g1e(),
                self.g2e(),
                self.g3e(),
                self.g4e(),
