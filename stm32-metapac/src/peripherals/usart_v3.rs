...
pub mod regs {
    ...
    impl Cr1 {
        ...
        #[doc = "Oversampling mode"]
        #[inline(always)]
        pub const fn set_over8(&mut self, val: super::vals::Over8) {
    ...
    impl defmt::Format for Cr1 {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Cr1 {{ ue: {=bool:?}, uesm: {=bool:?}, re: {=bool:?}, te: {=bool:?}, idleie: {=bool:?}, rxneie: {=bool:?}, tcie: {=bool:?}, txeie: {=bool:?}, peie: {=bool:?}, ps: {:?}, pce: {=bool:?}, wake: {:?}, m0: {:?}, mme: {=bool:?}, cmie: {=bool:?}, over8: {:?}, dedt: {=u8:?}, deat: {=u8:?}, rtoie: {=bool:?}, eobie: {=bool:?}, m1: {:?} }}",
                self.ue(),
                self.uesm(),
                self.re(),
                self.te(),
    ...
    impl Cr2 {
        ...
        #[doc = "7-bit Address Detection/4-bit Address Detection"]
        #[inline(always)]
        pub const fn set_addm(&mut self, val: super::vals::Addm) {
        ...
        #[doc = "Most significant bit first"]
        #[inline(always)]
        pub const fn set_msbfirst(&mut self, val: super::vals::Msbfirst) {
        ...
        #[doc = "Auto baud rate mode"]
        #[inline(always)]
        pub const fn set_abrmod(&mut self, val: super::vals::Abrmod) {
    ...
    impl Cr3 {
        ...
        #[doc = "DMA Disable on Reception Error"]
        #[inline(always)]
        pub const fn set_ddre(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 13usize)) | (((val as u32) & 0x01) << 13usize);
        }
        ...
        #[doc = "Driver enable polarity selection"]
        #[inline(always)]
        pub const fn set_dep(&mut self, val: super::vals::Dep) {
            self.0 = (self.0 & !(0x01 << 15usize)) | (((val.to_bits() as u32) & 0x01) << 15usize);
        }
        ...
        #[doc = "Wakeup from Stop mode interrupt flag selection"]
        #[inline(always)]
        pub const fn set_wus(&mut self, val: super::vals::Wus) {
    ...
    impl defmt::Format for Cr3 {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Cr3 {{ eie: {=bool:?}, iren: {=bool:?}, irlp: {:?}, hdsel: {=bool:?}, nack: {=bool:?}, scen: {=bool:?}, dmar: {=bool:?}, dmat: {=bool:?}, rtse: {=bool:?}, ctse: {=bool:?}, ctsie: {=bool:?}, onebit: {=bool:?}, ovrdis: {=bool:?}, ddre: {=bool:?}, dem: {=bool:?}, dep: {:?}, scarcnt: {=u8:?}, wus: {:?}, wufie: {=bool:?} }}",
                self.eie(),
                self.iren(),
                self.irlp(),
                self.hdsel(),
    ...
    impl defmt::Format for Isr {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Isr {{ pe: {=bool:?}, fe: {=bool:?}, ne: {=bool:?}, ore: {=bool:?}, idle: {=bool:?}, rxne: {=bool:?}, tc: {=bool:?}, txe: {=bool:?}, lbd: {=bool:?}, ctsif: {=bool:?}, cts: {=bool:?}, rtof: {=bool:?}, eobf: {=bool:?}, abre: {=bool:?}, abrf: {=bool:?}, busy: {=bool:?}, cmf: {=bool:?}, sbkf: {=bool:?}, rwu: {:?}, wuf: {=bool:?}, teack: {=bool:?}, reack: {=bool:?} }}",
                self.pe(),
                self.fe(),
                self.ne(),
                self.ore(),
