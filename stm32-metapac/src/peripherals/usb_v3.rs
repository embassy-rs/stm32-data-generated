...
# [inline (always)]
pub const fn lpmcsr (self) -> crate :: common :: Reg < regs :: Lpmcsr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x54usize) as _) } } # [doc = "Battery Charging Detector"]
# [inline (always)]
pub const fn bcdr (self) -> crate :: common :: Reg < regs :: Bcdr , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x58usize) as _) } } } pub mod regs { # [doc = "Battery Charging Detector"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
pub struct Bcdr (pub u32) ; impl Bcdr { # [doc = "Battery charging detector mode enable"]
# [inline (always)]
pub const fn bcden (& self) -> bool { let val = (self . 0 >> 0usize) & 0x01 ; val != 0 } # [doc = "Battery charging detector mode enable"]
# [inline (always)]
pub fn set_bcden (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 0usize)) | (((val as u32) & 0x01) << 0usize) ; } # [doc = "Data contact detection mode enable"]
# [inline (always)]
pub const fn dcden (& self) -> bool { let val = (self . 0 >> 1usize) & 0x01 ; val != 0 } # [doc = "Data contact detection mode enable"]
# [inline (always)]
pub fn set_dcden (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 1usize)) | (((val as u32) & 0x01) << 1usize) ; } # [doc = "Primary detection mode enable"]
# [inline (always)]
pub const fn pden (& self) -> bool { let val = (self . 0 >> 2usize) & 0x01 ; val != 0 } # [doc = "Primary detection mode enable"]
# [inline (always)]
pub fn set_pden (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 2usize)) | (((val as u32) & 0x01) << 2usize) ; } # [doc = "Secondary detection mode enable"]
# [inline (always)]
pub const fn sden (& self) -> bool { let val = (self . 0 >> 3usize) & 0x01 ; val != 0 } # [doc = "Secondary detection mode enable"]
# [inline (always)]
pub fn set_sden (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 3usize)) | (((val as u32) & 0x01) << 3usize) ; } # [doc = "Data contact detection status"]
# [inline (always)]
pub const fn dcdet (& self) -> bool { let val = (self . 0 >> 4usize) & 0x01 ; val != 0 } # [doc = "Data contact detection status"]
# [inline (always)]
pub fn set_dcdet (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 4usize)) | (((val as u32) & 0x01) << 4usize) ; } # [doc = "Primary detection status"]
# [inline (always)]
pub const fn pdet (& self) -> bool { let val = (self . 0 >> 5usize) & 0x01 ; val != 0 } # [doc = "Primary detection status"]
# [inline (always)]
pub fn set_pdet (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 5usize)) | (((val as u32) & 0x01) << 5usize) ; } # [doc = "Secondary detection status"]
# [inline (always)]
pub const fn sdet (& self) -> super :: vals :: Sdet { let val = (self . 0 >> 6usize) & 0x01 ; super :: vals :: Sdet :: from_bits (val as u8) } # [doc = "Secondary detection status"]
# [inline (always)]
pub fn set_sdet (& mut self , val : super :: vals :: Sdet) { self . 0 = (self . 0 & ! (0x01 << 6usize)) | (((val . to_bits () as u32) & 0x01) << 6usize) ; } # [doc = "DM pull-up detection status"]
# [inline (always)]
pub const fn ps2det (& self) -> bool { let val = (self . 0 >> 7usize) & 0x01 ; val != 0 } # [doc = "DM pull-up detection status"]
# [inline (always)]
pub fn set_ps2det (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 7usize)) | (((val as u32) & 0x01) << 7usize) ; } # [doc = "DP pull-up control"]
# [inline (always)]
pub const fn dppu (& self) -> bool { let val = (self . 0 >> 15usize) & 0x01 ; val != 0 } # [doc = "DP pull-up control"]
# [inline (always)]
pub fn set_dppu (& mut self , val : bool) { self . 0 = (self . 0 & ! (0x01 << 15usize)) | (((val as u32) & 0x01) << 15usize) ; } } impl Default for Bcdr { # [inline (always)]
fn default () -> Bcdr { Bcdr (0) } } # [doc = "Buffer table address"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
# [derive (Copy , Clone , Eq , PartialEq , Ord , PartialOrd)]
pub enum Sdet { # [doc = "CDP detected"]
CDP = 0x0 , # [doc = "DCP detected"]
DCP = 0x01 , } impl Sdet { # [inline (always)]
pub const fn from_bits (val : u8) -> Sdet { unsafe { core :: mem :: transmute (val & 0x01) } } # [inline (always)]
pub const fn to_bits (self) -> u8 { unsafe { core :: mem :: transmute (self) } } } impl From < u8 > for Sdet { # [inline (always)]
fn from (val : u8) -> Sdet { Sdet :: from_bits (val) } } impl From < Sdet > for u8 { # [inline (always)]
fn from (val : Sdet) -> u8 { Sdet :: to_bits (val) } } # [repr (u8)]
# [derive (Copy , Clone , Eq , PartialEq , Ord , PartialOrd)]
