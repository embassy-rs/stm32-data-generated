...
# [inline (always)]
pub const fn mem (self , n : usize) -> crate :: common :: Reg < u16 , crate :: common :: RW > { assert ! (n < 256usize) ; unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x0usize + n * 2usize) as _) } } }