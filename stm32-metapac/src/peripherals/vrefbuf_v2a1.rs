...
VREF2 = 0x02 , # [doc = "Voltage reference set to VREF_OUT2 (around 2.5 V)."]
VREF3 = 0x03 , _RESERVED_4 = 0x04 , _RESERVED_5 = 0x05 , _RESERVED_6 = 0x06 , _RESERVED_7 = 0x07 , } impl Vrs { # [inline (always)]
