...
pub(crate) static REGISTERS: IR = IR {
    ...
    fieldsets: &[
        ...
        FieldSet {
            name: "Awdhtr",
            extends: None,
            description: Some("analog watchdog 1-3 higher threshold register"),
            bit_size: 32,
            fields: &[
                Field {
                    name: "htr",
                    description: Some("Analog watchdog 1-3 higher threshold."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 23,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "bulb",
                    description: Some(
                        "Bulb sampling mode This bit is set and cleared by software to enable the bulb sampling mode. BULB bit must not be set when the SWTRIG bit is set. The very first ADC conversion is performed with the sampling time specified in SMPx bits. Note: The software is allowed to write this bit only when ADEN = 0. When the discontinuous mode is used, only DISCNUM[2:0] = 000 configuration is compatible with bulb mode.",
                    ),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 13 }),
                    bit_size: 1,
                    array: None,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "gcompcoeff",
                    description: Some(
                        "Gain compensation coefficient The coefficient is divided by 4096 to get the gain factor ranging from 0 to 39999756",
                    ),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 14,
                    array: None,
        ...
        FieldSet {
            name: "Ofr",
            extends: None,
            description: Some("offset 1 register"),
            bit_size: 32,
            fields: &[Field {
                name: "offset",
        ...
        FieldSet {
            ...
            fields: &[Field {
                name: "pcsel",
                description: Some("Channel x (VIN[i]) preselected"),
                bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                bit_size: 1,
    ...
    enums: &[
        ...
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "Cycles13",
                    description: Some("13 ADC clock cycles"),
                    value: 3,
                },
                EnumVariant {
                    name: "Cycles139",
                    description: Some("139 ADC clock cycles"),
                    value: 6,
                },
                EnumVariant {
                    name: "Cycles25",
                    description: Some("25 ADC clock cycles"),
                    value: 4,
                },
                EnumVariant {
                    name: "Cycles289",
                    description: Some("289 ADC clock cycles"),
                    value: 7,
                },
                EnumVariant {
                    name: "Cycles3",
                ...
                EnumVariant {
                    name: "Cycles8",
                    description: Some("8 ADC clock cycles"),
                    value: 2,
                },
            ],
        },
