...
pub(crate) static REGISTERS: IR = IR {
    blocks: &[Block {
        ...
        items: &[
            ...
            BlockItem {
                name: "smpr",
                description: Some("sampling time register 1"),
                array: None,
                byte_offset: 0x14,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "smpr2",
                description: Some("sampling time register 2"),
                array: None,
                byte_offset: 0x18,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "tr1",
                description: Some("analog watchdog threshold register 1"),
                array: None,
                byte_offset: 0x20,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "tr2",
                description: Some("analog watchdog threshold register 2"),
                array: None,
                byte_offset: 0x24,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "tr3",
                description: Some("analog watchdog threshold register 3"),
                array: None,
                byte_offset: 0x28,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
    ...
    fieldsets: &[
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "cont",
                    description: Some("single / continuous conversion mode for regular conversions"),
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "adstart",
                    description: Some("group regular conversion start"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 2 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "jadstart",
                    description: Some("group injected conversion start"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 3 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "adstp",
                    description: Some("group regular conversion stop"),
                ...
                Field {
                    name: "jadstp",
                    description: Some("group injected conversion stop"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 5 }),
                    bit_size: 1,
                    array: None,
                    enumm: Some("Adstp"),
                ...
                Field {
                    name: "advregen",
                    description: Some("voltage regulator enable"),
        ...
        FieldSet {
            ...
            fields: &[Field {
                ...
                bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                bit_size: 1,
                array: Some(Array::Regular(RegularArray { len: 18, stride: 1 })),
                enumm: Some("Difsel"),
            }],
        },
        FieldSet {
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "eosmpie",
                    description: Some("group regular end of sampling interrupt"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 1 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "eocie",
                    description: Some("group regular end of unitary conversion interrupt"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 2 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "eosie",
                    description: Some("group regular end of sequence conversions interrupt"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 3 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "ovrie",
                    description: Some("group regular overrun interrupt"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 4 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "jeocie",
                    description: Some("group injected end of unitary conversion interrupt"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 5 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "jeosie",
                    description: Some("group injected end of sequence conversions interrupt"),
                ...
                Field {
                    name: "awd1ie",
                    description: Some("analog watchdog 1 interrupt"),
                ...
                Field {
                    name: "awd2ie",
                    description: Some("analog watchdog 2 interrupt"),
                ...
                Field {
                    name: "awd3ie",
                    description: Some("analog watchdog 3 interrupt"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 9 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "jqovfie",
                    description: Some("group injected contexts queue overflow interrupt"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 10 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "eosmp",
                    description: Some("group regular end of sampling flag"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 1 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "eoc",
                    description: Some("group regular end of unitary conversion flag"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 2 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "eos",
                    description: Some("group regular end of sequence conversions flag"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 3 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "ovr",
                    description: Some("group regular overrun flag"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 4 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "jeoc",
                    description: Some("group injected end of unitary conversion flag"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 5 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "jeos",
                    description: Some("group injected end of sequence conversions flag"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 6 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "jqovf",
                    description: Some("group injected contexts queue overflow flag"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 10 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[Field {
                name: "jdata",
                description: Some("group injected sequencer rank conversion data"),
                bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                bit_size: 16,
                array: None,
                enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "jl",
                    description: Some("group injected sequencer scan length"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 2,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "jextsel",
                    description: Some("group injected external trigger source"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 2 }),
                    bit_size: 5,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            name: "Ofr",
            extends: None,
            description: Some("offset number x register"),
            bit_size: 32,
            fields: &[
                Field {
                    name: "offset",
                    description: Some("data offset"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 12,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "offsetpos",
                    description: Some("Positive offset"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 24 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "saten",
                    description: Some("Saturation enable"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 25 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "offset1_ch",
                    description: Some("Channel selection for the data offset"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 26 }),
                    bit_size: 5,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "offset_en",
                    description: Some("Offset enable"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 31 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "smp",
                    description: Some("channel n * 10 + x sampling time"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 3,
                ...
                Field {
                    name: "smpplus",
                    description: Some("Addition of one clock cycle to the sampling time"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 31 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "sq",
                    description: Some("group regular sequencer rank 1-4"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 6 }),
                    bit_size: 5,
                    array: Some(Array::Regular(RegularArray { len: 4, stride: 6 })),
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[Field {
                name: "sq",
                description: Some("group regular sequencer rank 5-9"),
                bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                bit_size: 5,
        ...
        FieldSet {
            ...
            fields: &[Field {
                name: "sq",
                description: Some("group regular sequencer rank 10-14"),
                bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                bit_size: 5,
                array: Some(Array::Regular(RegularArray { len: 5, stride: 6 })),
                enumm: None,
        ...
        FieldSet {
            ...
            fields: &[Field {
                name: "sq",
                description: Some("group regular sequencer rank 15-16"),
                bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                bit_size: 5,
