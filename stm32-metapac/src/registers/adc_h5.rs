...
pub(crate) static REGISTERS: IR = IR {
    blocks: &[Block {
        ...
        items: &[
            ...
            BlockItem {
                name: "tr2",
                description: Some("watchdog threshold register 2"),
                array: None,
                byte_offset: 0x24,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "tr3",
                description: Some("watchdog threshold register 3"),
                array: None,
                byte_offset: 0x28,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "ofr",
                description: Some("offset 1-4 register"),
            ...
            BlockItem {
                name: "jdr",
                description: Some("injected channel 1-4 register"),
                array: Some(Array::Regular(RegularArray { len: 4, stride: 4 })),
                byte_offset: 0x80,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
    ...
    fieldsets: &[
        ...
        FieldSet {
            name: "Jdr",
            extends: None,
            description: Some("injected channel 1-4 data register"),
            bit_size: 32,
            fields: &[Field {
                name: "jdata",
                description: Some(
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "op1",
                    description: Some("Option bit 1. Note - not documented for H562/H563/H573"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 1 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
    ...
    enums: &[
        ...
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "BothEdges",
                    description: Some("Hardware trigger detection on both the rising and falling edge"),
                    value: 3,
                },
                EnumVariant {
                    name: "Disabled",
        ...
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "Negative",
                    description: Some("Negative offset"),
                    value: 0,
                },
                EnumVariant {
                    name: "Positive",
        ...
        Enum {
            ...
            variants: &[
                ...
                EnumVariant {
                    name: "Cycles245",
                    description: Some("24.5 ADC clock cycles"),
                    value: 3,
                },
                EnumVariant {
                    name: "Cycles2475",
                    description: Some("247.5 ADC clock cycles"),
                    value: 6,
                },
                EnumVariant {
                    name: "Cycles25",
                ...
                EnumVariant {
                    name: "Cycles475",
                    description: Some("47.5 ADC clock cycles"),
                    value: 4,
                },
                EnumVariant {
                    name: "Cycles6405",
                    description: Some("640.5 ADC clock cycles"),
                    value: 7,
                },
                EnumVariant {
                    name: "Cycles65",
                    description: Some("6.5 ADC clock cycles"),
                    value: 1,
                },
                EnumVariant {
                    name: "Cycles925",
                    description: Some("92.5 ADC clock cycles"),
                    value: 5,
                },
            ],
        },
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "Cycles25",
                    description: Some("The sampling time remains set to 2.5 ADC clock cycles remains"),
                    value: 0,
                },
                EnumVariant {
                    name: "Cycles35",
        ...
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "Conversion",
                    description: Some("Software trigger starts the conversion for sampling time control trigger mode"),
                    value: 0,
                },
                EnumVariant {
                    name: "Sampling",
                    description: Some("Software trigger starts the sampling for sampling time control trigger mode"),
                    value: 1,
                },
            ],
        },
