...
pub(crate) static REGISTERS: IR = IR {
    blocks: &[Block {
        ...
        items: &[
            ...
            BlockItem {
                name: "ofcfgr",
                description: Some("offset 1-4 configuration register"),
                array: Some(Array::Regular(RegularArray { len: 4, stride: 4 })),
                byte_offset: 0x50,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
                    fieldset: Some("Ofcfgr"),
                }),
            },
            BlockItem {
                name: "ofr",
            ...
            BlockItem {
                name: "ltr1",
                description: Some("watchdog lower threshold register 1"),
                array: None,
                byte_offset: 0xa8,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "htr1",
                description: Some("watchdog higher threshold register 1"),
                array: None,
                byte_offset: 0xac,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
    ...
    fieldsets: &[
        FieldSet {
            ...
            fields: &[Field {
                name: "awd2ch",
                description: Some("analog watchdog 2 monitored channel selection"),
        ...
        FieldSet {
            ...
            fields: &[Field {
                name: "awd3ch",
                description: Some("analog watchdog 3 monitored channel selection"),
                bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                bit_size: 1,
                array: Some(Array::Regular(RegularArray { len: 20, stride: 1 })),
                enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "caladdos",
                    description: Some("Calibration additional offset."),
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "dmngt",
                    description: Some("DMA transfer enable"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 2,
                    array: None,
                    enumm: Some("Dmngt"),
                ...
                Field {
                    name: "extsel",
                    description: Some("group regular external trigger source"),
                ...
                Field {
                    name: "exten",
                    description: Some("group regular external trigger polarity"),
                ...
                Field {
                    name: "ovrmod",
                    description: Some("group regular overrun configuration"),
                ...
                Field {
                    name: "autdly",
                    description: Some("low power auto wait"),
                ...
                Field {
                    name: "discen",
                    description: Some("group regular sequencer discontinuous mode"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 16 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "discnum",
                    description: Some("group regular sequencer discontinuous number of ranks"),
                ...
                Field {
                    name: "jdiscen",
                    description: Some("group injected sequencer discontinuous mode"),
                ...
                Field {
                    name: "jqm",
                    description: Some("group injected contexts queue mode"),
                ...
                Field {
                    name: "awd1sgl",
                    description: Some("analog watchdog 1 monitoring a single channel or all channels"),
                ...
                Field {
                    name: "awd1en",
                    description: Some("analog watchdog 1 enable on scope group regular"),
                ...
                Field {
                    name: "jawd1en",
                    description: Some("analog watchdog 1 enable on scope group injected"),
                ...
                Field {
                    name: "jauto",
                    description: Some("group injected automatic trigger mode"),
                ...
                Field {
                    name: "awd1ch",
                    description: Some("analog watchdog 1 monitored channel selection"),
                ...
                Field {
                    name: "jqdis",
                    description: Some("group injected contexts queue disable"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 31 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "rovse",
                    description: Some("oversampler enable on scope group regular"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "jovse",
                    description: Some("oversampler enable on scope group injected"),
                ...
                Field {
                    name: "trovs",
                    description: Some("oversampling discontinuous mode (triggered mode) for group regular"),
        ...
        FieldSet {
            ...
            fields: &[Field {
                name: "htr1",
                description: Some("analog watchdog 2 threshold low"),
                bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                bit_size: 23,
                array: None,
                enumm: None,
        ...
        FieldSet {
            name: "Jdr",
            extends: None,
            description: Some("group injected sequencer rank 1 register"),
            bit_size: 32,
            fields: &[Field {
                name: "jdata",
                description: Some("group injected sequencer rank 1 conversion data"),
                bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                bit_size: 32,
                array: None,
                enumm: None,
        ...
        FieldSet {
            ...
            fields: &[Field {
                name: "ltr1",
                description: Some("analog watchdog 1 threshold low"),
                bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                bit_size: 26,
                array: None,
                enumm: None,
        ...
        FieldSet {
            ...
            fields: &[Field {
                name: "offset",
                description: Some("offset number x offset level"),
                bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                bit_size: 22,
                array: None,
                enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "selref",
                    description: Some("Internal reference voltage selection."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "selbg",
                    description: Some("Bandgap selection."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 1 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "vddcoreen",
                    description: Some("VDDCORE enable."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 2 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[Field {
                name: "pcsel",
                description: Some("Channel x (VINP[i]) pre selection"),
                bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                bit_size: 1,
                array: Some(Array::Regular(RegularArray { len: 20, stride: 1 })),
                enumm: Some("Pcsel"),
        ...
        FieldSet {
            name: "Smpr",
            extends: None,
            description: Some("sampling time register n"),
            bit_size: 32,
            fields: &[Field {
                name: "smp",
    ...
    enums: &[
        ...
        Enum {
            ...
            variants: &[
                ...
                EnumVariant {
                    name: "Cycles15015",
                    description: Some("1501.5 clock cycles"),
                    value: 7,
                },
                EnumVariant {
                    name: "Cycles245",
                ...
                EnumVariant {
                    name: "Cycles35",
                    description: Some("3.5 clock cycles"),
                    value: 1,
                },
                EnumVariant {
                    name: "Cycles475",
                ...
                EnumVariant {
                    name: "Cycles75",
                    description: Some("7.5 clock cycles"),
                    value: 2,
                },
            ],
        },
