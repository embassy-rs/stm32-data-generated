...
pub(crate) static REGISTERS: IR = IR {
    ...
    fieldsets: &[
        ...
        FieldSet {
            ...
            fields: &[Field {
                name: "offset",
                description: Some("Data offset y for the channel programmed in OFFSETy_CH[4:0] bits."),
                bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                bit_size: 22,
                array: None,
                enumm: None,
        ...
        FieldSet {
            ...
            fields: &[Field {
                name: "pcsel",
                description: Some("Channel i (Vless thansub>INPless than/sub>[i]) preselection."),
                bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                bit_size: 1,
        ...
        FieldSet {
            ...
            fields: &[Field {
                name: "smp",
                description: Some("Channel x sampling time selection (x=9 to 0)."),
                bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                bit_size: 3,
