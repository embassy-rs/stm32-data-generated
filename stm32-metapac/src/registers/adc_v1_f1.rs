    ...
    fieldsets: &[
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "dualmod",
                    description: Some("Dual mode selection (ADC1 only)"),
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "tsvrefe",
                    description: Some("Temperature sensor and VREFINT enable (ADC1 only)"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 23 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "adc2data",
                    description: Some("ADC2 data (ADC1 in dual mode only)"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 16 }),
                    bit_size: 16,
                    array: None,
                    enumm: None,
