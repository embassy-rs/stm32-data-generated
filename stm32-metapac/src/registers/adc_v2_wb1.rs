...
pub(crate) static REGISTERS: IR = IR {
    ...
    fieldsets: &[
        ...
        FieldSet {
            name: "ChselrSq",
            extends: None,
            description: Some("Channel selection register (CHSELRMOD = 1)"),
            bit_size: 32,
            fields: &[Field {
                name: "sq",
                description: Some("Channel number of the x-th conversion in the sequence (0b1111: end of sequence)"),
                bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                bit_size: 4,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "smp",
                    description: Some("Sampling time selection (SMP[1] is only available when SMPSEL is present)"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 3,
                ...
                Field {
                    name: "smpsel",
                    description: Some("Channel-x sampling time selection (0: SMP[0], 1: SMP[1])"),
