...
pub(crate) static REGISTERS: IR = IR {
    blocks: &[Block {
        ...
        items: &[
            ...
            BlockItem {
                name: "gcomp",
                description: Some("Gain compensation register (STM32G4 only)"),
                array: None,
                byte_offset: 0xc0,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "or",
                description: Some("Option register (STM32H5 and STM32H7RS only)"),
                array: None,
                byte_offset: 0xc8,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
    ...
    fieldsets: &[
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "adfcfg",
                    description: Some("Digital filter (ADF) configuration (STM32H7RS only)"),
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "lftrig",
                    description: Some("Low frequency trigger mode enable (STM32H5 only)"),
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "op0",
                    description: Some(
                        "Option bit 0 (INP0/INN1 GPIO switch control on ADC1, VDDCORE channel enable on ADC2)",
                    ),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 1,
                    array: None,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "smpplus",
                    description: Some("Addition of one clock cycle to the sampling time (SMPR[0] only)"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 31 }),
                    bit_size: 1,
                    array: None,
                    enumm: Some("Smpplus"),
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "awdfilt",
                    description: Some("Analog watchdog filtering parameter (TR[0] only)"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 12 }),
                    bit_size: 3,
                    array: None,
                    enumm: None,
    ...
    enums: &[
        ...
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "Cycles25",
                    description: Some("SMP = 000 selects 2.5 ADC clock cycles"),
                    value: 0,
                },
                EnumVariant {
                    name: "Cycles35",
                    description: Some("SMP = 000 selects 3.5 ADC clock cycles"),
                    value: 1,
                },
            ],
        },
