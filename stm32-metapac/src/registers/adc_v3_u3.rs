    ...
    fieldsets: &[
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "awdfilt",
                    description: Some("Analog watchdog filtering parameter (HTR[0] only)"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 29 }),
                    bit_size: 3,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "ldordyie",
                    description: Some("Voltage regulator ready interrupt enable"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 12 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "posoff",
                    description: Some("Positive offset (0: the offset is subtracted, 1: the offset is added)"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 24 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[Field {
                name: "vddcoreen",
                description: Some("VDDCORE channel enable"),
                bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                bit_size: 1,
                array: None,
                enumm: None,
    ...
    enums: &[
        ...
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "Cycles115",
                    description: Some("11.5 ADC clock cycles"),
                    value: 3,
                },
                EnumVariant {
                    name: "Cycles14995",
                    description: Some("1499.5 ADC clock cycles"),
                    value: 7,
                },
                EnumVariant {
                    name: "Cycles15",
                ...
                EnumVariant {
                    name: "Cycles235",
                    description: Some("23.5 ADC clock cycles"),
                    value: 4,
                },
                EnumVariant {
                    name: "Cycles2465",
                    description: Some("246.5 ADC clock cycles"),
                    value: 6,
                },
                EnumVariant {
                    name: "Cycles25",
                ...
                EnumVariant {
                    name: "Cycles465",
                    description: Some("46.5 ADC clock cycles"),
                    value: 5,
                },
                EnumVariant {
                    name: "Cycles65",
        ...
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "Conversion",
                    description: Some("Software trigger starts the conversion"),
                    value: 0,
                },
                EnumVariant {
                    name: "Sampling",
                    description: Some(
                        "Software trigger starts the sampling phase (the conversion starts when the trigger is cleared)",
                    ),
                    value: 1,
                },
            ],
