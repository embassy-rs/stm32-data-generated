...
pub(crate) static REGISTERS: IR = IR {
        ...
        Block {
            ...
            items: &[
                ...
                BlockItem {
                    name: "smpr",
                    description: Some(
                        "Sample time register. SMPR[i] holds the sample times of channels 10*i to 10*i+9.",
                    ),
        ...
        Block {
            ...
            items: &[
                ...
                BlockItem {
                    ...
                    array: Some(Array::Cursed(CursedArray { offsets: &[0, 4, 12] })),
                    byte_offset: 0x20,
                    inner: BlockItemInner::Register(Register {
                        access: Access::ReadWrite,
                        bit_size: 32,
                        fieldset: Some("Adc4Tr"),
                    }),
                },
                BlockItem {
                    name: "chselr",
                ...
                BlockItem {
                    name: "pwrr",
                    description: Some("Power register"),
                    array: None,
                    byte_offset: 0x44,
                    inner: BlockItemInner::Register(Register {
                        access: Access::ReadWrite,
    ...
    fieldsets: &[
        ...
        FieldSet {
            ...
            fields: &[Field {
                name: "chn21sel",
                description: Some("Channel 21 selection (0: DAC1 OUT1, 1: DAC1 OUT2)"),
                bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                bit_size: 1,
                array: None,
                enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "dpd",
                    description: Some("Deep-power-down mode"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 1 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "vrefsecsmp",
                    description: Some("VREF+ second sample: doubles the sampling time of the reference"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 3 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "i_apb_addr",
                    description: Some("Calibration factor address"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 8,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "i_apb_data",
                    description: Some("Calibration factor data"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 8 }),
                    bit_size: 8,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "validity",
                    description: Some("Calibration factor validity"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 16 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "latch_coef",
                    description: Some("Latch the calibration factors"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 24 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "capture_coef",
                    description: Some("Capture the calibration factors"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 25 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[Field {
                name: "calfact",
                description: Some("Calibration factor selected by CALINDEX"),
                bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                bit_size: 32,
                array: None,
                enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "calindex",
                    description: Some("Calibration factor index"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 24 }),
                    bit_size: 4,
                    array: None,
                    enumm: None,
    ...
    enums: &[
        ...
        Enum {
            ...
            variants: &[
                ...
                EnumVariant {
                    name: "Cycles8145",
                    description: Some("814.5 ADC clock cycles"),
                    value: 7,
                },
            ],
        },
        ...
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "Cycles12",
                    description: Some("12 ADC clock cycles"),
                    value: 2,
                },
                EnumVariant {
                    name: "Cycles20",
                    description: Some("20 ADC clock cycles"),
                    value: 3,
                },
                EnumVariant {
                    name: "Cycles36",
                    description: Some("36 ADC clock cycles"),
                    value: 4,
                },
                EnumVariant {
                    name: "Cycles391",
                    description: Some("391 ADC clock cycles"),
                    value: 6,
                },
                EnumVariant {
                    name: "Cycles5",
                    description: Some("5 ADC clock cycles"),
                    value: 0,
                },
                EnumVariant {
                    name: "Cycles6",
                    description: Some("6 ADC clock cycles"),
                    value: 1,
                },
                EnumVariant {
                    name: "Cycles68",
                    description: Some("68 ADC clock cycles"),
                    value: 5,
                },
                EnumVariant {
                    name: "Cycles814",
                    description: Some("814 ADC clock cycles"),
                    value: 7,
                },
            ],
        },
