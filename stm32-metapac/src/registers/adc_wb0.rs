...
pub(crate) static REGISTERS: IR = IR {
    blocks: &[Block {
        name: "Adc",
        extends: None,
        description: Some("ADC address block description."),
        items: &[
            BlockItem {
                name: "version_id",
                description: Some("VERSION_ID register."),
                array: None,
                byte_offset: 0x0,
                inner: BlockItemInner::Register(Register {
                    access: Access::Read,
                    bit_size: 32,
                    fieldset: Some("VersionId"),
                }),
            },
            BlockItem {
                name: "conf",
                description: Some("CONF register."),
                array: None,
                byte_offset: 0x4,
                inner: BlockItemInner::Register(Register {
            ...
            BlockItem {
                name: "ctrl",
                description: Some("CTRL register."),
                array: None,
                byte_offset: 0x8,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "ocm_ctrl",
                description: Some("Occasionnal mode control register."),
                array: None,
                byte_offset: 0xc,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
                    fieldset: Some("OcmCtrl"),
                }),
            },
            BlockItem {
                name: "pga_conf",
                description: Some("PGA configuration register."),
                array: None,
                byte_offset: 0x10,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
                    fieldset: Some("PgaConf"),
                }),
            },
            BlockItem {
                name: "switch",
                description: Some("SWITCH register."),
                array: None,
                byte_offset: 0x14,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
                    fieldset: Some("Switch"),
                }),
            },
            BlockItem {
                name: "df_conf",
                description: Some("Decimation filter configuration register."),
                array: None,
                byte_offset: 0x18,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
                    fieldset: Some("DfConf"),
                }),
            },
            BlockItem {
                name: "ds_conf",
                description: Some("DS_CONF register."),
                array: None,
                byte_offset: 0x1c,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
                    fieldset: Some("DsConf"),
                }),
            },
            BlockItem {
                name: "seq_1",
                description: Some("SEQ_1 register."),
                array: None,
                byte_offset: 0x20,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "seq_2",
                description: Some("SEQ_2 register."),
                array: None,
                byte_offset: 0x24,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "comp_1",
                description: Some("COMP_1 register."),
                array: None,
                byte_offset: 0x28,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "comp_2",
                description: Some("COMP_2 register."),
                array: None,
                byte_offset: 0x2c,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "comp_3",
                description: Some("COMP_3 register."),
                array: None,
                byte_offset: 0x30,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "comp_4",
                description: Some("COMP_4 register."),
                array: None,
                byte_offset: 0x34,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "comp_sel",
                description: Some("COMP_SEL register."),
                array: None,
                byte_offset: 0x38,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
                    fieldset: Some("CompSel"),
                }),
            },
            BlockItem {
                name: "wd_th",
                description: Some("WD_TH register."),
                array: None,
                byte_offset: 0x3c,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "wd_conf",
                description: Some("WD_CONF register."),
                array: None,
                byte_offset: 0x40,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
                    fieldset: Some("WdConf"),
                }),
            },
            BlockItem {
                name: "ds_dataout",
                description: Some("DS_DATAOUT register."),
                array: None,
                byte_offset: 0x44,
                inner: BlockItemInner::Register(Register {
                    access: Access::Read,
                    bit_size: 32,
                    fieldset: Some("DsDataout"),
                }),
            },
            BlockItem {
                name: "df_dataout",
                description: Some("Decimation filter Data output register."),
                array: None,
                byte_offset: 0x48,
                inner: BlockItemInner::Register(Register {
                    access: Access::Read,
                    bit_size: 32,
                    fieldset: Some("DfDataout"),
                }),
            },
            BlockItem {
                name: "irq_status",
                description: Some("IRQ_STATUS register."),
                array: None,
                byte_offset: 0x4c,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
                    fieldset: Some("IrqStatus"),
                }),
            },
            BlockItem {
                name: "irq_enable",
                description: Some("IRQ_ENABLE register."),
                array: None,
                byte_offset: 0x50,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
                    fieldset: Some("IrqEnable"),
                }),
            },
            BlockItem {
                name: "timer_conf",
    ...
    fieldsets: &[
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "gain1",
                    description: Some("GAIN1[11:0]: first calibration point: gain AUXADC_GAIN_1V2[11:0]."),
                ...
                Field {
                    name: "offset1",
                    description: Some("OFFSET1[7:0]: first calibration point: offset compensation[7:0] with sign."),
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "gain2",
                    description: Some("GAIN2[11:0]: second calibration point: gain AUXADC_GAIN_1V2[11:0]."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 12,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "offset2",
                    description: Some("OFFSET2[7:0]: second calibration point: offset compensation[7:0] with sign."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 12 }),
                    bit_size: 8,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "gain3",
                    description: Some("GAIN3[11:0]: third calibration point: gain AUXADC_GAIN_1V2[11:0]."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 12,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "offset3",
                    description: Some("OFFSET3[7:0]: third calibration point: offset compensation[7:0] with sign."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 12 }),
                    bit_size: 8,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "gain4",
                    description: Some("GAIN4[11:0]: fourth calibration point: gain AUXADC_GAIN_1V2[11:0]."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 12,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "offset4",
                    description: Some("OFFSET4[7:0]: fourth calibration point: offset compensation[7:0] with sign."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 12 }),
                    bit_size: 8,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "gain_offset0",
                    description: Some("gain / offset used in ADC single negative mode with Vinput range = 1.2V."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 2,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "gain_offset1",
                    description: Some("gain / offset used in ADC single positive mode with Vinput range = 1.2V."),
                ...
                Field {
                    name: "gain_offset2",
                    description: Some("gain / offset used in ADC differential mode with Vinput range = 1.2V."),
                ...
                Field {
                    name: "gain_offset3",
                    description: Some("gain / offset used in ADC single negative mode with Vinput range = 2.4V."),
                ...
                Field {
                    name: "gain_offset4",
                    description: Some("gain / offset used in ADC single positive mode with Vinput range = 2.4V."),
                ...
                Field {
                    name: "gain_offset5",
                    description: Some("gain / offset used in ADC differential mode with Vinput range = 2.4V."),
                ...
                Field {
                    name: "gain_offset6",
                    description: Some("gain / offset used in ADC single negative mode with Vinput range = 3.6V."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 12 }),
                    bit_size: 2,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "gain_offset7",
                    description: Some("gain / offset used in ADC single positive mode with Vinput range = 3.6V."),
                ...
                Field {
                    name: "gain_offset8",
                    description: Some("gain / offset used in ADC differential mode with Vinput range = 3.6V."),
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "op_mode",
                    description: Some("ADC mode selection (= data path selection)."),
                ...
                Field {
                    name: "dma_df_ena",
                    description: Some("enable DMA mode for Decimation Filter data path."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 14 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "ovr_df_cfg",
                    description: Some("decimation overrun configuration."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 16 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    ...
                    description: Some("possibility to keep the VBIAS_PRECH enabled to deactivate the filter."),
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "adc_on_off",
                    description: Some("ADC_ON_OFF: 0: power off the ADC 1: power on the ADC."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "start_con",
                    description: Some("generate a start pulse to initiate an ADC conversion."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 1 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "stop_op_mod",
                    description: Some("stop the on-going OP_MODE (ADC mode, Analog audio mode, Full."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 2 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "dig_aud_mode",
                    description: Some("enable the digital audio mode (the data path uses. the decimation filter)."),
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "df_cic_dhf",
                    description: Some("CIC filter decimator half factor."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 7 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "df_itp1p2",
                    description: Some("1.2 fractional interpolator enable."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 8 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "df_i_u2s",
                    description: Some("select signed/unsigned format for input."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 9 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "df_o_s2u",
                    description: Some("select signed/unsigned format for data output."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 10 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "pdm_rate",
                    description: Some("select the PDM clock rate."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 11 }),
                    bit_size: 4,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "df_microl_rn",
                    description: Some("left/right channel selection on digital microphone."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 15 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "df_hpf_en",
                    description: Some("high pass filter enable."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 16 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "df_half_d_en",
                    description: Some("half dynamic enable."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 17 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[Field {
                name: "df_data",
                description: Some("contain the converted data at the output of the. decimation filter."),
                bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                bit_size: 16,
                array: None,
                enumm: None,
        ...
        FieldSet {
            ...
            fields: &[Field {
                name: "ds_data",
                description: Some("DS_DATA[15:0]: contain the converted data at the output of the Down Sampler."),
                bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                bit_size: 16,
                array: None,
                enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "eoc_irq_ena",
                    description: Some("(Used in test mode only): End of ADC conversion interrupt enable."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "eods_irq_ena",
                    description: Some("End of conversion interrupt enable for the Down Sampler output."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 1 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "eodf_irq_ena",
                    description: Some("End of conversion interrupt enable for the decimation filter output."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 2 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "ovr_ds_irq_ena",
                    description: Some("Down Sampler overrun interrupt enable."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 5 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "ovr_df_irq_ena",
                    description: Some("decimation filter overrun interrupt enable."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 6 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    ...
                    description: Some("decimation filter saturation interrupt enable."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 7 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "eodf_irq",
                    description: Some("set when the decimation filter conversion is completed."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 2 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "ovr_df_irq",
                    description: Some("set to indicate a decimation filter overrun (a data is lost)."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 6 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "df_ovrfl_irq",
                    description: Some("set to indicate the decimation filter is saturated."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 7 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "ocm_src",
                    description: Some("select the occasional conversion source."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "ocm_ena",
                    description: Some("start occasional conversion in analog audio and full. modes."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 1 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "pga_gain",
                    description: Some("from 6 to 30 dB."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 4,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "pga_bias",
                    description: Some("set the microphone bias voltage."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 4 }),
                    bit_size: 3,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    ...
                    description: Some("Select the time step PD_STEP for the VBIAS_PRECH_DELAY timer."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 16 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[Field {
                name: "version_id",
                description: Some("VERSION_ID[7:0]: version of the embedded IP."),
                bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                bit_size: 8,
                array: None,
                enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "wd_lt",
                    description: Some("WD_LT[11:0]: analog watchdog low level threshold."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 12,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "wd_ht",
                    description: Some("WD_HT[11:0]: analog watchdog high level threshold."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 16 }),
                    bit_size: 12,
                    array: None,
                    enumm: None,
