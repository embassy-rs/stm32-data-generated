...
pub(crate) static REGISTERS: IR = IR {
    blocks: &[Block {
        ...
        items: &[
            ...
            BlockItem {
                name: "ipdr",
                description: Some("identification register"),
                array: None,
                byte_offset: 0xf8,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "sidr",
                description: Some("size identification register"),
                array: None,
                byte_offset: 0xfc,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
    ...
    fieldsets: &[
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "tsen",
                    description: Some("VSENSE enable This bit is set and cleared by software to control VSENSE"),
                ...
                Field {
                    name: "vbaten",
                    description: Some("VBAT enable This bit is set and cleared by software to control"),
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "adcnum",
                    description: Some("Number of ADCs implemented"),
                ...
                Field {
                    name: "mulpipe",
                    description: Some("Number of pipeline stages"),
                ...
                Field {
                    name: "idlevalue",
                    description: Some("Idle value for non-selected channels"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 12 }),
                    bit_size: 4,
                    array: None,
                    enumm: Some("Idlevalue"),
                },
            ],
        },
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "majrev",
                    description: Some("Major revision These bits returns the ADC IP major revision"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 4 }),
                    bit_size: 4,
                    array: None,
                    enumm: None,
    ...
    enums: &[
        ...
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "H13",
                    description: Some("Dummy channel selection is 0x13"),
                    value: 0,
                },
                EnumVariant {
                    name: "H1f",
                    description: Some("Dummy channel selection is 0x1F"),
                    value: 1,
                },
            ],
        },
