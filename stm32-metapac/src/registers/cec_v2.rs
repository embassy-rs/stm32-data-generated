...
pub(crate) static REGISTERS: IR = IR {
    blocks: &[Block {
        name: "Cec",
        extends: None,
        description: Some("CEC."),
        items: &[
            BlockItem {
                name: "cr",
                description: Some("CEC control register."),
                array: None,
                byte_offset: 0x0,
            ...
            BlockItem {
                name: "isr",
                description: Some("CEC Interrupt and Status Register."),
                array: None,
                byte_offset: 0x10,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "ier",
                description: Some("CEC interrupt enable register."),
                array: None,
                byte_offset: 0x14,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
    ...
    fieldsets: &[
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "brestp",
                    description: Some("Rx-Stop on Bit Rising Error The BRESTP bit is set and cleared by software."),
                ...
                Field {
                    name: "sftopt",
                    description: Some("SFT Option Bit The SFTOPT bit is set and cleared by software."),
                ...
                Field {
                    name: "lstn",
                    description: Some("Listen mode LSTN bit is set and cleared by software."),
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "txudrie",
                    description: Some("Tx-Underrun Interrupt Enable The TXUDRIE bit is set and cleared by software."),
                ...
                Field {
                    name: "txerrie",
                    description: Some("Tx-Error Interrupt Enable The TXERRIE bit is set and cleared by software."),
