    ...
    fieldsets: &[
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "lptim2",
                    description: Some("Clocking of LPTIMER2 counter when the core is halted"),
                ...
                Field {
                    name: "lptim1",
                    description: Some("Clocking of LPTIMER1 counter when the core is halted"),
