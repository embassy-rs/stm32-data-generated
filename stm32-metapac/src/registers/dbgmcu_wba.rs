...
pub(crate) static REGISTERS: IR = IR {
    blocks: &[Block {
        ...
        items: &[
            ...
            BlockItem {
                name: "cr",
                description: Some("status and configuration register"),
                array: None,
                byte_offset: 0x4,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "apb1hfzr",
                description: Some("APB1H peripheral freeze register"),
                array: None,
                byte_offset: 0xc,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "apb7fzr",
                description: Some("APB7 peripheral freeze register"),
                array: None,
                byte_offset: 0x24,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
                    fieldset: Some("Apb7fzr"),
                }),
            },
            BlockItem {
                name: "ahb1fzr",
            ...
            BlockItem {
                name: "dbg_auth_host",
                description: Some("debug host authentication register"),
                array: None,
                byte_offset: 0x100,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                ...
                description: Some("debug device authentication register"),
                array: None,
                byte_offset: 0x104,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
                    fieldset: Some("DbgAuthDevice"),
                }),
            },
            BlockItem {
                name: "pncr",
                description: Some("part number codification register"),
                array: None,
                byte_offset: 0x7dc,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "pidr4",
                description: Some("CoreSight peripheral identity register 4"),
                array: None,
                byte_offset: 0xfd0,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "pidr0",
                description: Some("CoreSight peripheral identity register 0"),
                array: None,
                byte_offset: 0xfe0,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "pidr1",
                description: Some("CoreSight peripheral identity register 1"),
                array: None,
                byte_offset: 0xfe4,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "pidr2",
                description: Some("CoreSight peripheral identity register 2"),
                array: None,
                byte_offset: 0xfe8,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "pidr3",
                description: Some("CoreSight peripheral identity register 3"),
                array: None,
                byte_offset: 0xfec,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "cidr0",
                description: Some("CoreSight component identity register 0"),
                array: None,
                byte_offset: 0xff0,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "cidr2",
                description: Some("CoreSight component identity register 2"),
                array: None,
                byte_offset: 0xff8,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "cidr3",
                description: Some("CoreSight component identity register 3"),
                array: None,
                byte_offset: 0xffc,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
    ...
    fieldsets: &[
        ...
        FieldSet {
            ...
            fields: &[Field {
                ...
                description: Some("LPTIM2 stop in CPU debug\r Write access can be protected by GTZC_TZSC.LPTIM2SEC."),
                bit_offset: BitOffset::Regular(RegularBitOffset { offset: 5 }),
                bit_size: 1,
                array: None,
                enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "dbg_tim2_stop",
                    description: Some("TIM2 stop in CPU debug\r Write access can be protected by GTZC_TZSC.TIM2SEC."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "dbg_tim3_stop",
                    description: Some("TIM3 stop in CPU debug\r Write access can be protected by GTZC_TZSC.TIM3SEC."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 1 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "dbg_wwdg_stop",
                    description: Some("WWDG stop in CPU debug\r Write access can be protected by GTZC_TZSC.WWDGSEC"),
                ...
                Field {
                    name: "dbg_iwdg_stop",
                    description: Some("IWDG stop in CPU debug\r Write access can be protected by GTZC_TZSC.IWDGSEC."),
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "dbg_tim1_stop",
                    description: Some("TIM1 stop in CPU debug\r Write access can be protected by GTZC_TZSC.TIM1SEC."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 11 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "dbg_tim16_stop",
                    description: Some("TIM16 stop in CPU debug\r Write access can be protected by GTZC_TZSC.TIM16SEC."),
                ...
                Field {
                    name: "dbg_tim17_stop",
                    description: Some("TIM17 stop in CPU debug\r Write access can be protected by GTZC_TZSC.TIM17SEC."),
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "dbg_i2c3_stop",
                    description: Some("I2C3 stop in CPU debug\r Access can be protected by GTZC_TZSC.I2C3SEC."),
                ...
                Field {
                    ...
                    description: Some("LPTIM1 stop in CPU debug\r Access can be protected by GTZC_TZSC.LPTIM1SEC."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 17 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[Field {
                name: "preamble",
                description: Some("Component ID bits [7:0]"),
                bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                bit_size: 8,
                array: None,
                enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "preamble",
                    description: Some("Component ID bits [11:8]"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 4,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "class",
                    description: Some("Component ID bits [15:12] - component class"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 4 }),
                    bit_size: 4,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[Field {
                name: "preamble",
                description: Some("Component ID bits [23:16]"),
                bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                bit_size: 8,
                array: None,
                enumm: None,
        ...
        FieldSet {
            ...
            fields: &[Field {
                name: "preamble",
                description: Some("Component ID bits [31:24]"),
                bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                bit_size: 8,
                array: None,
                enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "lpms",
                    description: Some("Device low power mode selected\r 10x: Standby mode\r others reserved"),
                ...
                Field {
                    name: "stopf",
                    description: Some("Device Stop flag"),
                ...
                Field {
                    name: "sbf",
                    description: Some("Device Standby flag"),
                ...
                Field {
                    name: "cds",
                    description: Some("CPU DeepSleep"),
        ...
        FieldSet {
            ...
            fields: &[Field {
                name: "auth_id",
                description: Some("Device specific ID\r Device specific ID used for RDP regression."),
                bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                bit_size: 32,
                array: None,
                enumm: None,
        ...
        FieldSet {
            ...
            fields: &[Field {
                name: "codification",
                description: Some("Part number codification"),
                bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                bit_size: 32,
                array: None,
                enumm: None,
