...
pub(crate) static REGISTERS: IR = IR {
    blocks: &[Block {
        name: "Dma2d",
        extends: None,
        description: Some("DMA2D"),
        items: &[
            BlockItem {
                name: "cr",
                description: Some("DMA2D control register"),
                array: None,
                byte_offset: 0x0,
            ...
            BlockItem {
                name: "isr",
                description: Some("DMA2D interrupt status register"),
                array: None,
                byte_offset: 0x4,
                inner: BlockItemInner::Register(Register {
                    access: Access::Read,
            ...
            BlockItem {
                name: "ifcr",
                description: Some("DMA2D interrupt flag clear register"),
                array: None,
                byte_offset: 0x8,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "fgmar",
                description: Some("DMA2D foreground memory address register"),
                array: None,
                byte_offset: 0xc,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "fgor",
                description: Some("DMA2D foreground offset register"),
                array: None,
                byte_offset: 0x10,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "bgmar",
                description: Some("DMA2D background memory address register"),
                array: None,
                byte_offset: 0x14,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "bgor",
                description: Some("DMA2D background offset register"),
                array: None,
                byte_offset: 0x18,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "fgpfccr",
                description: Some("DMA2D foreground PFC (pixel format converter) control register"),
                array: None,
                byte_offset: 0x1c,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "fgcolr",
                description: Some("DMA2D foreground color register"),
                array: None,
                byte_offset: 0x20,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "bgpfccr",
                description: Some("DMA2D background PFC (pixel format converter) control register"),
                array: None,
                byte_offset: 0x24,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "bgcolr",
                description: Some("DMA2D background color register"),
                array: None,
                byte_offset: 0x28,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "fgcmar",
                description: Some("DMA2D foreground CLUT memory address register"),
                array: None,
                byte_offset: 0x2c,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "bgcmar",
                description: Some("DMA2D background CLUT memory address register"),
                array: None,
                byte_offset: 0x30,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "opfccr",
                description: Some("DMA2D output PFC (pixel format converter) control register"),
                array: None,
                byte_offset: 0x34,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "ocolr",
                description: Some("DMA2D output color register"),
                array: None,
                byte_offset: 0x38,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "omar",
                description: Some("DMA2D output memory address register"),
                array: None,
                byte_offset: 0x3c,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "oor",
                description: Some("DMA2D output offset register"),
                array: None,
                byte_offset: 0x40,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "nlr",
                description: Some("DMA2D number of line register"),
                array: None,
                byte_offset: 0x44,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "lwr",
                description: Some("DMA2D line watermark register"),
                array: None,
                byte_offset: 0x48,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "amtcr",
                description: Some("DMA2D AXI master timer configuration register"),
                array: None,
                byte_offset: 0x4c,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
    ...
    fieldsets: &[
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "en",
                    description: Some("Enable. Enables the dead time functionality."),
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "teie",
                    description: Some("Transfer error interrupt enable. This bit is set and cleared by software."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 8 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "tcie",
                    description: Some("Transfer complete interrupt enable. This bit is set and cleared by software."),
                ...
                Field {
                    name: "twie",
                    description: Some("Transfer watermark interrupt enable. This bit is set and cleared by software."),
                ...
                Field {
                    name: "caeie",
                    description: Some("CLUT access error interrupt enable. This bit is set and cleared by software."),
                ...
                Field {
                    name: "ceie",
                    description: Some("Configuration error interrupt enable. This bit is set and cleared by software."),
        ...
        FieldSet {
            name: "Opfccr",
            extends: None,
            description: Some("DMA2D output PFC control register"),
            bit_size: 32,
            fields: &[
                Field {
                    name: "cm",
    ...
    enums: &[
        ...
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "InvertedAlpha",
                    description: Some("Inverted alpha"),
                    value: 1,
                },
                EnumVariant {
                    name: "RegularAlpha",
                    description: Some("Regular alpha"),
                    value: 0,
                },
            ],
        },
        ...
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "Regular",
                    description: Some("No red blue swap (RGB or ARGB)"),
                    value: 0,
                },
                EnumVariant {
                    name: "Swap",
                    description: Some("Red blue swap (BGR or ABGR)"),
                    value: 1,
                },
            ],
        },
        ...
        Enum {
            ...
            variants: &[
                ...
                EnumVariant {
                    name: "YCbCr",
                    description: Some("Color mode YCbCr"),
                    value: 11,
                },
            ],
        },
        ...
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "Bytes",
                    description: Some("Line offsets expressed in bytes"),
                    value: 1,
                },
                EnumVariant {
                    name: "Pixels",
                    description: Some("Line offsets expressed in pixels"),
                    value: 0,
                },
            ],
        },
        Enum {
            ...
            variants: &[
                ...
                EnumVariant {
                    ...
                    description: Some("Register-to-memory (no FG nor BG, only output stage active)"),
                    value: 3,
                },
            ],
        },
        ...
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "Regular",
                    description: Some("Regular byte order"),
                    value: 0,
                },
                EnumVariant {
                    name: "SwapBytes",
                    description: Some("Bytes are swapped two by two"),
                    value: 1,
                },
            ],
        },
