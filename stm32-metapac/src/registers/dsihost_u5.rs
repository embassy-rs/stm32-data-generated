...
pub(crate) static REGISTERS: IR = IR {
    blocks: &[Block {
        ...
        items: &[
            ...
            BlockItem {
                name: "isr0",
                description: Some("DSI Host interrupt and status register 0."),
                array: None,
                byte_offset: 0xbc,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "isr1",
                description: Some("DSI Host interrupt and status register 1."),
                array: None,
                byte_offset: 0xc0,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "dltrcr",
                description: Some("DSI Host data lane timer read configuration register."),
                array: None,
                byte_offset: 0xf4,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
                    fieldset: Some("Dltrcr"),
                }),
            },
            BlockItem {
                name: "vscr",
            ...
            BlockItem {
                name: "fbsr",
                description: Some("DSI Host FIFO and buffer status register."),
                array: None,
                byte_offset: 0x168,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "wisr",
                description: Some("DSI Wrapper interrupt and status register."),
                array: None,
                byte_offset: 0x40c,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "bcfgr",
                description: Some("DSI bias configuration register."),
                array: None,
                byte_offset: 0x808,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "dpcbcr",
                description: Some("DSI D-PHY clock band control register."),
                array: None,
                byte_offset: 0xc04,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
                    fieldset: Some("Dpcbcr"),
                }),
            },
            BlockItem {
                name: "dpcsrcr",
                description: Some("DSI D-PHY clock skew rate control register."),
                array: None,
                byte_offset: 0xc34,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
                    fieldset: Some("Dpcsrcr"),
                }),
            },
            BlockItem {
                name: "dpdl0bcr",
                description: Some("DSI D-PHY data lane 0 band control register."),
                array: None,
                byte_offset: 0xc70,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
                    fieldset: Some("Dpdl0bcr"),
                }),
            },
            BlockItem {
                name: "dpdl0srcr",
                description: Some("DSI D-PHY data lane 0 skew rate control register."),
                array: None,
                byte_offset: 0xca0,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
                    fieldset: Some("Dpdl0srcr"),
                }),
            },
            BlockItem {
                name: "dpdl1bcr",
                description: Some("DSI D-PHY data lane 1 band control register."),
                array: None,
                byte_offset: 0xd08,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
                    fieldset: Some("Dpdl1bcr"),
                }),
            },
            BlockItem {
                name: "dpdl1srcr",
                description: Some("DSI D-PHY data lane 1 skew rate control register."),
                array: None,
                byte_offset: 0xd38,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
                    fieldset: Some("Dpdl1srcr"),
                }),
            },
        ],
    }],
    fieldsets: &[
        FieldSet {
            ...
            fields: &[Field {
                name: "pwrup",
                description: Some("Power-up This bit powers-up the reference bias for the MIPI D-PHY."),
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "dpcc",
                    description: Some("D-PHY clock control This bit controls the D-PHY clock state:."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[Field {
                name: "en",
                description: Some("Enable This bit configures the DSI Host in either power-up mode or to reset."),
                bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                bit_size: 1,
                array: None,
                enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "fpe0",
                    description: Some("Force PHY error 0 Writing one to this bit forces a PHY error 0."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 16 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "fpe1",
                    description: Some("Force PHY error 1 Writing one to this bit forces a PHY error 1."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 17 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "fpe2",
                    description: Some("Force PHY error 2 Writing one to this bit forces a PHY error 2."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 18 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "fpe3",
                    description: Some("Force PHY error 3 Writing one to this bit forces a PHY error 3."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 19 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "fpe4",
                    description: Some("Force PHY error 4 Writing one to this bit forces a PHY error 4."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 20 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "fcrce",
                    description: Some("Force CRC error Writing one to this bit forces a CRC error."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 4 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "fpse",
                    description: Some("Force packet size error Writing one to this bit forces a packet size error."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 5 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "feotpe",
                    description: Some("Force EoTp error Writing one to this bit forces a EoTp error."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 6 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "dt",
                    description: Some("Type This field configures the packet data type of the header packet."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 6,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "vcid",
                    description: Some("Channel This field configures the virtual channel ID of the header packet."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 6 }),
                    bit_size: 2,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "data1",
                    description: Some("Payload byte 1 This field indicates the byte 1 of the packet payload."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 8,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "data2",
                    description: Some("Payload byte 2 This field indicates the byte 2 of the packet payload."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 8 }),
                    bit_size: 8,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "data3",
                    description: Some("Payload byte 3 This field indicates the byte 3 of the packet payload."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 16 }),
                    bit_size: 8,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "data4",
                    description: Some("Payload byte 4 This field indicates the byte 4 of the packet payload."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 24 }),
                    bit_size: 8,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "pe0",
                    description: Some("PHY error 0 This bit indicates the ErrEsc escape entry error from lane 0."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 16 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "pe2",
                    description: Some("PHY error 2 This bit indicates the ErrControl error from lane 0."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 18 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "colc",
                    description: Some("Color coding This field configures the DPI color coding. Others: Reserved."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 4,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "dep",
                    description: Some("Data enable polarity This bit configures the polarity of data enable pin."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "vsp",
                    description: Some("VSYNC polarity This bit configures the polarity of VSYNC pin."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 1 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "hsp",
                    description: Some("HSYNC polarity This bit configures the polarity of HSYNC pin."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 2 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[Field {
                name: "cmdm",
                description: Some("Command mode This bit configures the DSI Host in either video or command mode."),
                bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                bit_size: 1,
                array: None,
                enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "ettxe",
                    description: Some("EoTp transmission enable This bit enables the EoTP transmission."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "etrxe",
                    description: Some("EoTp reception enable This bit enables the EoTp reception."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 1 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "btae",
                    description: Some("Bus-turn-around enable This bit enables the bus-turn-around (BTA) request."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 2 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "crcrxe",
                    description: Some("CRC reception enable This bit enables the CRC reception and error reporting."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 4 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "cke",
                    description: Some("Clock enable This bit enables the D-PHY clock lane module:."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 2 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "pd",
                    description: Some("PHY direction This bit indicates the status of phydirection D-PHY signal."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 1 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "urcl",
                    description: Some("ULPS request on clock lane ULPS mode request on clock lane."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "uecl",
                    description: Some("ULPS exit on clock lane ULPS mode exit on clock lane."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 1 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "urdl",
                    description: Some("ULPS request on data lane ULPS mode request on all active data lanes."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 2 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "uedl",
                    description: Some("ULPS exit on data lane ULPS mode exit on all active data lanes."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 3 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "pge",
                    description: Some("Pattern generator enable This bit enables the video mode pattern generator."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 16 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "pgm",
                    description: Some("Pattern generator mode This bit configures the pattern generator mode."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 20 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "pgo",
                    description: Some("Pattern generator orientation This bit configures the color bar orientation."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 24 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[Field {
                name: "npsize",
                description: Some("Null packet size This field returns the number of bytes inside a null packet."),
                bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                bit_size: 13,
                array: None,
                enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "colm",
                    description: Some("Color mode This bit controls the display color mode in video mode."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "shtdn",
                    description: Some("Shutdown This bit controls the display shutdown in video mode."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 1 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "dsien",
                    description: Some("DSI enable This bit enables the DSI Wrapper."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 3 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "teie",
                    description: Some("Tearing effect interrupt enable This bit enables the tearing effect interrupt."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "erie",
                    description: Some("End of refresh interrupt enable This bit enables the end of refresh interrupt."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 1 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "plllie",
                    description: Some("PLL lock interrupt enable This bit enables the PLL lock interrupt."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 9 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "plluie",
                    description: Some("PLL unlock interrupt enable This bit enables the PLL unlock interrupt."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 10 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "plllif",
                    description: Some("PLL lock interrupt flag This bit is set when the PLL becomes locked."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 9 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "plluif",
                    description: Some("PLL unlock interrupt flag This bit is set when the PLL becomes unlocked."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 10 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "swcl",
                    description: Some("Swap clock lane pins This bit swaps the pins on clock lane."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 6 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "swdl0",
                    description: Some("Swap data lane 0 pins This bit swaps the pins on data lane 0."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 7 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "swdl1",
                    description: Some("Swap data lane 1 pins This bit swaps the pins on clock lane."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 8 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "pllen",
                    description: Some("PLL enable This bit enables the D-PHY PLL."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
