...
pub(crate) static REGISTERS: IR = IR {
    blocks: &[Block {
        name: "Dts",
        extends: None,
        description: Some("Digital temperature sensor."),
        items: &[
            BlockItem {
                name: "cfgr1",
                description: Some("Temperature sensor configuration register 1."),
                array: None,
                byte_offset: 0x0,
            ...
            BlockItem {
                name: "t0valr1",
                description: Some("Temperature sensor T0 value register 1."),
                array: None,
                byte_offset: 0x8,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
                    fieldset: Some("T0valr1"),
                }),
            },
            BlockItem {
                name: "rampvalr",
                description: Some("Temperature sensor ramp value register."),
                array: None,
                byte_offset: 0x10,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
                    fieldset: Some("Rampvalr"),
                }),
            },
            BlockItem {
                name: "itr1",
                description: Some("Temperature sensor interrupt threshold register 1."),
                array: None,
                byte_offset: 0x14,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "dr",
                description: Some("Temperature sensor data register."),
                array: None,
                byte_offset: 0x1c,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "sr",
                description: Some("Temperature sensor status register."),
                array: None,
                byte_offset: 0x20,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "itenr",
                description: Some("Temperature sensor interrupt enable register."),
                array: None,
                byte_offset: 0x24,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "icifr",
                description: Some("Temperature sensor clear interrupt flag register."),
                array: None,
                byte_offset: 0x28,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "or",
                description: Some("Temperature sensor option register."),
                array: None,
                byte_offset: 0x2c,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
    ...
    fieldsets: &[
        ...
        FieldSet {
            ...
            fields: &[Field {
                name: "mfreq",
                description: Some("Value of the counter output value for temperature sensor 1."),
                bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                bit_size: 16,
                array: None,
                enumm: None,
        ...
        FieldSet {
            ...
            fields: &[Field {
                name: "op",
                description: Some("general purpose option bits."),
                bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                bit_size: 1,
