    ...
    fieldsets: &[
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "dbg_swen",
                    description: Some("Debug access software enable"),
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "borf_lev",
                    description: Some("These bits contain the VDD supply level threshold that activates the reset"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 9 }),
                    bit_size: 2,
                    array: None,
                    enumm: Some("BorfLev"),
                ...
                Field {
                    name: "borr_lev",
                    description: Some("These bits contain the VDD supply level threshold that releases the reset."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 11 }),
                    bit_size: 2,
                    array: None,
                    enumm: Some("BorrLev"),
                ...
                Field {
                    ...
                    description: Some("SRAM parity check control"),
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "pcrop1a_end",
                    description: Some("PCROP1A area end offset"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 6,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[Field {
                name: "pcrop1a_strt",
                description: Some("PCROP1A area start offset"),
                bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                bit_size: 6,
                array: None,
                enumm: None,
        ...
        FieldSet {
            ...
            fields: &[Field {
                name: "pcrop1b_end",
                description: Some("PCROP1B area end offset"),
                bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                bit_size: 6,
                array: None,
                enumm: None,
        ...
        FieldSet {
            ...
            fields: &[Field {
                name: "pcrop1b_strt",
                description: Some("PCROP1B area start offset"),
                bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                bit_size: 6,
                array: None,
                enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "sec_size",
                    description: Some("Securable memory area size"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 5,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "optverr",
                    description: Some("Option and Engineering bits loading validity error"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 15 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "wrp1a_strt",
                    description: Some("WRP area A start offset"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 6,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "wrp1a_end",
                    description: Some("WRP area A end offset"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 16 }),
                    bit_size: 6,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "wrp1b_strt",
                    description: Some("WRP area B start offset"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 6,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "wrp1b_end",
                    description: Some("WRP area B end offset"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 16 }),
                    bit_size: 6,
                    array: None,
                    enumm: None,
