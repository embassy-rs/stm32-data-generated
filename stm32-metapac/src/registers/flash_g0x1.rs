...
pub(crate) static REGISTERS: IR = IR {
    blocks: &[Block {
        ...
        items: &[
            ...
            BlockItem {
                name: "eccr2",
                description: Some("Flash ECC register 2"),
                array: None,
                byte_offset: 0x1c,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "pcrop2asr",
                description: Some("Flash PCROP zone A Start address register bank 2"),
                array: None,
                byte_offset: 0x44,
                inner: BlockItemInner::Register(Register {
                    access: Access::Read,
                    bit_size: 32,
                    fieldset: Some("Pcrop2asr"),
                }),
            },
            BlockItem {
                name: "pcrop2aer",
                description: Some("Flash PCROP zone A End address register bank 2"),
                array: None,
                byte_offset: 0x48,
                inner: BlockItemInner::Register(Register {
                    access: Access::Read,
                    bit_size: 32,
                    fieldset: Some("Pcrop2aer"),
                }),
            },
            BlockItem {
                name: "wrp2ar",
                description: Some("Flash WRP area A address register bank 2"),
                array: None,
                byte_offset: 0x4c,
                inner: BlockItemInner::Register(Register {
                    access: Access::Read,
            ...
            BlockItem {
                name: "wrp2br",
                description: Some("Flash WRP area B address register bank 2"),
                array: None,
                byte_offset: 0x50,
                inner: BlockItemInner::Register(Register {
                    access: Access::Read,
            ...
            BlockItem {
                name: "pcrop2bsr",
                description: Some("Flash PCROP zone B Start address register bank 2"),
                array: None,
                byte_offset: 0x54,
                inner: BlockItemInner::Register(Register {
                    access: Access::Read,
                    bit_size: 32,
                    fieldset: Some("Pcrop2bsr"),
                }),
            },
            BlockItem {
                name: "pcrop2ber",
                description: Some("Flash PCROP zone B End address register bank 2"),
                array: None,
                byte_offset: 0x58,
                inner: BlockItemInner::Register(Register {
                    access: Access::Read,
                    bit_size: 32,
                    fieldset: Some("Pcrop2ber"),
                }),
            },
            BlockItem {
                name: "secr",
    ...
    fieldsets: &[
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "mer2",
                    description: Some("Mass erase bank 2"),
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "n_swap_bank",
                    description: Some("Bank swap configuration"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 20 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "dual_bank",
                    description: Some("Dual bank operation"),
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "sec_size_2",
                    description: Some("Securable memory area size, bank 2"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 20 }),
                    bit_size: 8,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "wrp2a_strt",
                    description: Some("WRP area A start offset bank 2"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 7,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "wrp2a_end",
                    description: Some("WRP area A end offset bank 2"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 16 }),
                    bit_size: 7,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "wrp2b_strt",
                    description: Some("WRP area B start offset bank 2"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 7,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "wrp2b_end",
                    description: Some("WRP area B end offset bank 2"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 16 }),
                    bit_size: 7,
                    array: None,
                    enumm: None,
