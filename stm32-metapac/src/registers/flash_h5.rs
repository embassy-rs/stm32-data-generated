...
pub(crate) static REGISTERS: IR = IR {
    blocks: &[Block {
        ...
        items: &[
            ...
            BlockItem {
                name: "nsobkkeyr",
                description: Some("FLASH non-secure OBK key register"),
                array: None,
                byte_offset: 0x10,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "secobkkeyr",
                description: Some("FLASH secure OBK key register"),
                array: None,
                byte_offset: 0x14,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "nsccr",
                description: Some("FLASH non-secure clear control register"),
                array: None,
                byte_offset: 0x30,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "secccr",
                description: Some("FLASH secure clear control register"),
                array: None,
                byte_offset: 0x34,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
                    fieldset: Some("Secccr"),
                }),
            },
            BlockItem {
                name: "privcfgr",
            ...
            BlockItem {
                name: "nsobkcfgr",
                description: Some("FLASH non-secure OBK configuration register"),
                array: None,
                byte_offset: 0x40,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
                    fieldset: Some("Nsobkcfgr"),
                }),
            },
            BlockItem {
                name: "secobkcfgr",
                description: Some("FLASH secure OBK configuration register"),
                array: None,
                byte_offset: 0x44,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
                    fieldset: Some("Secobkcfgr"),
                }),
            },
            BlockItem {
                name: "hdpextr",
            ...
            BlockItem {
                name: "nsepochr_cur",
                description: Some("FLASH non-secure EPOCH register"),
                array: None,
                byte_offset: 0x60,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
                    fieldset: Some("Nsepochr"),
                }),
            },
            BlockItem {
                name: "secepochr_cur",
                description: Some("FLASH secure EPOCH register"),
                array: None,
                byte_offset: 0x68,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
                    fieldset: Some("Secepochr"),
                }),
            },
            BlockItem {
                name: "optsr2_cur",
            ...
            BlockItem {
                name: "nsbootr_cur",
                description: Some("FLASH non-secure boot register"),
                array: None,
                byte_offset: 0x80,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
                    fieldset: Some("Nsbootr"),
                }),
            },
            BlockItem {
                name: "nsbootr_prg",
            ...
            BlockItem {
                name: "secbootr_cur",
                description: Some("FLASH secure boot register"),
                array: None,
                byte_offset: 0x88,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
                    fieldset: Some("Secbootr"),
                }),
            },
            BlockItem {
                name: "bootr_prg",
            ...
            BlockItem {
                name: "otpblr_cur",
                description: Some("FLASH non-secure OTP block lock"),
                array: None,
                byte_offset: 0x90,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "secbb1r1",
                description: Some("FLASH secure block based register for Bank 1"),
                array: None,
                byte_offset: 0xa0,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "privbb1r1",
                description: Some("FLASH privilege block based register for Bank 1"),
                array: None,
                byte_offset: 0xc0,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
                    fieldset: Some("Privbb"),
                }),
            },
            BlockItem {
                name: "privbb1r2",
            ...
            BlockItem {
                name: "secwm1r_cur",
                description: Some("FLASH security watermark for Bank 1"),
                array: None,
                byte_offset: 0xe0,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "wrp1r_cur",
                description: Some("FLASH write sector group protection for Bank 1"),
                array: None,
                byte_offset: 0xe8,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "edata1r_cur",
                description: Some("FLASH data sector configuration Bank 1"),
                array: None,
                byte_offset: 0xf0,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
                    fieldset: Some("Edata1r"),
                }),
            },
            BlockItem {
                name: "edata1r_prg",
            ...
            BlockItem {
                name: "hdp1r_cur",
                description: Some("FLASH HDP Bank 1 configuration"),
                array: None,
                byte_offset: 0xf8,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "secbb2r1",
                description: Some("FLASH secure block-based register for Bank 2"),
                array: None,
                byte_offset: 0x1a0,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "privbb2r1",
                description: Some("FLASH privilege block-based register for Bank 2"),
                array: None,
                byte_offset: 0x1c0,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "secwm2r_cur",
                description: Some("FLASH security watermark for Bank 2"),
                array: None,
                byte_offset: 0x1e0,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "wrp2r_cur",
                description: Some("FLASH write sector group protection for Bank 2"),
                array: None,
                byte_offset: 0x1e8,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "edata2r_cur",
                description: Some("FLASH data sectors configuration Bank 2"),
                array: None,
                byte_offset: 0x1f0,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
                    fieldset: Some("Edata2r"),
                }),
            },
            BlockItem {
                name: "edata2r_prg",
                description: Some("FLASH data sector configuration Bank 2"),
                array: None,
                byte_offset: 0x1f4,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "hdp2r_cur",
                description: Some("FLASH HDP Bank 2 configuration"),
                array: None,
                byte_offset: 0x1f8,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
    ...
    fieldsets: &[
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "secboot_lock",
                    description: Some("A field locking the values of UBE, SWAP_ BANK, and SECBOOTADD setting."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 8,
                    array: None,
                    enumm: Some("BootrSecbootLock"),
                },
                Field {
                    name: "secbootadd",
                    description: Some(
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "edata1_en",
                    description: Some("Bank 1 flash high-cycle data enable"),
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "edata2_en",
                    description: Some("Bank 2 flash high-cycle data enable"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 15 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "hdp1_strt",
                    description: Some("HDPL barrier start set in number of 8-Kbyte sectors"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 7,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "hdp1_end",
                    description: Some("HDPL barrier end set in number of 8-Kbyte sectors"),
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "nsboot_lock",
                    description: Some("A field locking the values of SWAP_ BANK, and NSBOOTADD settings."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 8,
                    array: None,
                    enumm: Some("NsbootrNsbootLock"),
                },
                Field {
                    name: "nsbootadd",
                    description: Some(
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    ...
                    description: Some("Clear the flag corresponding flag in FLASH_NSSR by writing this bit."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 23 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[Field {
                name: "ns_epoch",
                description: Some("Non-volatile non-secure EPOCH counter"),
                bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                bit_size: 24,
                array: None,
                enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    ...
                    bit_size: 2,
                    array: None,
                    enumm: Some("OptsrBorLev"),
                },
                Field {
                    name: "borh_en",
                    description: Some("Brownout high enable"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 2 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "sram13_rst",
                    description: Some("SRAM1 and SRAM3 erase upon system reset"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 2 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "bkpram_ecc",
                    description: Some("Backup RAM ECC detection and correction disable"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 4 }),
                    bit_size: 1,
                    array: None,
                    enumm: Some("OptsrBkpramEcc"),
                },
                Field {
                    name: "sram3_ecc",
                    description: Some("SRAM3 ECC detection and correction disable"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 5 }),
                    bit_size: 1,
                    array: None,
                    enumm: Some("OptsrSramEcc"),
                },
                Field {
                    name: "sram2_ecc",
                ...
                Field {
                    name: "usbpd_dis",
                    description: Some("USB power delivery configuration option bit"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 8 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[Field {
                name: "privbb",
                description: Some("Privileged / non-privileged 8-Kbyte flash Bank 2 sector attribute"),
                bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                bit_size: 32,
                array: None,
                enumm: Some("PrivbbrPrivbb"),
            }],
        },
        FieldSet {
            name: "Privcfgr",
            ...
            fields: &[
                Field {
                    name: "spriv",
                    description: Some("privilege attribute for secure registers"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 1,
                    array: None,
                    enumm: Some("Spriv"),
                ...
                Field {
                    name: "nspriv",
                    description: Some("privilege attribute for non secure registers"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 1 }),
                    bit_size: 1,
                    array: None,
                    enumm: Some("Nspriv"),
        ...
        FieldSet {
            ...
            fields: &[Field {
                name: "secbb",
                description: Some("Secure/non-secure flash Bank 2 sector attribute"),
                bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                bit_size: 32,
                array: None,
                enumm: Some("SecbbrSecbb"),
            }],
        },
        FieldSet {
            name: "Secbootr",
            ...
            fields: &[
                Field {
                    name: "secboot_lock",
                    description: Some("A field locking the values of UBE, SWAP_BANK, and SECBOOTADD settings."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 8,
                    array: None,
                    enumm: Some("SecbootrSecbootLock"),
                },
                Field {
                    name: "secbootadd",
                    description: Some("Unique boot entry secure address \r These bits reflect the Secure UBE address"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 8 }),
                    bit_size: 24,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[Field {
                name: "sec_epoch",
                description: Some("Non-volatile secure EPOCH counter"),
                bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                bit_size: 24,
                array: None,
                enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "swap_offset",
                    description: Some("key index (offset /16 bits) pointing for next swap.\r …"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 16 }),
                    bit_size: 9,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "secwmstrt",
                    description: Some("Bank2 security WM area start sector"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 7,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "secwmend",
                    description: Some("Bank2 security WM end sector"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 16 }),
                    bit_size: 7,
                    array: None,
                    enumm: None,
    ...
    enums: &[
        ...
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "B0x0",
                    description: Some("No flash operation on going during previous reset"),
                    value: 0,
                },
                EnumVariant {
                    name: "B0x1",
                ...
                EnumVariant {
                    name: "B0x2",
                    description: Some("OBK alternate sector erase"),
                    value: 2,
                },
                EnumVariant {
                    name: "B0x3",
                    description: Some("Sector erase operation interrupted"),
                    value: 3,
                },
                EnumVariant {
                    name: "B0x4",
                ...
                EnumVariant {
                    name: "B0x7",
                    description: Some("OBK swap sector request"),
                    value: 7,
                },
            ],
        },
        ...
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "B0x0",
                    description: Some("Bank1 is selected for Bank erase / sector erase / interrupt enable"),
                    value: 0,
                },
                EnumVariant {
                    name: "B0x1",
                    description: Some("Bank2 is selected for BER / SER"),
                    value: 1,
                },
            ],
        },
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "B0x0",
                    description: Some("access to non secure registers is always granted"),
                    value: 0,
                },
                EnumVariant {
                    name: "B0x1",
                    description: Some("access to non secure registers is denied in case of unprivileged access."),
                    value: 1,
                },
            ],
        },
        ...
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "B0x0",
                    description: Some("BKPRAM ECC check enabled"),
                    value: 0,
                },
                EnumVariant {
                    name: "B0x1",
                    description: Some("BKPRAM ECC check disabled"),
                    value: 1,
                },
            ],
        },
        Enum {
            ...
            variants: &[
                ...
                EnumVariant {
                    name: "B0xC3",
                    description: Some("ST-iRoT (system flash) selected"),
                    value: 195,
                },
            ],
        },
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "B0x1",
                    description: Some("BOR Level 2, the threshold level is medium (around 2.4 V)"),
                    value: 1,
                },
                EnumVariant {
                    name: "B0x2",
                    description: Some("BOR Level 3, the threshold level is high (around 2.7 V)"),
                    value: 2,
                },
            ],
        },
        ...
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "B0xB4",
                    description: Some("TrustZone enabled."),
                    value: 180,
                },
                EnumVariant {
                    name: "B0xC3",
                    description: Some("TrustZone disabled"),
                    value: 195,
                },
            ],
        },
        ...
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "B0x0",
                    description: Some("sectors (32 * (x-1) + y) in bank 2 is unprivileged"),
                    value: 0,
                },
                EnumVariant {
                    name: "B0x1",
                    description: Some("sector (32 * (x-1) + y) in bank 2 is privileged"),
                    value: 1,
                },
            ],
        },
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "B0x0",
                    description: Some("sectors (32 * (x-1) + y) in bank 2 is non secure"),
                    value: 0,
                },
                EnumVariant {
                    name: "B0x1",
                    description: Some("sector (32 * (x-1) + y) in bank 2 is secure"),
                    value: 1,
                },
            ],
        },
        ...
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "B0x0",
                    description: Some("access to secure registers is always granted"),
                    value: 0,
                },
                EnumVariant {
                    name: "B0x1",
                    description: Some("access to secure registers is denied in case of unprivileged access."),
                    value: 1,
                },
            ],
        },
