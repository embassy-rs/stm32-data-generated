...
pub(crate) static REGISTERS: IR = IR {
    blocks: &[Block {
        ...
        items: &[
            ...
            BlockItem {
                name: "nsbootr_cur",
                description: Some("FLASH non-secure unique boot entry register"),
                array: None,
                byte_offset: 0x80,
                inner: BlockItemInner::Register(Register {
                    access: Access::Read,
            ...
            BlockItem {
                name: "nsbootr_prg",
                description: Some("FLASH non-secure unique boot entry address"),
                array: None,
                byte_offset: 0x84,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "privbb1r",
                description: Some("FLASH privilege register for bank 1"),
                array: None,
                byte_offset: 0xc0,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "wrpsgn1r_cur",
                description: Some("FLASH write sector protection for Bank1"),
                array: None,
                byte_offset: 0xe8,
                inner: BlockItemInner::Register(Register {
                    access: Access::Read,
            ...
            BlockItem {
                name: "ecccorr",
                description: Some("FLASH Flash ECC correction register"),
                array: None,
                byte_offset: 0x100,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "wrpsgn2r_cur",
                description: Some("FLASH write sector protection for Bank2"),
                array: None,
                byte_offset: 0x1e8,
                inner: BlockItemInner::Register(Register {
                    access: Access::Read,
    ...
    fieldsets: &[
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "hdp1_strt",
                    description: Some("HDPL barrier start set in number of 8 Kbytes sectors"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 3,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "hdp1_end",
                    description: Some("HDPL barrier end set in number of 8 Kbytes sectors"),
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "hdp2_strt",
                    description: Some("Bank 2 HDPL barrier start set in number of 8 Kbytes sectors"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 3,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "hdp2_end",
                    description: Some("Bank 2 HDPL barrier end set in number of 8 Kbytes sectors"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 16 }),
                    bit_size: 3,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "nsboot_lock",
                    description: Some("A field locking the values of SWAP_BANK, and NSBOOTADD settings."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 8,
                    array: None,
                ...
                Field {
                    name: "nsbootadd",
                    description: Some("unique boot entry address\r These bits reflect the UBE address"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 8 }),
                    bit_size: 24,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "borh_en",
                    description: Some("Brownout high enable status bit"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 2 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "nrst_shdw",
                    description: Some("Core domain Shutdown entry reset option status bit"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 5 }),
                    bit_size: 1,
                    array: None,
                    enumm: Some("OptsrNrstShdw"),
                },
                Field {
                    name: "nrst_stop",
                ...
                Field {
                    name: "product_state",
                    description: Some("Life state code (based on Hamming 8,4)."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 8 }),
                    bit_size: 8,
                    array: None,
                    enumm: Some("ProductState"),
                },
                Field {
                    name: "io_vdd_hslv",
                    description: Some(
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "sram1_ecc",
                    description: Some("SRAM1 ECC detection and correction disable"),
        ...
        FieldSet {
            ...
            fields: &[Field {
                name: "privbb",
                description: Some("Privileged / unprivileged 8 Kbytes Flash Bank1 sector attribute (y = 0 to 7)"),
                bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                bit_size: 8,
                array: None,
                enumm: Some("Privbb"),
    ...
    enums: &[
        ...
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "B0xB4",
                    description: Some("The NSBOOTADD and SWAP_BANK are frozen."),
                    value: 180,
                },
                EnumVariant {
                    name: "B0xC3",
        ...
        Enum {
            ...
            variants: &[
                ...
                EnumVariant {
                    name: "B0x1",
                    description: Some("access to non secure registers is denied in case of non privileged access."),
                    value: 1,
                },
            ],
        },
        ...
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "B0x0",
                    description: Some("BOR OFF, POR/PDR reset threshold level is applied"),
                    value: 0,
                },
                EnumVariant {
                    name: "B0x1",
                    description: Some("BOR Level 1, the threshold level is low (around 2.1 V)"),
                    value: 1,
                },
                EnumVariant {
                    name: "B0x2",
        ...
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "B0x0",
                    description: Some("High-speed IO at low VDD voltage feature disabled (VDD can exceed 2.5 V)"),
                    value: 0,
                },
                EnumVariant {
                    name: "B0x1",
                    description: Some("High-speed IO at low VDD voltage feature enabled (VDD remains below 2.5 V)"),
                    value: 1,
                },
            ],
        },
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "B0x0",
                    description: Some("High-speed IO at low VDDIO2 voltage feature disabled (VDDIO2 can exceed 2.5 V)"),
                    value: 0,
                },
                EnumVariant {
                    name: "B0x1",
        ...
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "B0x0",
                    description: Some("a reset is generated when entering Shutdown mode on core domain"),
                    value: 0,
                },
                EnumVariant {
                    name: "B0x1",
                    description: Some("no reset generated when entering Shutdown mode on core domain."),
                    value: 1,
                },
            ],
        },
        ...
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "B0x0",
                    description: Some("sectors y in bank 1 is non privileged"),
                    value: 0,
                },
                EnumVariant {
                    name: "B0x1",
                    description: Some("sector y in bank 1 is privileged"),
                    value: 1,
                },
            ],
        },
        Enum {
            ...
            variants: &[
                ...
                EnumVariant {
                    name: "IrotProvisioned",
                    description: Some("iROT-Provisioned"),
                    value: 46,
                },
                EnumVariant {
                    name: "Locked",
                ...
                EnumVariant {
                    name: "Open",
                    description: Some("Open"),
                    value: 237,
                },
                EnumVariant {
                    name: "Provisioning",
                    description: Some("Provisioning"),
                    value: 23,
                },
                EnumVariant {
                    name: "Regression",
                    description: Some("Regression"),
                    value: 154,
                },
            ],
        },
