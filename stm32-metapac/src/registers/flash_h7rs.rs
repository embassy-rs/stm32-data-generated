...
pub(crate) static REGISTERS: IR = IR {
    blocks: &[Block {
        name: "Flash",
        extends: None,
        description: Some("Embedded Flash memory."),
        items: &[
            BlockItem {
                name: "acr",
            ...
            BlockItem {
                name: "keyr",
                description: Some("FLASH control key register."),
                array: None,
                byte_offset: 0x4,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "ier",
                description: Some("FLASH interrupt enable register."),
                array: None,
                byte_offset: 0x20,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "isr",
                description: Some("FLASH interrupt status register."),
                array: None,
                byte_offset: 0x24,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "icr",
                description: Some("FLASH interrupt clear register."),
                array: None,
                byte_offset: 0x28,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "crccr",
                description: Some("FLASH CRC control register."),
                array: None,
                byte_offset: 0x30,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "crcsaddr",
                description: Some("FLASH CRC start address register."),
                array: None,
                byte_offset: 0x34,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
                    fieldset: Some("Crcsaddr"),
                }),
            },
            BlockItem {
                name: "crceaddr",
                description: Some("FLASH CRC end address register."),
                array: None,
                byte_offset: 0x38,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
                    fieldset: Some("Crceaddr"),
                }),
            },
            BlockItem {
                name: "crcdatar",
                description: Some("FLASH CRC data register."),
                array: None,
                byte_offset: 0x3c,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
                    fieldset: Some("Crcdatar"),
                }),
            },
            BlockItem {
                name: "eccsfaddr",
                description: Some("FLASH ECC single error fail address."),
                array: None,
                byte_offset: 0x40,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
                    fieldset: Some("Eccsfaddr"),
                }),
            },
            BlockItem {
                name: "eccdfaddr",
                description: Some("FLASH ECC double error fail address."),
                array: None,
                byte_offset: 0x44,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
                    fieldset: Some("Eccdfaddr"),
                }),
            },
            BlockItem {
                name: "optkeyr",
                description: Some("FLASH options key register."),
                array: None,
                byte_offset: 0x100,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "optcr",
                description: Some("FLASH options control register."),
                array: None,
                byte_offset: 0x104,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "optisr",
                description: Some("FLASH options interrupt status register."),
                array: None,
                byte_offset: 0x108,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
                    fieldset: Some("Optisr"),
                }),
            },
            BlockItem {
                name: "opticr",
                description: Some("FLASH options interrupt clear register."),
                array: None,
                byte_offset: 0x10c,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
                    fieldset: Some("Opticr"),
                }),
            },
            BlockItem {
                name: "obkcr",
                description: Some("FLASH option byte key control register."),
                array: None,
                byte_offset: 0x110,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "obkdr",
                description: Some("FLASH option bytes key data register 0."),
            ...
            BlockItem {
                name: "nvsr",
                description: Some("FLASH non-volatile status register."),
                array: None,
                byte_offset: 0x200,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "nvsrp",
                description: Some("FLASH security status register programming."),
                array: None,
                byte_offset: 0x204,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "rotsr",
                description: Some("FLASH RoT status register."),
                array: None,
                byte_offset: 0x208,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "rotsrp",
                description: Some("FLASH RoT status register programming."),
                array: None,
                byte_offset: 0x20c,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
                    fieldset: Some("Rotsrp"),
                }),
            },
            BlockItem {
                name: "otplsr",
                description: Some("FLASH OTP lock status register."),
                array: None,
                byte_offset: 0x210,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
                    fieldset: Some("Otplsr"),
                }),
            },
            BlockItem {
                name: "otplsrp",
                description: Some("FLASH OTP lock status register programming."),
                array: None,
                byte_offset: 0x214,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
                    fieldset: Some("Otplsrp"),
                }),
            },
            BlockItem {
                name: "wrpsr",
                description: Some("FLASH write protection status register."),
                array: None,
                byte_offset: 0x218,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "wrpsrp",
                description: Some("FLASH write protection status register programming."),
                array: None,
                byte_offset: 0x21c,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
                    fieldset: Some("Wrpsrp"),
                }),
            },
            BlockItem {
                name: "hdpsr",
                description: Some("FLASH hide protection status register."),
                array: None,
                byte_offset: 0x230,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "hdpsrp",
                description: Some("FLASH hide protection status register programming."),
                array: None,
                byte_offset: 0x234,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
                    fieldset: Some("Hdpsrp"),
                }),
            },
            BlockItem {
                name: "epochsr",
                description: Some("FLASH epoch status register."),
                array: None,
                byte_offset: 0x250,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
                    fieldset: Some("Epochsr"),
                }),
            },
            BlockItem {
                name: "epochsrp",
                ...
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
                    fieldset: Some("Epochsrp"),
                }),
            },
            BlockItem {
                name: "obw1sr",
                description: Some("FLASH option byte word 1 status register."),
                array: None,
                byte_offset: 0x260,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
                    fieldset: Some("Obw1sr"),
                }),
            },
            BlockItem {
                name: "obw1srp",
                description: Some("FLASH option byte word 1 status register programming."),
                array: None,
                byte_offset: 0x264,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
                    fieldset: Some("Obw1srp"),
                }),
            },
            BlockItem {
                name: "obw2sr",
                description: Some("FLASH option byte word 2 status register."),
                array: None,
                byte_offset: 0x268,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
                    fieldset: Some("Obw2sr"),
                }),
            },
            BlockItem {
                name: "obw2srp",
                description: Some("FLASH option byte word 2 status register programming."),
                array: None,
                byte_offset: 0x26c,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
                    fieldset: Some("Obw2srp"),
                }),
            },
        ],
    }],
    fieldsets: &[
        ...
        FieldSet {
            ...
            fields: &[Field {
                name: "epoch",
                description: Some("Epoch This value is distributed by hardware to the SAES peripheral."),
                bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                bit_size: 24,
                array: None,
                enumm: None,
        ...
        FieldSet {
            ...
            fields: &[Field {
                name: "epoch",
                description: Some("Epoch programming Write to change corresponding bits in FLASH_EPOCHSR register."),
                bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                bit_size: 24,
                array: None,
                enumm: None,
        ...
        FieldSet {
            ...
            fields: &[Field {
                name: "rcheckf",
                description: Some("Root code check flag clear Set this bit to clear RCHECKF bit in FLASH_SR."),
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "crcendf",
                    description: Some("CRC end flag clear Setting this bit clears CRCENDF flag in FLASH_ISR register."),
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "eopie",
                    description: Some("End-of-program interrupt control bit."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 16 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "oblerrie",
                    description: Some("Option byte loading error interrupt enable bit."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 20 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "rdserrie",
                    description: Some("Read security error interrupt enable bit."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 24 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "sneccerrie",
                    description: Some("ECC single correction error interrupt enable bit."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 25 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "dbeccerrie",
                    description: Some("ECC double detection error interrupt enable bit."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 26 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "crcendie",
                    description: Some("CRC end of calculation interrupt enable bit."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 27 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "crcrderrie",
                    description: Some("CRC read error interrupt enable bit."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 28 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[Field {
                name: "nvstate",
                description: Some("Non-volatile state others: invalid configuration."),
                bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                bit_size: 8,
                array: None,
                enumm: Some("NvsrNvstate"),
            }],
        },
        FieldSet {
            name: "Nvsrp",
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "nextkl",
                    description: Some("Next key level 10 or 11: reserved."),
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "iwdg_hw",
                    description: Some("Independent watchdog HW Control."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 4 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "nrst_stop",
                    description: Some("Reset on stop mode."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 6 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "nrst_stby",
                    description: Some("Reset on standby mode."),
                ...
                Field {
                    name: "octo1_hslv",
                    description: Some("XSPIM_P1 High-Speed at Low-Voltage."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 8 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "octo2_hslv",
                    description: Some("XSPIM_P2 High-Speed at Low-Voltage."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 9 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "perso_ok",
                    description: Some("Personalization OK This bit is set on STMicroelectronics production line."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 28 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "bor_lev",
                    description: Some("Brownout level Write to change corresponding bits in FLASH_OBW1SR register."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 2 }),
                    bit_size: 2,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "itcm_axi_share",
                    description: Some("ITCM SRAM configuration."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 3,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "dtcm_axi_share",
                    description: Some("DTCM SRAM configuration."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 4 }),
                    bit_size: 3,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "i2c_ni3c",
                    description: Some("I2C Not I3C Write to change corresponding bit in FLASH_OBW2SR register."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 9 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "pg_opt",
                    description: Some("Program options."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 1 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "kvef",
                    description: Some("key valid error flag Set this bit to clear KVEF flag in FLASH_OPTISR register."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 27 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "oem_provd",
                    description: Some("OEM provisioned device Any other value: device is not provisioned by the OEM."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 8,
                    array: None,
                    enumm: Some("OemProvd"),
    ...
    enums: &[
        ...
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "Word16",
                    description: Some("every burst has a size of 16 Flash words (256 Bytes)."),
                    value: 1,
                },
                EnumVariant {
                    name: "Word256",
                    description: Some("every burst has a size of 256 Flash words (4 Kbytes)."),
                    value: 3,
                },
                EnumVariant {
                    name: "Word4",
                    description: Some("every burst has a size of 4 Flash words (64 Bytes)."),
                    value: 0,
                },
                EnumVariant {
                    name: "Word64",
                    description: Some("every burst has a size of 64 Flash words (1 Kbytes)."),
                    value: 2,
                },
            ],
        },
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "Delegated",
                    description: Some("Delegated debug (to OEM iRoT code in user Flash)."),
                    value: 111,
                },
                EnumVariant {
                    name: "Ecdsa",
                    description: Some("Authentication method using ECDSA signature (NIST P256)."),
                    value: 81,
                },
                EnumVariant {
                    name: "Locked",
                    description: Some("Locked device (no debug allowed)."),
                    value: 180,
                },
                EnumVariant {
                    name: "Password",
                    description: Some("Authentication method using password."),
                    value: 138,
                },
            ],
        },
        Enum {
            ...
            variants: &[EnumVariant {
                name: "Selected",
                description: Some("ST iRoT is selected at boot."),
                value: 180,
            }],
        },
        Enum {
        ...
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "Closed",
                    description: Some("CLOSED device."),
                    value: 81,
                },
                EnumVariant {
                    name: "Open",
                    description: Some("OPEN device."),
                    value: 180,
                },
            ],
        },
        ...
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "Bits128",
                    description: Some("Key size is 128 bits."),
                    value: 2,
                },
                EnumVariant {
                    name: "Bits256",
                    description: Some("Key size is 256 bits."),
                    value: 3,
                },
                EnumVariant {
                    name: "Bits32",
                    description: Some("Key size is 32 bits."),
                    value: 0,
                },
                EnumVariant {
                    name: "Bits64",
                    description: Some("Key size is 64 bits."),
                    value: 1,
                },
            ],
        },
        Enum {
            ...
            variants: &[EnumVariant {
                name: "Provisioned",
                description: Some("Device has been provisioned by the OEM."),
                value: 180,
            }],
        },
    ],
