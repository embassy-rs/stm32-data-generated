...
pub(crate) static REGISTERS: IR = IR {
    blocks: &[Block {
        name: "Flash",
        extends: None,
        description: Some("Mamba FLASH register block"),
        items: &[
            BlockItem {
                name: "acr",
    ...
    fieldsets: &[
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "prften",
                    description: Some("CPU Prefetch enable"),
                ...
                Field {
                    name: "icen",
                    description: Some("CPU Instruction cache enable"),
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "pg",
                    description: Some("Flash memory programming enable"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "per",
                    description: Some("Page erase enable"),
                ...
                Field {
                    name: "fstpg",
                    description: Some("Fast programming enable"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 18 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "rdp",
                    description: Some("Read protection level Other: Level 1, memories read protection active"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 8,
                    array: None,
                    enumm: Some("Rdp"),
                ...
                Field {
                    name: "nrst_shdw",
                    description: Some("Reset generated when entering Shutdown mode"),
                ...
                Field {
                    ...
                    description: Some("SRAM parity check control enable/disable"),
                ...
                Field {
                    ...
                    description: Some("Backup SRAM erase prevention"),
                ...
                Field {
                    name: "nrst_mode",
                    description: Some("NRST pin configuration"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 27 }),
                    bit_size: 2,
                    array: None,
                    enumm: Some("NrstMode"),
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "hdp1_pend",
                    description: Some("Last page of the first hide protection area"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 7,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "hdp1en",
                    description: Some("Hide protection area enable"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 24 }),
                    bit_size: 8,
                    array: None,
                    enumm: None,
    ...
    enums: &[
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "Level1",
                    description: Some("BOR rising level 1 with threshold around 2.1 V"),
                    value: 0,
                },
                EnumVariant {
                    name: "Level2",
                    description: Some("BOR rising level 2 with threshold around 2.3 V"),
                    value: 1,
                },
                EnumVariant {
                    name: "Level3",
                    description: Some("BOR rising level 3 with threshold around 2.6 V"),
                    value: 2,
                },
                EnumVariant {
                    name: "Level4",
                    description: Some("BOR rising level 4 with threshold around 2.9 V"),
                    value: 3,
                },
            ],
        },
        Enum {
            ...
            variants: &[
                ...
                EnumVariant {
                    name: "OnlyInternal",
                    description: Some("Standard GPIO: only internal RESET is possible"),
                    value: 2,
                },
            ],
        },
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "Level0",
                    description: Some("Level 0, read protection not active"),
                    value: 170,
                },
                EnumVariant {
                    name: "Level2",
                    description: Some("Level 2, chip read protection active"),
                    value: 204,
                },
            ],
        },
