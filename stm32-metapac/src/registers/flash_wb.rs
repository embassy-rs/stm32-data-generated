...
pub(crate) static REGISTERS: IR = IR {
    blocks: &[Block {
        ...
        items: &[
            ...
            BlockItem {
                name: "pcrop1asr",
                description: Some("Flash Bank 1 PCROP Start address zone A register"),
                array: None,
                byte_offset: 0x24,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
                    fieldset: Some("Pcrop1asr"),
                }),
            },
            BlockItem {
                name: "pcrop1aer",
                description: Some("Flash Bank 1 PCROP End address zone A register"),
                array: None,
                byte_offset: 0x28,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
                    fieldset: Some("Pcrop1aer"),
                }),
            },
            BlockItem {
                name: "wrp1ar",
            ...
            BlockItem {
                name: "pcrop1bsr",
                description: Some("Flash Bank 1 PCROP Start address area B register"),
                array: None,
                byte_offset: 0x34,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
                    fieldset: Some("Pcrop1bsr"),
                }),
            },
            BlockItem {
                name: "pcrop1ber",
                description: Some("Flash Bank 1 PCROP End address area B register"),
                array: None,
                byte_offset: 0x38,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
                    fieldset: Some("Pcrop1ber"),
                }),
            },
            BlockItem {
                name: "ipccbr",
                description: Some("IPCC mailbox data buffer address register"),
                array: None,
                byte_offset: 0x3c,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
                    fieldset: Some("Ipccbr"),
                }),
            },
            BlockItem {
                name: "c2acr",
                description: Some("CPU2 cortex M0 access control register"),
                array: None,
                byte_offset: 0x5c,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "c2sr",
                description: Some("CPU2 cortex M0 status register"),
                array: None,
                byte_offset: 0x60,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "c2cr",
                description: Some("CPU2 cortex M0 control register"),
                array: None,
                byte_offset: 0x64,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "sfr",
                description: Some("Secure flash start address register"),
                array: None,
                byte_offset: 0x80,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "srrvr",
                description: Some("Secure SRAM2 start address and cortex M0 reset vector register"),
                array: None,
                byte_offset: 0x84,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
    ...
    fieldsets: &[
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "pes",
                    description: Some("CPU1 CortexM4 program erase suspend request"),
                ...
                Field {
                    name: "empty",
                    description: Some("Flash User area empty"),
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "prften",
                    description: Some("CPU2 cortex M0 prefetch enable"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 8 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "icen",
                    description: Some("CPU2 cortex M0 instruction cache enable"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 9 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "icrst",
                    description: Some("CPU2 cortex M0 instruction cache reset"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 11 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "pes",
                    description: Some("CPU2 cortex M0 program erase suspend request"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 15 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "pnb",
                    description: Some("Page Number selection"),
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "cfgbsy",
                    description: Some("Programming or erase configuration busy"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 18 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "pesd",
                    description: Some("Programming or erase operation suspended"),
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "mer",
                    description: Some("This bit triggers the mass erase (all user pages) when set"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 2 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "cpuid",
                    description: Some("CPU identification"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 26 }),
                    bit_size: 3,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[Field {
                name: "ipccdba",
                description: Some("PCC mailbox data buffer base address"),
                bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                bit_size: 14,
                array: None,
                enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "ese",
                    description: Some("Security enabled"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 8 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "agc_trim",
                    description: Some("Radio Automatic Gain Control Trimming"),
        ...
        FieldSet {
            ...
            fields: &[Field {
                name: "pcrop1a_strt",
                description: Some("Bank 1 PCROPQ area start offset"),
                bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                bit_size: 9,
                array: None,
                enumm: None,
        ...
        FieldSet {
            ...
            fields: &[Field {
                name: "pcrop1b_end",
                description: Some("Bank 1 PCROP area end area B offset"),
                bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                bit_size: 9,
                array: None,
                enumm: None,
        ...
        FieldSet {
            ...
            fields: &[Field {
                name: "pcrop1b_strt",
                description: Some("Bank 1 PCROP area B start offset"),
                bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                bit_size: 9,
                array: None,
                enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "sfsa",
                    description: Some("Secure flash start address"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 8,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "fsd",
                    description: Some("Flash security disable"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 8 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "dds",
                    description: Some("Disable Cortex M0 debug access"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 12 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "optnv",
                    description: Some("User Option OPTVAL indication"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 13 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "sbrv",
                    description: Some("cortex M0 access control register"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 18,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "sbrsa",
                    description: Some("Secure backup SRAM2a start address"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 18 }),
                    bit_size: 5,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "brsd",
                    description: Some("backup SRAM2a security disable"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 23 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "snbrsa",
                    description: Some("Secure non backup SRAM2a start address"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 25 }),
                    bit_size: 5,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "nbrsd",
                    description: Some("non-backup SRAM2b security disable"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 30 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "c2opt",
                    description: Some("CPU2 cortex M0 boot reset vector memory selection"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 31 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "wrp1a_strt",
                    description: Some("Bank 1 WRP first area A start offset"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 8,
                    array: None,
                    enumm: None,
