...
pub(crate) static REGISTERS: IR = IR {
    blocks: &[Block {
        ...
        items: &[
            ...
            BlockItem {
                name: "ccr",
                description: Some("GFXMMU cache control register."),
                array: None,
                byte_offset: 0xc,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
    ...
    fieldsets: &[
        FieldSet {
            name: "Bcr",
            extends: None,
            description: Some("GFXMMU buffer configuration register."),
            bit_size: 32,
            fields: &[
                Field {
                    name: "pbo",
                    description: Some("Physical buffer offset. Offset of the physical buffer."),
                ...
                Field {
                    name: "pbba",
                    description: Some("Physical buffer base address. Base address MSB of the physical buffer."),
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "bm",
                    description: Some("192 Block mode. This bit defines the number of blocks per line."),
                ...
                Field {
                    name: "ce",
                    description: Some("Cache enable. This bit enables the cache unit."),
                ...
                Field {
                    name: "cl",
                    description: Some("Cache lock. This bit lock the cache onto the buffer defined in the CLB field."),
                ...
                Field {
                    name: "clb",
                    description: Some("Cache lock buffer. This field select the buffer on which the cache is locked."),
                ...
                Field {
                    name: "pd",
                    description: Some("Prefetch disable. This bit disables the prefetch of the cache."),
        ...
        FieldSet {
            name: "Luth",
            extends: None,
            description: Some("GFXMMU LUT entry high."),
            bit_size: 32,
            fields: &[Field {
                name: "lo",
                description: Some("Line offset. Line offset of line number x (i.e. offset of block 0 of line x)."),
                bit_offset: BitOffset::Regular(RegularBitOffset { offset: 4 }),
                bit_size: 18,
                array: None,
                enumm: None,
        ...
        FieldSet {
            name: "Lutl",
            extends: None,
            description: Some("GFXMMU LUT entry low."),
            bit_size: 32,
            fields: &[
                Field {
                    name: "en",
                    description: Some("Line enable."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "fvb",
                    description: Some("First Valid Block. Number of the first valid block of line number x."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 8 }),
                    bit_size: 8,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "lvb",
                    description: Some("Last Valid Block. Number of the last valid block of line number X."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 16 }),
                    bit_size: 8,
                    array: None,
                    enumm: None,
        ...
        Enum {
            ...
            variants: &[
                EnumVariant {
                    ...
                    description: Some("192 blocks per line."),
                    value: 1,
                },
                EnumVariant {
                    name: "_256blocksPerLine",
                    description: Some("256 blocks per line."),
                    value: 0,
                },
            ],
        },
        Enum {
            ...
            variants: &[
                EnumVariant {
                    ...
                    description: Some("Cache locked on buffer 0."),
                    value: 0,
                },
                EnumVariant {
                    name: "LockedOnBuffer1",
                    description: Some("Cache locked on buffer 1."),
                    value: 1,
                },
                EnumVariant {
                    name: "LockedOnBuffer2",
                    description: Some("Cache locked on buffer 2."),
                    value: 2,
                },
                EnumVariant {
                    name: "LockedOnBuffer3",
                    description: Some("Cache locked on buffer 3."),
                    value: 3,
                },
            ],
        },
