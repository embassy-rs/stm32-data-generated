    ...
    blocks: &[
        Block {
            ...
            items: &[
                BlockItem {
                    name: "lbar",
                    description: Some("GPDMA channel 15 linked-list base address register"),
                    array: None,
                    byte_offset: 0x0,
                    inner: BlockItemInner::Register(Register {
                        access: Access::ReadWrite,
                        bit_size: 32,
                        fieldset: Some("ChLbar"),
                    }),
                },
                BlockItem {
                    name: "fcr",
                    description: Some("GPDMA channel 15 flag clear register"),
                    array: None,
                    byte_offset: 0xc,
                    inner: BlockItemInner::Register(Register {
                        access: Access::ReadWrite,
                ...
                BlockItem {
                    name: "sr",
                    description: Some("GPDMA channel 15 status register"),
                    array: None,
                    byte_offset: 0x10,
                    inner: BlockItemInner::Register(Register {
                        access: Access::ReadWrite,
                ...
                BlockItem {
                    name: "cr",
                    description: Some("GPDMA channel 15 control register"),
                    array: None,
                    byte_offset: 0x14,
                    inner: BlockItemInner::Register(Register {
                        access: Access::ReadWrite,
                ...
                BlockItem {
                    name: "tr1",
                    description: Some("GPDMA channel 15 transfer register 1"),
                    array: None,
                    byte_offset: 0x40,
                    inner: BlockItemInner::Register(Register {
                        access: Access::ReadWrite,
                ...
                BlockItem {
                    name: "tr2",
                    description: Some("GPDMA channel 15 transfer register 2"),
                    array: None,
                    byte_offset: 0x44,
                    inner: BlockItemInner::Register(Register {
                        access: Access::ReadWrite,
                ...
                BlockItem {
                    name: "br1",
                    description: Some("GPDMA channel 15 alternate block register 1"),
                    array: None,
                    byte_offset: 0x48,
                    inner: BlockItemInner::Register(Register {
                        access: Access::ReadWrite,
                ...
                BlockItem {
                    name: "sar",
                    description: Some("GPDMA channel 15 source address register"),
                    array: None,
                    byte_offset: 0x4c,
                    inner: BlockItemInner::Register(Register {
                        access: Access::ReadWrite,
                ...
                BlockItem {
                    name: "dar",
                    description: Some("GPDMA channel 15 destination address register"),
                    array: None,
                    byte_offset: 0x50,
                    inner: BlockItemInner::Register(Register {
                        access: Access::ReadWrite,
                ...
                BlockItem {
                    name: "tr3",
                    description: Some("GPDMA channel 15 transfer register 3"),
                    array: None,
                    byte_offset: 0x54,
                    inner: BlockItemInner::Register(Register {
                        access: Access::ReadWrite,
                ...
                BlockItem {
                    name: "br2",
                    description: Some("GPDMA channel 15 block register 2"),
                    array: None,
                    byte_offset: 0x58,
                    inner: BlockItemInner::Register(Register {
                        access: Access::ReadWrite,
                ...
                BlockItem {
                    name: "llr",
                    description: Some("GPDMA channel 15 alternate linked-list address register"),
                    array: None,
                    byte_offset: 0x7c,
                    inner: BlockItemInner::Register(Register {
                        access: Access::ReadWrite,
        ...
        Block {
            name: "Gpdma",
            extends: None,
            description: Some("GPDMA"),
            items: &[
                BlockItem {
                    name: "seccfgr",
                    description: Some("GPDMA secure configuration register"),
                    array: None,
                    byte_offset: 0x0,
                    inner: BlockItemInner::Register(Register {
                        access: Access::ReadWrite,
                ...
                BlockItem {
                    name: "privcfgr",
                    description: Some("GPDMA privileged configuration register"),
                    array: None,
                    byte_offset: 0x4,
                    inner: BlockItemInner::Register(Register {
                        access: Access::ReadWrite,
                ...
                BlockItem {
                    name: "rcfglockr",
                    description: Some("GPDMA configuration lock register"),
                    array: None,
                    byte_offset: 0x8,
                    inner: BlockItemInner::Register(Register {
                        access: Access::ReadWrite,
                        bit_size: 32,
                        fieldset: Some("Rcfglockr"),
                    }),
                },
                BlockItem {
                    name: "misr",
                    description: Some("GPDMA non-secure masked interrupt status register"),
                    array: None,
                    byte_offset: 0xc,
                    inner: BlockItemInner::Register(Register {
                        access: Access::ReadWrite,
                ...
                BlockItem {
                    name: "smisr",
                    description: Some("GPDMA secure masked interrupt status register"),
                    array: None,
                    byte_offset: 0x10,
                    inner: BlockItemInner::Register(Register {
                        access: Access::ReadWrite,
                ...
                BlockItem {
                    name: "ch",
                    description: None,
                    array: Some(Array::Regular(RegularArray { len: 16, stride: 128 })),
                    byte_offset: 0x50,
                    inner: BlockItemInner::Block(BlockItemBlock { block: "Channel" }),
                },
            ],
        },
    ],
    fieldsets: &[
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "sdec",
                    description: Some("source address decrement"),
                ...
                Field {
                    name: "ddec",
                    description: Some("destination address decrement"),
        ...
        FieldSet {
            name: "ChBr2",
            extends: None,
            description: Some("GPDMA channel 12 block register 2"),
            bit_size: 32,
            fields: &[
                Field {
                    name: "brsao",
        ...
        FieldSet {
            name: "ChCr",
            extends: None,
            description: Some("GPDMA channel 11 control register"),
            bit_size: 32,
            fields: &[
                Field {
                    name: "en",
                ...
                Field {
                    name: "htie",
                    description: Some("half transfer complete interrupt enable"),
                ...
                Field {
                    name: "dteie",
                    description: Some("data transfer error interrupt enable"),
                ...
                Field {
                    name: "uleie",
                    description: Some("update link transfer error interrupt enable"),
                ...
                Field {
                    name: "useie",
                    description: Some("user setting error interrupt enable"),
                ...
                Field {
                    name: "suspie",
                    description: Some("completed suspension interrupt enable"),
                ...
                Field {
                    name: "toie",
                    description: Some("trigger overrun interrupt enable"),
        ...
        FieldSet {
            name: "ChFcr",
            extends: None,
            description: Some("GPDMA channel 7 flag clear register"),
            bit_size: 32,
            fields: &[
                Field {
                    name: "tcf",
                    description: Some("transfer complete flag clear"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 8 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "htf",
                    description: Some("half transfer flag clear"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 9 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "dtef",
                    description: Some("data transfer error flag clear"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 10 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "ulef",
                    description: Some("update link transfer error flag clear"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 11 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "usef",
                    description: Some("user setting error flag clear"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 12 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "suspf",
                    description: Some("completed suspension flag clear"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 13 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "tof",
                    description: Some("trigger overrun flag clear"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 14 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            name: "ChLbar",
            extends: None,
            description: Some("GPDMA channel 14 linked-list base address register"),
            bit_size: 32,
            fields: &[Field {
                name: "lba",
                description: Some("linked-list base address of GPDMA channel x"),
                bit_offset: BitOffset::Regular(RegularBitOffset { offset: 16 }),
                bit_size: 16,
                array: None,
                enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "dtef",
                    description: Some("data transfer error flag"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 10 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "ulef",
                    description: Some("update link transfer error flag"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 11 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "usef",
                    description: Some("user setting error flag"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 12 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "suspf",
                    description: Some("completed suspension flag"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 13 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "tof",
                    description: Some("trigger overrun flag"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 14 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            name: "ChTr1",
            extends: None,
            description: Some("GPDMA channel 8 transfer register 1"),
            bit_size: 32,
            fields: &[
                Field {
                    name: "sdw",
        ...
        FieldSet {
            name: "ChTr2",
            extends: None,
            description: Some("GPDMA channel 10 transfer register 2"),
            bit_size: 32,
            fields: &[
                Field {
                    name: "reqsel",
        ...
        FieldSet {
            name: "ChTr3",
            extends: None,
            description: Some("GPDMA channel 14 transfer register 3"),
            bit_size: 32,
            fields: &[
                Field {
                    name: "sao",
    ...
    enums: &[
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "Port0",
                    description: Some("port 0 (AHB) allocated"),
                    value: 0,
                },
                EnumVariant {
                    name: "Port1",
                    description: Some("port 1 (AHB) allocated"),
                    value: 1,
                },
            ],
        },
        ...
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "Add",
                    description: Some("The address is incremented by the programmed offset."),
                    value: 0,
                },
                EnumVariant {
                    name: "Subtract",
                    description: Some("The address is decremented by the programmed offset."),
                    value: 1,
                },
            ],
        },
        ...
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "Byte",
                    description: Some("byte"),
                    value: 0,
                },
                EnumVariant {
                    name: "HalfWord",
                    description: Some("half-word (2 bytes)"),
                    value: 1,
                },
                EnumVariant {
                    name: "Word",
                    description: Some("word (4 bytes)"),
                    value: 2,
                },
            ],
        },
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "LinkStep",
                    description: Some("channel executed once for the current LLI"),
                    value: 1,
                },
                EnumVariant {
        ...
        Enum {
            ...
            variants: &[
                ...
                EnumVariant {
                    ...
                    description: Some("low priority, high weight"),
                    value: 2,
                },
                EnumVariant {
                    name: "LowWithLowhWeight",
                    description: Some("low priority, low weight"),
                    value: 0,
                },
                EnumVariant {
                    name: "LowWithMidWeight",
                    description: Some("low priority, mid weight"),
                    value: 1,
                },
            ],
        },
        ...
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "FallingEdge",
                    description: Some("trigger on the falling edge"),
                    value: 2,
                },
                EnumVariant {
                    name: "None",
                    description: Some("no trigger (masked trigger event)"),
                    value: 0,
                },
                EnumVariant {
                    name: "NoneAlt",
                    description: Some("same as 00"),
                    value: 3,
                },
                EnumVariant {
                    name: "RisingEdge",
                    description: Some("trigger on the rising edge"),
                    value: 1,
                },
            ],
        },
