...
pub(crate) static REGISTERS: IR = IR {
    blocks: &[Block {
        name: "Gpio",
        extends: None,
        description: Some("General-purpose I/Os"),
        items: &[
            BlockItem {
                name: "moder",
                description: Some("GPIO port mode register"),
                array: None,
                byte_offset: 0x0,
            ...
            BlockItem {
                name: "otyper",
                description: Some("GPIO port output type register"),
                array: None,
                byte_offset: 0x4,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
                    fieldset: Some("Otyper"),
                }),
            },
            BlockItem {
                name: "ospeedr",
                description: Some("GPIO port output speed register"),
                array: None,
                byte_offset: 0x8,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
                    fieldset: Some("Ospeedr"),
                }),
            },
            BlockItem {
                name: "pupdr",
                description: Some("GPIO port pull-up/pull-down register"),
                array: None,
                byte_offset: 0xc,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "idr",
                description: Some("GPIO port input data register"),
                array: None,
                byte_offset: 0x10,
                inner: BlockItemInner::Register(Register {
                    access: Access::Read,
            ...
            BlockItem {
                name: "odr",
                description: Some("GPIO port output data register"),
                array: None,
                byte_offset: 0x14,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "bsrr",
                description: Some("GPIO port bit set/reset register"),
                array: None,
                byte_offset: 0x18,
                inner: BlockItemInner::Register(Register {
                    access: Access::Write,
            ...
            BlockItem {
                name: "lckr",
                description: Some("GPIO port configuration lock register"),
                array: None,
                byte_offset: 0x1c,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
    ...
    fieldsets: &[
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "bs",
                    description: Some("Port x set bit y (y= 0..15)"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 1,
        ...
        FieldSet {
            ...
            fields: &[Field {
                name: "idr",
                description: Some("Port input data (y = 0..15)"),
                bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                bit_size: 1,
                array: Some(Array::Regular(RegularArray { len: 16, stride: 1 })),
                enumm: Some("Idr"),
        ...
        FieldSet {
            ...
            fields: &[Field {
                name: "moder",
                description: Some("Port x configuration bits (y = 0..15)"),
                bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                bit_size: 2,
        ...
        FieldSet {
            ...
            fields: &[Field {
                name: "odr",
                description: Some("Port output data (y = 0..15)"),
                bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                bit_size: 1,
                array: Some(Array::Regular(RegularArray { len: 16, stride: 1 })),
                enumm: Some("Odr"),
    ...
    enums: &[
        ...
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "Alternate",
                    description: Some("Alternate function mode"),
                    value: 2,
                },
                EnumVariant {
                    name: "Analog",
                ...
                EnumVariant {
                    name: "Output",
                    description: Some("General purpose output mode"),
                    value: 1,
                },
            ],
        },
        ...
        Enum {
            ...
            variants: &[
                ...
                EnumVariant {
                    name: "LowSpeed",
                    description: Some("Low speed"),
                    value: 0,
                },
                EnumVariant {
                    name: "MediumSpeed",
                    description: Some("Medium speed"),
                    value: 1,
                },
                EnumVariant {
                    name: "VeryHighSpeed",
                    description: Some("Very high speed"),
                    value: 3,
                },
            ],
        },
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "OpenDrain",
                    description: Some("Output open-drain"),
                    value: 1,
                },
                EnumVariant {
                    name: "PushPull",
                    description: Some("Output push-pull (reset state)"),
                    value: 0,
                },
            ],
        },
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "Floating",
                    description: Some("No pull-up, pull-down"),
                    value: 0,
                },
                EnumVariant {
                    name: "PullDown",
