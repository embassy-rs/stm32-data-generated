...
pub(crate) static REGISTERS: IR = IR {
    ...
    fieldsets: &[
        ...
        FieldSet {
            ...
            fields: &[Field {
                name: "isc",
                description: Some("Interrupt semaphore x clear bit."),
        ...
        FieldSet {
            ...
            fields: &[Field {
                name: "ise",
                description: Some("Interrupt semaphore x enable bit."),
                bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                bit_size: 1,
                array: Some(Array::Regular(RegularArray { len: 32, stride: 1 })),
                enumm: None,
        ...
        FieldSet {
            ...
            fields: &[Field {
                name: "isf",
                description: Some("Interrupt semaphore x status bit before enable (mask)."),
                bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                bit_size: 1,
                array: Some(Array::Regular(RegularArray { len: 32, stride: 1 })),
                enumm: None,
        ...
        FieldSet {
            ...
            fields: &[Field {
                name: "misf",
                description: Some("masked interrupt semaphore x status bit after enable (mask)."),
                bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                bit_size: 1,
                array: Some(Array::Regular(RegularArray { len: 32, stride: 1 })),
                enumm: None,
