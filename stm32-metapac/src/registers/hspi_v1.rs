...
pub(crate) static REGISTERS: IR = IR {
    blocks: &[Block {
        name: "Hspi",
        extends: None,
        description: Some("HSPI."),
        items: &[
            BlockItem {
                name: "cr",
                description: Some("HSPI control register."),
                array: None,
                byte_offset: 0x0,
            ...
            BlockItem {
                name: "dcr1",
                description: Some("HSPI device configuration register 1."),
                array: None,
                byte_offset: 0x8,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "dcr2",
                description: Some("HSPI device configuration register 2."),
                array: None,
                byte_offset: 0xc,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "dcr3",
                description: Some("HSPI device configuration register 3."),
                array: None,
                byte_offset: 0x10,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "dcr4",
                description: Some("HSPI device configuration register 4."),
                array: None,
                byte_offset: 0x14,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "dlr",
                description: Some("HSPI data length register."),
                array: None,
                byte_offset: 0x40,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "psmkr",
                description: Some("HSPI polling status mask register."),
                array: None,
                byte_offset: 0x80,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "psmar",
                description: Some("HSPI polling status match register."),
                array: None,
                byte_offset: 0x88,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "pir",
                description: Some("HSPI polling interval register."),
                array: None,
                byte_offset: 0x90,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "ccr",
                description: Some("HSPI communication configuration register."),
                array: None,
                byte_offset: 0x100,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "tcr",
                description: Some("HSPI timing configuration register."),
                array: None,
                byte_offset: 0x108,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "ir",
                description: Some("HSPI instruction register."),
                array: None,
                byte_offset: 0x110,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "abr",
                description: Some("HSPI alternate bytes register."),
                array: None,
                byte_offset: 0x120,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "lptr",
                description: Some("HSPI low-power timeout register."),
                array: None,
                byte_offset: 0x130,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "wpccr",
                description: Some("HSPI wrap communication configuration register."),
                array: None,
                byte_offset: 0x140,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "wptcr",
                description: Some("HSPI wrap timing configuration register."),
                array: None,
                byte_offset: 0x148,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "wpir",
                description: Some("HSPI wrap instruction register."),
                array: None,
                byte_offset: 0x150,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "wpabr",
                description: Some("HSPI wrap alternate bytes register."),
                array: None,
                byte_offset: 0x160,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "wccr",
                description: Some("HSPI write communication configuration register."),
                array: None,
                byte_offset: 0x180,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "wtcr",
                description: Some("HSPI write timing configuration register."),
                array: None,
                byte_offset: 0x188,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "wir",
                description: Some("HSPI write instruction register."),
                array: None,
                byte_offset: 0x190,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "wabr",
                description: Some("HSPI write alternate bytes register."),
                array: None,
                byte_offset: 0x1a0,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "hlcr",
                description: Some("HSPI HyperBus latency configuration register."),
                array: None,
                byte_offset: 0x200,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "calfcr",
                description: Some("HSPI full-cycle calibration configuration."),
                array: None,
                byte_offset: 0x210,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "calmr",
                description: Some("HSPI DLL master calibration configuration."),
                array: None,
                byte_offset: 0x218,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "calsor",
                description: Some("HSPI DLL slave output calibration configuration."),
                array: None,
                byte_offset: 0x220,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "calsir",
                description: Some("HSPI DLL slave input calibration configuration."),
                array: None,
                byte_offset: 0x228,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
    ...
    fieldsets: &[
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "addtr",
                    description: Some("Address double transfer rate This bit sets the DTR mode for the address phase."),
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "teie",
                    description: Some("Transfer error interrupt enable This bit enables the transfer error interrupt."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 16 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "ftie",
                    description: Some("FIFO threshold interrupt enable This bit enables the FIFO threshold interrupt."),
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "dmode",
                    description: Some("Data mode This field defines the data phase mode of operation."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 24 }),
                    bit_size: 3,
                    array: None,
                    enumm: None,
