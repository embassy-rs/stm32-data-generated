    ...
    blocks: &[
        ...
        Block {
            ...
            items: &[
                ...
                BlockItem {
                    name: "cr_alternate",
                    description: Some("I3C message control register alternate."),
                    array: None,
                    byte_offset: 0x0,
                    inner: BlockItemInner::Register(Register {
                        access: Access::ReadWrite,
    ...
    fieldsets: &[
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "cfcf",
                    description: Some("clear frame complete flag (whatever the I3C is acting as controller/target)."),
                ...
                Field {
                    name: "crxtgtendf",
                    description: Some("clear target-initiated read end flag (when the I3C is acting as controller)."),
                ...
                Field {
                    name: "cerrf",
                    description: Some("clear error flag (whatever the I3C is acting as controller/target)."),
                ...
                Field {
                    name: "cibif",
                    description: Some("clear IBI request flag (when the I3C is acting as controller)."),
                ...
                Field {
                    name: "cibiendf",
                    description: Some("clear IBI end flag (when the I3C is acting as target)."),
                ...
                Field {
                    name: "ccrf",
                    description: Some("clear controller-role request flag (when the I3C is acting as controller)."),
                ...
                Field {
                    name: "ccrupdf",
                    description: Some("clear controller-role update flag (when the I3C is acting as target)."),
                ...
                Field {
                    name: "chjf",
                    description: Some("clear hot-join flag (when the I3C is acting as controller)."),
                ...
                Field {
                    name: "cwkpf",
                    description: Some("clear wakeup flag (when the I3C is acting as target)."),
                ...
                Field {
                    name: "cgetf",
                    description: Some("clear GETxxx CCC flag (when the I3C is acting as target)."),
                ...
                Field {
                    name: "cstaf",
                    description: Some("clear GETSTATUS CCC flag (when the I3C is acting as target)."),
                ...
                Field {
                    name: "cdaupdf",
                    description: Some("clear ENTDAA/RSTDAA/SETNEWDA CCC flag (when the I3C is acting as target)."),
                ...
                Field {
                    name: "cmwlupdf",
                    description: Some("clear SETMWL CCC flag (when the I3C is acting as target)."),
                ...
                Field {
                    name: "cmrlupdf",
                    description: Some("clear SETMRL CCC flag (when the I3C is acting as target)."),
                ...
                Field {
                    name: "crstf",
                    description: Some("clear reset pattern flag (when the I3C is acting as target)."),
                ...
                Field {
                    name: "casupdf",
                    description: Some("clear ENTASx CCC flag (when the I3C is acting as target)."),
                ...
                Field {
                    name: "cintupdf",
                    description: Some("clear ENEC/DISEC CCC flag (when the I3C is acting as target)."),
                ...
                Field {
                    name: "cdeff",
                    description: Some("clear DEFTGTS CCC flag (when the I3C is acting as target)."),
                ...
                Field {
                    name: "cgrpf",
                    description: Some("clear DEFGRPA CCC flag (when the I3C is acting as target)."),
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "cflush",
                    description: Some("C-FIFO flush (when I3C is acting as controller) This bit can only be written."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 21 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "mend",
                    description: Some("message end type (when the I3C is acting as controller)."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 31 }),
                    bit_size: 1,
                    array: None,
                    enumm: Some("Mend"),
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "mend",
                    description: Some("message end type (when I3C is acting as controller)."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 31 }),
                    bit_size: 1,
                    array: None,
                    enumm: Some("Mend"),
        ...
        FieldSet {
            name: "Devr",
            extends: None,
            description: Some("I3C device 4 characteristics register."),
            bit_size: 32,
            fields: &[
                Field {
                    name: "da",
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "errie",
                    description: Some("error interrupt enable (whatever the I3C is acting as controller/target)."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 11 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "ibiie",
                    description: Some("IBI request interrupt enable (when the I3C is acting as controller)."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 15 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "ibiendie",
                    description: Some("IBI end interrupt enable (when the I3C is acting as target)."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 16 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "crupdie",
                    description: Some("controller-role update interrupt enable (when the I3C is acting as target)."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 18 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "hjie",
                    description: Some("hot-join interrupt enable (when the I3C is acting as controller)."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 19 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "wkpie",
                    description: Some("wakeup interrupt enable (when the I3C is acting as target)."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 21 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "getie",
                    description: Some("GETxxx CCC interrupt enable (when the I3C is acting as target)."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 22 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "staie",
                    description: Some("GETSTATUS CCC interrupt enable (when the I3C is acting as target)."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 23 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "mwlupdie",
                    description: Some("SETMWL CCC interrupt enable (when the I3C is acting as target)."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 25 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "mrlupdie",
                    description: Some("SETMRL CCC interrupt enable (when the I3C is acting as target)."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 26 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "rstie",
                    description: Some("reset pattern interrupt enable (when the I3C is acting as target)."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 27 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "asupdie",
                    description: Some("ENTASx CCC interrupt enable (when the I3C is acting as target)."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 28 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "intupdie",
                    description: Some("ENEC/DISEC CCC interrupt enable (when the I3C is acting as target)."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 29 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "defie",
                    description: Some("DEFTGTS CCC interrupt enable (when the I3C is acting as target)."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 30 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "grpie",
                    description: Some("DEFGRPA CCC interrupt enable (when the I3C is acting as target)."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 31 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "stall",
                    description: Some("SCL stall error (when the I3C is acting as target)."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 5 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "derr",
                    description: Some("data error (when the I3C is acting as controller)."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 10 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
    ...
    enums: &[
        ...
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "Ce0",
                    description: Some("Transaction after sending CCC. Controller detected an illegally formatted CCC"),
                    value: 0,
                },
                EnumVariant {
                    name: "Ce1",
                ...
                EnumVariant {
                    name: "Te5",
                    description: Some("Transaction after detecting CCC. Target detected an illegally formatted CCC"),
                    value: 13,
                },
                EnumVariant {
                    name: "Te6",
        ...
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "Allowed",
                    description: Some("write to DA[7:0] and to IBIDEN in the I3C_DEVRx register is allowed"),
                    value: 0,
                },
                EnumVariant {
                    name: "Locked",
                    description: Some("write to DA[7:0] and to IBIDEN is disabled/locked"),
                    value: 1,
                },
            ],
        },
        ...
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "Read",
                    description: Some("read message"),
                    value: 1,
                },
                EnumVariant {
                    name: "Write",
                    description: Some("write message"),
                    value: 0,
                },
            ],
        },
        ...
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "Byte",
                    description: Some("TXFNFF is set when 1 byte must be written in TX-FIFO (in I3C_TDR)."),
                    value: 0,
                },
                EnumVariant {
                    name: "Word",
