...
pub(crate) static REGISTERS: IR = IR {
    blocks: &[
        Block {
            ...
            items: &[
                BlockItem {
                    name: "lbar",
                    description: Some("LPDMA channel 15 linked-list base address register"),
                    array: None,
                    byte_offset: 0x0,
                ...
                BlockItem {
                    name: "fcr",
                    description: Some("LPDMA channel 15 flag clear register"),
                    array: None,
                    byte_offset: 0xc,
                    inner: BlockItemInner::Register(Register {
                        access: Access::ReadWrite,
                ...
                BlockItem {
                    name: "sr",
                    description: Some("LPDMA channel 15 status register"),
                    array: None,
                    byte_offset: 0x10,
                    inner: BlockItemInner::Register(Register {
                        access: Access::ReadWrite,
                ...
                BlockItem {
                    name: "cr",
                    description: Some("LPDMA channel 15 control register"),
                    array: None,
                    byte_offset: 0x14,
                    inner: BlockItemInner::Register(Register {
                        access: Access::ReadWrite,
                ...
                BlockItem {
                    name: "tr1",
                    description: Some("LPDMA channel 15 transfer register 1"),
                    array: None,
                    byte_offset: 0x40,
                    inner: BlockItemInner::Register(Register {
                        access: Access::ReadWrite,
                ...
                BlockItem {
                    name: "tr2",
                    description: Some("LPDMA channel 15 transfer register 2"),
                    array: None,
                    byte_offset: 0x44,
                    inner: BlockItemInner::Register(Register {
                        access: Access::ReadWrite,
                ...
                BlockItem {
                    name: "br1",
                    description: Some("LPDMA channel 15 alternate block register 1"),
                    array: None,
                    byte_offset: 0x48,
                    inner: BlockItemInner::Register(Register {
                        access: Access::ReadWrite,
                ...
                BlockItem {
                    name: "sar",
                    description: Some("LPDMA channel 15 source address register"),
                    array: None,
                    byte_offset: 0x4c,
                    inner: BlockItemInner::Register(Register {
                        access: Access::ReadWrite,
                ...
                BlockItem {
                    name: "dar",
                    description: Some("LPDMA channel 15 destination address register"),
                    array: None,
                    byte_offset: 0x50,
                    inner: BlockItemInner::Register(Register {
                        access: Access::ReadWrite,
                ...
                BlockItem {
                    name: "tr3",
                    description: Some("LPDMA channel 15 transfer register 3"),
                    array: None,
                    byte_offset: 0x54,
                    inner: BlockItemInner::Register(Register {
                        access: Access::ReadWrite,
                ...
                BlockItem {
                    name: "br2",
                    description: Some("LPDMA channel 15 block register 2"),
                    array: None,
                    byte_offset: 0x58,
                    inner: BlockItemInner::Register(Register {
                        access: Access::ReadWrite,
                ...
                BlockItem {
                    name: "llr",
                    description: Some("LPDMA channel 15 alternate linked-list address register"),
                    array: None,
                    byte_offset: 0x7c,
                    inner: BlockItemInner::Register(Register {
                        access: Access::ReadWrite,
        ...
        Block {
            name: "Lpdma",
            extends: None,
            description: Some("LPDMA"),
            items: &[
                BlockItem {
                    name: "seccfgr",
                    description: Some("LPDMA secure configuration register"),
                    array: None,
                    byte_offset: 0x0,
                    inner: BlockItemInner::Register(Register {
                        access: Access::ReadWrite,
                ...
                BlockItem {
                    name: "privcfgr",
                    description: Some("LPDMA privileged configuration register"),
                    array: None,
                    byte_offset: 0x4,
                    inner: BlockItemInner::Register(Register {
                        access: Access::ReadWrite,
                ...
                BlockItem {
                    name: "rcfglockr",
                    description: Some("LPDMA configuration lock register"),
                    array: None,
                    byte_offset: 0x8,
                    inner: BlockItemInner::Register(Register {
                        access: Access::ReadWrite,
                ...
                BlockItem {
                    name: "misr",
                    description: Some("LPDMA non-secure masked interrupt status register"),
                    array: None,
                    byte_offset: 0xc,
                    inner: BlockItemInner::Register(Register {
                        access: Access::ReadWrite,
                ...
                BlockItem {
                    name: "smisr",
                    description: Some("LPDMA secure masked interrupt status register"),
                    array: None,
                    byte_offset: 0x10,
                    inner: BlockItemInner::Register(Register {
                        access: Access::ReadWrite,
    ...
    fieldsets: &[
        ...
        FieldSet {
            name: "ChBr2",
            extends: None,
            description: Some("LPDMA channel 12 block register 2"),
            bit_size: 32,
            fields: &[
                Field {
                    name: "brsao",
        ...
        FieldSet {
            name: "ChCr",
            extends: None,
            description: Some("LPDMA channel 11 control register"),
            bit_size: 32,
            fields: &[
                Field {
                    name: "en",
        ...
        FieldSet {
            name: "ChFcr",
            extends: None,
            description: Some("LPDMA channel 7 flag clear register"),
            bit_size: 32,
            fields: &[
                Field {
                    name: "tcf",
        ...
        FieldSet {
            name: "ChLbar",
            extends: None,
            description: Some("LPDMA channel 14 linked-list base address register"),
            bit_size: 32,
            fields: &[Field {
                name: "lba",
                description: Some("linked-list base address of LPDMA channel x"),
                bit_offset: BitOffset::Regular(RegularBitOffset { offset: 16 }),
                bit_size: 16,
                array: None,
                enumm: None,
        ...
        FieldSet {
            name: "ChTr1",
            extends: None,
            description: Some("LPDMA channel 8 transfer register 1"),
            bit_size: 32,
            fields: &[
                Field {
                    name: "sdw",
        ...
        FieldSet {
            name: "ChTr2",
            extends: None,
            description: Some("LPDMA channel 10 transfer register 2"),
            bit_size: 32,
            fields: &[
                Field {
                    name: "reqsel",
        ...
        FieldSet {
            name: "ChTr3",
            extends: None,
            description: Some("LPDMA channel 14 transfer register 3"),
            bit_size: 32,
            fields: &[
                Field {
                    name: "sao",
