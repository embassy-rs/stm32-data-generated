    ...
    blocks: &[
        Block {
            ...
            items: &[
                BlockItem {
                    name: "isr",
                    description: Some("MDMA channel x interrupt/status register."),
                    array: None,
                    byte_offset: 0x0,
                ...
                BlockItem {
                    name: "ifcr",
                    description: Some("MDMA channel x interrupt flag clear register."),
                    array: None,
                    byte_offset: 0x4,
                    inner: BlockItemInner::Register(Register {
                        access: Access::Write,
                ...
                BlockItem {
                    name: "esr",
                    description: Some("MDMA Channel x error status register."),
                    array: None,
                    byte_offset: 0x8,
                    inner: BlockItemInner::Register(Register {
                        access: Access::Read,
                ...
                BlockItem {
                    name: "cr",
                    description: Some("This register is used to control the concerned channel."),
                    array: None,
                    byte_offset: 0xc,
                    inner: BlockItemInner::Register(Register {
                ...
                BlockItem {
                    name: "tcr",
                    description: Some("This register is used to configure the concerned channel."),
                    array: None,
                    byte_offset: 0x10,
                    inner: BlockItemInner::Register(Register {
                        access: Access::ReadWrite,
                ...
                BlockItem {
                    name: "bndtr",
                    description: Some("MDMA Channel x block number of data register."),
                    array: None,
                    byte_offset: 0x14,
                    inner: BlockItemInner::Register(Register {
                        access: Access::ReadWrite,
                ...
                BlockItem {
                    name: "sar",
                    description: Some("MDMA channel x source address register."),
                    array: None,
                    byte_offset: 0x18,
                    inner: BlockItemInner::Register(Register {
                        access: Access::ReadWrite,
                ...
                BlockItem {
                    name: "dar",
                    description: Some("MDMA channel x destination address register."),
                    array: None,
                    byte_offset: 0x1c,
                    inner: BlockItemInner::Register(Register {
                        access: Access::ReadWrite,
                ...
                BlockItem {
                    name: "brur",
                    description: Some("MDMA channel x Block Repeat address Update register."),
                    array: None,
                    byte_offset: 0x20,
                    inner: BlockItemInner::Register(Register {
                        access: Access::ReadWrite,
                ...
                BlockItem {
                    name: "lar",
                    description: Some("MDMA channel x Link Address register."),
                    array: None,
                    byte_offset: 0x24,
                    inner: BlockItemInner::Register(Register {
                        access: Access::ReadWrite,
                ...
                BlockItem {
                    name: "tbr",
                    description: Some("MDMA channel x Trigger and Bus selection Register."),
                    array: None,
                    byte_offset: 0x28,
                    inner: BlockItemInner::Register(Register {
                        access: Access::ReadWrite,
                ...
                BlockItem {
                    name: "mar",
                    description: Some("MDMA channel x Mask address register."),
                    array: None,
                    byte_offset: 0x30,
                    inner: BlockItemInner::Register(Register {
                        access: Access::ReadWrite,
                ...
                BlockItem {
                    name: "mdr",
                    description: Some("MDMA channel x Mask Data register."),
                    array: None,
                    byte_offset: 0x34,
                    inner: BlockItemInner::Register(Register {
                        access: Access::ReadWrite,
        ...
        Block {
            name: "Mdma",
            extends: None,
            description: Some("MDMA."),
            items: &[
                BlockItem {
                    name: "gisr0",
                    description: Some("MDMA Global Interrupt/Status Register."),
                    array: None,
                    byte_offset: 0x0,
                    inner: BlockItemInner::Register(Register {
                        access: Access::Read,
                ...
                BlockItem {
                    ...
                    array: Some(Array::Regular(RegularArray { len: 16, stride: 64 })),
                    byte_offset: 0x40,
    ...
    fieldsets: &[
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "bndt",
                    description: Some("block number of data to transfer."),
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "suv",
                    description: Some("source adresse update value."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 16,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "duv",
                    description: Some("destination address update."),
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "btie",
                    description: Some("Block Transfer interrupt enable This bit is set and cleared by software."),
                ...
                Field {
                    name: "bex",
                    description: Some("byte Endianness exchange."),
                ...
                Field {
                    name: "hex",
                    description: Some("Half word Endianes exchange."),
                ...
                Field {
                    name: "wex",
                    description: Some("Word Endianness exchange."),
        ...
        FieldSet {
            ...
            fields: &[Field {
                name: "dar",
                description: Some("Destination adr base."),
                bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                bit_size: 32,
                array: None,
                enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "tcif",
                    description: Some("channel x buffer transfer complete."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 4 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "crqa",
                    description: Some("channel x request active flag."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 16 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[Field {
                name: "lar",
                description: Some("Link address register."),
                bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                bit_size: 32,
                array: None,
                enumm: None,
        ...
        FieldSet {
            ...
            fields: &[Field {
                name: "sar",
                description: Some("source adr base."),
                bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                bit_size: 32,
                array: None,
                enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "sbus",
                    description: Some("Source BUS select This bit is protected and can be written only if EN is 0."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 16 }),
                    bit_size: 1,
                    array: None,
                    enumm: Some("Bus"),
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "sincos",
                    description: Some("source increment offset size."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 8 }),
                    bit_size: 2,
                    array: None,
                    enumm: Some("Wordsize"),
                ...
                Field {
                    name: "dincos",
                    description: Some("Destination increment offset."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 10 }),
                    bit_size: 2,
                    array: None,
                    enumm: Some("Wordsize"),
                ...
                Field {
                    name: "sburst",
                    description: Some("source burst transfer configuration."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 12 }),
                    bit_size: 3,
                    array: None,
                    enumm: Some("Burst"),
                ...
                Field {
                    name: "dburst",
                    description: Some("Destination burst transfer configuration."),
                ...
                Field {
                    name: "tlen",
                    description: Some("buffer transfer lengh."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 18 }),
                    bit_size: 7,
                    array: None,
                    enumm: None,
    ...
    enums: &[
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "Incr128",
                    description: Some("Incremental burst of 128 beats"),
                    value: 6,
                },
                EnumVariant {
                    name: "Incr16",
                ...
                EnumVariant {
                    name: "Incr256",
                    description: Some("Incremental burst of 256 beats"),
                    value: 7,
                },
                EnumVariant {
                    name: "Incr32",
                    description: Some("Incremental burst of 32 beats"),
                    value: 4,
                },
                EnumVariant {
                    name: "Incr4",
                ...
                EnumVariant {
                    name: "Incr64",
                    description: Some("Incremental burst of 64 beats"),
                    value: 5,
                },
                EnumVariant {
                    name: "Incr8",
        ...
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "Ahb",
                    description: Some("AHB bus/TCM"),
                    value: 1,
                },
                EnumVariant {
                    name: "System",
                    description: Some("System/AXI bus"),
                    value: 0,
                },
            ],
        },
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "Decrement",
                    description: Some("Address pointer is decremented after each data transfer"),
                    value: 3,
                },
                EnumVariant {
                    name: "Fixed",
        ...
        Enum {
            ...
            variants: &[
                ...
                EnumVariant {
                    ...
                    description: Some("Right aligned, sign extended"),
                    value: 1,
                },
            ],
        },
        ...
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "Block",
                    description: Some("Each MDMA request (software or hardware) triggers a block transfer"),
                    value: 1,
                },
                EnumVariant {
                    name: "Buffer",
                    description: Some("Each MDMA request (software or hardware) triggers a buffer transfer"),
                    value: 0,
                },
                EnumVariant {
                    name: "Repeated",
                    description: Some("Each MDMA request (software or hardware) triggers a repeated block transfer"),
                    value: 2,
                },
                EnumVariant {
                    name: "WholeData",
        ...
        Enum {
            ...
            variants: &[
                ...
                EnumVariant {
                    name: "DoubleWord",
                    description: Some("DoubleWord (64-bit)"),
                    value: 3,
                },
                EnumVariant {
                    name: "HalfWord",
                    description: Some("HalfWord (16-bit)"),
                    value: 1,
                },
                EnumVariant {
                    name: "Word",
