...
pub(crate) static REGISTERS: IR = IR {
    blocks: &[Block {
        ...
        items: &[
            ...
            BlockItem {
                name: "dcr1",
                description: Some("device configuration register 1"),
                array: None,
                byte_offset: 0x8,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "dcr2",
                description: Some("device configuration register 2"),
                array: None,
                byte_offset: 0xc,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "dcr3",
                description: Some("device configuration register 3"),
                array: None,
                byte_offset: 0x10,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "dcr4",
                description: Some("device configuration register 4"),
                array: None,
                byte_offset: 0x14,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "tcr",
                description: Some("timing configuration register"),
                array: None,
                byte_offset: 0x108,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "ir",
                description: Some("instruction register"),
                array: None,
                byte_offset: 0x110,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "abr",
                description: Some("alternate bytes register"),
                array: None,
                byte_offset: 0x120,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "wpccr",
                description: Some("wrap communication configuration register"),
                array: None,
                byte_offset: 0x140,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "wptcr",
                description: Some("wrap timing configuration register"),
                array: None,
                byte_offset: 0x148,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "wpir",
                description: Some("wrap instruction register"),
                array: None,
                byte_offset: 0x150,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "wpabr",
                description: Some("wrap alternate bytes register"),
                array: None,
                byte_offset: 0x160,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "wccr",
                description: Some("write communication configuration register"),
                array: None,
                byte_offset: 0x180,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "wtcr",
                description: Some("write timing configuration register"),
                array: None,
                byte_offset: 0x188,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "wir",
                description: Some("write instruction register"),
                array: None,
                byte_offset: 0x190,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "wabr",
                description: Some("write alternate bytes register"),
                array: None,
                byte_offset: 0x1a0,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "hlcr",
                description: Some("OCTOSPI HyperBus latency configuration register"),
                array: None,
                byte_offset: 0x200,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
    ...
    fieldsets: &[
        FieldSet {
            ...
            fields: &[Field {
                name: "alternate",
                description: Some("Alternate bytes"),
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "isize",
                    description: Some("Instruction size. This bit defines instruction size."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 4 }),
                    bit_size: 2,
                    array: None,
                    enumm: Some("SizeInBits"),
                },
                Field {
                    name: "admode",
                    description: Some(
                ...
                Field {
                    name: "adsize",
                    description: Some("Address size. This field defines address size."),
                ...
                Field {
                    name: "absize",
                    description: Some("Alternate bytes size. This bit defines alternate bytes size."),
                ...
                Field {
                    name: "ddtr",
                    description: Some("Data double transfer rate. This bit sets the DTR mode for the data phase."),
                ...
                Field {
                    name: "dqse",
                    description: Some("DQS enable. This bit enables the data strobe management."),
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "smie",
                    description: Some("Status match interrupt enable. This bit enables the status match interrupt."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 19 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "toie",
                    description: Some("Timeout interrupt enable. This bit enables the timeout interrupt."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 20 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "frck",
                    description: Some("Free running clock. This bit configures the free running clock."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 1 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "dlybyp",
                    description: Some("Delay block bypass"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 3 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "maxtran",
                    description: Some("Maximum transfer"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 8,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "ctef",
                    description: Some("Clear transfer error flag Writing 1 clears the TEF flag in the SR register."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "ctcf",
                    description: Some("Clear transfer complete flag Writing 1 clears the TCF flag in the SR register."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 1 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "csmf",
                    description: Some("Clear status match flag Writing 1 clears the SMF flag in the SR register."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 3 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "ctof",
                    description: Some("Clear timeout flag Writing 1 clears the TOF flag in the SR register."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 4 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "lm",
                    description: Some("Latency mode. This bit selects the Latency mode."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 1,
                    array: None,
                    enumm: Some("LatencyMode"),
                },
                Field {
                    name: "wzl",
                    description: Some("Write zero latency. This bit enables zero latency on write operations."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 1 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[Field {
                name: "instruction",
                description: Some("Instruction to be sent to the external SPI device"),
                bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                bit_size: 32,
                array: None,
                enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "dhqc",
                    description: Some("Delay hold quarter cycle"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 28 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            name: "Wccr",
            extends: None,
            description: Some("OCTOSPI write communication configuration register"),
            bit_size: 32,
            fields: &[
                Field {
                    name: "imode",
                ...
                Field {
                    name: "absize",
                    description: Some("Alternate bytes size. This field defines alternate bytes size:"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 20 }),
                    bit_size: 2,
                    array: None,
                    enumm: Some("SizeInBits"),
        ...
        FieldSet {
            ...
            fields: &[Field {
                name: "instruction",
                description: Some("Instruction Instruction to be sent to the external SPI device"),
                bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                bit_size: 32,
                array: None,
                enumm: None,
        ...
        FieldSet {
            name: "Wpccr",
            extends: None,
            description: Some("OCTOSPI wrap communication configuration register"),
            bit_size: 32,
            fields: &[
                Field {
                    name: "imode",
                ...
                Field {
                    name: "isize",
                    description: Some("Instruction size. This field defines instruction size."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 4 }),
                    bit_size: 2,
                    array: None,
                    enumm: Some("SizeInBits"),
        ...
        FieldSet {
            ...
            fields: &[Field {
                name: "instruction",
                description: Some("[31: 0]: Instruction Instruction to be sent to the external SPI device"),
                bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                bit_size: 32,
                array: None,
                enumm: None,
    ...
    enums: &[
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "FlashOne",
                    description: Some("FLASH 1 selected (data exchanged over IO[3:0])"),
                    value: 0,
                },
                EnumVariant {
                    name: "FlashTwo",
                    description: Some("FLASH 2 selected (data exchanged over IO[7:4])"),
                    value: 1,
                },
            ],
        },
        Enum {
            ...
            variants: &[
                EnumVariant {
                    ...
                    description: Some("Automatic status-polling mode"),
                    value: 2,
                },
                EnumVariant {
                    name: "IndirectRead",
                    description: Some("Indirect-read mode"),
                    value: 1,
                },
                EnumVariant {
                    name: "IndirectWrite",
                    description: Some("Indirect-write mode"),
                    value: 0,
                },
                EnumVariant {
                    name: "MemoryMapped",
                    description: Some("Memory-mapped mode"),
                    value: 3,
                },
            ],
        },
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "Fixed",
                    description: Some("Fixed latency"),
                    value: 1,
                },
                EnumVariant {
                    name: "Variable",
                    description: Some("Variable initial latency"),
                    value: 0,
                },
            ],
        },
        ...
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "BStandard",
                    description: Some("Standard mode"),
                    value: 2,
                },
                EnumVariant {
                    name: "HyperBusMemory",
        ...
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "EightLines",
                    description: Some("Alternate bytes on eight lines"),
                    value: 4,
                },
                EnumVariant {
                    name: "FourLines",
                    description: Some("Alternate bytes on four lines"),
                    value: 3,
                },
                EnumVariant {
                    name: "None",
                    description: Some("No alternate bytes"),
                    value: 0,
                },
                EnumVariant {
                    name: "OneLine",
                    description: Some("Alternate bytes on a single line"),
                    value: 1,
                },
                EnumVariant {
                    name: "TwoLines",
                    description: Some("Alternate bytes on two lines"),
                    value: 2,
                },
            ],
        },
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "HalfCycle",
                    description: Some("1/2 cycle shift"),
                    value: 1,
                },
                EnumVariant {
                    name: "None",
        ...
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "_16bit",
                    description: Some("16-bit alternate bytes"),
                    value: 1,
                },
                EnumVariant {
                    name: "_24bit",
                    description: Some("24-bit alternate bytes"),
                    value: 2,
                },
                EnumVariant {
                    name: "_32bit",
                    description: Some("32-bit alternate bytes"),
                    value: 3,
                },
                EnumVariant {
                    name: "_8bit",
                    description: Some("8-bit alternate bytes"),
                    value: 0,
                },
            ],
        },
