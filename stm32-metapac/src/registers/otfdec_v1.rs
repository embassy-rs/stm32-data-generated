...
pub(crate) static REGISTERS: IR = IR {
    blocks: &[
        Block {
            name: "Otfdec",
            extends: None,
            description: Some("On-The-Fly Decryption engine."),
            items: &[
                BlockItem {
                    name: "cr",
                    description: Some("OTFDEC control register."),
                    array: None,
                    byte_offset: 0x0,
                ...
                BlockItem {
                    name: "privcfgr",
                    description: Some("OTFDEC_PRIVCFGR."),
                    array: None,
                    byte_offset: 0x10,
                    inner: BlockItemInner::Register(Register {
                        access: Access::ReadWrite,
                ...
                BlockItem {
                    ...
                    byte_offset: 0x20,
                    inner: BlockItemInner::Block(BlockItemBlock { block: "Region" }),
                },
                BlockItem {
                    name: "isr",
                    description: Some("OTFDEC interrupt status register."),
                    array: None,
                    byte_offset: 0x300,
                    inner: BlockItemInner::Register(Register {
                        access: Access::ReadWrite,
                ...
                BlockItem {
                    name: "icr",
                    description: Some("OTFDEC interrupt clear register."),
                    array: None,
                    byte_offset: 0x304,
                    inner: BlockItemInner::Register(Register {
                        access: Access::ReadWrite,
                ...
                BlockItem {
                    name: "ier",
                    description: Some("OTFDEC interrupt enable register."),
                    array: None,
                    byte_offset: 0x308,
                    inner: BlockItemInner::Register(Register {
                        access: Access::ReadWrite,
        ...
        Block {
            ...
            items: &[
                BlockItem {
                    name: "cfgr",
                    description: Some("OTFDEC region 3 configuration register."),
                    array: None,
                    byte_offset: 0x0,
                    inner: BlockItemInner::Register(Register {
                        access: Access::ReadWrite,
                        bit_size: 32,
                        fieldset: Some("RegionCfgr"),
                    }),
                },
                BlockItem {
                    name: "startaddr",
                    description: Some("OTFDEC region 3 start address register."),
                    array: None,
                    byte_offset: 0x4,
                    inner: BlockItemInner::Register(Register {
                        access: Access::ReadWrite,
                ...
                BlockItem {
                    name: "endaddr",
                    description: Some("OTFDEC region 3 end address register."),
                    array: None,
                    byte_offset: 0x8,
                    inner: BlockItemInner::Register(Register {
                        access: Access::ReadWrite,
                ...
                BlockItem {
                    name: "noncer",
                    description: Some("OTFDEC region 3 nonce register 0."),
                ...
                BlockItem {
                    name: "keyr",
                    description: Some("OTFDEC region 3 key register 0."),
    ...
    enums: &[
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "Decryption",
                    description: Some("OTFDEC working in decryption mode"),
                    value: 0,
                },
                EnumVariant {
                    name: "Encryption",
                    description: Some("OTFDEC working in encryption mode"),
                    value: 1,
                },
            ],
        },
        Enum {
            ...
            variants: &[
                ...
                EnumVariant {
                    name: "Standard",
                    description: Some("All read accesses are decrypted (instruction or data)."),
                    value: 2,
                },
            ],
        },
