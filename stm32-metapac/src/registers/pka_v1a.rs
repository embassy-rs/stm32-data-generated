...
pub(crate) static REGISTERS: IR = IR {
    ...
    fieldsets: &[
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "lmf",
                    description: Some("Limited mode flag This bit is updated when EN bit in PKA_CR is set."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 1 }),
                    bit_size: 1,
                    array: None,
                    enumm: Some("Lmf"),
                ...
                Field {
                    name: "ramerrf",
                    description: Some("PKA RAM error flag This bit is cleared using RAMERRFC bit in PKA_CLRFR."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 19 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "addrerrf",
                    description: Some("Address error flag This bit is cleared using ADDRERRFC bit in PKA_CLRFR."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 20 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "operrf",
                    description: Some("Operation error flag This bit is cleared using OPERRFC bit in PKA_CLRFR."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 21 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
    ...
    enums: &[Enum {
        ...
        variants: &[
            EnumVariant {
                name: "All",
                description: Some("All values documented in MODE bitfield can be used."),
                value: 0,
            },
            EnumVariant {
                name: "Limited",
                description: Some("Only ECDSA verification (MODE = 0x26) is supported by the PKA."),
                value: 1,
            },
        ],
    }],
