...
pub(crate) static REGISTERS: IR = IR {
    blocks: &[Block {
        name: "Pwr",
        extends: None,
        description: Some("PWR address block description"),
        items: &[
            BlockItem {
                name: "cr1",
            ...
            BlockItem {
                name: "sr1",
                description: Some("PWR status register 1"),
                array: None,
                byte_offset: 0x10,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "sr2",
                description: Some("PWR status register 2"),
                array: None,
                byte_offset: 0x14,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "scr",
                description: Some("PWR status clear register"),
                array: None,
                byte_offset: 0x18,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "pucr",
                description: Some("PWR Port pull-up control register"),
            ...
            BlockItem {
                name: "pdcr",
                description: Some("PWR Port pull-down control register"),
                array: Some(Array::Regular(RegularArray { len: 6, stride: 8 })),
                byte_offset: 0x24,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
    ...
    enums: &[Enum {
        ...
        variants: &[
            EnumVariant {
                name: "Shutdown",
                description: Some("Selects Shutdown mode when entering DeepSleep."),
                value: 4,
            },
            EnumVariant {
                name: "Standby",
                description: Some("Selects Standby mode when entering DeepSleep."),
                value: 3,
            },
            EnumVariant {
                name: "Stop",
                description: Some("Selects Stop mode when entering DeepSleep."),
                value: 0,
            },
        ],
    }],
