...
pub(crate) static REGISTERS: IR = IR {
    blocks: &[Block {
        ...
        items: &[
            ...
            BlockItem {
                name: "ucpdr",
                description: Some("PWR USB Type-C power delivery register."),
                array: None,
                byte_offset: 0x2c,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "usbscr",
                description: Some("PWR USB supply control register."),
                array: None,
                byte_offset: 0x38,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
                    fieldset: Some("Usbscr"),
                }),
            },
            BlockItem {
                name: "vmsr",
    ...
    fieldsets: &[
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "ethernetso",
                    description: Some("ETHERNET RAM shut-off in Stop mode."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 16 }),
                    bit_size: 1,
                    array: None,
                    enumm: Some("ShutOff"),
                ...
                Field {
                    name: "sram3so",
                    description: Some("AHB SRAM3 shut-off in Stop mode."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 23 }),
                    bit_size: 1,
                    array: None,
                    enumm: Some("ShutOff"),
                ...
                Field {
                    name: "sram2_16so",
                    description: Some("AHB SRAM2 16-Kbyte shut-off in Stop mode."),
                ...
                Field {
                    name: "sram2_48so",
                    description: Some("AHB SRAM2 48-Kbyte shut-off in Stop mode."),
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "wupsec",
                    description: Some("WUPx secure protection."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 1,
                ...
                Field {
                    name: "retsec",
                    description: Some("retention secure protection."),
                ...
                Field {
                    name: "scmsec",
                    description: Some("supply configuration and monitoring secure protection."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 13 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "vusbsec",
                    description: Some("voltage USB secure protection."),
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "usb33den",
                    description: Some("V_DDUSB voltage level detector enable."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 24 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "usb33rdy",
                    description: Some("V_DDUSB ready."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 24 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
