...
pub(crate) static REGISTERS: IR = IR {
    blocks: &[Block {
        ...
        items: &[
            ...
            BlockItem {
                name: "vossr",
                description: Some("PWR voltage scaling status register."),
                array: None,
                byte_offset: 0x14,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "bdcr",
                description: Some("PWR Backup domain control register."),
                array: None,
                byte_offset: 0x20,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "bdsr",
                description: Some("PWR Backup domain status register."),
                array: None,
                byte_offset: 0x28,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "sccr",
                description: Some("PWR supply configuration control register."),
                array: None,
                byte_offset: 0x30,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "wuscr",
                description: Some("PWR wakeup status clear register."),
                array: None,
                byte_offset: 0x40,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "wusr",
                description: Some("PWR wakeup status register."),
                array: None,
                byte_offset: 0x44,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "wucr",
                description: Some("PWR wakeup configuration register."),
                array: None,
                byte_offset: 0x48,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
    ...
    fieldsets: &[
        FieldSet {
            ...
            fields: &[
                Field {
                    ...
                    bit_size: 1,
                    array: None,
                    enumm: Some("Retention"),
                },
                Field {
                    name: "monen",
                    description: Some("Backup domain voltage and temperature monitoring enable."),
                ...
                Field {
                    name: "vbe",
                    description: Some("V_BAT charging enable Note: Reset only by POR,."),
                ...
                Field {
                    name: "vbrs",
                    description: Some("V_BAT charging resistor selection."),
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "vbatl",
                    description: Some("V_BAT level monitoring versus low threshold."),
                ...
                Field {
                    name: "vbath",
                    description: Some("V_BAT level monitoring versus high threshold."),
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "lpms",
                    description: Some("low-power mode selection This bit defines the Deepsleep mode."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 1,
                    array: None,
                    enumm: Some("Lpms"),
                ...
                Field {
                    ...
                    bit_size: 1,
                    array: None,
                    enumm: Some("PowerModeInStopMode"),
                },
                Field {
                    name: "booste",
                    description: Some(
                ...
                Field {
                    name: "sram2so",
                    description: Some("AHB SRAM2 shut-off in Stop mode."),
                ...
                Field {
                    name: "sram1so",
                    description: Some("AHB SRAM1 shut-off in Stop mode."),
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "avden",
                    description: Some("peripheral voltage monitor on V_DDA enable."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 8 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "vddio2rdy",
                    description: Some("voltage detector output on V_DDIO2 This bit is set and cleared by hardware."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 20 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "vosrdy",
                    description: Some("Ready bit for V_CORE voltage scaling output selection."),
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    ...
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 16 }),
                    bit_size: 2,
                    array: Some(Array::Regular(RegularArray { len: 5, stride: 2 })),
                    enumm: Some("Wuppupd"),
                },
            ],
        },
        FieldSet {
            ...
            fields: &[Field {
                name: "cwuf",
                description: Some("clear wakeup pin flag for WUFx These bits are always read as 0."),
                bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                bit_size: 1,
                array: Some(Array::Regular(RegularArray { len: 5, stride: 1 })),
                enumm: None,
    ...
    enums: &[
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "Level0",
                    description: Some("AVD level0 (VAVD0 ~ 1.7 V)"),
                    value: 0,
                },
                EnumVariant {
                    name: "Level1",
                    description: Some("AVD level1 (VAVD1 ~ 2.1 V)"),
                    value: 1,
                },
                EnumVariant {
                    name: "Level2",
                    description: Some("AVD level2 (VAVD2 ~ 2.5 V)"),
                    value: 2,
                },
                EnumVariant {
                    name: "Level3",
                    description: Some("AVD level3 (VAVD3 ~ 2.8 V)"),
                    value: 3,
                },
            ],
        },
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "Standby",
                    description: Some("Allows Standby mode when entering DeepSleep."),
                    value: 1,
                },
                EnumVariant {
                    name: "Stop",
                    description: Some("Keeps Stop mode when entering DeepSleep."),
                    value: 0,
                },
            ],
        },
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "Level0",
                    description: Some("PVD level0 (VPVD0 ~ 1.95 V)"),
                    value: 0,
                },
                EnumVariant {
                    name: "Level1",
                    description: Some("PVD level1 (VPVD1 ~ 2.10 V)"),
                    value: 1,
                },
                EnumVariant {
                    name: "Level2",
                    description: Some("PVD level2 (VPVD2 ~ 2.25 V)"),
                    value: 2,
                },
                EnumVariant {
                    name: "Level3",
                    description: Some("PVD level3 (VPVD3 ~ 2.40 V)"),
                    value: 3,
                },
                EnumVariant {
                    name: "Level4",
                    description: Some("PVD level4 (VPVD4 ~ 2.55 V)"),
                    value: 4,
                },
                EnumVariant {
                    name: "Level5",
                    description: Some("PVD level5 (VPVD5 ~ 2.70 V)"),
                    value: 5,
                },
                EnumVariant {
                    name: "Level6",
                    description: Some("PVD level6 (VPVD6 ~ 2.85 V)"),
                    value: 6,
                },
                EnumVariant {
                    name: "PvdInPin",
                    description: Some("PVD_IN pin"),
                    value: 7,
                },
            ],
        },
        Enum {
            ...
            variants: &[
                ...
                EnumVariant {
                    name: "Normal",
                    description: Some("Remains in normal mode when the system enters Stop mode (quick restart time)."),
                    value: 0,
                },
            ],
        },
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "Lost",
                    description: Some("Content is lost."),
                    value: 0,
                },
                EnumVariant {
                    name: "Preserved",
                    description: Some("Content is preserved."),
                    value: 1,
                },
            ],
        },
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "Kept",
                    description: Some("Content is kept."),
                    value: 0,
                },
                EnumVariant {
                    name: "Lost",
        ...
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "Scale3",
                    description: Some("SVOS3 scale 3 (default)"),
                    value: 3,
                },
                EnumVariant {
                    name: "Scale4",
                    description: Some("SVOS4 scale 4"),
                    value: 2,
                },
                EnumVariant {
                    name: "Scale5",
                    description: Some("SVOS5 scale 5"),
                    value: 1,
                },
            ],
        },
