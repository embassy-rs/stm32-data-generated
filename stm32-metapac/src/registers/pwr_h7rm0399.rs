...
pub(crate) static REGISTERS: IR = IR {
    blocks: &[Block {
        ...
        items: &[
            ...
            BlockItem {
                name: "csr1",
                description: Some("PWR control status register 1"),
                array: None,
                byte_offset: 0x4,
                inner: BlockItemInner::Register(Register {
                    access: Access::Read,
            ...
            BlockItem {
                name: "cpucr",
                description: Some("This register allows controlling CPU1 power."),
                array: None,
                byte_offset: 0x10,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "wkupfr",
                description: Some("reset only by system reset, not reset by wakeup from Standby mode"),
                array: None,
                byte_offset: 0x24,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
                    fieldset: Some("Wkupfr"),
                }),
            },
            BlockItem {
                name: "wkupepr",
    ...
    fieldsets: &[
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "run_d3",
                    description: Some("Keep system D3 domain in Run mode regardless of the CPU sub-systems modes"),
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "avden",
                    description: Some("Peripheral voltage monitor on VDDA enable"),
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "vbatl",
                    description: Some("VBAT level monitoring versus low threshold"),
                ...
                Field {
                    name: "vbath",
                    description: Some("VBAT level monitoring versus high threshold"),
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "bypass",
                    description: Some("Power management unit bypass"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "ldoen",
                    description: Some("Low drop-out regulator enable"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 1 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "sden",
                    description: Some("SD converter Enable"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 2 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "sdexthp",
                    description: Some("Step-down converter forced ON and in High Power MR mode"),
                ...
                Field {
                    name: "sdlevel",
                    description: Some("Step-down converter voltage output level selection"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 4 }),
                    bit_size: 2,
                    array: None,
                    enumm: Some("Sdlevel"),
                ...
                Field {
                    name: "vbe",
                    description: Some("VBAT charging enable"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 8 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "vbrs",
                    description: Some("VBAT charging resistor selection"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 9 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "sdextrdy",
                    description: Some("SMPS step-down converter external supply ready"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 16 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "usb33den",
                    description: Some("VDD33USB voltage level detector enable."),
                ...
                Field {
                    name: "usbregen",
                    description: Some("USB regulator enable."),
                ...
                Field {
                    name: "usb33rdy",
                    description: Some("USB supply ready."),
        ...
        FieldSet {
            ...
            fields: &[Field {
                name: "wkupc",
                description: Some("Clear Wakeup pin flag for WKUP. These bits are always read as 0."),
                bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                bit_size: 6,
                array: None,
                enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "wkuppupd",
                    description: Some("Wakeup pin pull configuration"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 16 }),
                    bit_size: 2,
                    array: Some(Array::Regular(RegularArray { len: 6, stride: 2 })),
                    enumm: Some("Wkuppupd"),
                },
            ],
        },
