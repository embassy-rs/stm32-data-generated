...
pub(crate) static REGISTERS: IR = IR {
    blocks: &[Block {
        ...
        items: &[
            ...
            BlockItem {
                name: "csr3",
                description: Some("PWR CPU control register 3."),
                array: None,
                byte_offset: 0x10,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "csr4",
                description: Some("PWR control status register 4."),
                array: None,
                byte_offset: 0x14,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "wkupcr",
                description: Some("PWR wakeup clear register."),
                array: None,
                byte_offset: 0x20,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "wkupfr",
                description: Some("PWR wakeup flag register."),
                array: None,
                byte_offset: 0x24,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "wkupepr",
                description: Some("PWR wakeup enable and polarity register."),
                array: None,
                byte_offset: 0x28,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "ucpdr",
                description: Some("PWR USB Type-C and Power Delivery register."),
                array: None,
                byte_offset: 0x2c,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "pucrn",
                description: Some("PWR port N pull-up control register."),
                array: None,
                byte_offset: 0x34,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "pdcrn",
                description: Some("PWR port N pull-down control register."),
                array: None,
                byte_offset: 0x38,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "pucro",
                description: Some("PWR port O pull-up control register."),
                array: None,
                byte_offset: 0x3c,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "pdcro",
                description: Some("PWR port O pull-down control register."),
                array: None,
                byte_offset: 0x40,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "pdcrp",
                description: Some("PWR port P pull-down control register."),
                array: None,
                byte_offset: 0x44,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "pdr1",
                description: Some("PWR debug register 1."),
                array: None,
                byte_offset: 0x50,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
    ...
    fieldsets: &[
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "vbatl",
                    description: Some("V<sub>BAT</sub> level monitoring versus low threshold."),
                ...
                Field {
                    name: "vbath",
                    description: Some("V<sub>BAT</sub> level monitoring versus high threshold."),
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "xspicap1",
                    description: Some("XSPI port 1 capacitor control bits see the product datasheet for more details."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 10 }),
                    bit_size: 2,
                    array: None,
                    enumm: Some("Xspicap"),
                ...
                Field {
                    name: "xspicap2",
                    description: Some("XSPI port 2 capacitor control bits see the product datasheet for more details."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 12 }),
                    bit_size: 2,
                    array: None,
                    enumm: Some("Xspicap"),
                ...
                Field {
                    name: "usb33den",
                    description: Some("VDD33_USB voltage level detector enable."),
                ...
                Field {
                    name: "usbhsregen",
                    description: Some("USB HS regulator enable."),
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "pdds",
                    description: Some("Power Down Deepsleep. This bit allows CPU to define the Deepsleep mode."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 1,
                    array: None,
                    enumm: Some("Pdds"),
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "vosrdy",
                    description: Some("VOS Ready bit."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 1 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "unlocked",
                    description: Some("Debug Register Unlocked."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 1,
                    array: None,
                    enumm: Some("Unlocked"),
                ...
                Field {
                    name: "sdfpwmen",
                    description: Some("Step down converter force PWM mode."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 3 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "ucpd_dbdis",
                    description: Some("UCPD dead battery disable."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[Field {
                name: "wkupc",
                description: Some("Clear Wakeup pin flag for WKUP1 These bits are always read as 0."),
                bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                bit_size: 1,
    ...
    enums: &[
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "Level1",
                    description: Some("AVD level 1."),
                    value: 0,
                },
                EnumVariant {
                    name: "Level2",
                    description: Some("AVD level 2."),
                    value: 1,
                },
                EnumVariant {
                    name: "Level3",
                    description: Some("AVD level 3."),
                    value: 2,
                },
                EnumVariant {
                    name: "Level4",
                    description: Some("AVD level 4."),
                    value: 3,
                },
            ],
        },
        Enum {
            ...
            variants: &[
                ...
                EnumVariant {
                    name: "Below",
                    description: Some("VDDA is lower than the AVD threshold selected with the ALS[1:0] bits."),
                    value: 1,
                },
            ],
        },
        ...
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "External",
                    description: Some("External voltage level on PVD_IN pin, compared to internal VREFINT level."),
                    value: 7,
                },
                EnumVariant {
                    name: "Level1",
                    description: Some("PVD level 1."),
                    value: 0,
                },
                EnumVariant {
                    name: "Level2",
                    description: Some("PVD level 2."),
                    value: 1,
                },
                EnumVariant {
                    name: "Level3",
                    description: Some("PVD level 3."),
                    value: 2,
                },
                EnumVariant {
                    name: "Level4",
                    description: Some("PVD level 4."),
                    value: 3,
                },
                EnumVariant {
                    name: "Level5",
                    description: Some("PVD level 5."),
                    value: 4,
                },
                EnumVariant {
                    name: "Level6",
                    description: Some("PVD level 6."),
                    value: 5,
                },
                EnumVariant {
                    name: "Level7",
                    description: Some("PVD level 7."),
                    value: 6,
                },
            ],
        },
        ...
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "LowPower",
                    description: Some("RAM enters to low power mode when system enters to STOP."),
                    value: 0,
                },
                EnumVariant {
                    name: "Normal",
                    description: Some("RAM remains in normal mode when system enters to STOP."),
                    value: 1,
                },
            ],
        },
        ...
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "FreeRunning",
                    description: Some("SD_Converter clock free running."),
                    value: 0,
                },
                EnumVariant {
                    name: "Synchronized",
                    description: Some("SD_Converter clock synchronised to ADC."),
                    value: 1,
                },
            ],
        },
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "Locked",
                    description: Some("accessed locked: key was not written and after each register write access."),
                    value: 0,
                },
                EnumVariant {
                    name: "Unlocked",
                    description: Some("after key 0xCAFECAFE was written in this register."),
                    value: 1,
                },
            ],
        },
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "Ohm15k",
                    description: Some("Charge VBAT through a 1.5 k resistor."),
                    value: 1,
                },
                EnumVariant {
                    name: "Ohm5k",
                    description: Some("Charge VBAT through a 5 k resistor."),
                    value: 0,
                },
            ],
        },
        ...
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "Disabled",
                    description: Some("XSPI Capacitor OFF (default) note: to confirm with analog design."),
                    value: 0,
                },
                EnumVariant {
                    name: "Full",
                    description: Some("XSPI Capacitor set to full capacitance."),
                    value: 3,
                },
                EnumVariant {
                    name: "OneThird",
                    description: Some("XSPI Capacitor set to 1/3."),
                    value: 1,
                },
                EnumVariant {
                    name: "TwoThirds",
                    description: Some("XSPI Capacitor set to 2/3."),
                    value: 2,
                },
            ],
        },
