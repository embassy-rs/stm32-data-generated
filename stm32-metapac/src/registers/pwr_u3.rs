...
pub(crate) static REGISTERS: IR = IR {
    blocks: &[Block {
        name: "Pwr",
        extends: None,
        description: Some("PWR Address block."),
        items: &[
            BlockItem {
                name: "cr1",
            ...
            BlockItem {
                name: "vosr",
                description: Some("PWR voltage scaling register."),
                array: None,
                byte_offset: 0xc,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "svmcr",
                description: Some("PWR supply voltage monitoring control register."),
                array: None,
                byte_offset: 0x10,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "wucr1",
                description: Some("PWR wakeup control register 1."),
                array: None,
                byte_offset: 0x14,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "wucr2",
                description: Some("PWR wakeup control register 2."),
                array: None,
                byte_offset: 0x18,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "wucr3",
                description: Some("PWR wakeup control register 3."),
                array: None,
                byte_offset: 0x1c,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "dbpcr",
                description: Some("PWR disable Backup domain register."),
                array: None,
                byte_offset: 0x28,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "privcfgr",
                description: Some("PWR privilege control register."),
                array: None,
                byte_offset: 0x34,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "svmsr",
                description: Some("PWR supply voltage monitoring status register."),
                array: None,
                byte_offset: 0x3c,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "apcr",
                description: Some("PWR apply pull configuration register."),
                array: None,
                byte_offset: 0x4c,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "pucra",
                description: Some("PWR port A pull-up control register."),
                array: None,
                byte_offset: 0x50,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "pdcra",
                description: Some("PWR port A pull-down control register."),
                array: None,
                byte_offset: 0x54,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "pucrb",
                description: Some("PWR port B pull-up control register."),
                array: None,
                byte_offset: 0x58,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "pdcrb",
                description: Some("PWR port B pull-down control register."),
                array: None,
                byte_offset: 0x5c,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "pucrc",
                description: Some("PWR port C pull-up control register."),
                array: None,
                byte_offset: 0x60,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "pdcrc",
                description: Some("PWR port C pull-down control register."),
                array: None,
                byte_offset: 0x64,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "pucrd",
                description: Some("PWR port D pull-up control register."),
                array: None,
                byte_offset: 0x68,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "pdcrd",
                description: Some("PWR port D pull-down control register."),
                array: None,
                byte_offset: 0x6c,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "pucre",
                description: Some("PWR port E pull-up control register."),
                array: None,
                byte_offset: 0x70,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "pdcre",
                description: Some("PWR port E pull-down control register."),
                array: None,
                byte_offset: 0x74,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "pucrg",
                description: Some("PWR port G pull-up control register."),
                array: None,
                byte_offset: 0x80,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "pdcrg",
                description: Some("PWR port G pull-down control register."),
                array: None,
                byte_offset: 0x84,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "pucrh",
                description: Some("PWR port H pull-up control register."),
                array: None,
                byte_offset: 0x88,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "pdcrh",
                description: Some("PWR port H pull-down control register."),
                array: None,
                byte_offset: 0x8c,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "i3cpucr1",
                description: Some("PWR I3C pull-up control register 1."),
                array: None,
                byte_offset: 0xb0,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
                    fieldset: Some("I3cpucr1"),
                }),
            },
            BlockItem {
                name: "i3cpucr2",
                description: Some("PWR I3C pull-up control register 2."),
                array: None,
                byte_offset: 0xb4,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
                    fieldset: Some("I3cpucr2"),
                }),
            },
        ],
    }],
    fieldsets: &[
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "vbe",
                    description: Some("None 0: VBAT battery charging disabled 1: VBAT battery charging enabled."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "pa1_i3cpu",
                    description: Some("When set, the bit activates the I3C pull-up on PA1."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "pa6_i3cpu",
                    description: Some("When set, the bit activates the I3C pull-up on PA6."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 1 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "pa7_i3cpu",
                    description: Some("When set, the bit activates the I3C pull-up on PA7."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 2 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "pb2_i3cpu",
                    description: Some("When set, the bit activates the I3C pull-up on PB2."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 4 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "pb6_i3cpu",
                    description: Some("When set, the bit activates the I3C pull-up on PB6."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 5 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "pb8_i3cpu",
                    description: Some("When set, the bit activates the I3C pull-up on PB8."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 6 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "pb9_i3cpu",
                    description: Some("When set, the bit activates the I3C pull-up on PB9."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 7 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "pb10_i3cpu",
                    description: Some("When set, the bit activates the I3C pull-up on PB10."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 8 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "pb12_i3cpu",
                    description: Some("When set, the bit activates the I3C pull-up on PB12."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 9 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "pb13_i3cpu",
                    description: Some("When set, the bit activates the I3C pull-up on PB13."),
                ...
                Field {
                    name: "pb14_i3cpu",
                    description: Some("When set, the bit activates the I3C pull-up on PB14."),
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "pc0_i3cpu",
                    description: Some("When set, the bit activates the I3C pull-up on PC0."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "pc1_i3cpu",
                    description: Some("When set, the bit activates the I3C pull-up on PC1."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 1 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "pd12_i3cpu",
                    description: Some("When set, the bit activates the I3C pull-up on PD12."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 3 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "pd13_i3cpu",
                    description: Some("When set, the bit activates the I3C pull-up on PD13."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 4 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "pg7_i3cpu",
                    description: Some("When set, the bit activates the I3C pull-up on PG7."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 6 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "pg8_i3cpu",
                    description: Some("When set, the bit activates the I3C pull-up on PG8."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 7 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "pg13_i3cpu",
                    description: Some("When set, the bit activates the I3C pull-up on PG13."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 8 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "pg14_i3cpu",
                    description: Some("When set, the bit activates the I3C pull-up on PG14."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 9 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "ph3_i3cpu",
                    description: Some("When set, the bit activates the I3C pull-up on PH3."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 11 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "pvde",
                    description: Some("None 0: PVD disabled 1: PVD enabled."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 4 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "uvmen",
                    description: Some("None 0: VDDUSB voltage monitor disabled 1: VDDUSB voltage monitor enabled."),
                ...
                Field {
                    name: "io2vmen",
                    description: Some("None 0: VDDIO2 voltage monitor disabled 1: VDDIO2 voltage monitor enabled."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 25 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "avm1en",
                    description: Some("None 0: VDDA voltage monitor 1 disabled 1: VDDA voltage monitor 1 enabled."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 26 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "avm2en",
                    description: Some("None 0: VDDA voltage monitor 2 disabled 1: VDDA voltage monitor 2 enabled."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 27 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "regs",
                    description: Some("None 0: LDO selected 1: SMPS selected."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 1 }),
                    bit_size: 1,
                    array: None,
                    enumm: Some("Regsel"),
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "wupen1",
                    description: Some("None 0: Wakeup line WKUP1 disabled 1: Wakeup line WKUP1 enabled."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "wupen2",
                    description: Some("None 0: Wakeup line WKUP2 disabled 1: Wakeup line WKUP2 enabled."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 1 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "wupen3",
                    description: Some("None 0: Wakeup line WKUP3 disabled 1: Wakeup line WKUP3 enabled."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 2 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "wupen4",
                    description: Some("None 0: Wakeup line WKUP4 disabled 1: Wakeup line WKUP4 enabled."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 3 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "wupen5",
                    description: Some("None 0: Wakeup line WKUP5 disabled 1: Wakeup line WKUP5 enabled."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 4 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "wupen6",
                    description: Some("None 0: Wakeup line WKUP6 disabled 1: Wakeup line WKUP6 enabled."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 5 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "wupen7",
                    description: Some("None 0: Wakeup line WKUP7 disabled 1: Wakeup line WKUP7 enabled."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 6 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "wupen8",
                    description: Some("None 0: Wakeup line WKUP8 disabled 1: Wakeup line WKUP8 enabled."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 7 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "wupen9",
                    description: Some("None 0: Wakeup line WKUP9 disabled 1: Wakeup line WKUP9 enabled."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 8 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "wupen10",
                    description: Some("None 0: Wakeup line WKUP10 disabled 1: Wakeup line WKUP10 enabled."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 9 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "cwuf1",
                    description: Some("Writing 1 to this bit clears the WUF1 flag in WUSR."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "cwuf2",
                    description: Some("Writing 1 to this bit clears the WUF2 flag in WUSR."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 1 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "cwuf3",
                    description: Some("Writing 1 to this bit clears the WUF3 flag in WUSR."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 2 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "cwuf4",
                    description: Some("Writing 1 to this bit clears the WUF4 flag in WUSR."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 3 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "cwuf5",
                    description: Some("Writing 1 to this bit clears the WUF5 flag in WUSR."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 4 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "cwuf6",
                    description: Some("Writing 1 to this bit clears the WUF6 flag in WUSR."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 5 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "cwuf7",
                    description: Some("Writing 1 to this bit clears the WUF7 flag in WUSR."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 6 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "cwuf8",
                    description: Some("Writing 1 to this bit clears the WUF8 flag in WUSR."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 7 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "cwuf9",
                    description: Some("Writing 1 to this bit clears the WUF9 flag in WUSR."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 8 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "cwuf10",
                    description: Some("Writing 1 to this bit clears the WUF10 flag in WUSR."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 9 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
    ...
    enums: &[
        ...
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "Lost",
                    description: Some("Content lost in Stop modes."),
                    value: 1,
                },
                EnumVariant {
                    name: "Retained",
                    description: Some("Contents retained in Stop modes."),
                    value: 0,
                },
            ],
        },
        Enum {
            ...
            variants: &[
                ...
                EnumVariant {
                    name: "V20",
                    description: Some("VPVD0 around 2.0V."),
                    value: 0,
                },
                EnumVariant {
                    name: "V22",
                    description: Some("VPVD1 around 2.2V."),
                    value: 1,
                },
                EnumVariant {
                    name: "V24",
                    description: Some("VPVD2 around 2.4V."),
                    value: 2,
                },
                EnumVariant {
                    name: "V25",
                    description: Some("VPVD3 around 2.5V."),
                    value: 3,
                },
                EnumVariant {
                    name: "V26",
                    description: Some("VPVD4 around 2.6V."),
                    value: 4,
                },
                EnumVariant {
                    name: "V28",
                    description: Some("VPVD5 around 2.8V."),
                    value: 5,
                },
                EnumVariant {
                    name: "V29",
                    description: Some("VPVD6 around 2.9V."),
                    value: 6,
                },
            ],
        },
        ...
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "PoweredOff",
                    description: Some("SRAM1 powered off."),
                    value: 1,
                },
                EnumVariant {
                    name: "PoweredOn",
                    description: Some("SRAM1 powered on."),
                    value: 0,
                },
            ],
        },
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "Charge15k",
                    description: Some("Charge VBAT through a 1.5 k ohm resistor."),
                    value: 1,
                },
                EnumVariant {
                    name: "Charge5k",
                    description: Some("Charge VBAT through a 5 k ohm resistor."),
                    value: 0,
                },
            ],
        },
        ...
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "WkuPx0",
                    description: Some("WKUPx_0."),
                    value: 0,
                },
                EnumVariant {
                    name: "WkuPx1",
                    description: Some("WKUPx_1."),
                    value: 1,
                },
                EnumVariant {
                    name: "WkuPx2",
                    description: Some("WKUPx_2."),
                    value: 2,
                },
                EnumVariant {
                    name: "WkuPx3",
                    description: Some("WKUPx_3."),
                    value: 3,
                },
            ],
        },
