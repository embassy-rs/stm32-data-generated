...
pub(crate) static REGISTERS: IR = IR {
    blocks: &[Block {
        ...
        items: &[
            ...
            BlockItem {
                name: "pucra",
                description: Some("PUCRA register."),
                array: None,
                byte_offset: 0x20,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "pdcra",
                description: Some("PDCRA register."),
                array: None,
                byte_offset: 0x24,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "pucrb",
                description: Some("PUCRB register."),
                array: None,
                byte_offset: 0x28,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "pdcrb",
                description: Some("PDCRB register."),
                array: None,
                byte_offset: 0x2c,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "i_ox_cfg",
                description: Some("IOxCFG register."),
                array: None,
                byte_offset: 0x40,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
                    fieldset: Some("IOxCfg"),
                }),
            },
            BlockItem {
                name: "dbgr",
                description: Some("DBGR register."),
                array: None,
                byte_offset: 0x84,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "extsrr",
                description: Some("EXTSRR register."),
                array: None,
                byte_offset: 0x88,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
                    fieldset: Some("Extsrr"),
                }),
            },
        ],
    }],
    fieldsets: &[
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "ensdnbor",
                    description: Some("ENSDNBOR: Enable BOR supply monitoring during shutdown mode."),
                ...
                Field {
                    name: "apc",
                    description: Some("APC Apply Pull-up and pull-down configuration from CPU."),
                ...
                Field {
                    name: "enborh",
                    description: Some("ENBORH: enable BORH configuration."),
                ...
                Field {
                    name: "selborh",
                    description: Some("SELBORH[1:0]: BORH selection of Vbor threshold."),
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "pvdls",
                    description: Some("PVDLS[2:0] Programmable Voltage Detector Level selection then PVDO=1)."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 1 }),
                    bit_size: 3,
                    array: None,
                    enumm: Some("Pvdls"),
                ...
                Field {
                    name: "ramret1",
                    description: Some("Enables the RAM2 bank retention in DEEPSTOP mode."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 5 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "ramret3",
                    description: Some("Enables the RAM3 bank retention in DEEPSTOP mode."),
                ...
                Field {
                    name: "ents",
                    description: Some("ENTS: Enable Temperature Sensor."),
                ...
                Field {
                    name: "lsilpmufen",
                    description: Some("LSI LPMU force enable."),
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "smpsbomsel",
                    description: Some("SMPSBOMSEL: SMPS BOM Selection:."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 4 }),
                    bit_size: 2,
                    array: None,
                    enumm: Some("Smpsbomsel"),
                },
                Field {
                    name: "smpsfrdy",
                    description: Some(
                ...
                Field {
                    name: "smps_ena_dcm",
                    description: Some("SMPS_ENA_DCM: enable discontinuous conduction mode."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 11 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    ...
                    description: Some("SMPS_PRECH_CUR_SEL[1:0] Selection for SMPS PRECHARGE limit current."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 13 }),
                    bit_size: 2,
                    array: None,
                    enumm: Some("SmpsPrechCurSel"),
                },
            ],
        },
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "ewu20",
                    description: Some("Enable wakeup on PB8 I/O event."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 8 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "ewu21",
                    description: Some("Enable wakeup on PB9 I/O event."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 9 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "ewu22",
                    description: Some("Enable wakeup on PB10 I/O event."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 10 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "ewu23",
                    description: Some("Enable wakeup on PB11 I/O event."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 11 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "ewu24",
                    description: Some("Enable wakeup on PA12 I/O event."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 12 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "ewu25",
                    description: Some("Enable wakeup on PA13 I/O event."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 13 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "ewu26",
                    description: Some("Enable wakeup on PA14 I/O event."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 14 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "ewu27",
                    description: Some("Enable wakeup on PA15 I/O event."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 15 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "wup20",
                    description: Some("Wake-up polarity for PB8 IO event."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 8 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "wup21",
                    description: Some("Wake-up polarity for PB9 IO event."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 9 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "wup22",
                    description: Some("Wake-up polarity for PB10 IO event."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 10 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "wup23",
                    description: Some("Wake-up polarity for PB11 IO event."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 11 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "wup24",
                    description: Some("Wake-up polarity for PB12 IO event."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 12 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "wup25",
                    description: Some("Wake-up polarity for PB13 IO event."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 13 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "wup26",
                    description: Some("Wake-up polarity for PB14 IO event."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 14 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "wup27",
                    description: Some("Wake-up polarity for PB15 IO event."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 15 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "iocfg0",
                    description: Some("Drive configuration for PA8."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 2,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "iocfg1",
                    description: Some("Drive configuration for PA9."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 2 }),
                    bit_size: 2,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "iocfg2",
                    description: Some("Drive configuration for PA10."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 4 }),
                    bit_size: 2,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "iocfg3",
                    description: Some("Drive configuration for PA11."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 6 }),
                    bit_size: 2,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "iocfg4",
                    description: Some("Drive configuration for PA4."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 8 }),
                    bit_size: 2,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "iocfg5",
                    description: Some("Drive configuration for PA5."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 10 }),
                    bit_size: 2,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "iocfg6",
                    description: Some("Drive configuration for PA6."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 12 }),
                    bit_size: 2,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "iocfg7",
                    description: Some("Drive configuration for PA7."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 14 }),
                    bit_size: 2,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "wuf20",
                    description: Some("PB8 I/O wake-up flag."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 8 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "wuf21",
                    description: Some("PB9 I/O wake-up flag."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 9 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "wuf22",
                    description: Some("PB10 I/O wake-up flag."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 10 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "wuf23",
                    description: Some("PB11 I/O wake-up flag."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 11 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "wuf24",
                    description: Some("PB12 I/O wake-up flag."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 12 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "wuf25",
                    description: Some("PB13 I/O wake-up flag."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 13 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "wuf26",
                    description: Some("PB14 I/O wake-up flag."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 14 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "wuf27",
                    description: Some("PB15 I/O wake-up flag."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 15 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
    ...
    enums: &[
        ...
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "B0x0",
                    description: Some("System has not been in DEEPSTOP mode."),
                    value: 0,
                },
                EnumVariant {
                    name: "B0x1",
                    description: Some("System has been in DEEPSTOP mode."),
                    value: 1,
                },
            ],
        },
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "B0x0",
                    description: Some("BORH off (VBOR0): threshold level for above 1.60V voltage operation."),
                    value: 0,
                },
                EnumVariant {
                    name: "B0x1",
                    description: Some("BORH is enabled, threshold level depends on SELBOR[1:0]."),
                    value: 1,
                },
            ],
        },
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "B0x0",
                    description: Some("the PD_ALL_SHUTDOWN signal is set during SHUTDOWN mode."),
                    value: 0,
                },
                EnumVariant {
                    name: "B0x1",
                    description: Some("the PD_ALL_SHUTDOWN signal is not set during SHUTDOWN mode."),
                    value: 1,
                },
            ],
        },
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "B0x0",
                    description: Some("Deep Stop mode (default)."),
                    value: 0,
                },
                EnumVariant {
                    name: "B0x1",
        ...
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "B0x0",
                    description: Some("Pull-Down not activated on Port A[i]."),
                    value: 0,
                },
                EnumVariant {
                    name: "B0x1",
                    description: Some("Pull-Down activated on Port A[i] when APC bit of PWRC CR3 bit is set."),
                    value: 1,
                },
            ],
        },
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "B0x0",
                    description: Some("Pull-Down not activated on Port B[i]."),
                    value: 0,
                },
                EnumVariant {
                    name: "B0x1",
                    description: Some("Pull-Down activated on Port B[i] when APC bit of PWRC CR3 bit is set."),
                    value: 1,
                },
            ],
        },
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "B0x0",
                    description: Some("Pull-Up not activated on port A[i]."),
                    value: 0,
                },
                EnumVariant {
                    name: "B0x1",
        ...
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "B0x0",
                    description: Some("Pull-Up not activated on port B[i]."),
                    value: 0,
                },
                EnumVariant {
                    name: "B0x1",
        ...
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "B0x0",
                    description: Some("2.05 V - Lowest level."),
                    value: 0,
                },
                EnumVariant {
                    name: "B0x1",
                    description: Some("2.20 V."),
                    value: 1,
                },
                EnumVariant {
                    name: "B0x2",
                    description: Some("2.36 V."),
                    value: 2,
                },
                EnumVariant {
                    name: "B0x3",
                    description: Some("2.52 V."),
                    value: 3,
                },
                EnumVariant {
                    name: "B0x4",
                    description: Some("2.64 V."),
                    value: 4,
                },
                EnumVariant {
                    name: "B0x5",
                    description: Some("2.81 V."),
                    value: 5,
                },
                EnumVariant {
                    name: "B0x6",
                    description: Some("2.91 V - Highest level."),
                    value: 6,
                },
                EnumVariant {
                    name: "B0x7",
        ...
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "B0x0",
                    description: Some("LP regulator is not ready."),
                    value: 0,
                },
                EnumVariant {
                    name: "B0x1",
                    description: Some("LP regulator is ready."),
                    value: 1,
                },
            ],
        },
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "B0x0",
                    description: Some("Main regulator is not ready."),
                    value: 0,
                },
                EnumVariant {
                    name: "B0x1",
                    description: Some("Main regulator is ready."),
                    value: 1,
                },
            ],
        },
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "B0x0",
                    description: Some("RF IP does not require attention."),
                    value: 0,
                },
                EnumVariant {
                    name: "B0x1",
                    description: Some("RF IP awake and requesting system attention."),
                    value: 1,
                },
            ],
        },
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "B0x0",
                    description: Some("BORH Level 1 (VBOR1): threshold level for above 2.0V voltage operation."),
                    value: 0,
                },
                EnumVariant {
                    name: "B0x1",
                    description: Some("BORH Level 2 (VBOR2): threshold level for above 2.21 V voltage operation."),
                    value: 1,
                },
                EnumVariant {
                    name: "B0x2",
                    description: Some("BORH Level 3 (VBOR3): threshold level for above 2.52 V voltage operation."),
                    value: 2,
                },
                EnumVariant {
                    name: "B0x3",
                    description: Some("BORH Level 4(VBOR4): threshold level for above 2.81 V voltage operation."),
                    value: 3,
                },
            ],
        },
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "B0x0",
                    description: Some("2.5mA."),
                    value: 0,
                },
                EnumVariant {
                    name: "B0x1",
                    description: Some("5mA."),
                    value: 1,
                },
                EnumVariant {
                    name: "B0x2",
                    description: Some("10mA."),
                    value: 2,
                },
                EnumVariant {
                    name: "B0x3",
                    description: Some("20mA (default)."),
                    value: 3,
                },
            ],
        },
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "B0x0",
                    description: Some("BOM1."),
                    value: 0,
                },
                EnumVariant {
                    name: "B0x1",
                    description: Some("BOM2 (default)."),
                    value: 1,
                },
                EnumVariant {
                    name: "B0x2",
                    description: Some("BOM3."),
                    value: 2,
                },
                EnumVariant {
                    name: "B0x3",
        ...
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "B0x0",
                    description: Some("no effect (by default)."),
                    value: 0,
                },
                EnumVariant {
                    name: "B0x1",
                    description: Some("SMPS is disabled and bypassed (ENABLE_3V3=0 and PRECHARGE_3V3=1)."),
                    value: 1,
                },
            ],
        },
        Enum {
            ...
            variants: &[
                ...
                EnumVariant {
                    name: "B0x1",
                    description: Some("SMPS is considered READY."),
                    value: 1,
                },
            ],
        },
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "B0x0",
                    description: Some("in Low Power mode, SMPS is in PRECHARGE, output is connected to VDDIO."),
                    value: 0,
                },
                EnumVariant {
                    name: "B0x1",
                    description: Some("in Low Power mode, SMPS is disabled, output is floating."),
                    value: 1,
                },
            ],
        },
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "B0x0",
                    description: Some("SMPS regulator is not ready."),
                    value: 0,
                },
                EnumVariant {
                    name: "B0x1",
                    description: Some("SMPS regulator is ready."),
                    value: 1,
                },
            ],
        },
        Enum {
            ...
            variants: &[
                ...
                EnumVariant {
                    name: "B0x1",
                    description: Some("clear the interrupt."),
                    value: 1,
                },
            ],
        },
