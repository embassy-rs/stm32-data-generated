...
pub(crate) static REGISTERS: IR = IR {
    blocks: &[Block {
        name: "Ramcfg",
        extends: None,
        description: Some("RAMs configuration controller."),
        items: &[
            BlockItem {
                name: "m1cr",
                description: Some("RAMCFG memory 1 control register."),
                array: None,
                byte_offset: 0x0,
            ...
            BlockItem {
                name: "m1isr",
                description: Some("RAMCFG memory interrupt status register."),
                array: None,
                byte_offset: 0x8,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "m1erkeyr",
                description: Some("RAMCFG memory 1 erase key register."),
                array: None,
                byte_offset: 0x28,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "m2cr",
                description: Some("RAMCFG memory 2 control register."),
                array: None,
                byte_offset: 0x40,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "m2ier",
                description: Some("RAMCFG memory 2 interrupt enable register."),
                array: None,
                byte_offset: 0x44,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "m2sear",
                description: Some("RAMCFG memory 2 ECC single error address register."),
                array: None,
                byte_offset: 0x4c,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
                    fieldset: Some("M2sear"),
                }),
            },
            BlockItem {
                name: "m2dear",
                description: Some("RAMCFG memory 2 ECC double error address register."),
                array: None,
                byte_offset: 0x50,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
                    fieldset: Some("M2dear"),
                }),
            },
            BlockItem {
                name: "m2icr",
                description: Some("RAMCFG memory 2 interrupt clear register 2."),
                array: None,
                byte_offset: 0x54,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "m2wpr1",
                description: Some("RAMCFG memory 2 write protection register 1."),
                array: None,
                byte_offset: 0x58,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "m2ecckeyr",
                description: Some("RAMCFG memory 2 ECC key register."),
                array: None,
                byte_offset: 0x64,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
                    fieldset: Some("M2ecckeyr"),
                }),
            },
            BlockItem {
                name: "m2erkeyr",
                description: Some("RAMCFG memory 2 erase key register."),
                array: None,
                byte_offset: 0x68,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "m3ier",
                description: Some("RAMCFG memory 3 interrupt enable register."),
                array: None,
                byte_offset: 0x84,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "m3sear",
                description: Some("RAMCFG memory 3 ECC single error address register."),
                array: None,
                byte_offset: 0x8c,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
                    fieldset: Some("M3sear"),
                }),
            },
            BlockItem {
                name: "m3dear",
                description: Some("RAMCFG memory 3 ECC double error address register."),
                array: None,
                byte_offset: 0x90,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
                    fieldset: Some("M3dear"),
                }),
            },
            BlockItem {
                name: "m3icr",
                description: Some("RAMCFG memory 3 interrupt clear register 3."),
                array: None,
                byte_offset: 0x94,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "m3ecckeyr",
                description: Some("RAMCFG memory 3 ECC key register."),
                array: None,
                byte_offset: 0xa4,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
                    fieldset: Some("M3ecckeyr"),
                }),
            },
            BlockItem {
                name: "m3erkeyr",
                description: Some("RAMCFG memory 3 erase key register."),
                array: None,
                byte_offset: 0xa8,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
                    fieldset: Some("M3erkeyr"),
                }),
            },
            BlockItem {
                name: "m4erkeyr",
                description: Some("RAMCFG memory 4 erase key register."),
                array: None,
                byte_offset: 0xe8,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
                    fieldset: Some("M4erkeyr"),
                }),
            },
            BlockItem {
                name: "m5cr",
                description: Some("RAMCFG memory 5 control register."),
                array: None,
                byte_offset: 0x100,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "m5ier",
                description: Some("RAMCFG memory 5 interrupt enable register."),
                array: None,
                byte_offset: 0x104,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "m5sear",
                description: Some("RAMCFG memory 5 ECC single error address register."),
                array: None,
                byte_offset: 0x10c,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
                    fieldset: Some("M5sear"),
                }),
            },
            BlockItem {
                name: "m5dear",
                description: Some("RAMCFG memory 5 ECC double error address register."),
                array: None,
                byte_offset: 0x110,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
                    fieldset: Some("M5dear"),
                }),
            },
            BlockItem {
                name: "m5icr",
                description: Some("RAMCFG memory 5 interrupt clear register 5."),
                array: None,
                byte_offset: 0x114,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "m5ecckeyr",
                description: Some("RAMCFG memory 5 ECC key register."),
                array: None,
                byte_offset: 0x124,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
                    fieldset: Some("M5ecckeyr"),
                }),
            },
            BlockItem {
                name: "m5erkeyr",
                description: Some("RAMCFG memory 5 erase key register."),
                array: None,
                byte_offset: 0x128,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
                    fieldset: Some("M5erkeyr"),
                }),
            },
        ],
    }],
    fieldsets: &[
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "seie",
                    description: Some("ECC single error interrupt enable."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "deie",
                    description: Some("ECC double error interrupt enable."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 1 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
