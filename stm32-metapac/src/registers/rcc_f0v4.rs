    ...
    fieldsets: &[
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "pllmcodiv",
                    description: Some("PLL clock not divided for MCO"),
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "hsi48cal",
                    description: Some("HSI48 factory clock calibration"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 24 }),
                    bit_size: 8,
                    array: None,
                    enumm: None,
    ...
    enums: &[
        ...
        Enum {
            ...
            variants: &[
                ...
                EnumVariant {
                    name: "Hsi48",
                    description: Some("Internal RC 48 MHz (HSI48) oscillator clock selected"),
                    value: 8,
                },
                EnumVariant {
                    name: "Lse",
        ...
        Enum {
            ...
            variants: &[
                ...
                EnumVariant {
                    name: "Hsi48DivPrediv",
                    description: Some("HSI48 divided by PREDIV selected as PLL input clock"),
                    value: 3,
                },
                EnumVariant {
                    name: "HsiDiv2",
        ...
        Enum {
            ...
            variants: &[
                ...
                EnumVariant {
                    name: "Hsi48",
                    description: Some("HSI48 used as system clock"),
                    value: 3,
                },
                EnumVariant {
                    name: "Pll1P",
        ...
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "Hsi48",
                    description: Some("HSI48 selected as USB clock source"),
                    value: 0,
                },
                EnumVariant {
                    name: "Pll1P",
