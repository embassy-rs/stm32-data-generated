...
pub(crate) static REGISTERS: IR = IR {
    blocks: &[Block {
        ...
        items: &[
            ...
            BlockItem {
                name: "dlycfgr",
                description: Some("delay configuration register"),
                array: None,
                byte_offset: 0xa4,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
                    fieldset: Some("Dlycfgr"),
                }),
            },
        ],
    }],
    fieldsets: &[
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "pkasmen",
                    description: Some("PKA clocks enable during Sleep and Stop modes"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 15 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "sdmmc2smen",
                    description: Some("SDMMC2 clocks enable during Sleep and Stop modes"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 23 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "octospi1en",
                    description: Some("OctoSPI1 memory interface clock enable"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 8 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "octospi1rst",
                    description: Some("OctoSPI1 memory interface reset"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 8 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "octospi1smen",
                    description: Some("OctoSPI1 memory interface clocks enable during Sleep and Stop modes"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 8 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "lsesysdis",
                    description: Some("Disable the Clock LSE propagation to the system"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 7 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
    ...
    enums: &[
        ...
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "Hsi",
                    description: Some("HSI clock selected as DFSDM audio clock"),
                    value: 1,
                },
                EnumVariant {
                    name: "Msi",
                    description: Some("MSI clock selected as DFSDM audio clock"),
                    value: 2,
                },
                EnumVariant {
                    name: "Pllsai1P",
                    description: Some("SAI1clock selected as DFSDM audio clock"),
                    value: 0,
                },
            ],
        },
        ...
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "Pclk2",
                    description: Some("APB2 clock (PCLK2) selected as DFSDM kernel clock"),
                    value: 0,
                },
                EnumVariant {
                    name: "Sys",
                    description: Some("System clock selected as DFSDM kernel clock"),
                    value: 1,
                },
            ],
        },
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "DsiPhyDiv8",
                    description: Some("DSI-PHY is selected as DSI byte lane clock source (usual case)"),
                    value: 0,
                },
                EnumVariant {
                    name: "Pllsai2Q",
        ...
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "Msi",
                    description: Some("MSI clock selected as OctoSPI kernel clock"),
                    value: 1,
                },
                EnumVariant {
                    name: "Pll1Q",
                    description: Some("PLL48M1CLK clock selected as OctoSPI kernel clock"),
                    value: 2,
                },
                EnumVariant {
                    name: "Sys",
                    description: Some("System clock selected as OctoSPI kernel clock"),
                    value: 0,
                },
            ],
        },
        ...
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "Hsi",
                    description: Some("HSI clock selected as SAIx clock"),
                    value: 4,
                },
                EnumVariant {
                    name: "Pll1P",
                    description: Some("PLLSAI3CLK clock is selected as SAIx clock"),
                    value: 2,
                },
                EnumVariant {
                    name: "Pllsai1P",
                    description: Some("PLLSAI1CLK clock is selected as SAIx clock"),
                    value: 0,
                },
                EnumVariant {
                    name: "Pllsai2P",
                    description: Some("PLLSAI2CLK clock is selected as SAIx clock"),
                    value: 1,
                },
                EnumVariant {
                    name: "Sai1Extclk",
                    description: Some("External clock SAIx_EXTCLK clock selected as SAIx clock"),
                    value: 3,
                },
            ],
        },
        ...
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "Hsi48",
                    description: Some("48 MHz clock is selected as SDMMC kernel clock"),
                    value: 0,
                },
                EnumVariant {
                    name: "Pll1P",
