...
pub(crate) static REGISTERS: IR = IR {
    blocks: &[Block {
        ...
        items: &[
            ...
            BlockItem {
                name: "icscr3",
                description: Some("RCC internal clock sources calibration register 3"),
                array: None,
                byte_offset: 0x10,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
                    fieldset: Some("Icscr3"),
                }),
            },
            BlockItem {
                name: "cfgr1",
                description: Some("RCC clock configuration register 1"),
                array: None,
                byte_offset: 0x1c,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "cfgr2",
                description: Some("RCC clock configuration register 2"),
                array: None,
                byte_offset: 0x20,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "cfgr3",
                description: Some("RCC clock configuration register 3"),
                array: None,
                byte_offset: 0x24,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "pll1cfgr",
                description: Some("RCC PLL1 configuration register"),
                array: None,
                byte_offset: 0x28,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
                    fieldset: Some("Pll1cfgr"),
                }),
            },
            BlockItem {
                name: "pll1divr",
            ...
            BlockItem {
                name: "ahb5rstr",
                description: Some("RCC AHB5 peripheral reset register"),
                array: None,
                byte_offset: 0x70,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
                    fieldset: Some("Ahb5rstr"),
                }),
            },
            BlockItem {
                name: "apb1rstr1",
                description: Some("RCC APB1 peripheral reset register 1"),
                array: None,
                byte_offset: 0x74,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "apb1rstr2",
                description: Some("RCC APB1 peripheral reset register 2"),
                array: None,
                byte_offset: 0x78,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "apb7rstr",
                description: Some("RCC APB7 peripheral reset register"),
                array: None,
                byte_offset: 0x80,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
                    fieldset: Some("Apb7rstr"),
                }),
            },
            BlockItem {
                name: "ahb1enr",
                description: Some("RCC AHB1 peripheral clock enable register"),
                array: None,
                byte_offset: 0x88,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "ahb2enr",
                description: Some("RCC AHB2 peripheral clock enable register"),
                array: None,
                byte_offset: 0x8c,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "ahb4enr",
                description: Some("RCC AHB4 peripheral clock enable register"),
                array: None,
                byte_offset: 0x94,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "ahb5enr",
                description: Some("RCC AHB5 peripheral clock enable register"),
                array: None,
                byte_offset: 0x98,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
                    fieldset: Some("Ahb5enr"),
                }),
            },
            BlockItem {
                name: "apb1enr1",
                description: Some("RCC APB1 peripheral clock enable register 1"),
                array: None,
                byte_offset: 0x9c,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "apb1enr2",
                description: Some("RCC APB1 peripheral clock enable register 2"),
                array: None,
                byte_offset: 0xa0,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "apb2enr",
                description: Some("RCC APB2 peripheral clock enable register"),
                array: None,
                byte_offset: 0xa4,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "apb7enr",
                description: Some("RCC APB7 peripheral clock enable register"),
                array: None,
                byte_offset: 0xa8,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
                    fieldset: Some("Apb7enr"),
                }),
            },
            BlockItem {
                name: "ahb1smenr",
                description: Some("RCC AHB1 peripheral clocks enable in Sleep and Stop modes register"),
                array: None,
                byte_offset: 0xb0,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "ahb2smenr",
                description: Some("RCC AHB2 peripheral clocks enable in Sleep and Stop modes register"),
                array: None,
                byte_offset: 0xb4,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "ahb4smenr",
                description: Some("RCC AHB4 peripheral clocks enable in Sleep and Stop modes register"),
                array: None,
                byte_offset: 0xbc,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
                    fieldset: Some("Ahb4smenr"),
                }),
            },
            BlockItem {
                name: "ahb5smenr",
                description: Some("RCC AHB5 peripheral clocks enable in Sleep and Stop modes register"),
                array: None,
                byte_offset: 0xc0,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
                    fieldset: Some("Ahb5smenr"),
                }),
            },
            BlockItem {
                name: "apb1smenr1",
                description: Some("RCC APB1 peripheral clocks enable in Sleep and Stop modes\tregister 1"),
                array: None,
                byte_offset: 0xc4,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "apb1smenr2",
                description: Some("RCC APB1 peripheral clocks enable in Sleep and Stop modes \tregister 2"),
                array: None,
                byte_offset: 0xc8,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "apb2smenr",
                description: Some("RCC APB2 peripheral clocks enable in Sleep and Stop modes register"),
                array: None,
                byte_offset: 0xcc,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "apb7smenr",
                description: Some("RCC APB7 peripheral clock enable in Sleep and Stop modes register"),
                array: None,
                byte_offset: 0xd0,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
                    fieldset: Some("Apb7smenr"),
                }),
            },
            BlockItem {
                name: "ccipr1",
            ...
            BlockItem {
                name: "ccipr3",
                description: Some("RCC peripherals independent clock configuration register 3"),
                array: None,
                byte_offset: 0xe8,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "csr",
                description: Some("RCC control/status register"),
                array: None,
                byte_offset: 0xf4,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "ascr",
                description: Some("RCC audio synchronization control register"),
                array: None,
                byte_offset: 0x1c0,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "asier",
                description: Some("RCC audio synchronization interrupt enable register"),
                array: None,
                byte_offset: 0x1c4,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "assr",
                description: Some("RCC audio synchronization status register"),
                array: None,
                byte_offset: 0x1c8,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "ascntr",
                description: Some("RCC audio synchronization counter register"),
                array: None,
                byte_offset: 0x1cc,
                inner: BlockItemInner::Register(Register {
                    access: Access::Read,
                    bit_size: 32,
                    fieldset: Some("Ascntr"),
                }),
            },
            BlockItem {
                name: "asarr",
                description: Some("RCC audio synchronization auto-reload register"),
                array: None,
                byte_offset: 0x1d0,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "ascar",
                description: Some("RCC audio synchronization capture register"),
                array: None,
                byte_offset: 0x1d4,
                inner: BlockItemInner::Register(Register {
                    access: Access::Read,
            ...
            BlockItem {
                name: "ascor",
                description: Some("RCC audio synchronization compare register"),
                array: None,
                byte_offset: 0x1d8,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "radioenr",
                description: Some("RCC RADIO peripheral clock enable register"),
                array: None,
                byte_offset: 0x208,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
                    fieldset: Some("Radioenr"),
                }),
            },
            BlockItem {
                name: "ecscr1",
                description: Some("RCC external clock sources calibration register 1"),
                array: None,
                byte_offset: 0x210,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
                    fieldset: Some("Ecscr1"),
                }),
            },
        ],
    }],
    fieldsets: &[
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "ptaconven",
                    description: Some("PTACONV bus clock enable"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 1 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "ptaconvrst",
                    description: Some("PTACONV reset."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 1 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "ptaconvsmen",
                    description: Some("PTACONV bus clock enable during Sleep and Stop modes."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 1 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "sai1en",
                    description: Some("SAI1 bus and kernel clocks enable"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 21 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "sai1smen",
                    description: Some("SAI1 bus and kernel clocks enable during Sleep and Stop modes."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 21 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "compen",
                    description: Some("COMP bus clock enable"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 15 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "compsmen",
                    description: Some("COMP bus clock enable during Sleep and Stop modes."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 15 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "caie",
                    description: Some("Capture trigger interrupt enable\r This bit is set and cleared by software."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "coie",
                    description: Some("Comparer interrupt enable\r This field is set and cleared by software."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 1 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "caeie",
                    description: Some("Capture error interrupt enable\r This field is set and cleared by software."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 2 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    ...
                    bit_size: 1,
                    array: None,
                    enumm: Some("Lsiprediv"),
                },
                Field {
                    name: "lsi2on",
                    description: Some("LSI2 oscillator enable"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 29 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "lsi2mode",
                    description: Some("LSI2 oscillator operating mode configuration."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 3,
                    array: None,
                    enumm: Some("Lsi2mode"),
                ...
                Field {
                    name: "lsi2cfg",
                    description: Some("LSI2 oscillator configuration."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 4 }),
                    bit_size: 4,
                    array: None,
                    enumm: Some("Lsi2cfg"),
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "otghssel",
                    description: Some("USB OTG_HS PHY kernel clock source selection."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 28 }),
                    bit_size: 2,
                    array: None,
                    enumm: Some("Otghssel"),
    ...
    enums: &[
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "Hclk4",
                    description: Some("hclk4 clock selected"),
                    value: 0,
                },
                EnumVariant {
                    name: "Hse",
                ...
                EnumVariant {
                    name: "Pll1P",
                    description: Some("pll1pclk selected"),
                    value: 2,
                },
                EnumVariant {
                    name: "Sys",
        ...
        Enum {
            ...
            variants: &[
                ...
                EnumVariant {
                    name: "Pll1Q",
                    description: Some("pll1qclk selected."),
                    value: 1,
                },
            ],
        },
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "Div1",
                    description: Some("hclk5 = SYSCLK not divided"),
                    value: 0,
                },
                EnumVariant {
                    name: "Div2",
                    description: Some("hclk5 = SYSCLK divided by 2"),
                    value: 1,
                },
            ],
        },
        ...
        Enum {
            ...
            variants: &[
                ...
                EnumVariant {
                    name: "Div3",
                    description: Some("hclk5 = SYSCLK divided by 3"),
                    value: 5,
                },
                EnumVariant {
                    name: "Div4",
                    description: Some("hclk5 = SYSCLK divided by 4"),
                    value: 6,
                },
                EnumVariant {
                    name: "Div6",
                    description: Some("hclk5 = SYSCLK divided by 6"),
                    value: 7,
                },
            ],
        },
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "Div1",
                    description: Some("HSE not divided, SYSCLK = HSE"),
                    value: 0,
                },
                EnumVariant {
                    name: "Div2",
                    description: Some("HSE divided, SYSCLK = HSE/2"),
                    value: 1,
                },
            ],
        },
        Enum {
            ...
            variants: &[
                ...
                EnumVariant {
                    name: "Pclk1",
                    description: Some("pclk1 selected"),
                    value: 0,
                },
                EnumVariant {
                    name: "Sys",
        ...
        Enum {
            ...
            variants: &[
                ...
                EnumVariant {
                    name: "Pclk7",
                    description: Some("pclk7 selected"),
                    value: 0,
                },
                EnumVariant {
                    name: "Sys",
        ...
        Enum {
            ...
            variants: &[
                ...
                EnumVariant {
                    name: "Lse",
                    description: Some("LSE selected"),
                    value: 3,
                },
                EnumVariant {
                    name: "Lsi",
                    description: Some("LSI selected"),
                    value: 1,
                },
                EnumVariant {
                    name: "Pclk7",
        ...
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "R",
                    description: Some("current source resistance R"),
                    value: 1,
                },
                EnumVariant {
                    name: "R23",
                    description: Some("current source resistance 2/3 x R"),
                    value: 3,
                },
                EnumVariant {
                    name: "R34",
                    description: Some("current source resistance 3/4 x R"),
                    value: 2,
                },
                EnumVariant {
                    name: "R54",
                    description: Some("current source resistance 5/4 x R"),
                    value: 0,
                },
            ],
        },
        ...
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "LowPower",
                    description: Some("low-power, medium accuracy."),
                    value: 1,
                },
                EnumVariant {
                    name: "NominalPower",
                    description: Some("nominal-power, high accuracy."),
                    value: 0,
                },
                EnumVariant {
                    name: "UltraLowPower",
                    description: Some("ultra-low-power, low accuracy."),
                    value: 2,
                },
            ],
        },
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "Div1",
                    description: Some("LSI not divided"),
                    value: 0,
                },
                EnumVariant {
                    name: "Div128",
                    description: Some("LSI divided by 128"),
                    value: 1,
                },
            ],
        },
        ...
        Enum {
            ...
            variants: &[
                ...
                EnumVariant {
                    name: "Hclk5",
                    description: Some("hclk5 clock selected"),
                    value: 10,
                },
                EnumVariant {
                    name: "Hse",
                ...
                EnumVariant {
                    name: "Pll1P",
                    description: Some("pll1pclk clock selected"),
                    value: 8,
                },
                EnumVariant {
                    name: "Pll1Q",
                    description: Some("pll1qclk clock selected"),
                    value: 9,
                },
                EnumVariant {
                    name: "Pll1R",
                    description: Some("pll1rclk clock selected"),
                    value: 5,
                },
                EnumVariant {
                    name: "Sysclkpre",
                    description: Some("sysclkpre system clock after PLL1RCLKPRE division selected"),
                    value: 1,
                },
            ],
        },
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "Hse",
                    description: Some("HSE32 selected."),
                    value: 0,
                },
                EnumVariant {
                    name: "HseDiv2",
                    description: Some("HSE32 divided by 2 selected."),
                    value: 2,
                },
                EnumVariant {
                    name: "Pll1P",
                ...
                EnumVariant {
                    name: "Pll1PDiv2",
                    description: Some("pll1pclk divided by 2 selected."),
                    value: 3,
                },
            ],
        },
        ...
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "Div1",
                    description: Some("pll1rclk not divided, sysclkpre = pll1rclk"),
                    value: 0,
                },
                EnumVariant {
                    name: "Divided",
                    description: Some("pll1rclk divided, sysclkpre = pll1rclk divided"),
                    value: 1,
                },
            ],
        },
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "Step2",
                    description: Some("pll1rclk 2-step division"),
                    value: 0,
                },
                EnumVariant {
                    name: "Step3",
                    description: Some("pll1rclk 3-step division"),
                    value: 1,
                },
            ],
        },
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "Freq4to8mhz",
                    description: Some("PLL2 input (ref2_ck) clock range frequency between 4 and 8 MHz"),
                    value: 0,
                },
                EnumVariant {
                    name: "Freq8to16mhz",
                    description: Some("PLL2 input (ref2_ck) clock range frequency between 8 and 16 MHz"),
                    value: 3,
                },
            ],
        },
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "Disable",
                    description: Some("no clock sent to PLL1"),
                    value: 0,
                },
                EnumVariant {
                    name: "Hse",
                    description: Some("HSE clock after HSEPRE divider selected as PLL1 clock entry"),
                    value: 3,
                },
                EnumVariant {
                    name: "Hsi",
                    description: Some("HSI clock selected as PLL1 clock entry"),
                    value: 2,
                },
            ],
        },
        ...
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "Disable",
                    description: Some("no clock selected, 2.4 GHz RADIO sleep timer kernel clock disabled"),
                    value: 0,
                },
                EnumVariant {
                    name: "Hse",
                    description: Some("HSE oscillator clock divided by 1000 selected"),
                    value: 3,
                },
                EnumVariant {
                    name: "Lse",
        ...
        Enum {
            ...
            variants: &[
                ...
                EnumVariant {
                    name: "Pll1Q",
                    description: Some("pll1qclk divide by 2 selected"),
                    value: 3,
                },
            ],
        },
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "Disable",
                    description: Some("no clock selected, RTC and TAMP kernel clock disabled"),
                    value: 0,
                },
                EnumVariant {
                    name: "Hse",
                    description: Some("HSE oscillator clock divided by 32 selected, and enabled"),
                    value: 3,
                },
                EnumVariant {
                    name: "Lse",
                    description: Some("LSE oscillator clock selected, and enabled"),
                    value: 1,
                },
                EnumVariant {
                    name: "Lsi",
                    description: Some("LSI oscillator clock selected, and enabled"),
                    value: 2,
                },
            ],
        },
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "Audioclk",
                    description: Some("input pin AUDIOCLK selected."),
                    value: 3,
                },
                EnumVariant {
                    name: "Hsi",
        ...
        Enum {
            ...
            variants: &[
                ...
                EnumVariant {
                    name: "Pclk2",
                    description: Some("pclk2 selected"),
                    value: 0,
                },
                EnumVariant {
                    name: "Sys",
        ...
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "Hse",
                    description: Some("HSE or HSE/2, as defined by HSEPRE, selected as system clock"),
                    value: 2,
                },
                EnumVariant {
                    name: "Hsi",
                ...
                EnumVariant {
                    name: "Pll1R",
                    description: Some("pll1rclk selected as system clock"),
                    value: 3,
                },
            ],
        },
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "Hclk1Div8",
                    description: Some("hclk1 divided by 8 selected"),
                    value: 0,
                },
                EnumVariant {
                    name: "Lse",
        ...
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "Hsi",
                    description: Some("HSI divider disabled"),
                    value: 0,
                },
                EnumVariant {
                    name: "HsiDiv256",
