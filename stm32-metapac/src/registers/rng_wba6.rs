...
pub(crate) static REGISTERS: IR = IR {
    blocks: &[Block {
        ...
        items: &[
            ...
            BlockItem {
                name: "nscr",
                description: Some("RNG noise source control register."),
                array: None,
                byte_offset: 0xc,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
    ...
    enums: &[
        ...
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "ConfigA",
                    description: Some("Recommended value for RNG certification (0x0000_6688)"),
                    value: 26248,
                },
                EnumVariant {
                    name: "ConfigBC",
                    description: Some("Recommended value for config B and C (not NIST certifiable) (0x0000_AAC7)"),
                    value: 43727,
                },
                EnumVariant {
                    name: "Magic",
        ...
        Enum {
            ...
            variants: &[
                ...
                EnumVariant {
                    name: "ConfigC",
                    description: Some("Recommended value for config C (not NIST certifiable) (0x0000_82)"),
                    value: 130,
                },
            ],
        },
