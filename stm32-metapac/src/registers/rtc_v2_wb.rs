...
pub(crate) static REGISTERS: IR = IR {
    blocks: &[Block {
        ...
        items: &[
            ...
            BlockItem {
                name: "tampcr",
                description: Some("Tamper configuration register"),
                array: None,
                byte_offset: 0x40,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
                    fieldset: Some("Tampcr"),
                }),
            },
            BlockItem {
                name: "alrmssr",
            ...
            BlockItem {
                ...
                array: Some(Array::Regular(RegularArray { len: 20, stride: 4 })),
                byte_offset: 0x50,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
    ...
    fieldsets: &[
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "itsf",
                    description: Some("Internal time-stamp flag"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 17 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "rtc_alarm_type",
                    description: Some("RTC_ALARM on PC13 output type"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "rtc_out_rmp",
                    description: Some("RTC_OUT remap"),
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "tampxnoerase",
                    description: Some("Tamper no erase"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 17 }),
                    bit_size: 1,
                    array: Some(Array::Regular(RegularArray { len: 3, stride: 3 })),
                    enumm: None,
                ...
                Field {
                    name: "tampxmf",
                    description: Some("Tamper mask flag"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 18 }),
                    bit_size: 1,
                    array: Some(Array::Regular(RegularArray { len: 3, stride: 3 })),
                    enumm: None,
