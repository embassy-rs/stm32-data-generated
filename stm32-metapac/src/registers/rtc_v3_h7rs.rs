...
pub(crate) static REGISTERS: IR = IR {
    ...
    fieldsets: &[
        FieldSet {
            name: "Alrbinr",
            extends: None,
            description: Some("RTC alarm binary mode register"),
            bit_size: 32,
            fields: &[Field {
                name: "ss",
                description: Some(
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "coe",
                    description: Some("Calibration output enable. This bit enables the CALIB output."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 23 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "alrfclr",
                    description: Some("Alarm flag automatic clear."),
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "alrpriv",
                    description: Some("Alarm and SSR underflow privilege protection"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 1,
                    array: Some(Array::Regular(RegularArray { len: 2, stride: 1 })),
                    enumm: Some("Priv"),
                ...
                Field {
                    name: "wutpriv",
                    description: Some("Wakeup timer privilege protection."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 2 }),
                    bit_size: 1,
                    array: None,
                    enumm: Some("Priv"),
                ...
                Field {
                    name: "tspriv",
                    description: Some("Timestamp privilege protection."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 3 }),
                    bit_size: 1,
                    array: None,
                    enumm: Some("Priv"),
                ...
                Field {
                    name: "initpriv",
                    description: Some("Initialization privilege protection."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 14 }),
                    bit_size: 1,
                    array: None,
                    enumm: Some("Priv"),
                ...
                Field {
                    name: "priv_",
                    description: Some("RTC privilege protection."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 15 }),
                    bit_size: 1,
                    array: None,
                    enumm: Some("Priv"),
    ...
    enums: &[
        ...
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "NotMatch",
                    description: Some("Date/day dont care in Alarm comparison"),
                    value: 1,
                },
                EnumVariant {
                    name: "ToMatch",
        ...
        Enum {
            ...
            variants: &[
                ...
                EnumVariant {
                    name: "WeekDay",
                    description: Some("DU[3:0] represents the week day. DT[1:0] is dont care."),
                    value: 1,
                },
            ],
        },
        ...
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "Bit10",
                    description: Some("1s calendar increment is generated each time SS[10:0] = 0"),
                    value: 3,
                },
                EnumVariant {
                    name: "Bit11",
                    description: Some("1s calendar increment is generated each time SS[11:0] = 0"),
                    value: 4,
                },
                EnumVariant {
                    name: "Bit12",
                    description: Some("1s calendar increment is generated each time SS[12:0] = 0"),
                    value: 5,
                },
                EnumVariant {
                    name: "Bit13",
                    description: Some("1s calendar increment is generated each time SS[13:0] = 0"),
                    value: 6,
                },
                EnumVariant {
                    name: "Bit14",
                    description: Some("1s calendar increment is generated each time SS[14:0] = 0"),
                    value: 7,
                },
                EnumVariant {
                    name: "Bit7",
                    description: Some("1s calendar increment is generated each time SS[7:0] = 0"),
                    value: 0,
                },
                EnumVariant {
                    name: "Bit8",
                    description: Some("1s calendar increment is generated each time SS[8:0] = 0"),
                    value: 1,
                },
                EnumVariant {
                    name: "Bit9",
                    description: Some("1s calendar increment is generated each time SS[9:0] = 0"),
                    value: 2,
                },
            ],
        },
