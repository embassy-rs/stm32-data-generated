    ...
    fieldsets: &[
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "wutwf",
                    description: Some("Wakeup timer write flag"),
                ...
                Field {
                    name: "init",
                    description: Some("Initialization mode"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 7 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            name: "Smcr",
            extends: None,
            description: Some("RTC secure mode control register"),
            bit_size: 32,
            fields: &[
                Field {
                    name: "alrdprot",
                    description: Some("Alarm x protection"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 1,
                    array: Some(Array::Regular(RegularArray { len: 2, stride: 1 })),
                    enumm: None,
                ...
                Field {
                    name: "wutdprot",
                    description: Some("Wakeup timer protection"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 2 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "tsdprot",
                    description: Some("Timestamp protection"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 3 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "caldprot",
                    description: Some("Shift register, daylight saving, calibration and reference clock protection"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 13 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "initdprot",
                    description: Some("Initialization protection"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 14 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "decprot",
                    description: Some("RTC global protection"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 15 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
