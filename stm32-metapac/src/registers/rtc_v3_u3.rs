...
pub(crate) static REGISTERS: IR = IR {
    blocks: &[Block {
        name: "Rtc",
        extends: None,
        description: Some("RTC register block."),
        items: &[
            BlockItem {
                name: "tr",
                description: Some("RTC time register."),
                array: None,
                byte_offset: 0x0,
            ...
            BlockItem {
                name: "dr",
                description: Some("RTC date register."),
                array: None,
                byte_offset: 0x4,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "ssr",
                description: Some("RTC subsecond register."),
                array: None,
                byte_offset: 0x8,
                inner: BlockItemInner::Register(Register {
                    access: Access::Read,
            ...
            BlockItem {
                name: "icsr",
                description: Some("RTC initialization control and status register."),
                array: None,
                byte_offset: 0xc,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "prer",
                description: Some("RTC prescaler register."),
                array: None,
                byte_offset: 0x10,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "wutr",
                description: Some("RTC wake-up timer register."),
                array: None,
                byte_offset: 0x14,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "cr",
                description: Some("RTC control register."),
                array: None,
                byte_offset: 0x18,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "privcr",
                description: Some("RTC privilege mode control register."),
                array: None,
                byte_offset: 0x1c,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "seccfgr",
                description: Some("RTC secure configuration register."),
                array: None,
                byte_offset: 0x20,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "wpr",
                description: Some("RTC write protection register."),
                array: None,
                byte_offset: 0x24,
                inner: BlockItemInner::Register(Register {
                    access: Access::Write,
            ...
            BlockItem {
                name: "calr",
                description: Some("RTC calibration register."),
                array: None,
                byte_offset: 0x28,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "shiftr",
                description: Some("RTC shift control register."),
                array: None,
                byte_offset: 0x2c,
                inner: BlockItemInner::Register(Register {
                    access: Access::Write,
            ...
            BlockItem {
                name: "tstr",
                description: Some("RTC timestamp time register."),
                array: None,
                byte_offset: 0x30,
                inner: BlockItemInner::Register(Register {
                    access: Access::Read,
            ...
            BlockItem {
                name: "tsdr",
                description: Some("RTC timestamp date register."),
                array: None,
                byte_offset: 0x34,
                inner: BlockItemInner::Register(Register {
                    access: Access::Read,
            ...
            BlockItem {
                name: "tsssr",
                description: Some("RTC timestamp subsecond register."),
                array: None,
                byte_offset: 0x38,
                inner: BlockItemInner::Register(Register {
                    access: Access::Read,
            ...
            BlockItem {
                name: "alrmr",
                description: Some("RTC alarm register."),
            ...
            BlockItem {
                name: "alrmssr",
                description: Some("RTC alarm subsecond register."),
                array: Some(Array::Regular(RegularArray { len: 2, stride: 8 })),
                byte_offset: 0x44,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "sr",
                description: Some("RTC status register."),
                array: None,
                byte_offset: 0x50,
                inner: BlockItemInner::Register(Register {
                    access: Access::Read,
            ...
            BlockItem {
                name: "misr",
                description: Some("RTC nonsecure masked interrupt status register."),
                array: None,
                byte_offset: 0x54,
                inner: BlockItemInner::Register(Register {
                    access: Access::Read,
            ...
            BlockItem {
                name: "smisr",
                description: Some("RTC secure masked interrupt status register."),
                array: None,
                byte_offset: 0x58,
                inner: BlockItemInner::Register(Register {
                    access: Access::Read,
            ...
            BlockItem {
                name: "scr",
                description: Some("RTC status clear register."),
                array: None,
                byte_offset: 0x5c,
                inner: BlockItemInner::Register(Register {
                    access: Access::Write,
            ...
            BlockItem {
                name: "tamptscr",
                description: Some("RTC timestamp on tamper control register."),
                array: None,
                byte_offset: 0x64,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
                    fieldset: Some("Tamptscr"),
                }),
            },
            BlockItem {
                name: "tsidr",
                description: Some("RTC timestamp status register."),
                array: None,
                byte_offset: 0x68,
                inner: BlockItemInner::Register(Register {
                    access: Access::Read,
    ...
    fieldsets: &[
        ...
        FieldSet {
            name: "Alrmssr",
            extends: None,
            description: Some("RTC alarm A subsecond register."),
            bit_size: 32,
            fields: &[
                Field {
                    name: "ss",
                    description: Some("Subseconds value."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 15,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "lpcal",
                    description: Some("RTC low-power mode."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 12 }),
                    bit_size: 1,
                    array: None,
                    enumm: Some("Lpcal"),
                ...
                Field {
                    name: "calp",
                    description: Some("Increase frequency of RTC by 488."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 15 }),
                    bit_size: 1,
                    array: None,
                    enumm: Some("Calp"),
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "wucksel",
                    description: Some("ck_wut wake-up clock selection."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 3,
                    array: None,
                    enumm: Some("Wucksel"),
                ...
                Field {
                    name: "refckon",
                    description: Some("REFIN reference clock detection enable (50 or 60Hz)."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 4 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "wute",
                    description: Some("Wake-up timer enable."),
                ...
                Field {
                    name: "wutie",
                    description: Some("Wake-up timer interrupt enable."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 14 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "alrfclr",
                    description: Some("Alarm A flag automatic clear."),
                ...
                Field {
                    name: "out2en",
                    description: Some("OUT2 output enable."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 31 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "wutwf",
                    description: Some("Wake-up timer write flag."),
                ...
                Field {
                    name: "bcdu",
                    description: Some("BCD update (BIN = 10 or 11)."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 10 }),
                    bit_size: 3,
                    array: None,
                    enumm: Some("Bcdu"),
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "alrmf",
                    description: Some("Alarm A masked flag."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 1,
                    array: Some(Array::Regular(RegularArray { len: 2, stride: 1 })),
                    enumm: None,
                ...
                Field {
                    name: "wutmf",
                    description: Some("Wake-up timer nonsecure masked flag."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 2 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "tsmf",
                    description: Some("Timestamp nonsecure masked flag."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 3 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "tsovmf",
                    description: Some("Timestamp overflow nonsecure masked flag."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 4 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "itsmf",
                    description: Some("Internal timestamp nonsecure masked flag."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 5 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "ssrumf",
                    description: Some("SSR underflow nonsecure masked flag."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 6 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "cwutf",
                    description: Some("Clear wake-up timer flag."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 2 }),
                    bit_size: 1,
                    array: None,
                    enumm: Some("Calrf"),
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "alrasec",
                    description: Some("Alarm A and SSR underflow protection."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "alrbsec",
                    description: Some("Alarm B protection."),
                ...
                Field {
                    name: "wutsec",
                    description: Some("Wake-up timer protection."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 2 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "alrmf",
                    description: Some("Alarm A interrupt secure masked flag."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 1,
                    array: Some(Array::Regular(RegularArray { len: 2, stride: 1 })),
                    enumm: None,
                ...
                Field {
                    name: "wutmf",
                    description: Some("Wake-up timer interrupt secure masked flag."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 2 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "tsmf",
                    description: Some("Timestamp interrupt secure masked flag."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 3 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "tsovmf",
                    description: Some("Timestamp overflow interrupt secure masked flag."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 4 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "itsmf",
                    description: Some("Internal timestamp interrupt secure masked flag."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 5 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "ssrumf",
                    description: Some("SSR underflow secure masked flag."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 6 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "wutf",
                    description: Some("Wake-up timer flag."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 2 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "tampts",
                    description: Some("Timestamp on external tamper TAMP1 event."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 1,
                ...
                Field {
                    name: "itampts",
                    description: Some("Timestamp on internal tamper event."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 16 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[Field {
                name: "tsid",
                description: Some("Timestamp flag source identification."),
                bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                bit_size: 6,
                array: None,
                enumm: None,
        ...
        FieldSet {
            ...
            fields: &[Field {
                name: "ss",
                description: Some("Subsecond value/synchronous binary counter values."),
                bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                bit_size: 32,
                array: None,
                enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "wut",
                    description: Some("Wake-up auto-reload value bits."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 16,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "wutoclr",
                    description: Some("Wake-up auto-reload output clear value."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 16 }),
                    bit_size: 16,
                    array: None,
                    enumm: None,
    ...
    enums: &[
        Enum {
            ...
            variants: &[
                ...
                EnumVariant {
                    name: "WeekDay",
                    description: Some("DU[3:0] represents the week day."),
                    value: 1,
                },
            ],
        },
        Enum {
            ...
            variants: &[
                ...
                EnumVariant {
                    name: "FreeRunning",
                    description: Some("The synchronous binary counter (SS[31:0] in SSR) is free-running."),
                    value: 0,
                },
            ],
        },
        ...
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "CalFreq1hz",
                    description: Some("Calibration output is 1Hz."),
                    value: 1,
                },
                EnumVariant {
                    name: "CalFreq512hz",
                    description: Some("Calibration output is 512Hz."),
                    value: 0,
                },
            ],
        },
        ...
        Enum {
            ...
            variants: &[
                ...
                EnumVariant {
                    name: "WakeUp",
                    description: Some("Wake-up output enabled."),
                    value: 3,
                },
            ],
        },
        ...
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "FallingEdge",
                    description: Some("TS input falling edge generates a timestamp event."),
                    value: 1,
                },
                EnumVariant {
                    name: "RisingEdge",
                    description: Some("TS input rising edge generates a timestamp event."),
                    value: 0,
                },
            ],
        },
