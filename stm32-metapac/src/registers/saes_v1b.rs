...
pub(crate) static REGISTERS: IR = IR {
    blocks: &[Block {
        name: "Saes",
        extends: None,
        description: Some("Secure advanced encryption standard hardware accelerator."),
        items: &[
            BlockItem {
                name: "cr",
            ...
            BlockItem {
                name: "keyr",
                description: Some("SAES key register 0."),
            ...
            BlockItem {
                name: "ivr",
                description: Some("SAES initialization vector register 0."),
    ...
    enums: &[
        ...
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "Bit",
                    description: Some("Bit-level swapping"),
                    value: 3,
                },
                EnumVariant {
                    name: "Byte",
                    description: Some("Byte swapping (8-bit data)"),
                    value: 2,
                },
                EnumVariant {
                    name: "HalfWord",
                    description: Some("Half-word swapping (16-bit data)"),
                    value: 1,
                },
                EnumVariant {
                    name: "None",
                    description: Some("No swapping (32-bit data)."),
                    value: 0,
                },
            ],
        },
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "Bhk",
                    description: Some("Boot hardware key"),
                    value: 2,
                },
                EnumVariant {
                    name: "Dhuk",
                    description: Some("Derived hardware unique key"),
                    value: 1,
                },
                EnumVariant {
                    name: "SoftwareKey",
                    description: Some("Software key, loaded in key registers SAES_KEYx"),
                    value: 0,
                },
                EnumVariant {
                    name: "XorDhukBhk",
                    description: Some("XOR of DHUK and BHK"),
                    value: 4,
                },
            ],
        },
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "Bits128",
                    description: Some("128-bit"),
                    value: 0,
                },
                EnumVariant {
                    name: "Bits256",
                    description: Some("256-bit"),
                    value: 1,
                },
            ],
        },
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "Normal",
                    description: Some("AES peripheral"),
                    value: 0,
                },
                EnumVariant {
                    name: "SharedKey",
        ...
        Enum {
            ...
            variants: &[
                ...
                EnumVariant {
                    name: "KeyDerivation",
                    description: Some("Key derivation (or key preparation), for ECB/CBC decryption only"),
                    value: 1,
                },
            ],
        },
