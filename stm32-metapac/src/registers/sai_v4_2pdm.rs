    ...
    enums: &[
        ...
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "_2mics",
                    description: Some("Configuration with 2 microphones"),
                    value: 0,
                },
                EnumVariant {
                    name: "_4mics",
                    description: Some("Configuration with 4 microphones"),
                    value: 1,
                },
                EnumVariant {
                    name: "_6mics",
                    description: Some("Configuration with 6 microphones"),
                    value: 2,
                },
                EnumVariant {
                    name: "_8mics",
                    description: Some("Configuration with 8 microphones"),
                    value: 3,
                },
            ],
        },
        ...
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "LessThan256",
                    description: Some("Master clock frequency = Fless thansub FSless than/sub x 256"),
                    value: 0,
                },
                EnumVariant {
                    name: "LessThan512",
                    description: Some("Master clock frequency = Fless thansub FSless than/sub x 512"),
                    value: 1,
                },
            ],
        },
