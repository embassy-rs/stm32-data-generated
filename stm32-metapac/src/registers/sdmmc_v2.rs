...
pub(crate) static REGISTERS: IR = IR {
    blocks: &[Block {
        ...
        items: &[
            ...
            BlockItem {
                name: "dctrl",
                description: Some("The SDMMC_DCTRL register control the data path state machine (DPSM)."),
                array: None,
                byte_offset: 0x2c,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "ver",
                description: Some("SDMMC IP version register"),
                array: None,
                byte_offset: 0x3f4,
                inner: BlockItemInner::Register(Register {
                    access: Access::Read,
            ...
            BlockItem {
                name: "id",
                description: Some("SDMMC IP identification register"),
                array: None,
                byte_offset: 0x3f8,
                inner: BlockItemInner::Register(Register {
                    access: Access::Read,
    ...
    fieldsets: &[
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "rwstart",
                    description: Some("Read wait start. If this bit is set, read wait operation starts."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 8 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "ccrcfailc",
                    description: Some("CCRCFAIL flag clear bit Set by software to clear the CCRCFAIL flag."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "dcrcfailc",
                    description: Some("DCRCFAIL flag clear bit Set by software to clear the DCRCFAIL flag."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 1 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "ctimeoutc",
                    description: Some("CTIMEOUT flag clear bit Set by software to clear the CTIMEOUT flag."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 2 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "dtimeoutc",
                    description: Some("DTIMEOUT flag clear bit Set by software to clear the DTIMEOUT flag."),
                ...
                Field {
                    name: "txunderrc",
                    description: Some("TXUNDERR flag clear bit Set by software to clear TXUNDERR flag."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 4 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "rxoverrc",
                    description: Some("RXOVERR flag clear bit Set by software to clear the RXOVERR flag."),
                ...
                Field {
                    name: "cmdrendc",
                    description: Some("CMDREND flag clear bit Set by software to clear the CMDREND flag."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 6 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "cmdsentc",
                    description: Some("CMDSENT flag clear bit Set by software to clear the CMDSENT flag."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 7 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "dataendc",
                    description: Some("DATAEND flag clear bit Set by software to clear the DATAEND flag."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 8 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "dholdc",
                    description: Some("DHOLD flag clear bit Set by software to clear the DHOLD flag."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 9 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "dbckendc",
                    description: Some("DBCKEND flag clear bit Set by software to clear the DBCKEND flag."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 10 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "dabortc",
                    description: Some("DABORT flag clear bit Set by software to clear the DABORT flag."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 11 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "busyd0endc",
                    description: Some("BUSYD0END flag clear bit Set by software to clear the BUSYD0END flag."),
                ...
                Field {
                    name: "sdioitc",
                    description: Some("SDIOIT flag clear bit Set by software to clear the SDIOIT flag."),
                ...
                Field {
                    name: "ackfailc",
                    description: Some("ACKFAIL flag clear bit Set by software to clear the ACKFAIL flag."),
                ...
                Field {
                    name: "acktimeoutc",
                    description: Some("ACKTIMEOUT flag clear bit Set by software to clear the ACKTIMEOUT flag."),
                ...
                Field {
                    name: "vswendc",
                    description: Some("VSWEND flag clear bit Set by software to clear the VSWEND flag."),
                ...
                Field {
                    name: "ckstopc",
                    description: Some("CKSTOP flag clear bit Set by software to clear the CKSTOP flag."),
                ...
                Field {
                    name: "idmatec",
                    description: Some("IDMA transfer error clear bit Set by software to clear the IDMATE flag."),
        ...
        FieldSet {
            ...
            fields: &[Field {
                name: "ip_id",
                description: Some("SDMMC IP identification."),
                bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                bit_size: 32,
                array: None,
                enumm: None,
        ...
        FieldSet {
            ...
            fields: &[Field {
                name: "cardstatus",
                description: Some("see Table 432"),
                bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                bit_size: 32,
                array: None,
                enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "rxfifof",
                    description: Some("Receive FIFO full This bit is cleared when one FIFO location becomes empty."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 17 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "txfifoe",
                    description: Some("Transmit FIFO empty This bit is cleared when one FIFO location becomes full."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 18 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "minrev",
                    description: Some("IP minor revision number."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 4,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "majrev",
                    description: Some("IP major revision number."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 4 }),
                    bit_size: 4,
                    array: None,
                    enumm: None,
