...
pub(crate) static REGISTERS: IR = IR {
    blocks: &[Block {
        name: "Syscfg",
        extends: None,
        description: Some("register block"),
        items: &[
            BlockItem {
                name: "cfgr1",
            ...
            BlockItem {
                name: "itline0",
                description: Some("interrupt line 0 status register"),
                array: None,
                byte_offset: 0x80,
                inner: BlockItemInner::Register(Register {
                    access: Access::Read,
            ...
            BlockItem {
                name: "itline2",
                description: Some("interrupt line 2 status register"),
                array: None,
                byte_offset: 0x88,
                inner: BlockItemInner::Register(Register {
                    access: Access::Read,
            ...
            BlockItem {
                name: "itline3",
                description: Some("interrupt line 3 status register"),
                array: None,
                byte_offset: 0x8c,
                inner: BlockItemInner::Register(Register {
                    access: Access::Read,
            ...
            BlockItem {
                name: "itline4",
                description: Some("interrupt line 4 status register"),
                array: None,
                byte_offset: 0x90,
                inner: BlockItemInner::Register(Register {
                    access: Access::Read,
            ...
            BlockItem {
                name: "itline5",
                description: Some("interrupt line 5 status register"),
                array: None,
                byte_offset: 0x94,
                inner: BlockItemInner::Register(Register {
                    access: Access::Read,
            ...
            BlockItem {
                name: "itline6",
                description: Some("interrupt line 6 status register"),
                array: None,
                byte_offset: 0x98,
                inner: BlockItemInner::Register(Register {
                    access: Access::Read,
            ...
            BlockItem {
                name: "itline7",
                description: Some("interrupt line 7 status register"),
                array: None,
                byte_offset: 0x9c,
                inner: BlockItemInner::Register(Register {
                    access: Access::Read,
            ...
            BlockItem {
                name: "itline9",
                description: Some("interrupt line 9 status register"),
                array: None,
                byte_offset: 0xa4,
                inner: BlockItemInner::Register(Register {
                    access: Access::Read,
            ...
            BlockItem {
                name: "itline10",
                description: Some("interrupt line 10 status register"),
                array: None,
                byte_offset: 0xa8,
                inner: BlockItemInner::Register(Register {
                    access: Access::Read,
            ...
            BlockItem {
                name: "itline11",
                description: Some("interrupt line 11 status register"),
                array: None,
                byte_offset: 0xac,
                inner: BlockItemInner::Register(Register {
                    access: Access::Read,
            ...
            BlockItem {
                name: "itline12",
                description: Some("interrupt line 12 status register"),
                array: None,
                byte_offset: 0xb0,
                inner: BlockItemInner::Register(Register {
                    access: Access::Read,
            ...
            BlockItem {
                name: "itline13",
                description: Some("interrupt line 13 status register"),
                array: None,
                byte_offset: 0xb4,
                inner: BlockItemInner::Register(Register {
                    access: Access::Read,
            ...
            BlockItem {
                name: "itline14",
                description: Some("interrupt line 14 status register"),
                array: None,
                byte_offset: 0xb8,
                inner: BlockItemInner::Register(Register {
                    access: Access::Read,
            ...
            BlockItem {
                name: "itline16",
                description: Some("interrupt line 16 status register"),
                array: None,
                byte_offset: 0xc0,
                inner: BlockItemInner::Register(Register {
                    access: Access::Read,
            ...
            BlockItem {
                name: "itline19",
                description: Some("interrupt line 19 status register"),
                array: None,
                byte_offset: 0xcc,
                inner: BlockItemInner::Register(Register {
                    access: Access::Read,
            ...
            BlockItem {
                name: "itline21",
                description: Some("interrupt line 21 status register"),
                array: None,
                byte_offset: 0xd4,
                inner: BlockItemInner::Register(Register {
                    access: Access::Read,
            ...
            BlockItem {
                name: "itline22",
                description: Some("interrupt line 22 status register"),
                array: None,
                byte_offset: 0xd8,
                inner: BlockItemInner::Register(Register {
                    access: Access::Read,
            ...
            BlockItem {
                name: "itline23",
                description: Some("interrupt line 23 status register"),
                array: None,
                byte_offset: 0xdc,
                inner: BlockItemInner::Register(Register {
                    access: Access::Read,
            ...
            BlockItem {
                name: "itline25",
                description: Some("interrupt line 25 status register"),
                array: None,
                byte_offset: 0xe4,
                inner: BlockItemInner::Register(Register {
                    access: Access::Read,
            ...
            BlockItem {
                name: "itline27",
                description: Some("interrupt line 27 status register"),
                array: None,
                byte_offset: 0xec,
                inner: BlockItemInner::Register(Register {
                    access: Access::Read,
            ...
            BlockItem {
                name: "itline28",
                description: Some("interrupt line 28 status register"),
                array: None,
                byte_offset: 0xf0,
                inner: BlockItemInner::Register(Register {
                    access: Access::Read,
    ...
    fieldsets: &[
        ...
        FieldSet {
            ...
            fields: &[Field {
                name: "tim1_cc",
                description: Some("Timer 1 capture compare interrupt request pending"),
                bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                bit_size: 1,
                array: None,
                enumm: None,
        ...
        FieldSet {
            ...
            fields: &[Field {
                name: "tim14",
                description: Some("Timer 14 interrupt request pending"),
                bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                bit_size: 1,
                array: None,
                enumm: None,
        ...
        FieldSet {
            ...
            fields: &[Field {
                name: "tim17",
                description: Some("Timer 17 interrupt request pending"),
                bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                bit_size: 1,
                array: None,
                enumm: None,
        ...
        FieldSet {
            ...
            fields: &[Field {
                name: "i2c1",
                description: Some("I2C1 interrupt request pending, combined with EXTI line 23"),
                bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                bit_size: 1,
                array: None,
                enumm: None,
        ...
        FieldSet {
            ...
            fields: &[Field {
                name: "usart2",
                description: Some("USART2 interrupt request pending (EXTI line 26)"),
                bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                bit_size: 1,
                array: None,
                enumm: None,
        ...
        FieldSet {
            ...
            fields: &[Field {
                name: "dma1_ch1",
                description: Some("DMA1 channel 1interrupt request pending"),
                bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                bit_size: 1,
                array: None,
                enumm: None,
    ...
    enums: &[
        ...
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "MainFlash",
                    description: Some("Main Flash memory mapped at address 0"),
                    value: 0,
                },
                EnumVariant {
                    name: "MainFlashAlt",
                    description: Some("Main Flash memory mapped at address 0 (alternate encoding)"),
                    value: 2,
                },
                EnumVariant {
                    name: "Sram",
                    description: Some("Embedded SRAM mapped at address 0"),
                    value: 3,
                },
                EnumVariant {
                    name: "SystemFlash",
                    description: Some("System Flash memory mapped at address 0"),
                    value: 1,
                },
            ],
        },
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "Pb7",
                    description: Some("PB7"),
                    value: 0,
                },
                EnumVariant {
                    name: "Pc14",
                    description: Some("PC14"),
                    value: 1,
                },
            ],
        },
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "Pa0",
                    description: Some("PA0"),
                    value: 1,
                },
                EnumVariant {
                    name: "Pa1",
                    description: Some("PA1"),
                    value: 2,
                },
                EnumVariant {
                    name: "Pa2",
                    description: Some("PA2"),
                    value: 3,
                },
                EnumVariant {
                    name: "Pf2",
                    description: Some("PF2"),
                    value: 0,
                },
            ],
        },
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "Pa11",
                    description: Some("PA11"),
                    value: 1,
                },
                EnumVariant {
                    name: "Pa8",
                    description: Some("PA8"),
                    value: 0,
                },
            ],
        },
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "Pa14",
                    description: Some("PA14"),
                    value: 0,
                },
                EnumVariant {
                    name: "Pb6",
                    description: Some("PB6"),
                    value: 1,
                },
                EnumVariant {
                    name: "Pc15",
                    description: Some("PC15"),
                    value: 2,
                },
            ],
        },
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "Pa12",
                    description: Some("PA12"),
                    value: 1,
                },
                EnumVariant {
                    name: "Pa7",
                    description: Some("PA7"),
                    value: 0,
                },
            ],
        },
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "Pa3",
                    description: Some("PA3"),
                    value: 0,
                },
                EnumVariant {
                    name: "Pa4",
                    description: Some("PA4"),
                    value: 1,
                },
                EnumVariant {
                    name: "Pa5",
                    description: Some("PA5"),
                    value: 2,
                },
                EnumVariant {
                    name: "Pa6",
                    description: Some("PA6"),
                    value: 3,
                },
            ],
        },
