    ...
    fieldsets: &[
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "lockup_lock",
                    description: Some("Cortex-M0 LOCKUP bit enable bit"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    ...
                    description: Some("SRAM parity lock bit"),
    ...
    enums: &[
        ...
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "Tim16",
                    description: Some("TIM16 selected"),
                    value: 0,
                },
                EnumVariant {
                    name: "Usart1",
                    description: Some("USART1 selected"),
                    value: 1,
                },
                EnumVariant {
                    name: "Usart4",
                    description: Some("USART4 selected"),
                    value: 2,
                },
            ],
        },
