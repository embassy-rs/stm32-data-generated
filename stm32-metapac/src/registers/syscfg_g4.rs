...
pub(crate) static REGISTERS: IR = IR {
    blocks: &[Block {
        ...
        items: &[
            ...
            BlockItem {
                name: "swpr",
                description: Some("SRAM Write protection register 1"),
                array: None,
                byte_offset: 0x20,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
    ...
    fieldsets: &[
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "i2c_pb6_fmp",
                    description: Some("FM+ drive capability on PB6"),
                ...
                Field {
                    name: "i2c1_fmp",
                    description: Some("I2C1 FM+ drive capability enable"),
                ...
                Field {
                    name: "fpu_ie",
                    description: Some("FPU Interrupts Enable"),
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "spl",
                    description: Some("SRAM Parity Lock"),
                ...
                Field {
                    name: "spf",
                    description: Some("SRAM Parity Flag"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 8 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[Field {
                name: "exti",
                description: Some("EXTI x configuration"),
                bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                bit_size: 4,
                array: Some(Array::Regular(RegularArray { len: 4, stride: 4 })),
                enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "fb_mode",
                    description: Some("User Flash Bank mode"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 8 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "ccmer",
                    description: Some("CCM SRAM Erase"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "ccmbsy",
                    description: Some("CCM SRAM busy by erase operation"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 1 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[Field {
                name: "key",
                description: Some("SRAM2 Key for software erase"),
                bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                bit_size: 8,
                array: None,
                enumm: None,
        ...
        FieldSet {
            name: "Swpr",
            extends: None,
            description: Some("SRAM Write protection register"),
            bit_size: 32,
            fields: &[Field {
                name: "page_wp",
