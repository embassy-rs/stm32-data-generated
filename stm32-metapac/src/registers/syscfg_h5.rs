...
pub(crate) static REGISTERS: IR = IR {
    blocks: &[Block {
        name: "Syscfg",
        extends: None,
        description: Some("SBS register block"),
        items: &[
            BlockItem {
                name: "hdplcr",
            ...
            BlockItem {
                name: "nexthdplcr",
                description: Some("SBS next HDPL control register"),
                array: None,
                byte_offset: 0x18,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
                    fieldset: Some("Nexthdplcr"),
                }),
            },
            BlockItem {
                name: "dbgcr",
            ...
            BlockItem {
                name: "rsscmdr",
                description: Some("SBS RSS command register"),
                array: None,
                byte_offset: 0x34,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "epochselcr",
                description: Some("SBS EPOCH selection control register"),
                array: None,
                byte_offset: 0xa0,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
                    fieldset: Some("Epochselcr"),
                }),
            },
            BlockItem {
                name: "seccfgr",
                description: Some("SBS security mode configuration control register"),
                array: None,
                byte_offset: 0xc0,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "cnslckr",
                description: Some("SBS CPU non-secure lock register"),
                array: None,
                byte_offset: 0x144,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "cslckr",
                description: Some("SBS CPU secure lock register"),
                array: None,
                byte_offset: 0x148,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
    ...
    fieldsets: &[
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "eth_sel_phy",
                    description: Some("Ethernet PHY interface selection\r Other: reserved"),
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "classbsec",
                    description: Some("ClassB security enable"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 1 }),
                    bit_size: 1,
                    array: None,
                    enumm: Some("Sec"),
                ...
                Field {
                    name: "sdce_sec_en",
                    description: Some("control accessibility of SMPS_DIV_CLOCK _EN in SBS_PMCR"),
    ...
    enums: &[
        ...
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "B0x0",
                    description: Some("SEC_EPOCH counter input selected"),
                    value: 0,
                },
                EnumVariant {
                    name: "B0x1",
                    description: Some("NS_EPOCH (non-secure) input selected"),
                    value: 1,
                },
            ],
        },
        Enum {
            ...
            variants: &[
                ...
                EnumVariant {
                    name: "ReservedRgmii",
                    description: Some("reserved (RGMII)"),
                    value: 1,
                },
                EnumVariant {
                    name: "Rmii",
        ...
        Enum {
            ...
            variants: &[
                ...
                EnumVariant {
                    name: "B0x6f",
                    description: Some("HDPL3, application (secure/non-secure)"),
                    value: 111,
                },
                EnumVariant {
                    name: "B0x8a",
        ...
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "B0x0",
                    description: Some("SBS_CFGR2 register accessible through secure or non-secure transaction"),
                    value: 0,
                },
                EnumVariant {
                    name: "B0x1",
                    description: Some("SBS_CFGR2 register only accessible through secure transaction"),
                    value: 1,
                },
            ],
        },
