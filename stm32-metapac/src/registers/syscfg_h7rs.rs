...
pub(crate) static REGISTERS: IR = IR {
    blocks: &[Block {
        ...
        items: &[
            BlockItem {
                name: "bootsr",
                description: Some("SBS boot status register."),
                array: None,
                byte_offset: 0x0,
            ...
            BlockItem {
                name: "hdplcr",
                description: Some("SBS hide protection control register."),
                array: None,
                byte_offset: 0x10,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "hdplsr",
                description: Some("SBS hide protection status register."),
                array: None,
                byte_offset: 0x14,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "cccsr",
                description: Some("SBS I/O compensation cell control and status register."),
                array: None,
                byte_offset: 0x110,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "ccswvalr",
                description: Some("SBS compensation cell for I/Os software value register."),
                array: None,
                byte_offset: 0x118,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
                    fieldset: Some("Ccswvalr"),
                }),
            },
            BlockItem {
                name: "bklockr",
                description: Some("SBS break lockup register."),
                array: None,
                byte_offset: 0x120,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
                    fieldset: Some("Bklockr"),
                }),
            },
            BlockItem {
                name: "exticr",
    ...
    fieldsets: &[
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "comp_en",
                    description: Some("Compensation cell enable Set this bit to enable the compensation cell."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "comp_rdy",
                    description: Some("Compensation cell ready This bit provides the status of the compensation cell."),
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "ap_unlock",
                    description: Some("access port unlock Write 0xB4 to this bitfield to open the device access port."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 8,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "fmplus_pb6",
                    description: Some("Fast-mode Plus on PB(6)."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 4 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "fmplus_pb7",
                    description: Some("Fast-mode Plus on PB(7)."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 5 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "fmplus_pb8",
                    description: Some("Fast-mode Plus on PB(8)."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 6 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "fmplus_pb9",
                    description: Some("Fast-mode Plus on PB(9)."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 7 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
    ...
    enums: &[
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "Ws0",
                    description: Some("No wait state added when accessing any AXIRAM with ECC = 0."),
                    value: 0,
                },
                EnumVariant {
                    name: "Ws1",
        ...
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "Hdpl0",
                    description: Some("HDPL0, corresponding to ST-RSS (default when device is close)."),
                    value: 180,
                },
                EnumVariant {
                    name: "Hdpl1",
