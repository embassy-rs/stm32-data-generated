...
pub(crate) static REGISTERS: IR = IR {
    blocks: &[Block {
        ...
        items: &[
            BlockItem {
                name: "seccfgr",
                description: Some("secure configuration register"),
                array: None,
                byte_offset: 0x0,
            ...
            BlockItem {
                name: "cnslckr",
                description: Some("CPU non-secure lock register"),
                array: None,
                byte_offset: 0xc,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "cslockr",
                description: Some("CPU secure lock register"),
                array: None,
                byte_offset: 0x10,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
    ...
    fieldsets: &[
        ...
        FieldSet {
            ...
            fields: &[Field {
                name: "rsscmd",
                description: Some("RSS commands\r This field defines a command to be executed by the RSS."),
                bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                bit_size: 16,
                array: None,
                enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "syscfgsec",
                    description: Some("clock control, memory erase status and compensation cell registers security"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
