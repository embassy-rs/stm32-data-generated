...
pub(crate) static REGISTERS: IR = IR {
    blocks: &[Block {
        ...
        items: &[
            ...
            BlockItem {
                name: "hwcfgr2",
                description: Some("TAMP hardware configuration register 2"),
                array: None,
                byte_offset: 0x3ec,
                inner: BlockItemInner::Register(Register {
                    access: Access::Read,
                    bit_size: 32,
                    fieldset: Some("Hwcfgr2"),
                }),
            },
            BlockItem {
                name: "hwcfgr1",
                description: Some("TAMP hardware configuration register 1"),
                array: None,
                byte_offset: 0x3f0,
                inner: BlockItemInner::Register(Register {
                    access: Access::Read,
                    bit_size: 32,
                    fieldset: Some("Hwcfgr1"),
                }),
            },
            BlockItem {
                name: "verr",
    ...
    fieldsets: &[
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "active_tamper",
                    description: Some("ACTIVE_TAMPER"),
        ...
        FieldSet {
            ...
            fields: &[Field {
                name: "ipid",
                description: Some("IP Identification"),
                bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                bit_size: 32,
                array: None,
                enumm: None,
        ...
        FieldSet {
            ...
            fields: &[Field {
                name: "sid",
                description: Some("Size Identification"),
                bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                bit_size: 32,
                array: None,
                enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "minrev",
                    description: Some("Minor Revision number"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 4,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "majrev",
                    description: Some("Major Revision number"),
