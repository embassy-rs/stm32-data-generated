...
pub(crate) static REGISTERS: IR = IR {
    blocks: &[Block {
        name: "Tamp",
        extends: None,
        description: Some("TAMP register block."),
        items: &[
            BlockItem {
                name: "cr1",
            ...
            BlockItem {
                name: "misr",
                description: Some("TAMP nonsecure masked interrupt status register."),
                array: None,
                byte_offset: 0x34,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "bkpr",
                description: Some("TAMP backup X register"),
    ...
    fieldsets: &[
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "tampam",
                    description: Some("Tamper X active mode"),
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "tampe",
                    description: Some("Tamper detection on INx enable"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 1,
                    array: Some(Array::Regular(RegularArray { len: 6, stride: 1 })),
                    enumm: None,
                ...
                Field {
                    ...
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 16 }),
                    bit_size: 1,
                    array: Some(Array::Regular(RegularArray { len: 13, stride: 1 })),
                    enumm: None,
                },
            ],
        },
        ...
        FieldSet {
            ...
            fields: &[Field {
                name: "itamppom",
                description: Some("Internal Tamper X potential mode"),
                bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                bit_size: 1,
                array: Some(Array::Regular(RegularArray { len: 13, stride: 1 })),
                enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "tampflt",
                    description: Some("INx filter count."),
                ...
                Field {
                    name: "tampprch",
                    description: Some("INx precharge duration."),
                ...
                Field {
                    name: "tamppudis",
                    description: Some("INx pull-up disable."),
        ...
        FieldSet {
            ...
            fields: &[Field {
                name: "rpcfg",
                description: Some("Configurable resource X protection."),
    ...
    enums: &[
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "Div1",
                    description: Some("RTCCLK is selected"),
                    value: 0,
                },
                EnumVariant {
                    name: "Div128",
        ...
        Enum {
            ...
            variants: &[
                EnumVariant {
                    ...
                    description: Some("If TAMPFLT 00 Tamper 2 input staying high triggers a tamper detection event."),
                    value: 1,
                },
                EnumVariant {
                    name: "FilteredLowOrUnfilteredHigh",
                    description: Some("If TAMPFLT 00 Tamper 2 input staying low triggers a tamper detection event."),
                    value: 0,
                },
            ],
        },
