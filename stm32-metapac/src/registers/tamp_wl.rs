...
pub(crate) static REGISTERS: IR = IR {
    blocks: &[Block {
        ...
        items: &[
            ...
            BlockItem {
                name: "countr",
                description: Some("monotonic counter register"),
                array: None,
                byte_offset: 0x40,
                inner: BlockItemInner::Register(Register {
                    access: Access::Read,
    ...
    fieldsets: &[
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "tampe",
                    description: Some("Tamper detection on IN X enable"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                    bit_size: 1,
                ...
                Field {
                    name: "itampe",
                    description: Some("Internal tamper X enable"),
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "tampmsk",
                    description: Some("Tamper X mask. The tamper X interrupt must not be enabled when TAMPMSK is set."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 16 }),
                    bit_size: 1,
                    array: Some(Array::Regular(RegularArray { len: 3, stride: 1 })),
                    enumm: Some("Tampmsk"),
                ...
                Field {
                    name: "bkerase",
                    description: Some("Backup registers erase"),
    ...
    enums: &[
        Enum {
            ...
            variants: &[EnumVariant {
                name: "Reset",
                description: Some("Reset backup registers"),
                value: 1,
            }],
        },
        Enum {
