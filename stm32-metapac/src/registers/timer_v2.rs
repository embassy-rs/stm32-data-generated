    ...
    enums: &[
        ...
        Enum {
            ...
            variants: &[
                ...
                EnumVariant {
                    name: "QuadratureEncoderModeX1Ti1pf1",
                    description: Some(
                ...
                EnumVariant {
                    name: "QuadratureEncoderModeX1Ti2pf2",
                    description: Some(
