...
pub(crate) static REGISTERS: IR = IR {
    blocks: &[Block {
        ...
        items: &[
            ...
            BlockItem {
                name: "ipver",
                description: Some("UCPD IP ID register"),
                array: None,
                byte_offset: 0x3f4,
                inner: BlockItemInner::Register(Register {
                    access: Access::Read,
    ...
    fieldsets: &[
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "cc1vconnen",
                    description: Some("VCONN switch enable for CC1"),
                ...
                Field {
                    name: "cc2vconnen",
                    description: Some("VCONN switch enable for CC2"),
