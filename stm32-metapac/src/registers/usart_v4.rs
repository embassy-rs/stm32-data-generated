    ...
    fieldsets: &[
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "fifoen",
                    description: Some("FIFO mode enable"),
                ...
                Field {
                    name: "txfeie",
                    description: Some("TXFIFO empty interrupt enable"),
                ...
                Field {
                    name: "rxffie",
                    description: Some("RXFIFO Full interrupt enable"),
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "txftie",
                    description: Some("TXFIFO threshold interrupt enable"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 23 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "rxftcfg",
                    description: Some("Receive FIFO threshold configuration"),
                ...
                Field {
                    name: "txftcfg",
                    description: Some("TXFIFO threshold configuration"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 29 }),
                    bit_size: 3,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "txft",
                    description: Some("TXFIFO threshold flag"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 27 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
    ...
    enums: &[
        ...
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "Div1",
                    description: Some("input clock not divided"),
                    value: 0,
                },
                EnumVariant {
                    name: "Div10",
                    description: Some("input clock divided by 10"),
                    value: 5,
                },
                EnumVariant {
                    name: "Div12",
                    description: Some("input clock divided by 12"),
                    value: 6,
                },
                EnumVariant {
                    name: "Div128",
                    description: Some("input clock divided by 128"),
                    value: 10,
                },
                EnumVariant {
                    name: "Div16",
                    description: Some("input clock divided by 16"),
                    value: 7,
                },
                EnumVariant {
                    name: "Div2",
                    description: Some("input clock divided by 2"),
                    value: 1,
                },
                EnumVariant {
                    name: "Div256",
                    description: Some("input clock divided by 256"),
                    value: 11,
                },
                EnumVariant {
                    name: "Div32",
                    description: Some("input clock divided by 32"),
                    value: 8,
                },
                EnumVariant {
                    name: "Div4",
                    description: Some("input clock divided by 4"),
                    value: 2,
                },
                EnumVariant {
                    name: "Div6",
                    description: Some("input clock divided by 6"),
                    value: 3,
                },
                EnumVariant {
                    name: "Div64",
                    description: Some("input clock divided by 64"),
                    value: 9,
                },
                EnumVariant {
                    name: "Div8",
                    description: Some("input clock divided by 8"),
                    value: 4,
                },
            ],
        },
