...
pub(crate) static REGISTERS: IR = IR {
    blocks: &[Block {
        ...
        items: &[
            ...
            BlockItem {
                name: "bcdr",
                description: Some("Battery Charging Detector"),
                array: None,
                byte_offset: 0x58,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
    ...
    fieldsets: &[
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "bcden",
                    description: Some("Battery charging detector mode enable"),
                ...
                Field {
                    name: "dcden",
                    description: Some("Data contact detection mode enable"),
                ...
                Field {
                    name: "pden",
                    description: Some("Primary detection mode enable"),
                ...
                Field {
                    name: "sden",
                    description: Some("Secondary detection mode enable"),
                ...
                Field {
                    name: "dcdet",
                    description: Some("Data contact detection status"),
                ...
                Field {
                    name: "pdet",
                    description: Some("Primary detection status"),
                ...
                Field {
                    name: "sdet",
                    description: Some("Secondary detection status"),
                ...
                Field {
                    name: "dppu",
                    description: Some("DP pull-up control"),
    ...
    enums: &[
        ...
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "Cdp",
                    description: Some("CDP detected"),
                    value: 0,
                },
                EnumVariant {
                    name: "Dcp",
                    description: Some("DCP detected"),
                    value: 1,
                },
            ],
        },
