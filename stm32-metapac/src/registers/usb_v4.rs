...
pub(crate) static REGISTERS: IR = IR {
    blocks: &[Block {
        name: "Usb",
        extends: None,
        description: Some("Universal serial bus full-speed host/device interface"),
        items: &[
            BlockItem {
                name: "epr",
                description: Some("endpoint/channel"),
    ...
    fieldsets: &[
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "pdet",
                    description: Some("Primary detection (PD) status Device mode This bit gives the result of PD."),
                ...
                Field {
                    name: "sdet",
                    description: Some("Secondary detection (SD) status Device mode This bit gives the result of SD."),
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "l1reqm",
                    description: Some("LPM L1 state request interrupt mask"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 7 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "resetm",
                    description: Some("reset interrupt mask"),
                ...
                Field {
                    name: "thr512m",
                    description: Some("512 byte threshold interrupt mask"),
        ...
        FieldSet {
            name: "Epr",
            extends: None,
            description: Some("endpoint/channel 0 register"),
            bit_size: 32,
            fields: &[
                Field {
                    name: "ea",
    ...
    enums: &[
        ...
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "Ack",
                    description: Some("The valid LPM Token will be ACK / ACK answer"),
                    value: 1,
                },
                EnumVariant {
                    name: "Nyet",
                    description: Some("The valid LPM Token will be NYET / NYET answer"),
                    value: 0,
                },
            ],
        },
