...
pub(crate) static REGISTERS: IR = IR {
    blocks: &[Block {
        name: "Xspi",
        extends: None,
        description: Some("XSPI register block"),
        items: &[
            BlockItem {
                name: "cr",
                description: Some("XSPI control register"),
                array: None,
                byte_offset: 0x0,
            ...
            BlockItem {
                name: "dcr1",
                description: Some("XSPI device configuration register 1"),
                array: None,
                byte_offset: 0x8,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "dcr2",
                description: Some("XSPI device configuration register 2"),
                array: None,
                byte_offset: 0xc,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "dcr3",
                description: Some("XSPI device configuration register 3"),
                array: None,
                byte_offset: 0x10,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "dcr4",
                description: Some("XSPI device configuration register 4"),
                array: None,
                byte_offset: 0x14,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "sr",
                description: Some("XSPI status register"),
                array: None,
                byte_offset: 0x20,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "fcr",
                description: Some("XSPI flag clear register"),
                array: None,
                byte_offset: 0x24,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "dlr",
                description: Some("XSPI data length register"),
                array: None,
                byte_offset: 0x40,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "ar",
                description: Some("XSPIaddress register"),
                array: None,
                byte_offset: 0x48,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "dr",
                description: Some("XSPI data register"),
                array: None,
                byte_offset: 0x50,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "psmkr",
                description: Some("XSPI polling status mask register"),
                array: None,
                byte_offset: 0x80,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "psmar",
                description: Some("XSPI polling status match register"),
                array: None,
                byte_offset: 0x88,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "pir",
                description: Some("XSPI polling interval register"),
                array: None,
                byte_offset: 0x90,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "ccr",
                description: Some("XSPI communication configuration register"),
                array: None,
                byte_offset: 0x100,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "tcr",
                description: Some("XSPI timing configuration register"),
                array: None,
                byte_offset: 0x108,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "ir",
                description: Some("XSPI instruction register"),
                array: None,
                byte_offset: 0x110,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "abr",
                description: Some("XSPI alternate bytes register"),
                array: None,
                byte_offset: 0x120,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "lptr",
                description: Some("XSPI low-power timeout register"),
                array: None,
                byte_offset: 0x130,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "wpccr",
                description: Some("XSPI wrap communication configuration register"),
                array: None,
                byte_offset: 0x140,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "wptcr",
                description: Some("XSPI wrap timing configuration register"),
                array: None,
                byte_offset: 0x148,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "wpir",
                description: Some("XSPI wrap instruction register"),
                array: None,
                byte_offset: 0x150,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "wpabr",
                description: Some("XSPI wrap alternate byte register"),
                array: None,
                byte_offset: 0x160,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "wccr",
                description: Some("XSPI write communication configuration register"),
                array: None,
                byte_offset: 0x180,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "wtcr",
                description: Some("XSPI write timing configuration register"),
                array: None,
                byte_offset: 0x188,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "wir",
                description: Some("XSPI write instruction register"),
                array: None,
                byte_offset: 0x190,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "wabr",
                description: Some("XSPI write alternate byte register"),
                array: None,
                byte_offset: 0x1a0,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "hlcr",
                description: Some("XSPI HyperBus latency configuration register"),
                array: None,
                byte_offset: 0x200,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "calfcr",
                description: Some("XSPI full-cycle calibration configuration"),
                array: None,
                byte_offset: 0x210,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
                    fieldset: Some("Calfcr"),
                }),
            },
            BlockItem {
                name: "calmr",
                description: Some("XSPI DLL master calibration configuration"),
                array: None,
                byte_offset: 0x218,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
            ...
            BlockItem {
                name: "calsor",
                description: Some("XSPI DLL slave output calibration configuration"),
                array: None,
                byte_offset: 0x220,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
                    fieldset: Some("Calsor"),
                }),
            },
            BlockItem {
                name: "calsir",
                description: Some("XSPI DLL slave input calibration configuration"),
                array: None,
                byte_offset: 0x228,
                inner: BlockItemInner::Register(Register {
                    access: Access::ReadWrite,
                    bit_size: 32,
                    fieldset: Some("Calsir"),
                }),
            },
        ],
    }],
    fieldsets: &[
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "isize",
                    description: Some("Instruction size\r This bit defines instruction size."),
                ...
                Field {
                    name: "adsize",
                    description: Some("Address size\r This field defines address size."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 12 }),
                    bit_size: 2,
                    array: None,
                    enumm: Some("CcrAdsize"),
                },
                Field {
                    name: "abmode",
                    description: Some(
                ...
                Field {
                    name: "absize",
                    description: Some("Alternate bytes size\r This bit defines alternate bytes size."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 20 }),
                    bit_size: 2,
                    array: None,
                    enumm: Some("CcrAbsize"),
                },
                Field {
                    name: "dmode",
                    description: Some(
                ...
                Field {
                    name: "ddtr",
                    description: Some("Data double transfer rate\r This bit sets the DTR mode for the data phase."),
                ...
                Field {
                    name: "dqse",
                    description: Some("DQS enable\r This bit enables the data strobe management."),
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "smie",
                    description: Some("Status match interrupt enable\r This bit enables the status match interrupt."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 19 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
                ...
                Field {
                    name: "toie",
                    description: Some("Timeout interrupt enable\r This bit enables the timeout interrupt."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 20 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "frck",
                    description: Some("Free running clock\r This bit configures the free running clock."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 1 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "ctof",
                    description: Some("Clear timeout flag\r Writing 1 clears the TOF flag in the XSPI_SR register."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 4 }),
                    bit_size: 1,
                    array: None,
                    enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "wzl",
                    description: Some("Write zero latency\r This bit enables zero latency on write operations."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 1 }),
                    bit_size: 1,
                    array: None,
                    enumm: Some("Wzl"),
        ...
        FieldSet {
            ...
            fields: &[Field {
                name: "instruction",
                description: Some("Instruction\r Instruction to be sent to the external SPI device"),
                bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                bit_size: 32,
                array: None,
                enumm: None,
        ...
        FieldSet {
            ...
            fields: &[Field {
                name: "match_",
                description: Some("Status match\r Value to be compared with the masked status register to get a match"),
                bit_offset: BitOffset::Regular(RegularBitOffset { offset: 0 }),
                bit_size: 32,
                array: None,
                enumm: None,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "absize",
                    description: Some("Alternate bytes size\r This field defines alternate bytes size:"),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 20 }),
                    bit_size: 2,
                    array: None,
                    enumm: Some("WccrAbsize"),
                },
                Field {
                    name: "dmode",
                    description: Some("Data mode\r This field defines the data phase mode of operation."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 24 }),
                    bit_size: 3,
                    array: None,
                    enumm: Some("WccrDmode"),
                },
                Field {
                    name: "ddtr",
                    description: Some("data double transfer rate\r This bit sets the DTR mode for the data phase."),
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "isize",
                    description: Some("Instruction size\r This field defines instruction size."),
                    bit_offset: BitOffset::Regular(RegularBitOffset { offset: 4 }),
                    bit_size: 2,
                    array: None,
                    enumm: Some("WpccrIsize"),
                },
                Field {
                    name: "admode",
                    description: Some(
    ...
    enums: &[
        Enum {
            ...
            variants: &[
                ...
                EnumVariant {
                    name: "B0x1",
                    description: Some("Automatic status-polling mode stops as soon as there is a match."),
                    value: 1,
                },
            ],
        },
        ...
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "B0x0",
                    description: Some("no address"),
                    value: 0,
                },
                EnumVariant {
                    name: "B0x1",
                    description: Some("address on a single line"),
                    value: 1,
                },
                EnumVariant {
                    name: "B0x2",
                    description: Some("address on two lines"),
                    value: 2,
                },
                EnumVariant {
                    name: "B0x3",
                    description: Some("address on four lines"),
                    value: 3,
                },
                EnumVariant {
                    name: "B0x4",
                    description: Some("address on eight lines"),
                    value: 4,
                },
            ],
        },
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "B0x0",
                    description: Some("8-bit address"),
                    value: 0,
                },
                EnumVariant {
                    name: "B0x1",
                    description: Some("16-bit address"),
                    value: 1,
                },
                EnumVariant {
                    name: "B0x2",
                    description: Some("24-bit address"),
                    value: 2,
                },
                EnumVariant {
                    name: "B0x3",
                    description: Some("32-bit address"),
                    value: 3,
                },
            ],
        },
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "B0x0",
                    description: Some("no data"),
                    value: 0,
                },
                EnumVariant {
                    name: "B0x1",
                    description: Some("data on a single line"),
                    value: 1,
                },
                EnumVariant {
                    name: "B0x2",
                    description: Some("data on two lines"),
                    value: 2,
                },
                EnumVariant {
                    name: "B0x3",
                    description: Some("data on four lines"),
                    value: 3,
                },
                EnumVariant {
                    name: "B0x4",
                    description: Some("data on eight lines"),
                    value: 4,
                },
                EnumVariant {
                    name: "B0x5",
                    description: Some("data on 16 lines"),
                    value: 5,
                },
            ],
        },
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "B0x0",
                    description: Some("no instruction"),
                    value: 0,
                },
                EnumVariant {
                    name: "B0x1",
                    description: Some("instruction on a single line"),
                    value: 1,
                },
                EnumVariant {
                    name: "B0x2",
                    description: Some("instruction on two lines"),
                    value: 2,
                },
                EnumVariant {
                    name: "B0x3",
                    description: Some("instruction on four lines"),
                    value: 3,
                },
                EnumVariant {
                    name: "B0x4",
                    description: Some("instruction on eight lines"),
                    value: 4,
                },
            ],
        },
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "B0x0",
                    description: Some("8-bit instruction"),
                    value: 0,
                },
                EnumVariant {
                    name: "B0x1",
                    description: Some("16-bit instruction"),
                    value: 1,
                },
                EnumVariant {
                    name: "B0x2",
                    description: Some("24-bit instruction"),
                    value: 2,
                },
                EnumVariant {
                    name: "B0x3",
                    description: Some("32-bit instruction"),
                    value: 3,
                },
            ],
        },
        ...
        Enum {
            ...
            variants: &[EnumVariant {
                name: "B0x0",
                description: Some("NCS boundary disabled"),
                value: 0,
            }],
        },
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "B0x0",
                    description: Some("NCS stays high for at least 1 cycle between external device commands."),
                    value: 0,
                },
                EnumVariant {
                    name: "B0x1",
                    description: Some("NCS stays high for at least 2 cycles between external device commands."),
                    value: 1,
                },
                EnumVariant {
                    name: "B0x3f",
                    description: Some("NCS stays high for at least 64 cycles between external device commands."),
                    value: 63,
                },
            ],
        },
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "B0x0",
                    description: Some("NCS1 active"),
                    value: 0,
                },
                EnumVariant {
                    name: "B0x1",
                    description: Some("NCS2 active"),
                    value: 1,
                },
            ],
        },
        ...
        Enum {
            ...
            variants: &[
                ...
                EnumVariant {
                    name: "B0x3f",
                    description: Some("FTF is set if there are 64 free bytes available to be written to in the FIFO"),
                    value: 63,
                },
            ],
        },
        ...
        Enum {
            ...
            variants: &[EnumVariant {
                name: "B0x0",
                description: Some("maximum communication disabled"),
                value: 0,
            }],
        },
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "B0x0",
                    description: Some("data exchanged over IO[3:0]"),
                    value: 0,
                },
                EnumVariant {
                    name: "B0x1",
                    description: Some("data exchanged over IO[7:4]"),
                    value: 1,
                },
                EnumVariant {
                    name: "B0x2",
                    description: Some("data exchanged over IO[11:8]"),
                    value: 2,
                },
                EnumVariant {
                    name: "B0x3",
                    description: Some("data exchanged over IO[15:12]"),
                    value: 3,
                },
            ],
        },
        ...
        Enum {
            ...
            variants: &[EnumVariant {
                name: "B0x0",
                description: Some("refresh disabled"),
                value: 0,
            }],
        },
        Enum {
        ...
        Enum {
            ...
            variants: &[
                ...
                EnumVariant {
                    name: "B0x7",
                    description: Some("DATA reserved"),
                    value: 7,
                },
            ],
        },
        ...
        Enum {
            ...
            variants: &[
                ...
                EnumVariant {
                    name: "B0x5",
                    description: Some("alternate bytes on 16 lines"),
                    value: 5,
                },
                EnumVariant {
                    name: "B0x7",
        ...
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "B0x0",
                    description: Some("wrapped reads are not supported by the memory."),
                    value: 0,
                },
                EnumVariant {
                    name: "B0x2",
                    description: Some("external memory supports wrap size of 16 bytes."),
                    value: 2,
                },
                EnumVariant {
                    name: "B0x3",
                    description: Some("external memory supports wrap size of 32 bytes."),
                    value: 3,
                },
                EnumVariant {
                    name: "B0x4",
                    description: Some("external memory supports wrap size of 64 bytes."),
                    value: 4,
                },
                EnumVariant {
                    name: "B0x5",
                    description: Some("external memory supports wrap size of 128 bytes."),
                    value: 5,
                },
            ],
        },
        Enum {
            ...
            variants: &[
                EnumVariant {
                    name: "B0x0",
                    description: Some("latency on write accesses"),
                    value: 0,
                },
                EnumVariant {
                    name: "B0x1",
                    description: Some("no latency on write accesses"),
                    value: 1,
                },
            ],
        },
